...
:GENERATE_INSTALL
"%PATH_ASM%\CENServicesGenerator.exe" "..\..\..\source\middleware\SG\AdminVCC\AdminVCC.sgp" -c -v "SG-OUTPUT-DIR|c:\COBIS-SG\Output\;MVN-REP-ID|cobis-dev;MVN-REP-URL|http://repolib.cobiscorp.com:8081/nexus/content/repositories/cobis-dev-maven/;MVN-GOAL|install;NUGET-REP-URL|local"

@echo off
rem ***********************************************************************
rem *    ARCHIVO:         cr_genestctaxml.bat
rem *    NOMBRE LOGICO:   N/A
rem *    PRODUCTO:        COB_CREDITO
rem ***********************************************************************
rem *                     IMPORTANTE
...
rem ***********************************************************************
rem *                     PROPOSITO
rem *  realiza la generacion de estados en cuenta 
rem ***********************************************************************
...
java -jar cloud-generatexml-cfdi-1.0.0-jar-with-dependencies.jar %1 

goto fin

:ayuda
echo full.cmd [parametro 1] 
echo [parametro 1]: Ruta Estado de Cuenta XML

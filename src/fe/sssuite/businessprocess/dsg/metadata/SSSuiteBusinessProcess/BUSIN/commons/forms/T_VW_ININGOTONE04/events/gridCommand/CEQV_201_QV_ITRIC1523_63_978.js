//gridCommand (Button) QueryView: GridRefinancingOperations
    ...
    task.gridCommand.CEQV_201_QV_ITRIC1523_63_978 = function(entities, gridExecuteCommandEventArgs) { // GridCommand
																										// (Button)
																										// QueryView:
																										// Borrowers
    	...
    	entities.GeneralParameters ={acronymRule : "VALPORREN",

...
designerEvents.api.executionexpromision = designerEvents.api.executionexpromision || designer.dsgEvents();

function VC_EEIIN03_XTFOM_383(cobisMainModule) {
    cobisMainModule.controllerProvider.register("VC_EEIIN03_XTFOM_383_MAIN_CTRL", ["$scope", "breadcrumbs",

    function($scope, breadcrumbs) {
        $scope.breadcrumbs = breadcrumbs;
    }]);
    cobisMainModule.controllerProvider.register("VC_EEIIN03_XTFOM_383_CTRL", ["cobisMessage", cobis.modules.CONTAINER + ".preferencesService", "dsgnrUtils", "designer", "$scope", "$location", "$document", "$parse", "$filter", "$modal", "$q", "$compile", "$timeout",
    ...
    function(cobisMessage, preferencesService, dsgnrUtils, designer, $scope, $location, $document, $parse, $filter, $modal, $q, $compile, $timeout) {
        ...
        $scope.vc = designer.initViewContainer({
            moduleId: "BUSIN",
            subModuleId: "FLCRE",
            taskId: "T_FLCRE_31_EEIIN03",
            taskVersion: "1.0.0",
            viewContainerId: "VC_EEIIN03_XTFOM_383",
            hasCloseModalEvent: false,
            serverEvents: true
        },
            "${contextPath}/resources/BUSIN/FLCRE/T_FLCRE_31_EEIIN03",
        designerEvents.api.executionexpromision,
        $scope.rowData);
        ...
        if (!$scope.vc.loaded) {
            ...
            $scope.vc.viewState.VC_EEIIN03_XTFOM_383 = {
                style: []
            }
            //ViewState - Container: executionExpromisionForm
            $scope.vc.createViewState({
                id: "VC_EEIIN03_XTFOM_383",
                hasId: true,
                componentStyle: "",
                label: 'executionExpromisionForm',
                enabled: designer.constants.mode.All
            });
            //ViewState - Container: HearderView
            $scope.vc.createViewState({
                id: "VC_EEIIN03_DRVIW_305",
                hasId: true,
                componentStyle: "",
                label: 'HearderView',
                enabled: designer.constants.mode.All
            ...
            }]; //ViewState - Container: OperationsView
            $scope.vc.createViewState({
                id: "VC_EEIIN03_PRATI_666",
                hasId: true,
                componentStyle: "",
            ...
            }]; //ViewState - Container: PaytmentPlan
            $scope.vc.createViewState({
                id: "VC_EEIIN03_AETLN_775",
                hasId: true,
                componentStyle: "",
        ...
        $scope._initPage_ProcessRender = function(page) {
            if (page.hasSearchRenderEvent) {
                $scope.vc.render('VC_EEIIN03_XTFOM_383');
            }
            return page;
        };
...
if (typeof cobisMainModule === "undefined") {
    var cobisMainModule = cobis.createModule("VC_EEIIN03_XTFOM_383", ["ngResource", "ngRoute", "kendo.directives", "ui.bootstrap", "oc.lazyLoad", "pascalprecht.translate", cobis.modules.CONTAINER, "designerModule"], ["DSGNR", "BUSIN"]);
    ...
    function($controllerProvider, $compileProvider, $filterProvider, $locationProvider, $routeProvider, $provide, $translateProvider, $translatePartialLoaderProvider, $ocLazyLoadProvider) {
        ...
        $routeProvider.when("/VC_EEIIN03_XTFOM_383", {
            templateUrl: "VC_EEIIN03_XTFOM_383_FORM.html",
            controller: "VC_EEIIN03_XTFOM_383_CTRL",
            label: "executionExpromisionForm",
            resolve: {
            ...
            redirectTo: function(routeParams, path, search) {
                return "/VC_EEIIN03_XTFOM_383?" + $.param(search);
            }
        });
        VC_EEIIN03_XTFOM_383(cobisMainModule);
    }]);
} else {
    VC_EEIIN03_XTFOM_383(cobisMainModule);
}
...
designerEvents.api.printingdocuments = designerEvents.api.printingdocuments || designer.dsgEvents();

function VC_INGME81_PICMT_612(cobisMainModule) {
    cobisMainModule.controllerProvider.register("VC_INGME81_PICMT_612_MAIN_CTRL", ["$scope", "breadcrumbs",

    function($scope, breadcrumbs) {
        $scope.breadcrumbs = breadcrumbs;
    }]);
    cobisMainModule.controllerProvider.register("VC_INGME81_PICMT_612_CTRL", ["cobisMessage", cobis.modules.CONTAINER + ".preferencesService", "dsgnrUtils", "designer", "$scope", "$location", "$document", "$parse", "$filter", "$modal", "$q", "$compile", "$timeout",
    ...
    function(cobisMessage, preferencesService, dsgnrUtils, designer, $scope, $location, $document, $parse, $filter, $modal, $q, $compile, $timeout) {
        ...
        $scope.vc = designer.initViewContainer({
            moduleId: "BUSIN",
            subModuleId: "FLCRE",
            taskId: "T_FLCRE_61_INGME81",
            taskVersion: "1.0.0",
            viewContainerId: "VC_INGME81_PICMT_612",
            hasCloseModalEvent: false,
            serverEvents: true
        },
            "${contextPath}/resources/BUSIN/FLCRE/T_FLCRE_61_INGME81",
        designerEvents.api.printingdocuments,
        $scope.rowData);
        ...
        if (!$scope.vc.loaded) {
            ...
            $scope.vc.viewState.VC_INGME81_PICMT_612 = {
                style: []
            }
            //ViewState - Container: PrintingDocumentForm
            $scope.vc.createViewState({
                id: "VC_INGME81_PICMT_612",
                hasId: true,
                componentStyle: "",
                label: 'PrintingDocumentForm',
                enabled: designer.constants.mode.All
            });
            //ViewState - Container: Head
            $scope.vc.createViewState({
                id: "VC_INGME81_HEADQ_801",
                hasId: true,
                componentStyle: "",
                label: 'Head',
                enabled: designer.constants.mode.All
            ...
            }]; //ViewState - Container: Document
            $scope.vc.createViewState({
                id: "VC_INGME81_DCMET_400",
                hasId: true,
                componentStyle: "",
                label: 'Document',
                enabled: designer.constants.mode.All
            ...
            $scope.vc.createViewState({
                id: "T_FLCRE_61_INGME81_CANCEL",
                componentStyle: "",
                label: 'Cancel',
                enabled: designer.constants.mode.All,
                visible: designer.constants.mode.All
            });
            //ViewState - Command: PrintDocuments
            $scope.vc.createViewState({
                id: "CM_INGME81IND42",
                componentStyle: "",
        ...
        $scope._initPage_ProcessRender = function(page) {
            if (page.hasSearchRenderEvent) {
                $scope.vc.render('VC_INGME81_PICMT_612');
            }
            return page;
        };
...
if (typeof cobisMainModule === "undefined") {
    var cobisMainModule = cobis.createModule("VC_INGME81_PICMT_612", ["ngResource", "ngRoute", "kendo.directives", "ui.bootstrap", "oc.lazyLoad", "pascalprecht.translate", cobis.modules.CONTAINER, "designerModule"], ["DSGNR", "BUSIN"]);
    ...
    function($controllerProvider, $compileProvider, $filterProvider, $locationProvider, $routeProvider, $provide, $translateProvider, $translatePartialLoaderProvider, $ocLazyLoadProvider) {
        ...
        $routeProvider.when("/VC_INGME81_PICMT_612", {
            templateUrl: "VC_INGME81_PICMT_612_FORM.html",
            controller: "VC_INGME81_PICMT_612_CTRL",
            label: "PrintingDocumentForm",
            resolve: {
            ...
            redirectTo: function(routeParams, path, search) {
                return "/VC_INGME81_PICMT_612?" + $.param(search);
            }
        });
        VC_INGME81_PICMT_612(cobisMainModule);
    }]);
} else {
    VC_INGME81_PICMT_612(cobisMainModule);
}
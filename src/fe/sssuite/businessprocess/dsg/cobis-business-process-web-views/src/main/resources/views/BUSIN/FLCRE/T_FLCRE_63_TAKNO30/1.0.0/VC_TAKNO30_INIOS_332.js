...
designerEvents.api.tasksindicos = designerEvents.api.tasksindicos || designer.dsgEvents();

function VC_TAKNO30_INIOS_332(cobisMainModule) {
    cobisMainModule.controllerProvider.register("VC_TAKNO30_INIOS_332_MAIN_CTRL", ["$scope", "breadcrumbs",

    function($scope, breadcrumbs) {
        $scope.breadcrumbs = breadcrumbs;
    }]);
    cobisMainModule.controllerProvider.register("VC_TAKNO30_INIOS_332_CTRL", ["cobisMessage", cobis.modules.CONTAINER + ".preferencesService", "dsgnrUtils", "designer", "$scope", "$location", "$document", "$parse", "$filter", "$modal", "$q", "$compile", "$timeout",
    ...
    function(cobisMessage, preferencesService, dsgnrUtils, designer, $scope, $location, $document, $parse, $filter, $modal, $q, $compile, $timeout) {
        ...
        $scope.vc = designer.initViewContainer({
            moduleId: "BUSIN",
            subModuleId: "FLCRE",
            taskId: "T_FLCRE_63_TAKNO30",
            taskVersion: "1.0.0",
            viewContainerId: "VC_TAKNO30_INIOS_332",
            hasCloseModalEvent: false,
            serverEvents: true
        },
            "${contextPath}/resources/BUSIN/FLCRE/T_FLCRE_63_TAKNO30",
        designerEvents.api.tasksindicos,
        $scope.rowData);
        ...
        if (!$scope.vc.loaded) {
            ...
            $scope.vc.viewState.VC_TAKNO30_INIOS_332 = {
                style: []
            }
            //ViewState - Group: [Grupo Sin Nombre]
            $scope.vc.createViewState({
                id: "GR_SIDICSVIEW91_03",
                hasId: true,
                componentStyle: "",
            ...
            //ViewState - Group: Sindicos
            $scope.vc.createViewState({
                id: "GR_SIDICSVIEW91_04",
                hasId: true,
                componentStyle: "",
                label: "BUSIN.DLB_BUSIN_NGRSESDIO_85942",
                haslabelArgs: true,
                enabled: designer.constants.mode.All,
                visible: designer.constants.mode.All
            });
            //ViewState - Entity: HeaderPunishment, Attribute: Sindico1
            $scope.vc.createViewState({
                id: "VA_SIDICSVIEW9104_NICO675",
                componentStyle: "",
                label: "BUSIN.DLB_BUSIN_SNDICO1UK_44598",
                haslabelArgs: true,
                validationCode: 32,
            ...
            //ViewState - Entity: HeaderPunishment, Attribute: Sindico2
            $scope.vc.createViewState({
                id: "VA_SIDICSVIEW9104_SII2083",
                componentStyle: "",
                label: "BUSIN.DLB_BUSIN_SNDICO2CP_20469",
                haslabelArgs: true,
                validationCode: 32,
                readOnly: designer.constants.mode.Query,
                enabled: designer.constants.mode.All,
            ...
            $scope.vc.createViewState({
                id: "T_FLCRE_63_TAKNO30_CANCEL",
                componentStyle: "",
                label: 'Cancel',
                enabled: designer.constants.mode.All,
                visible: designer.constants.mode.All
            });
            //ViewState - Command: CM_Accept
            $scope.vc.createViewState({
                id: "CM_TAKNO30ACT14",
                componentStyle: "",
        ...
        $scope._initPage_ProcessRender = function(page) {
            if (page.hasSearchRenderEvent) {
                $scope.vc.render('VC_TAKNO30_INIOS_332');
            }
            return page;
        };
...
if (typeof cobisMainModule === "undefined") {
    var cobisMainModule = cobis.createModule("VC_TAKNO30_INIOS_332", ["ngResource", "ngRoute", "kendo.directives", "ui.bootstrap", "oc.lazyLoad", "pascalprecht.translate", cobis.modules.CONTAINER, "designerModule"], ["DSGNR", "BUSIN"]);
    ...
    function($controllerProvider, $compileProvider, $filterProvider, $locationProvider, $routeProvider, $provide, $translateProvider, $translatePartialLoaderProvider, $ocLazyLoadProvider) {
        ...
        $routeProvider.when("/VC_TAKNO30_INIOS_332", {
            templateUrl: "VC_TAKNO30_INIOS_332_FORM.html",
            controller: "VC_TAKNO30_INIOS_332_CTRL",
            label: "Sindicos",
            resolve: {
            ...
            redirectTo: function(routeParams, path, search) {
                return "/VC_TAKNO30_INIOS_332?" + $.param(search);
            }
        });
        VC_TAKNO30_INIOS_332(cobisMainModule);
    }]);
} else {
    VC_TAKNO30_INIOS_332(cobisMainModule);
}
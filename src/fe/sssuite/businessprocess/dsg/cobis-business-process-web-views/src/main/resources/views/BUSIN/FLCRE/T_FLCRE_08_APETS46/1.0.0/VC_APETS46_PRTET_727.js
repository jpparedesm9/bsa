...
designerEvents.api.approvewarrantiesticket = designerEvents.api.approvewarrantiesticket || designer.dsgEvents();

function VC_APETS46_PRTET_727(cobisMainModule) {
    cobisMainModule.controllerProvider.register("VC_APETS46_PRTET_727_MAIN_CTRL", ["$scope", "breadcrumbs",

    function($scope, breadcrumbs) {
        $scope.breadcrumbs = breadcrumbs;
    }]);
    cobisMainModule.controllerProvider.register("VC_APETS46_PRTET_727_CTRL", ["cobisMessage", cobis.modules.CONTAINER + ".preferencesService", "dsgnrUtils", "designer", "$scope", "$location", "$document", "$parse", "$filter", "$modal", "$q", "$compile", "$timeout",
    ...
    function(cobisMessage, preferencesService, dsgnrUtils, designer, $scope, $location, $document, $parse, $filter, $modal, $q, $compile, $timeout) {
        ...
        $scope.vc = designer.initViewContainer({
            moduleId: "BUSIN",
            subModuleId: "FLCRE",
            taskId: "T_FLCRE_08_APETS46",
            taskVersion: "1.0.0",
            viewContainerId: "VC_APETS46_PRTET_727",
            hasCloseModalEvent: false,
            serverEvents: true
        },
            "${contextPath}/resources/BUSIN/FLCRE/T_FLCRE_08_APETS46",
        designerEvents.api.approvewarrantiesticket,
        $scope.rowData);
        ...
        if (!$scope.vc.loaded) {
            ...
            $scope.vc.viewState.VC_APETS46_PRTET_727 = {
                style: []
            }
            //ViewState - Container: ApproveWarrantiesTicket
            $scope.vc.createViewState({
                id: "VC_APETS46_PRTET_727",
                hasId: true,
                componentStyle: "",
                label: 'ApproveWarrantiesTicket',
                enabled: designer.constants.mode.All
            });
            //ViewState - Container: Boleta Garantia
            $scope.vc.createViewState({
                id: "VC_APETS46_OLGNT_719",
                hasId: true,
                componentStyle: "",
                label: 'Boleta Garantia',
                enabled: designer.constants.mode.All
            });
            ...
            //ViewState - Container: Deudores
            $scope.vc.createViewState({
                id: "VC_APETS46_EUDOE_328",
                hasId: true,
                componentStyle: "",
            ...
            }]; //ViewState - Container: Aprobación
            $scope.vc.createViewState({
                id: "VC_APETS46_OBACN_162",
                hasId: true,
                componentStyle: "",
                label: 'Aprobaci\u00f3n',
                enabled: designer.constants.mode.All
        ...
        $scope._initPage_ProcessRender = function(page) {
            if (page.hasSearchRenderEvent) {
                $scope.vc.render('VC_APETS46_PRTET_727');
            }
            return page;
        };
...
if (typeof cobisMainModule === "undefined") {
    var cobisMainModule = cobis.createModule("VC_APETS46_PRTET_727", ["ngResource", "ngRoute", "kendo.directives", "ui.bootstrap", "oc.lazyLoad", "pascalprecht.translate", cobis.modules.CONTAINER, "designerModule"], ["DSGNR", "BUSIN"]);
    ...
    function($controllerProvider, $compileProvider, $filterProvider, $locationProvider, $routeProvider, $provide, $translateProvider, $translatePartialLoaderProvider, $ocLazyLoadProvider) {
        ...
        $routeProvider.when("/VC_APETS46_PRTET_727", {
            templateUrl: "VC_APETS46_PRTET_727_FORM.html",
            controller: "VC_APETS46_PRTET_727_CTRL",
            label: "ApproveWarrantiesTicket",
            resolve: {
            ...
            redirectTo: function(routeParams, path, search) {
                return "/VC_APETS46_PRTET_727?" + $.param(search);
            }
        });
        VC_APETS46_PRTET_727(cobisMainModule);
    }]);
} else {
    VC_APETS46_PRTET_727(cobisMainModule);
}
...
designerEvents.api.taskapplicationcreditline = designerEvents.api.taskapplicationcreditline || designer.dsgEvents();

function VC_APPEI02_OPNRL_677(cobisMainModule) {
    cobisMainModule.controllerProvider.register("VC_APPEI02_OPNRL_677_MAIN_CTRL", ["$scope", "breadcrumbs",

    function($scope, breadcrumbs) {
        $scope.breadcrumbs = breadcrumbs;
    }]);
    cobisMainModule.controllerProvider.register("VC_APPEI02_OPNRL_677_CTRL", ["cobisMessage", cobis.modules.CONTAINER + ".preferencesService", "dsgnrUtils", "designer", "$scope", "$location", "$document", "$parse", "$filter", "$modal", "$q", "$compile", "$timeout",
    ...
    function(cobisMessage, preferencesService, dsgnrUtils, designer, $scope, $location, $document, $parse, $filter, $modal, $q, $compile, $timeout) {
        ...
        $scope.vc = designer.initViewContainer({
            moduleId: "BUSIN",
            subModuleId: "FLCRE",
            taskId: "T_FLCRE_40_APPEI02",
            taskVersion: "1.0.0",
            viewContainerId: "VC_APPEI02_OPNRL_677",
            hasCloseModalEvent: false,
            serverEvents: true
        },
            "${contextPath}/resources/BUSIN/FLCRE/T_FLCRE_40_APPEI02",
        designerEvents.api.taskapplicationcreditline,
        $scope.rowData);
        ...
        if (!$scope.vc.loaded) {
            ...
            $scope.vc.viewState.VC_APPEI02_OPNRL_677 = {
                style: []
            }
            //ViewState - Container: FormApplicationCreditLine
            $scope.vc.createViewState({
                id: "VC_APPEI02_OPNRL_677",
                hasId: true,
                componentStyle: "",
                label: 'FormApplicationCreditLine',
                enabled: designer.constants.mode.All
            });
            //ViewState - Container: Pestaña para HeaderView
            $scope.vc.createViewState({
                id: "VC_APPEI02_PARVW_373",
                hasId: true,
                componentStyle: "",
            ...
            //ViewState - Entity: OriginalHeader, Attribute: AmountApproved
            $scope.vc.createViewState({
                id: "VA_APITONEAEE5506_AUPR372",
                componentStyle: "",
                label: "BUSIN.DLB_BUSIN_MNTAPRODO_28697",
                haslabelArgs: true,
                format: "#,##0.00",
                decimals: 2,
                validationCode: 40,
            ...
            //ViewState - Container: Pestaña para ApproveCreditRequest
            $scope.vc.createViewState({
                id: "VC_APPEI02_ESPIT_813",
                hasId: true,
                componentStyle: "",
                label: 'Pesta\u00f1a para ApproveCreditRequest',
                enabled: designer.constants.mode.All
            });
            //ViewState - Container: Borrower Data
            $scope.vc.createViewState({
                id: "VC_APPEI02_RPNOM_893",
                hasId: true,
                componentStyle: "",
            ...
            //ViewState - Container: DocumentProductView
            $scope.vc.createViewState({
                id: "VC_APPEI02_UNDCI_832",
                hasId: true,
                componentStyle: "",
                label: 'DocumentProductView',
                enabled: designer.constants.mode.All
            });
            //ViewState - Group: [Grupo Sin Nombre]
            $scope.vc.createViewState({
            ...
            $scope.vc.createViewState({
                id: "T_FLCRE_40_APPEI02_CANCEL",
                componentStyle: "",
                label: 'Cancel',
                enabled: designer.constants.mode.All,
                visible: designer.constants.mode.All
            });
            //ViewState - Command: SaveApplication
            $scope.vc.createViewState({
                id: "CM_APPEI02PAO80",
                componentStyle: "",
            ...
            //ViewState - Command: Registrar Infocred
            $scope.vc.createViewState({
                id: "CM_APPEI02EGC47",
                componentStyle: "",
            ...
            //ViewState - Command: PrintApplication
            $scope.vc.createViewState({
                id: "CM_APPEI02TCI41",
                componentStyle: "",
            ...
            //ViewState - Command: Infocred Report
            $scope.vc.createViewState({
                id: "CM_APPEI02ORE38",
                componentStyle: "",
        ...
        $scope._initPage_ProcessRender = function(page) {
            if (page.hasSearchRenderEvent) {
                $scope.vc.render('VC_APPEI02_OPNRL_677');
            }
            return page;
        };
...
if (typeof cobisMainModule === "undefined") {
    var cobisMainModule = cobis.createModule("VC_APPEI02_OPNRL_677", ["ngResource", "ngRoute", "kendo.directives", "ui.bootstrap", "oc.lazyLoad", "pascalprecht.translate", cobis.modules.CONTAINER, "designerModule"], ["DSGNR", "BUSIN"]);
    ...
    function($controllerProvider, $compileProvider, $filterProvider, $locationProvider, $routeProvider, $provide, $translateProvider, $translatePartialLoaderProvider, $ocLazyLoadProvider) {
        ...
        $routeProvider.when("/VC_APPEI02_OPNRL_677", {
            templateUrl: "VC_APPEI02_OPNRL_677_FORM.html",
            controller: "VC_APPEI02_OPNRL_677_CTRL",
            label: "FormApplicationCreditLine",
            resolve: {
            ...
            redirectTo: function(routeParams, path, search) {
                return "/VC_APPEI02_OPNRL_677?" + $.param(search);
            }
        });
        VC_APPEI02_OPNRL_677(cobisMainModule);
    }]);
} else {
    VC_APPEI02_OPNRL_677(cobisMainModule);
}
...
designerEvents.api.taskvalidationquotavsavailablebalance = designerEvents.api.taskvalidationquotavsavailablebalance || designer.dsgEvents();

function VC_SVVAL50_FTBLA_532(cobisMainModule) {
    cobisMainModule.controllerProvider.register("VC_SVVAL50_FTBLA_532_MAIN_CTRL", ["$scope", "breadcrumbs",

    function($scope, breadcrumbs) {
        $scope.breadcrumbs = breadcrumbs;
    }]);
    cobisMainModule.controllerProvider.register("VC_SVVAL50_FTBLA_532_CTRL", ["cobisMessage", cobis.modules.CONTAINER + ".preferencesService", "dsgnrUtils", "designer", "$scope", "$location", "$document", "$parse", "$filter", "$modal", "$q", "$compile", "$timeout",
    ...
    function(cobisMessage, preferencesService, dsgnrUtils, designer, $scope, $location, $document, $parse, $filter, $modal, $q, $compile, $timeout) {
        ...
        $scope.vc = designer.initViewContainer({
            moduleId: "BUSIN",
            subModuleId: "FLCRE",
            taskId: "T_FLCRE_89_SVVAL50",
            taskVersion: "1.0.0",
            viewContainerId: "VC_SVVAL50_FTBLA_532",
            hasCloseModalEvent: false,
            serverEvents: true
        },
            "${contextPath}/resources/BUSIN/FLCRE/T_FLCRE_89_SVVAL50",
        designerEvents.api.taskvalidationquotavsavailablebalance,
        $scope.rowData);
        ...
        if (!$scope.vc.loaded) {
            ...
            $scope.vc.viewState.VC_SVVAL50_FTBLA_532 = {
                style: []
            }
            //ViewState - Container: FormValidationQuotaVsAvailableBalance
            $scope.vc.createViewState({
                id: "VC_SVVAL50_FTBLA_532",
                hasId: true,
                componentStyle: "",
            ...
            }]; //ViewState - Container: Grp_OtherData
            $scope.vc.createViewState({
                id: "VC_SVVAL50_PRDAT_127",
                hasId: true,
                componentStyle: "",
                label: 'Grp_OtherData',
                enabled: designer.constants.mode.All
        ...
        $scope._initPage_ProcessRender = function(page) {
            if (page.hasSearchRenderEvent) {
                $scope.vc.render('VC_SVVAL50_FTBLA_532');
            }
            return page;
        };
...
if (typeof cobisMainModule === "undefined") {
    var cobisMainModule = cobis.createModule("VC_SVVAL50_FTBLA_532", ["ngResource", "ngRoute", "kendo.directives", "ui.bootstrap", "oc.lazyLoad", "pascalprecht.translate", cobis.modules.CONTAINER, "designerModule"], ["DSGNR", "BUSIN"]);
    ...
    function($controllerProvider, $compileProvider, $filterProvider, $locationProvider, $routeProvider, $provide, $translateProvider, $translatePartialLoaderProvider, $ocLazyLoadProvider) {
        ...
        $routeProvider.when("/VC_SVVAL50_FTBLA_532", {
            templateUrl: "VC_SVVAL50_FTBLA_532_FORM.html",
            controller: "VC_SVVAL50_FTBLA_532_CTRL",
            ...
            redirectTo: function(routeParams, path, search) {
                return "/VC_SVVAL50_FTBLA_532?" + $.param(search);
            }
        });
        VC_SVVAL50_FTBLA_532(cobisMainModule);
    }]);
} else {
    VC_SVVAL50_FTBLA_532(cobisMainModule);
}
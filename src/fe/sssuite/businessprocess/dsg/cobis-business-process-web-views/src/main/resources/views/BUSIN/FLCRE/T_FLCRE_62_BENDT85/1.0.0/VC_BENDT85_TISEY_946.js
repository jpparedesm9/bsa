...
designerEvents.api.creditlinedisbursementdataentry = designerEvents.api.creditlinedisbursementdataentry || designer.dsgEvents();

function VC_BENDT85_TISEY_946(cobisMainModule) {
    cobisMainModule.controllerProvider.register("VC_BENDT85_TISEY_946_MAIN_CTRL", ["$scope", "breadcrumbs",

    function($scope, breadcrumbs) {
        $scope.breadcrumbs = breadcrumbs;
    }]);
    cobisMainModule.controllerProvider.register("VC_BENDT85_TISEY_946_CTRL", ["cobisMessage", cobis.modules.CONTAINER + ".preferencesService", "dsgnrUtils", "designer", "$scope", "$location", "$document", "$parse", "$filter", "$modal", "$q", "$compile", "$timeout",
    ...
    function(cobisMessage, preferencesService, dsgnrUtils, designer, $scope, $location, $document, $parse, $filter, $modal, $q, $compile, $timeout) {
        ...
        $scope.vc = designer.initViewContainer({
            moduleId: "BUSIN",
            subModuleId: "FLCRE",
            taskId: "T_FLCRE_62_BENDT85",
            taskVersion: "1.0.0",
            viewContainerId: "VC_BENDT85_TISEY_946",
            hasCloseModalEvent: false,
            serverEvents: true
        },
            "${contextPath}/resources/BUSIN/FLCRE/T_FLCRE_62_BENDT85",
        designerEvents.api.creditlinedisbursementdataentry,
        $scope.rowData);
        ...
        if (!$scope.vc.loaded) {
            ...
            $scope.vc.viewState.VC_BENDT85_TISEY_946 = {
                style: []
            }
            //ViewState - Container: FormCreditLineDisbursementDataEntry
            $scope.vc.createViewState({
                id: "VC_BENDT85_TISEY_946",
                hasId: true,
                componentStyle: "",
                label: 'FormCreditLineDisbursementDataEntry',
                enabled: designer.constants.mode.All
            });
            //ViewState - Container: Pestaña para HeaderLineView
            $scope.vc.createViewState({
                id: "VC_BENDT85_EAAEV_092",
                hasId: true,
                componentStyle: "",
            ...
            //ViewState - Group: Panel Cabecera para OriginalHeader
            $scope.vc.createViewState({
                id: "GR_HEDRCRILIW98_65",
                hasId: true,
                componentStyle: "",
                label: 'Panel Cabecera para OriginalHeader',
                enabled: designer.constants.mode.All,
                visible: designer.constants.mode.All
            });
            //ViewState - Entity: OriginalHeader, Attribute: ApplicationNumber
            $scope.vc.createViewState({
                id: "VA_HEDRCRILIW9865_IOUR250",
                componentStyle: "",
            ...
            $scope.vc.catalogs.VA_HEDRCRILIW9865_FICE186 = new kendo.data.DataSource({
                transport: {
                    read: function(options) {
                        $scope.vc.loadCatalogCobis('VA_HEDRCRILIW9865_FICE186', 'cl_oficina', function(response) {
                            if (angular.isDefined(response.data)) {
                                var catalogResponse = response.data['RESULTVA_HEDRCRILIW9865_FICE186'];
                            ...
                            $scope.vc.setComboBoxDefaultValue("VA_HEDRCRILIW9865_FICE186");
            ...
            $scope.vc.catalogs.VA_HEDRCRILIW9865_ITCE389 = new kendo.data.DataSource({
                transport: {
                    read: function(options) {
                        $scope.vc.loadCatalogCobis('VA_HEDRCRILIW9865_ITCE389', 'cl_ciudad', function(response) {
                            if (angular.isDefined(response.data)) {
                                var catalogResponse = response.data['RESULTVA_HEDRCRILIW9865_ITCE389'];
                                if (angular.isDefined(catalogResponse) && !$.isEmptyObject(catalogResponse)) {
                                    options.success(catalogResponse);
                                } else {
                                    options.success([]);
                            ...
                            $scope.vc.setComboBoxDefaultValue("VA_HEDRCRILIW9865_ITCE389");
                        }, null, options.data.filter, 0);
                    }
                },
                serverFiltering: true,
            ...
            $scope.vc.catalogs.VA_HEDRCRILIW9865_URQT955 = new kendo.data.DataSource({
                transport: {
                    read: function(options) {
                        $scope.vc.loadCatalogCobis('VA_HEDRCRILIW9865_URQT955', 'cl_moneda', function(response) {
                            if (angular.isDefined(response.data)) {
                                var catalogResponse = response.data['RESULTVA_HEDRCRILIW9865_URQT955'];
                                if (angular.isDefined(catalogResponse) && !$.isEmptyObject(catalogResponse)) {
                                    options.success(catalogResponse);
                                } else {
                                    options.success([]);
                            ...
                            $scope.vc.setComboBoxDefaultValue("VA_HEDRCRILIW9865_URQT955");
                        }, null, options.data.filter, 0);
                    }
                },
                serverFiltering: true,
            ...
            $scope.vc.catalogs.VA_HEDRCRILIW9865_NQUE409 = new kendo.data.DataSource({
                transport: {
                    read: function(options) {
                        $scope.vc.loadCatalogCobis('VA_HEDRCRILIW9865_NQUE409', 'ca_tdividendo', function(response) {
                            if (angular.isDefined(response.data)) {
                                var catalogResponse = response.data['RESULTVA_HEDRCRILIW9865_NQUE409'];
                                if (angular.isDefined(catalogResponse) && !$.isEmptyObject(catalogResponse)) {
                                    options.success(catalogResponse);
                                } else {
                                    options.success([]);
                            ...
                            $scope.vc.setComboBoxDefaultValue("VA_HEDRCRILIW9865_NQUE409");
                        }, null, options.data.filter, 0);
                    }
                },
                serverFiltering: true,
            ...
            $scope.vc.createViewState({
                id: "VA_HEDRCRILIW9865_FNME415",
                componentStyle: "",
                label: "BUSIN.DLB_BUSIN_OFFICERTU_38261",
                haslabelArgs: true,
                validationCode: 0,
                readOnly: designer.constants.mode.All,
                enabled: designer.constants.mode.None,
            ...
            $scope.vc.catalogs.VA_HEDRCRILIW9865_RUCE792 = new kendo.data.DataSource({
                transport: {
                    read: function(options) {
                        $scope.vc.loadCatalogCobis('VA_HEDRCRILIW9865_RUCE792', 'cr_producto_FIE', function(response) {
                            if (angular.isDefined(response.data)) {
                                var catalogResponse = response.data['RESULTVA_HEDRCRILIW9865_RUCE792'];
                                if (angular.isDefined(catalogResponse) && !$.isEmptyObject(catalogResponse)) {
                                    options.success(catalogResponse);
                                } else {
                                    options.success([]);
                            ...
                            $scope.vc.setComboBoxDefaultValue("VA_HEDRCRILIW9865_RUCE792");
                        }, null, options.data.filter, 0);
                    }
                },
                serverFiltering: true,
            ...
            //ViewState - Container: Pestaña para DistributionLineHeaderView
            $scope.vc.createViewState({
                id: "VC_BENDT85_EAANW_670",
                hasId: true,
                componentStyle: "",
                label: 'Pesta\u00f1a para DistributionLineHeaderView',
                enabled: designer.constants.mode.All
            });
            ...
            //ViewState - Container: Pestaña para BorrowerView
            $scope.vc.createViewState({
                id: "VC_BENDT85_EAAOE_870",
                hasId: true,
                componentStyle: "",
        ...
        $scope._initPage_ProcessRender = function(page) {
            if (page.hasSearchRenderEvent) {
                $scope.vc.render('VC_BENDT85_TISEY_946');
            }
            return page;
        };
...
if (typeof cobisMainModule === "undefined") {
    var cobisMainModule = cobis.createModule("VC_BENDT85_TISEY_946", ["ngResource", "ngRoute", "kendo.directives", "ui.bootstrap", "oc.lazyLoad", "pascalprecht.translate", cobis.modules.CONTAINER, "designerModule"], ["DSGNR", "BUSIN"]);
    ...
    function($controllerProvider, $compileProvider, $filterProvider, $locationProvider, $routeProvider, $provide, $translateProvider, $translatePartialLoaderProvider, $ocLazyLoadProvider) {
        ...
        $routeProvider.when("/VC_BENDT85_TISEY_946", {
            templateUrl: "VC_BENDT85_TISEY_946_FORM.html",
            controller: "VC_BENDT85_TISEY_946_CTRL",
            label: "FormCreditLineDisbursementDataEntry",
            resolve: {
            ...
            redirectTo: function(routeParams, path, search) {
                return "/VC_BENDT85_TISEY_946?" + $.param(search);
            }
        });
        VC_BENDT85_TISEY_946(cobisMainModule);
    }]);
} else {
    VC_BENDT85_TISEY_946(cobisMainModule);
}
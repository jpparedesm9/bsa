...
designerEvents.api.entrywarrantymodifyline = designerEvents.api.entrywarrantymodifyline || designer.dsgEvents();

function VC_EATLI88_FNNTI_747(cobisMainModule) {
    cobisMainModule.controllerProvider.register("VC_EATLI88_FNNTI_747_MAIN_CTRL", ["$scope", "breadcrumbs",

    function($scope, breadcrumbs) {
        $scope.breadcrumbs = breadcrumbs;
    }]);
    cobisMainModule.controllerProvider.register("VC_EATLI88_FNNTI_747_CTRL", ["cobisMessage", cobis.modules.CONTAINER + ".preferencesService", "dsgnrUtils", "designer", "$scope", "$location", "$document", "$parse", "$filter", "$modal", "$q", "$compile", "$timeout",
    ...
    function(cobisMessage, preferencesService, dsgnrUtils, designer, $scope, $location, $document, $parse, $filter, $modal, $q, $compile, $timeout) {
        ...
        $scope.vc = designer.initViewContainer({
            moduleId: "BUSIN",
            subModuleId: "FLCRE",
            taskId: "T_FLCRE_54_EATLI88",
            taskVersion: "1.0.0",
            viewContainerId: "VC_EATLI88_FNNTI_747",
            hasCloseModalEvent: false,
            serverEvents: true
        },
            "${contextPath}/resources/BUSIN/FLCRE/T_FLCRE_54_EATLI88",
        designerEvents.api.entrywarrantymodifyline,
        $scope.rowData);
        ...
        if (!$scope.vc.loaded) {
            ...
            $scope.vc.viewState.VC_EATLI88_FNNTI_747 = {
                style: []
            }
            //ViewState - Container: FormEntryWarrantyModifyLine
            $scope.vc.createViewState({
                id: "VC_EATLI88_FNNTI_747",
                hasId: true,
                componentStyle: "",
                label: 'FormEntryWarrantyModifyLine',
                enabled: designer.constants.mode.All
            });
            //ViewState - Container: ApplicationHeaderView
            $scope.vc.createViewState({
                id: "VC_EATLI88_ACRVI_802",
                hasId: true,
                componentStyle: "",
            ...
            //ViewState - Container: GuaranteesView
            $scope.vc.createViewState({
                id: "VC_EATLI88_RPOSB_260",
                hasId: true,
                componentStyle: "",
                label: 'GuaranteesView',
                enabled: designer.constants.mode.All
            });
            //ViewState - Group: [Grupo Sin Nombre]
            $scope.vc.createViewState({
            ...
            //ViewState - Entity: GuaranteesBtn, Attribute: Monto
            $scope.vc.createViewState({
                id: "VA_UARNTEESEW9610_ONTO328",
                componentStyle: "",
            ...
            //ViewState - Entity: GuaranteesBtn, Attribute: Associatebtn
            $scope.vc.createViewState({
                id: "VA_UARNTEESEW9610_SCTE295",
                componentStyle: "",
                label: "DSGNR.SYS_DSGNR_LBLESTETQ_00024",
                haslabelArgs: true,
                validationCode: 0,
            ...
            //ViewState - Entity: GuaranteesBtn, Attribute: Searchbtn
            $scope.vc.createViewState({
            ...
            //ViewState - Container: PersonalWarranties
            $scope.vc.createViewState({
                id: "VC_EATLI88_RNORE_290",
                hasId: true,
                componentStyle: "",
                label: 'PersonalWarranties',
                enabled: designer.constants.mode.All
            });
            //ViewState - Group: [Grupo Sin Nombre]
            $scope.vc.createViewState({
            ...
            $scope.vc.grids.QV_PESAU2317_81.toolbar = []; //ViewState - Container: OtherWarranties
            $scope.vc.createViewState({
                id: "VC_EATLI88_UNNRE_376",
                hasId: true,
                componentStyle: "",
                label: 'OtherWarranties',
                enabled: designer.constants.mode.All
            });
            //ViewState - Group: [Grupo Sin Nombre]
            $scope.vc.createViewState({
        ...
        $scope._initPage_ProcessRender = function(page) {
            if (page.hasSearchRenderEvent) {
                $scope.vc.render('VC_EATLI88_FNNTI_747');
            }
            return page;
        };
...
if (typeof cobisMainModule === "undefined") {
    var cobisMainModule = cobis.createModule("VC_EATLI88_FNNTI_747", ["ngResource", "ngRoute", "kendo.directives", "ui.bootstrap", "oc.lazyLoad", "pascalprecht.translate", cobis.modules.CONTAINER, "designerModule"], ["DSGNR", "BUSIN"]);
    ...
    function($controllerProvider, $compileProvider, $filterProvider, $locationProvider, $routeProvider, $provide, $translateProvider, $translatePartialLoaderProvider, $ocLazyLoadProvider) {
        ...
        $routeProvider.when("/VC_EATLI88_FNNTI_747", {
            templateUrl: "VC_EATLI88_FNNTI_747_FORM.html",
            controller: "VC_EATLI88_FNNTI_747_CTRL",
            label: "FormEntryWarrantyModifyLine",
            resolve: {
            ...
            redirectTo: function(routeParams, path, search) {
                return "/VC_EATLI88_FNNTI_747?" + $.param(search);
            }
        });
        VC_EATLI88_FNNTI_747(cobisMainModule);
    }]);
} else {
    VC_EATLI88_FNNTI_747(cobisMainModule);
}
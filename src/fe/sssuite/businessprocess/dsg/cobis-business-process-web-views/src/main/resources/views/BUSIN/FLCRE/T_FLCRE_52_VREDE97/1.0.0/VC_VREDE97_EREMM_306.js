...
designerEvents.api.tsendrecommended = designerEvents.api.tsendrecommended || designer.dsgEvents();

function VC_VREDE97_EREMM_306(cobisMainModule) {
    cobisMainModule.controllerProvider.register("VC_VREDE97_EREMM_306_MAIN_CTRL", ["$scope", "breadcrumbs",

    function($scope, breadcrumbs) {
        $scope.breadcrumbs = breadcrumbs;
    }]);
    cobisMainModule.controllerProvider.register("VC_VREDE97_EREMM_306_CTRL", ["cobisMessage", cobis.modules.CONTAINER + ".preferencesService", "dsgnrUtils", "designer", "$scope", "$location", "$document", "$parse", "$filter", "$modal", "$q", "$compile", "$timeout",
    ...
    function(cobisMessage, preferencesService, dsgnrUtils, designer, $scope, $location, $document, $parse, $filter, $modal, $q, $compile, $timeout) {
        ...
        $scope.vc = designer.initViewContainer({
            moduleId: "BUSIN",
            subModuleId: "FLCRE",
            taskId: "T_FLCRE_52_VREDE97",
            taskVersion: "1.0.0",
            viewContainerId: "VC_VREDE97_EREMM_306",
            hasCloseModalEvent: false,
            serverEvents: true
        },
            "${contextPath}/resources/BUSIN/FLCRE/T_FLCRE_52_VREDE97",
        designerEvents.api.tsendrecommended,
        $scope.rowData);
        ...
        if (!$scope.vc.loaded) {
            ...
            $scope.vc.viewState.VC_VREDE97_EREMM_306 = {
                style: []
            }
            //ViewState - Group: Contenedor Plegable
            $scope.vc.createViewState({
                id: "GR_SEDCMMENED30_54",
                hasId: true,
                componentStyle: "",
            ...
            //ViewState - Group: Panel Plegable para HeaderPunishment
            $scope.vc.createViewState({
                id: "GR_SEDCMMENED30_85",
                hasId: true,
                componentStyle: "",
                label: 'Panel Plegable para HeaderPunishment',
                enabled: designer.constants.mode.All,
                visible: designer.constants.mode.All
            });
            //ViewState - Entity: HeaderPunishment, Attribute: CourtDate
            $scope.vc.createViewState({
                id: "VA_SEDCMMENED3085_ORTT907",
                componentStyle: "",
            ...
            $scope.vc.createViewState({
                id: "T_FLCRE_52_VREDE97_CANCEL",
                componentStyle: "",
                label: 'Cancel',
                enabled: designer.constants.mode.All,
                visible: designer.constants.mode.All
            });
            //ViewState - Command: Procesar
            $scope.vc.createViewState({
                id: "CM_VREDE97PCE89",
                componentStyle: "",
            ...
            $scope.vc.createViewState({
                id: "CM_VREDE97AER98",
                componentStyle: "",
                tooltip: "BUSIN.DLB_BUSIN_CANCELARI_56591",
        ...
        $scope._initPage_ProcessRender = function(page) {
            if (page.hasSearchRenderEvent) {
                $scope.vc.render('VC_VREDE97_EREMM_306');
            }
            return page;
        };
...
if (typeof cobisMainModule === "undefined") {
    var cobisMainModule = cobis.createModule("VC_VREDE97_EREMM_306", ["ngResource", "ngRoute", "kendo.directives", "ui.bootstrap", "oc.lazyLoad", "pascalprecht.translate", cobis.modules.CONTAINER, "designerModule"], ["DSGNR", "BUSIN"]);
    ...
    function($controllerProvider, $compileProvider, $filterProvider, $locationProvider, $routeProvider, $provide, $translateProvider, $translatePartialLoaderProvider, $ocLazyLoadProvider) {
        ...
        $routeProvider.when("/VC_VREDE97_EREMM_306", {
            templateUrl: "VC_VREDE97_EREMM_306_FORM.html",
            controller: "VC_VREDE97_EREMM_306_CTRL",
            labelId: "BUSIN.DLB_BUSIN_RECENDAON_73799",
            resolve: {
            ...
            redirectTo: function(routeParams, path, search) {
                return "/VC_VREDE97_EREMM_306?" + $.param(search);
            }
        });
        VC_VREDE97_EREMM_306(cobisMainModule);
    }]);
} else {
    VC_VREDE97_EREMM_306(cobisMainModule);
}
...
designerEvents.api.legalanalysisactivity = designerEvents.api.legalanalysisactivity || designer.dsgEvents();

function VC_AITIV39_LGLAA_742(cobisMainModule) {
    cobisMainModule.controllerProvider.register("VC_AITIV39_LGLAA_742_MAIN_CTRL", ["$scope", "breadcrumbs",

    function($scope, breadcrumbs) {
        $scope.breadcrumbs = breadcrumbs;
    }]);
    cobisMainModule.controllerProvider.register("VC_AITIV39_LGLAA_742_CTRL", ["cobisMessage", cobis.modules.CONTAINER + ".preferencesService", "dsgnrUtils", "designer", "$scope", "$location", "$document", "$parse", "$filter", "$modal", "$q", "$compile", "$timeout",
    ...
    function(cobisMessage, preferencesService, dsgnrUtils, designer, $scope, $location, $document, $parse, $filter, $modal, $q, $compile, $timeout) {
        ...
        $scope.vc = designer.initViewContainer({
            moduleId: "BUSIN",
            subModuleId: "FLCRE",
            taskId: "T_FLCRE_35_AITIV39",
            taskVersion: "1.0.0",
            viewContainerId: "VC_AITIV39_LGLAA_742",
            hasCloseModalEvent: false,
            serverEvents: true
        },
            "${contextPath}/resources/BUSIN/FLCRE/T_FLCRE_35_AITIV39",
        designerEvents.api.legalanalysisactivity,
        $scope.rowData);
        ...
        if (!$scope.vc.loaded) {
            ...
            $scope.vc.viewState.VC_AITIV39_LGLAA_742 = {
                style: []
            }
            //ViewState - Container: LegalAnalysisActivityForm
            $scope.vc.createViewState({
                id: "VC_AITIV39_LGLAA_742",
                hasId: true,
                componentStyle: "",
                label: 'LegalAnalysisActivityForm',
                enabled: designer.constants.mode.All
            });
            //ViewState - Container: Head
            $scope.vc.createViewState({
                id: "VC_AITIV39_HEADX_110",
                hasId: true,
                componentStyle: "",
                label: 'Head',
                enabled: designer.constants.mode.All
            ...
            //ViewState - Container: HeaderOfficer
            $scope.vc.createViewState({
                id: "VC_AITIV39_DERFF_144",
                hasId: true,
                componentStyle: "",
                label: 'HeaderOfficer',
                enabled: designer.constants.mode.All
            ...
            }]; //ViewState - Container: Central
            $scope.vc.createViewState({
                id: "VC_AITIV39_GUOIB_483",
                hasId: true,
                componentStyle: "",
                label: 'Central',
                enabled: designer.constants.mode.All
        ...
        $scope._initPage_ProcessRender = function(page) {
            if (page.hasSearchRenderEvent) {
                $scope.vc.render('VC_AITIV39_LGLAA_742');
            }
            return page;
        };
...
if (typeof cobisMainModule === "undefined") {
    var cobisMainModule = cobis.createModule("VC_AITIV39_LGLAA_742", ["ngResource", "ngRoute", "kendo.directives", "ui.bootstrap", "oc.lazyLoad", "pascalprecht.translate", cobis.modules.CONTAINER, "designerModule"], ["DSGNR", "BUSIN"]);
    ...
    function($controllerProvider, $compileProvider, $filterProvider, $locationProvider, $routeProvider, $provide, $translateProvider, $translatePartialLoaderProvider, $ocLazyLoadProvider) {
        ...
        $routeProvider.when("/VC_AITIV39_LGLAA_742", {
            templateUrl: "VC_AITIV39_LGLAA_742_FORM.html",
            controller: "VC_AITIV39_LGLAA_742_CTRL",
            label: "LegalAnalysisActivityForm",
            resolve: {
            ...
            redirectTo: function(routeParams, path, search) {
                return "/VC_AITIV39_LGLAA_742?" + $.param(search);
            }
        });
        VC_AITIV39_LGLAA_742(cobisMainModule);
    }]);
} else {
    VC_AITIV39_LGLAA_742(cobisMainModule);
}
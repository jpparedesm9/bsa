...
designerEvents.api.taskaprovedview = designerEvents.api.taskaprovedview || designer.dsgEvents();

function VC_SKVEW14_OROEW_520(cobisMainModule) {
    cobisMainModule.controllerProvider.register("VC_SKVEW14_OROEW_520_MAIN_CTRL", ["$scope", "breadcrumbs",

    function($scope, breadcrumbs) {
        $scope.breadcrumbs = breadcrumbs;
    }]);
    cobisMainModule.controllerProvider.register("VC_SKVEW14_OROEW_520_CTRL", ["cobisMessage", cobis.modules.CONTAINER + ".preferencesService", "dsgnrUtils", "designer", "$scope", "$location", "$document", "$parse", "$filter", "$modal", "$q", "$compile", "$timeout",
    ...
    function(cobisMessage, preferencesService, dsgnrUtils, designer, $scope, $location, $document, $parse, $filter, $modal, $q, $compile, $timeout) {
        ...
        $scope.vc = designer.initViewContainer({
            moduleId: "BUSIN",
            subModuleId: "FLCRE",
            taskId: "T_FLCRE_69_SKVEW14",
            taskVersion: "1.0.0",
            viewContainerId: "VC_SKVEW14_OROEW_520",
            hasCloseModalEvent: false,
            serverEvents: true
        },
            "${contextPath}/resources/BUSIN/FLCRE/T_FLCRE_69_SKVEW14",
        designerEvents.api.taskaprovedview,
        $scope.rowData);
        ...
        if (!$scope.vc.loaded) {
            ...
            $scope.vc.viewState.VC_SKVEW14_OROEW_520 = {
                style: []
            }
            //ViewState - Container: formApprobedView
            $scope.vc.createViewState({
                id: "VC_SKVEW14_OROEW_520",
                hasId: true,
                componentStyle: "",
                label: 'formApprobedView',
                enabled: designer.constants.mode.All
            });
            //ViewState - Container: ApplicationHeaderView
            $scope.vc.createViewState({
                id: "VC_SKVEW14_IOAEI_774",
                hasId: true,
                componentStyle: "",
            ...
            $scope.vc.createViewState({
                id: "VC_SKVEW14_NNOBR_018",
                hasId: true,
                componentStyle: "",
                label: 'ApproveCreditRequest',
                enabled: designer.constants.mode.All
            });
        ...
        $scope._initPage_ProcessRender = function(page) {
            if (page.hasSearchRenderEvent) {
                $scope.vc.render('VC_SKVEW14_OROEW_520');
            }
            return page;
        };
...
if (typeof cobisMainModule === "undefined") {
    var cobisMainModule = cobis.createModule("VC_SKVEW14_OROEW_520", ["ngResource", "ngRoute", "kendo.directives", "ui.bootstrap", "oc.lazyLoad", "pascalprecht.translate", cobis.modules.CONTAINER, "designerModule"], ["DSGNR", "BUSIN"]);
    ...
    function($controllerProvider, $compileProvider, $filterProvider, $locationProvider, $routeProvider, $provide, $translateProvider, $translatePartialLoaderProvider, $ocLazyLoadProvider) {
        ...
        $routeProvider.when("/VC_SKVEW14_OROEW_520", {
            templateUrl: "VC_SKVEW14_OROEW_520_FORM.html",
            controller: "VC_SKVEW14_OROEW_520_CTRL",
            label: "formApprobedView",
            resolve: {
            ...
            redirectTo: function(routeParams, path, search) {
                return "/VC_SKVEW14_OROEW_520?" + $.param(search);
            }
        });
        VC_SKVEW14_OROEW_520(cobisMainModule);
    }]);
} else {
    VC_SKVEW14_OROEW_520(cobisMainModule);
}
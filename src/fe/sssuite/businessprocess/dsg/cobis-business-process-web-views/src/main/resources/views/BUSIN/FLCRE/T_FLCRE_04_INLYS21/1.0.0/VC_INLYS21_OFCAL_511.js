...
designerEvents.api.applicationanalysis = designerEvents.api.applicationanalysis || designer.dsgEvents();

function VC_INLYS21_OFCAL_511(cobisMainModule) {
    cobisMainModule.controllerProvider.register("VC_INLYS21_OFCAL_511_MAIN_CTRL", ["$scope", "breadcrumbs",

    function($scope, breadcrumbs) {
        $scope.breadcrumbs = breadcrumbs;
    }]);
    cobisMainModule.controllerProvider.register("VC_INLYS21_OFCAL_511_CTRL", ["cobisMessage", cobis.modules.CONTAINER + ".preferencesService", "dsgnrUtils", "designer", "$scope", "$location", "$document", "$parse", "$filter", "$modal", "$q", "$compile", "$timeout",
    ...
    function(cobisMessage, preferencesService, dsgnrUtils, designer, $scope, $location, $document, $parse, $filter, $modal, $q, $compile, $timeout) {
        ...
        $scope.vc = designer.initViewContainer({
            moduleId: "BUSIN",
            subModuleId: "FLCRE",
            taskId: "T_FLCRE_04_INLYS21",
            taskVersion: "1.0.0",
            viewContainerId: "VC_INLYS21_OFCAL_511",
            hasCloseModalEvent: false,
            serverEvents: true
        },
            "${contextPath}/resources/BUSIN/FLCRE/T_FLCRE_04_INLYS21",
        designerEvents.api.applicationanalysis,
        $scope.rowData);
        ...
        if (!$scope.vc.loaded) {
            ...
            $scope.vc.viewState.VC_INLYS21_OFCAL_511 = {
                style: []
            }
            //ViewState - Container: Application Analysis
            $scope.vc.createViewState({
                id: "VC_INLYS21_OFCAL_511",
                hasId: true,
                componentStyle: "",
                label: "BUSIN.DLB_BUSIN_PICATIANY_18759",
                haslabelArgs: true,
                enabled: designer.constants.mode.All
            });
            //ViewState - Container: Operation Data
            $scope.vc.createViewState({
                id: "VC_INLYS21_IODAA_525",
                hasId: true,
                componentStyle: "",
                label: "BUSIN.DLB_BUSIN_EATIONDAA_74861",
                haslabelArgs: true,
                enabled: designer.constants.mode.All
            });
            ...
            //ViewState - Container: OfficerAnalysisData
            $scope.vc.createViewState({
                id: "VC_INLYS21_ONOBR_840",
                hasId: true,
                componentStyle: "",
                label: 'OfficerAnalysisData',
                enabled: designer.constants.mode.All
            });
            ...
            }]; //ViewState - Container: [ExpromisionOperations]
            $scope.vc.createViewState({
                id: "VC_INLYS21_EROES_021",
                hasId: true,
                componentStyle: "",
            ...
            }]; //ViewState - Container: Other Data
            $scope.vc.createViewState({
                id: "VC_INLYS21_OHETA_530",
                hasId: true,
                componentStyle: "",
                label: 'Other Data',
                enabled: designer.constants.mode.All
        ...
        $scope._initPage_ProcessRender = function(page) {
            if (page.hasSearchRenderEvent) {
                $scope.vc.render('VC_INLYS21_OFCAL_511');
            }
            return page;
        };
...
if (typeof cobisMainModule === "undefined") {
    var cobisMainModule = cobis.createModule("VC_INLYS21_OFCAL_511", ["ngResource", "ngRoute", "kendo.directives", "ui.bootstrap", "oc.lazyLoad", "pascalprecht.translate", cobis.modules.CONTAINER, "designerModule"], ["DSGNR", "BUSIN"]);
    ...
    function($controllerProvider, $compileProvider, $filterProvider, $locationProvider, $routeProvider, $provide, $translateProvider, $translatePartialLoaderProvider, $ocLazyLoadProvider) {
        ...
        $routeProvider.when("/VC_INLYS21_OFCAL_511", {
            templateUrl: "VC_INLYS21_OFCAL_511_FORM.html",
            controller: "VC_INLYS21_OFCAL_511_CTRL",
            labelId: "BUSIN.DLB_BUSIN_PICATIANY_18759",
            resolve: {
            ...
            redirectTo: function(routeParams, path, search) {
                return "/VC_INLYS21_OFCAL_511?" + $.param(search);
            }
        });
        VC_INLYS21_OFCAL_511(cobisMainModule);
    }]);
} else {
    VC_INLYS21_OFCAL_511(cobisMainModule);
}
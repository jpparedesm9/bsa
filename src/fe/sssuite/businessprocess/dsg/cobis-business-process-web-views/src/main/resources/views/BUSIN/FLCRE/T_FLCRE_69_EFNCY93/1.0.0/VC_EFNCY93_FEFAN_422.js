...
designerEvents.api.refinancingdataentry = designerEvents.api.refinancingdataentry || designer.dsgEvents();

function VC_EFNCY93_FEFAN_422(cobisMainModule) {
    cobisMainModule.controllerProvider.register("VC_EFNCY93_FEFAN_422_MAIN_CTRL", ["$scope", "breadcrumbs",

    function($scope, breadcrumbs) {
        $scope.breadcrumbs = breadcrumbs;
    }]);
    cobisMainModule.controllerProvider.register("VC_EFNCY93_FEFAN_422_CTRL", ["cobisMessage", cobis.modules.CONTAINER + ".preferencesService", "dsgnrUtils", "designer", "$scope", "$location", "$document", "$parse", "$filter", "$modal", "$q", "$compile", "$timeout",
    ...
    function(cobisMessage, preferencesService, dsgnrUtils, designer, $scope, $location, $document, $parse, $filter, $modal, $q, $compile, $timeout) {
        ...
        $scope.vc = designer.initViewContainer({
            moduleId: "BUSIN",
            subModuleId: "FLCRE",
            taskId: "T_FLCRE_69_EFNCY93",
            taskVersion: "1.0.0",
            viewContainerId: "VC_EFNCY93_FEFAN_422",
            hasCloseModalEvent: false,
            serverEvents: true
        },
            "${contextPath}/resources/BUSIN/FLCRE/T_FLCRE_69_EFNCY93",
        designerEvents.api.refinancingdataentry,
        $scope.rowData);
        ...
        if (!$scope.vc.loaded) {
            ...
            $scope.vc.viewState.VC_EFNCY93_FEFAN_422 = {
                style: []
            }
            //ViewState - Container: formRefinancing
            $scope.vc.createViewState({
                id: "VC_EFNCY93_FEFAN_422",
                hasId: true,
                componentStyle: "",
                label: 'formRefinancing',
                enabled: designer.constants.mode.All
            });
            //ViewState - Container: Pestaña para HeaderView
            $scope.vc.createViewState({
                id: "VC_EFNCY93_ERDRV_854",
                hasId: true,
                componentStyle: "",
                label: 'Pesta\u00f1a para HeaderView',
                enabled: designer.constants.mode.All
            });
            ...
            $scope.vc.catalogs.VA_ORIAHEADER8602_SOET680 = new kendo.data.DataSource({
                transport: {
                    read: function(options) {
                        $scope.vc.loadCatalogCobis('VA_ORIAHEADER8602_SOET680', 'cr_tipo_calificacion', function(response) {
                            if (angular.isDefined(response.data)) {
                                var catalogResponse = response.data['RESULTVA_ORIAHEADER8602_SOET680'];
                                if (angular.isDefined(catalogResponse) && !$.isEmptyObject(catalogResponse)) {
                                    options.success(catalogResponse);
                                } else {
                                    options.success([]);
                            ...
                            $scope.vc.setComboBoxDefaultValue("VA_ORIAHEADER8602_SOET680");
                        }, null, options.data.filter, 0);
                    }
                },
                serverFiltering: true,
            ...
            $scope.vc.catalogs.VA_ORIAHEADER8602_SCOR487 = new kendo.data.DataSource({
                transport: {
                    read: function(options) {
                        $scope.vc.loadCatalogCobis('VA_ORIAHEADER8602_SCOR487', 'cr_cal_manual_empre', function(response) {
                            if (angular.isDefined(response.data)) {
                                var catalogResponse = response.data['RESULTVA_ORIAHEADER8602_SCOR487'];
                                if (angular.isDefined(catalogResponse) && !$.isEmptyObject(catalogResponse)) {
                                    options.success(catalogResponse);
                                } else {
                                    options.success([]);
                            ...
                            $scope.vc.setComboBoxDefaultValue("VA_ORIAHEADER8602_SCOR487");
                        }, null, options.data.filter, 0);
                    }
                },
                serverFiltering: true,
            ...
            $scope.vc.catalogs.VA_ORIAHEADER8602_DSIN223 = new kendo.data.DataSource({
                transport: {
                    read: function(options) {
                        options.success([{
                            code: 'S',
            ...
            if (typeof $scope.vc.catalogs.VA_ORIAHEADER8602_DSIN223 !== "undefined") {}
            //ViewState - Entity: OriginalHeader, Attribute: IsDebtorOwner
            $scope.vc.createViewState({
                id: "VA_ORIAHEADER8602_IBTO888",
                componentStyle: "",
            ...
            $scope.vc.catalogs.VA_ORIAHEADER8602_IBTO888 = new kendo.data.DataSource({
                transport: {
                    read: function(options) {
                        options.success([{
                            code: 'S',
            ...
            if (typeof $scope.vc.catalogs.VA_ORIAHEADER8602_IBTO888 !== "undefined") {}
            //ViewState - Container: OfficerAnalysisView
            $scope.vc.createViewState({
                id: "VC_EFNCY93_ERISV_657",
                hasId: true,
                componentStyle: "",
            ...
            //ViewState - Container: Pestaña para RefinancingOperationView
            $scope.vc.createViewState({
                id: "VC_EFNCY93_PPINW_423",
                hasId: true,
                componentStyle: "",
                label: "BUSIN.DLB_BUSIN_RNINOPETI_81936",
                haslabelArgs: true,
                enabled: designer.constants.mode.All
            });
            ...
            }]; //ViewState - Container: Pestaña para CreditOtherDataView
            $scope.vc.createViewState({
                id: "VC_EFNCY93_ADETE_920",
                hasId: true,
                componentStyle: "",
                label: 'Pesta\u00f1a para CreditOtherDataView',
                enabled: designer.constants.mode.All
            });
            ...
            $scope.vc.createViewState({
                id: "CM_EFNCY93HID35",
                componentStyle: "",
                tooltip: "BUSIN.DLB_BUSIN_CONCEPTOM_59109",
                label: "BUSIN.DLB_BUSIN_CONCEPTOM_59109",
                haslabelArgs: true,
                enabled: designer.constants.mode.All,
                visible: designer.constants.mode.All
            });
            ...
            var unregister = $scope.$watch('vc.afterInitData', function(newValue, oldValue) {
                if (newValue !== oldValue) {
                    unregister();
                    $scope.vc.catalogs.VA_ORIAHEADER8602_DSIN223.read();
                    $scope.vc.catalogs.VA_ORIAHEADER8602_IBTO888.read();
        ...
        $scope._initPage_ProcessRender = function(page) {
            if (page.hasSearchRenderEvent) {
                $scope.vc.render('VC_EFNCY93_FEFAN_422');
            }
            return page;
        };
...
if (typeof cobisMainModule === "undefined") {
    var cobisMainModule = cobis.createModule("VC_EFNCY93_FEFAN_422", ["ngResource", "ngRoute", "kendo.directives", "ui.bootstrap", "oc.lazyLoad", "pascalprecht.translate", cobis.modules.CONTAINER, "designerModule"], ["DSGNR", "BUSIN"]);
    ...
    function($controllerProvider, $compileProvider, $filterProvider, $locationProvider, $routeProvider, $provide, $translateProvider, $translatePartialLoaderProvider, $ocLazyLoadProvider) {
        ...
        $routeProvider.when("/VC_EFNCY93_FEFAN_422", {
            templateUrl: "VC_EFNCY93_FEFAN_422_FORM.html",
            controller: "VC_EFNCY93_FEFAN_422_CTRL",
            label: "formRefinancing",
            resolve: {
            ...
            redirectTo: function(routeParams, path, search) {
                return "/VC_EFNCY93_FEFAN_422?" + $.param(search);
            }
        });
        VC_EFNCY93_FEFAN_422(cobisMainModule);
    }]);
} else {
    VC_EFNCY93_FEFAN_422(cobisMainModule);
}
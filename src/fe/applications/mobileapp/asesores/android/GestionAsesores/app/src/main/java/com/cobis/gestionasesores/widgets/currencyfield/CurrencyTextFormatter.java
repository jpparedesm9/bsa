...
public final class CurrencyTextFormatter {
    ...
    public static double formatDouble(String val, Currency currency, Locale locale, Locale defaultLocale) {
    ...
    public static String formatText(double value, Locale locale) {
        return formatText(value, locale, Locale.US);
    }


    public static String formatText(double value, Locale locale, Locale defaultLocale) {

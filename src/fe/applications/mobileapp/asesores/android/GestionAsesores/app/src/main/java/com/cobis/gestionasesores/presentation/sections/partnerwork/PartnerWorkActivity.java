...
public class PartnerWorkActivity extends BaseActivity {

    public static final String EXTRA_SECTION = "com.cobis.gestionasesores.extras.extra_section";
    public static final String EXTRA_PERSON_ID = "com.cobis.gestionasesores.extras.extra_person_id";

    public static Intent newIntent(Context context,int personId, Section section) {
        Intent intent = new Intent(context, PartnerWorkActivity.class);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_partner_work);

        PartnerWorkFragment fragment = (PartnerWorkFragment) getSupportFragmentManager()
                .findFragmentById(R.id.fragment_container);
        if (fragment == null) {
            fragment = PartnerWorkFragment.newInstance();
            getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container, fragment).commit();
        }

        new PartnerWorkPresenter(fragment,

package com.cobis.gestionasesores.widgets.searchablespinner;
...
public class SearchableListDialog extends DialogFragment implements
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        String strPositiveButton = _strPositiveButtonText == null ? getString(R.string.search_dialog_default_positive_btn) : _strPositiveButtonText;
        alertDialog.setPositiveButton(strPositiveButton, _onClickListener);

        String strTitle = _strTitle == null ? getString(R.string.search_dialog_default_title) : _strTitle;

...
class CurrencyTextWatcher implements TextWatcher {
    ...
    private CurrencyInputEditText editText;
     ...
     */
    public CurrencyTextWatcher(CurrencyInputEditText textBox){
     ...
     */
    public CurrencyTextWatcher(CurrencyInputEditText textBox, Locale defaultLocale){
        editText = textBox;
        lastGoodInput = "";

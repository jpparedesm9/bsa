...
/**
 * Created by bqtdesa02 on 9/22/2017.
 * https://github.com/gingo/android-emulator-detector/blob/master/EmulatorDetectorProject/EmulatorDetector/src/main/java/net/skoumal/emulatordetector/EmulatorDetector.java
 */
...
public final class EmulatorDetector {
    ...
    private boolean checkPhoneNumber() {
        ...
        @SuppressLint({"HardwareIds", "MissingPermission"}) String phoneNumber = telephonyManager.getLine1Number();
    ...
    private boolean checkQEmuProps() {
        ...
        for (Property property : PROPERTIES) {
            ...
            if ((property.seekValue == null) && (property_value != null)) {
                found_props++;
            }
            if ((property.seekValue != null)
                    && (property_value.contains(property.seekValue))) {
                found_props++;
            }

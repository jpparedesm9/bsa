...
public class HttpAuthModule {
    ...
    @Provides
    public OkHttpClient providerAuthOkHttpClient() {
    ...
    @Provides
    public Retrofit providerAuthRetrofit(OkHttpClient okHttpClient) {
    ...
    @Provides
    public AuthApi providerAuthApi() {
        return providerAuthRetrofit(providerAuthOkHttpClient()).create(AuthApi.class);
    }
}

 ...
 */
public class UnlockFragment extends Fragment implements UnlockMVP.UnlockView {

    @Inject
    public UnlockMVP.UnlockPresenter presenter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ((App) Objects.requireNonNull(getActivity()).getApplication()).getComponent().injectUnlock(this);
    ...
    public void showUnlockSuccess() {
        Toast.makeText(getContext(), "Desbloqueo completo", Toast.LENGTH_SHORT).show();
        getActivity().finish();
    }

    @Override
    public void showUnlockResponseError(String message) {

...
Imports COBISCorp.tCOBIS.PER.Cost
 Public  Partial  Class FCicProFinalClass
Inherits COBISCorp.tCOBIS.COBISExplorer.CompositeUI.COBISFuncionalityView
	...
	Private Sub cmdBoton_Click(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles _cmdBoton_0.Click, _cmdBoton_1.Click, _cmdBoton_5.Click, _cmdBoton_2.Click, _cmdBoton_4.Click, _cmdBoton_3.Click
		...
		Select Case Index
			Case 0
                ...
                If FMTransmitirRPC(sqlconn, ServerName, "cob_remesas", "sp_ciclo_profinal", True, FMLoadResString(1547)) Then
			...
			Case 1
				...
				If txtCampo(2).Text.Trim() = "" Then
                    COBISMessageBox.Show(FMLoadResString(2519), FMLoadResString(1472), COBISMessageBox.COBISButtons.OK, COBISMessageBox.COBISIcon.Error)
					txtCampo(2).Focus()
					Exit Sub
				End If
                ...
                If FMTransmitirRPC(sqlconn, ServerName, "cob_remesas", "sp_ciclo_profinal", True, FMLoadResString(1576)) Then
                    PMChequea(sqlconn)
            ...
            Case 2
                If txtCampo(2).Text.Trim() = "" Then
                    ...
                    Exit Sub
                End If
                Response = CStr(COBISMsgBox.MsgBox(FMLoadResString(1856), DgDef, FMLoadResString(1867)))
                If StringsHelper.ToDoubleSafe(Response) = IDYES Then
                    ...
                    PMPasoValores(sqlconn, "@i_profinal", 0, SQLINT2, txtCampo(1).Text)
                    PMPasoValores(sqlconn, "@i_ciclo", 0, SQLCHAR, txtCampo(2).Text)
                    If FMTransmitirRPC(sqlconn, ServerName, "cob_remesas", "sp_ciclo_profinal", True, FMLoadResString(1915)) Then
                        PMChequea(sqlconn)
                        cmdBoton_Click(cmdBoton(0), New EventArgs())
                    Else
                        PMChequea(sqlconn)
            ...
            Case 5
                ...
                If FMTransmitirRPC(sqlconn, ServerName, "cob_remesas", "sp_ciclo_profinal", True, FMLoadResString(1542)) Then
                    PMChequea(sqlconn)
                    cmdBoton_Click(cmdBoton(0), New EventArgs())
                Else
                    PMChequea(sqlconn)
	...
	Private Sub FCicProFinal_Load(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles MyBase.Load
	...
	Private Sub FCicProFinal_Closed(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles MyBase.Closed
        ...
        If eventArgs.KeyCode = VGTeclaAyuda Then
            ...
            Select Case Index
                ...
                Case 1
                    ...
                    FRegistros.Dispose() '18/05/2016 migracion
                Case 2
                    PMCatalogo("A", "cc_ciclo", txtCampo(2), lblDescripcion(2), FRegistros)
                    VLPaso = True
            End Select
        End If
	End Sub
	...
	Private Sub txtCampo_Leave(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles _txtCampo_2.Leave, _txtCampo_1.Leave, _txtCampo_0.Leave
		...
		If Not VLPaso Then
			Select Case Index
                Case 0
                    'Se limpia los campos y el grid
                    txtCampo(1).Text = ""
                    lblDescripcion(1).Text = ""
                    txtCampo(2).Text = ""
				...
				Case 2
					If txtCampo(2).Text.Trim() = "" Then
						...
						Exit Sub
					End If
                    PMCatalogo("V", "cc_ciclo", txtCampo(2), lblDescripcion(2), Nothing)

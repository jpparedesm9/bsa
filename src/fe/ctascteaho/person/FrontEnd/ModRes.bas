...
'*************************************************************
    ...
    'xrs: 18/02/1999
'P_FIXIT: Replace 'pnlTransaccionLine.ForeColor=[Value]' function with 'pnlTransaccionLine.ForeColor=System.Drawing.ColorTranslator.FromOle([Value])' function in .NET                                       FixIT90210ae-R9757-R1B8ZE
'FIXIT: pnlTransaccionLine.ForeColor property has no Visual Basic .NET equivalent and will not be upgraded.     FixIT90210ae-R7594-R67265
...
'! '*************************************************************
'! ' PROPOSITO: Borrar la barra de mensajes de ayuda y de
'! '            transacciones
'! ' INPUT    : Ninguno
'! ' OUTPUT   : Ninguno
'! '*************************************************************
...
'FIXIT: 'Style' is not a property of the generic 'Control' object in Visual Basic .NET. To access 'Style' declare 'VTCtl' using its actual type instead of 'Control'     FixIT90210ae-R1460-RCFE85
            If VTCtl.Style = 1 Then
'FIXIT: 'WhatsThisHelpID' is not a property of the generic 'Control' object in Visual Basic .NET. To access 'WhatsThisHelpID' declare 'VTCtl' using its actual type instead of 'Control'     FixIT90210ae-R1460-RCFE85
'FIXIT: 'Picture' is not a property of the generic 'Control' object in Visual Basic .NET. To access 'Picture' declare 'VTCtl' using its actual type instead of 'Control'     FixIT90210ae-R1460-RCFE85
...
'*************************************************************
    ...
    Dim VTCtl As Object
'FIXIT: Declare 'VTObj' with an early-bound data type                                      FixIT90210ae-R1672-R1B8ZE
    Dim VTObj As Object
'FIXIT: Declare 'VTFnt' with an early-bound data type                                      FixIT90210ae-R1672-R1B8ZE
    Dim VTFnt As Object
    Dim VTsCtlType As String
...
'FIXIT: 'Caption' is not a property of the generic 'Control' object in Visual Basic .NET. To access 'Caption' declare 'VTCtl' using its actual type instead of 'Control'     FixIT90210ae-R1460-RCFE85
'FIXIT: 'HelpContextID' is not a property of the generic 'Control' object in Visual Basic .NET. To access 'HelpContextID' declare 'VTCtl' using its actual type instead of 'Control'     FixIT90210ae-R1460-RCFE85
            VTCtl.Caption = LoadResString(CInt(VTCtl.HelpContextID))
        ElseIf VTsCtlType = "TabStrip" Then
'FIXIT: 'Tabs' is not a property of the generic 'Control' object in Visual Basic .NET. To access 'Tabs' declare 'VTCtl' using its actual type instead of 'Control'     FixIT90210ae-R1460-RCFE85
...
'FIXIT: 'Buttons' is not a property of the generic 'Control' object in Visual Basic .NET. To access 'Buttons' declare 'VTCtl' using its actual type instead of 'Control'     FixIT90210ae-R1460-RCFE85
            For Each VTObj In VTCtl.Buttons
                VTObj.ToolTipText = LoadResString(CInt(VTObj.ToolTipText))
            Next
        ElseIf VTsCtlType = "ListView" Then
'FIXIT: 'ColumnHeaders' is not a property of the generic 'Control' object in Visual Basic .NET. To access 'ColumnHeaders' declare 'VTCtl' using its actual type instead of 'Control'     FixIT90210ae-R1460-RCFE85
            For Each VTObj In VTCtl.ColumnHeaders
                VTObj.Text = LoadResString(CInt(VTObj.Tag))
            Next
        ElseIf VTsCtlType = "TextValid" Then
'FIXIT: 'HelpLine' is not a property of the generic 'Control' object in Visual Basic .NET. To access 'HelpLine' declare 'VTCtl' using its actual type instead of 'Control'     FixIT90210ae-R1460-RCFE85
'FIXIT: 'WhatsThisHelpID' is not a property of the generic 'Control' object in Visual Basic .NET. To access 'WhatsThisHelpID' declare 'VTCtl' using its actual type instead of 'Control'     FixIT90210ae-R1460-RCFE85
...
'FIXIT: 'Row' is not a property of the generic 'Control' object in Visual Basic .NET. To access 'Row' declare 'VTCtl' using its actual type instead of 'Control'     FixIT90210ae-R1460-RCFE85
            VTCtl.Row = 0
'FIXIT: 'MaxCols' is not a property of the generic 'Control' object in Visual Basic .NET. To access 'MaxCols' declare 'VTCtl' using its actual type instead of 'Control'     FixIT90210ae-R1460-RCFE85
            For VTi% = 1 To VTCtl.MaxCols
'FIXIT: 'Col' is not a property of the generic 'Control' object in Visual Basic .NET. To access 'Col' declare 'VTCtl' using its actual type instead of 'Control'     FixIT90210ae-R1460-RCFE85
                VTCtl.Col = VTi%
...
'FIXIT: 'Caption' is not a property of the generic 'Control' object in Visual Basic .NET. To access 'Caption' declare 'VTCtl' using its actual type instead of 'Control'     FixIT90210ae-R1460-RCFE85
            ...
            VTnVal = 0
'FIXIT: 'ToolTipText' is not a property of the generic 'Control' object in Visual Basic .NET. To access 'ToolTipText' declare 'VTCtl' using its actual type instead of 'Control'     FixIT90210ae-R1460-RCFE85

...
'! removed Global Const CG_HKEY_USER = &H80000003
...
'!   FMObtenerSeccionToken$ = ""
'! End Function
'! Public Function FMSetScreenSaverTimeOut(parTiempo As Long) As Boolean
'! '*************************************************************
'! ' Objetivo:  Obtiene el el directorio del sistema de
'! '            windows
'! ' Input   :  parTiempo  ' Tiempo de activación en segundos
'! ' Output  :  FMSetScreenSaverTimeOut
'! '*************************************************************
'! '                       MODIFICACIONES
'! ' FECHA          AUTOR           RAZON
'! ' 21/Nov/97      J.Bucheli       Emision Inicial
'! '*************************************************************
'!
'!     If SystemParametersInfo(15, parTiempo&, "", 3) = 0 Then
'!         FMSetScreenSaverTimeOut = False
'!     Else
'!         FMSetScreenSaverTimeOut = True
'!     End If
'! End Function
'!
...
'FIXIT: Replace 'Mid' function with 'Mid$' function                                        FixIT90210ae-R9757-R1B8ZE
    If (AscW(Mid$(VTtmpVal, VTKeyValSize, 1)) = 0) Then                   ' Win95: String de terminación nulo
...
'FIXIT: Replace 'Mid' function with 'Mid$' function                                        FixIT90210ae-R9757-R1B8ZE
                parKeyVal = parKeyVal + Hex$(AscW(Mid$(VTtmpVal, VTi, 1))) ' Construir valor Char. Caracter por caracter
            Next

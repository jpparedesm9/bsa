...
Begin VB.Form FTran497 
   BackColor       =   &H00C0C0C0&
   Caption         =   "Depósito de Ahorros"
   ClientHeight    =   5325
   ClientLeft      =   1845
   ClientTop       =   2850
   ClientWidth     =   9360
...
'*************************************************************
' ARCHIVO:          ftran497.frm
' NOMBRE LOGICO:    FTran497
...
'*************************************************************
'                         PROPOSITO
' Permite realizar el Depósito de Ahorros
'*************************************************************
'                       MODIFICACIONES
' FECHA          AUTOR           RAZON
...
Private Sub cmdBoton_Click(Index As Integer)
    ...
    Case 0
        ...
        End If
         ...
         PMPasoValores sqlconn&, "@t_trn", 0, SQLINT4, "251"
         ...
         PMPasoValores sqlconn&, "@i_sldlib", 0, SQLMONEY, "0.00"
         PMPasoValores sqlconn&, "@i_nctrl", 0, SQLINT4, "0"
         PMPasoValores sqlconn&, "@i_planilla", 0, SQLVARCHAR, txtCampo(0).Text
    
         
         If FMTransmitirRPC(sqlconn&, ServerName$, "cob_ahorros", "sp_ah_deposito", True, "Ok... Deposito Monetario de prueba") Then
             PMChequea sqlconn&

...
designerEvents.api.loanstatuschangemain = designerEvents.api.loanstatuschangemain || designer.dsgEvents();

function VC_LOANSTATCE_588120(cobisMainModule) {
    cobisMainModule.controllerProvider.register("VC_LOANSTATCE_588120_MAIN_CTRL", ["$scope", "breadcrumbs",

    function($scope, breadcrumbs) {
        $scope.breadcrumbs = breadcrumbs;
    }]);
    cobisMainModule.controllerProvider.register("VC_LOANSTATCE_588120_CTRL", ["cobisMessage", cobis.modules.CONTAINER + ".preferencesService", "dsgnrUtils", "designer", "$scope", "$location", "$document", "$parse", "$filter", "$modal", "$q", "$compile", "$timeout", "$translate",
    ...
    function(cobisMessage, preferencesService, dsgnrUtils, designer, $scope, $location, $document, $parse, $filter, $modal, $q, $compile, $timeout, $translate) {
        ...
        $scope.vc = designer.initViewContainer({
            ...
            taskVersion: "1.0.0",
            viewContainerId: "VC_LOANSTATCE_588120",
            hasCloseModalEvent: false,
            serverEvents: true
        },
            "${contextPath}/resources/ASSTS/CMMNS/T_LOANSTATUSGNI_120",
        designerEvents.api.loanstatuschangemain,
        $scope.rowData);
        ...
        if (!$scope.vc.loaded) {
            ...
            $scope.vc.temporarySave = function() {
                ...
                $scope.vc.execute("temporarySave", VC_LOANSTATCE_588120, data, function() {});
            };
            $scope.vc.temporaryRead = function() {
                if (page.hasTemporaryDataSupport) {
                    ...
                    return $scope.vc.executeService("readTemporaryData", VC_LOANSTATCE_588120, data).then(

                    function(response) {
                        var result = $scope.vc.processTemporaryResponse(response);
                        if (result) {
                            $scope.vc.execute("deleteTemporaryData", VC_LOANSTATCE_588120, data, function() {});
            ...
            $scope.vc.viewState.VC_LOANSTATCE_588120 = {
                style: []
            }
            //ViewState - Container: ViewContainerBase
            $scope.vc.createViewState({
                id: "VC_LOANSTATCE_588120",
                hasId: true,
                componentStyle: [],
                label: "ASSTS.LBL_ASSTS_CAMBIOEOA_47107",
                enabled: designer.constants.mode.All
            });
            //ViewState - Container: ViewContainerBase
            $scope.vc.createViewState({
                id: "VC_VUYOJBQTYU_229120",
                hasId: true,
                componentStyle: [],
            ...
            //ViewState - Container: ViewContainerBase
            $scope.vc.createViewState({
                id: "VC_VJBOQKTMFN_200120",
                hasId: true,
                componentStyle: [],
                label: 'ViewContainerBase',
                enabled: designer.constants.mode.All
            });
            //ViewState - Container: LoanStatusChangeForm
            $scope.vc.createViewState({
                id: "VC_YRXPGLWZFA_955840",
                hasId: true,
                componentStyle: [],
                label: 'LoanStatusChangeForm',
                enabled: designer.constants.mode.All
            });
            //ViewState - Group: Group1371
            $scope.vc.createViewState({
                id: "G_LOANSTAGHS_220722",
                hasId: true,
                componentStyle: [],
                label: 'Group1371',
                enabled: designer.constants.mode.All,
            ...
            //ViewState - Entity: Loan, Attribute: newStatus
            $scope.vc.createViewState({
                id: "VA_NEWSTATUSLZHCOE_110722",
                componentStyle: [],
                label: "ASSTS.LBL_ASSTS_NUEVOESTA_11189",
                validationCode: 0,
                readOnly: designer.constants.mode.Query,
                enabled: designer.constants.mode.All,
                visible: designer.constants.mode.All,
            ...
            $scope.vc.catalogs.VA_NEWSTATUSLZHCOE_110722 = new kendo.data.DataSource({
                transport: {
                    read: function(options) {
                        $scope.vc.loadCatalog('VA_NEWSTATUSLZHCOE_110722', function(response) {
                            if (response.success) {
                                var catalogResponse = response.data['RESULTVA_NEWSTATUSLZHCOE_110722'];
                            ...
                            $scope.vc.setComboBoxDefaultValue("VA_NEWSTATUSLZHCOE_110722");
                        },
            ...
            //ViewState - Group: Group1806
            $scope.vc.createViewState({
                id: "G_LOANSTASSE_267722",
                hasId: true,
                componentStyle: [],
                label: 'Group1806',
                enabled: designer.constants.mode.All,
        ...
        $scope._initPage_ProcessRender = function(page) {
            if (page.hasSearchRenderEvent) {
                $scope.vc.render('VC_LOANSTATCE_588120');
            }
            return page;
        };
...
if (typeof cobisMainModule === "undefined") {
    var cobisMainModule = cobis.createModule("VC_LOANSTATCE_588120", ["ngResource", "ngRoute", "kendo.directives", "ui.bootstrap", "oc.lazyLoad", "pascalprecht.translate", cobis.modules.CONTAINER, "designerModule"], ["DSGNR", "ASSTS"]);
    ...
    function($controllerProvider, $compileProvider, $filterProvider, $locationProvider, $routeProvider, $provide, $translateProvider, $translatePartialLoaderProvider, $ocLazyLoadProvider) {
        ...
        $routeProvider.when("/VC_LOANSTATCE_588120", {
            templateUrl: "VC_LOANSTATCE_588120_FORM.html",
            controller: "VC_LOANSTATCE_588120_CTRL",
            labelId: "ASSTS.LBL_ASSTS_CAMBIOEOA_47107",
            resolve: {
            ...
            redirectTo: function(routeParams, path, search) {
                return "/VC_LOANSTATCE_588120?" + $.param(search);
            }
        });
        VC_LOANSTATCE_588120(cobisMainModule);
    }]);
} else {
    VC_LOANSTATCE_588120(cobisMainModule);
}
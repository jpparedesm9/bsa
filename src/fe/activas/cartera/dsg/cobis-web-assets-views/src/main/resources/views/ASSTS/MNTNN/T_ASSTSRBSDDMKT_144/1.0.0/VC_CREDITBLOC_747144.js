...
designerEvents.api.creditblockcomposite = designerEvents.api.creditblockcomposite || designer.dsgEvents();

function VC_CREDITBLOC_747144(cobisMainModule) {
    cobisMainModule.controllerProvider.register("VC_CREDITBLOC_747144_MAIN_CTRL", ["$scope", "breadcrumbs",

    function($scope, breadcrumbs) {
        $scope.breadcrumbs = breadcrumbs;
    }]);
    cobisMainModule.controllerProvider.register("VC_CREDITBLOC_747144_CTRL", ["cobisMessage", cobis.modules.CONTAINER + ".preferencesService", "dsgnrUtils", "designer", "$scope", "$location", "$document", "$parse", "$filter", "$modal", "$q", "$compile", "$timeout", "$translate",
    ...
    function(cobisMessage, preferencesService, dsgnrUtils, designer, $scope, $location, $document, $parse, $filter, $modal, $q, $compile, $timeout, $translate) {
        ...
        $scope.vc = designer.initViewContainer({
            ...
            taskVersion: "1.0.0",
            viewContainerId: "VC_CREDITBLOC_747144",
            hasCloseModalEvent: false,
            serverEvents: true
        },
            "${contextPath}/resources/ASSTS/MNTNN/T_ASSTSRBSDDMKT_144",
        designerEvents.api.creditblockcomposite,
        $scope.rowData);
        ...
        if (!$scope.vc.loaded) {
            ...
            $scope.vc.metadata = {
                ...
                entities: {
                    ...
                    Block: {
                        blocked: 'AT11_BLOCKEDD360',
                        disbursementDate: 'AT26_DISBURED360',
                        user: 'AT30_USERDAEQ360',
                        registerCode: 'AT32_REGISTDD360',
                        customerName: 'AT34_CUSTOMMM360',
                        active: 'AT42_ACTIVEWR360',
                        customerId: 'AT43_CUSTOMIR360',
                        quota: 'AT58_QUOTAVJY360',
                        enabledAut: 'AT63_ENABLETT360',
                        expirationDate: 'AT76_EXPIRANI360',
                        dateLastUpdate: 'AT90_DATELATE360',
                        available: 'AT96_AVAILAEE360',
                        _pks: [],
                        _entityId: 'EN_BLOCKYZZG_360',
                        _entityVersion: '1.0.0',
                        _transient: false
                    }
                },
            ...
            $scope.vc.temporarySave = function() {
                ...
                $scope.vc.execute("temporarySave", VC_CREDITBLOC_747144, data, function() {});
            };
            $scope.vc.temporaryRead = function() {
                if (page.hasTemporaryDataSupport) {
                    ...
                    return $scope.vc.executeService("readTemporaryData", VC_CREDITBLOC_747144, data).then(

                    function(response) {
                        var result = $scope.vc.processTemporaryResponse(response);
                        if (result) {
                            $scope.vc.execute("deleteTemporaryData", VC_CREDITBLOC_747144, data, function() {});
            ...
            $scope.vc.viewState.VC_CREDITBLOC_747144 = {
                style: []
            }
            //ViewState - Container: ViewContainerBase
            $scope.vc.createViewState({
                id: "VC_CREDITBLOC_747144",
                hasId: true,
                componentStyle: [],
            ...
            //ViewState - Container: ViewContainerBase
            $scope.vc.createViewState({
                id: "VC_NWICXIOFUT_294144",
                hasId: true,
                componentStyle: [],
                label: 'ViewContainerBase',
                enabled: designer.constants.mode.All
            });
            //ViewState - Container: CreditBlock
            $scope.vc.createViewState({
                id: "VC_KIVYCDWGBN_789501",
                hasId: true,
                componentStyle: [],
                label: 'CreditBlock',
                enabled: designer.constants.mode.All
            });
            //ViewState - Group: Group2512
            $scope.vc.createViewState({
                id: "G_CREDITBLKO_155902",
                hasId: true,
                componentStyle: [],
                label: 'Group2512',
                enabled: designer.constants.mode.All,
            ...
            $scope.vc.createViewState({
                id: "G_CREDITBLKO_155902-default-blank",
                componentStyle: [],
                label: '',
                validationCode: 0,
                readOnly: designer.constants.mode.None,
            ...
            $scope.vc.model.Block = {
                blocked: $scope.vc.channelDefaultValues("Block", "blocked"),
                disbursementDate: $scope.vc.channelDefaultValues("Block", "disbursementDate"),
                user: $scope.vc.channelDefaultValues("Block", "user"),
                registerCode: $scope.vc.channelDefaultValues("Block", "registerCode"),
                customerName: $scope.vc.channelDefaultValues("Block", "customerName"),
                active: $scope.vc.channelDefaultValues("Block", "active"),
                customerId: $scope.vc.channelDefaultValues("Block", "customerId"),
                quota: $scope.vc.channelDefaultValues("Block", "quota"),
                enabledAut: $scope.vc.channelDefaultValues("Block", "enabledAut"),
                expirationDate: $scope.vc.channelDefaultValues("Block", "expirationDate"),
                dateLastUpdate: $scope.vc.channelDefaultValues("Block", "dateLastUpdate"),
                available: $scope.vc.channelDefaultValues("Block", "available")
            };
            //ViewState - Group: Group1631
            $scope.vc.createViewState({
                id: "G_CREDITBKCC_893902",
                hasId: true,
                componentStyle: [],
                label: 'Group1631',
                enabled: designer.constants.mode.All,
            ...
            //ViewState - Entity: Block, Attribute: customerId
            $scope.vc.createViewState({
                id: "VA_CUSTOMERIDRKBLP_589902",
                componentStyle: [],
            ...
            //ViewState - Entity: Block, Attribute: disbursementDate
            $scope.vc.createViewState({
                id: "VA_DISBURSEMENTATT_183902",
                componentStyle: [],
                label: "ASSTS.LBL_ASSTS_FECHAACAC_64681",
                validationCode: 0,
                readOnly: designer.constants.mode.Query,
                enabled: designer.constants.mode.All,
                visible: designer.constants.mode.All
            });
            //ViewState - Entity: Block, Attribute: expirationDate
            $scope.vc.createViewState({
                id: "VA_EXPIRATIONDAEET_757902",
                componentStyle: [],
                label: "ASSTS.LBL_ASSTS_FECHAVEEI_95705",
                validationCode: 0,
                readOnly: designer.constants.mode.Query,
                enabled: designer.constants.mode.All,
                visible: designer.constants.mode.All
            });
            //ViewState - Entity: Block, Attribute: quota
            $scope.vc.createViewState({
                id: "VA_QUOTAJPWNMBZJHS_719902",
                componentStyle: [],
                label: "ASSTS.LBL_ASSTS_CUPOLCRME_79596",
                format: "c",
                decimals: kendo.cultures.current.numberFormat.decimals,
                validationCode: 0,
                readOnly: designer.constants.mode.Query,
            ...
            //ViewState - Entity: Block, Attribute: registerCode
            $scope.vc.createViewState({
                id: "VA_REGISTERCODEHHL_386902",
                componentStyle: [],
                label: "ASSTS.LBL_ASSTS_REGISTROO_19494",
                validationCode: 0,
                readOnly: designer.constants.mode.Query,
                enabled: designer.constants.mode.All,
                visible: designer.constants.mode.All
            });
            //ViewState - Entity: Block, Attribute: blocked
            $scope.vc.createViewState({
                id: "VA_BLOCKEDNRTUOVUF_821902",
                componentStyle: [],
                label: "ASSTS.LBL_ASSTS_BLOQUEAOO_16829",
                validationCode: 0,
                readOnly: designer.constants.mode.Query,
                enabled: designer.constants.mode.All,
                visible: designer.constants.mode.All
            });
            //ViewState - Entity: Block, Attribute: available
            $scope.vc.createViewState({
                id: "VA_AVAILABLETTDYZZ_850902",
                componentStyle: [],
                label: "ASSTS.LBL_ASSTS_DISPONILE_39281",
                format: "c",
                decimals: kendo.cultures.current.numberFormat.decimals,
                validationCode: 0,
                readOnly: designer.constants.mode.Query,
            ...
            //ViewState - Entity: Block, Attribute: user
            $scope.vc.createViewState({
                id: "VA_USERWLUITPUDIFC_464902",
                componentStyle: [],
                label: "ASSTS.LBL_ASSTS_USUARIOUM_49320",
                validationCode: 0,
                readOnly: designer.constants.mode.Query,
                enabled: designer.constants.mode.All,
                visible: designer.constants.mode.All
            });
            //ViewState - Entity: Block, Attribute: dateLastUpdate
            $scope.vc.createViewState({
                id: "VA_DATELASTUPDATTT_119902",
                componentStyle: [],
                label: "ASSTS.LBL_ASSTS_FECHAULMT_29216",
                validationCode: 0,
                readOnly: designer.constants.mode.Query,
                enabled: designer.constants.mode.All,
                visible: designer.constants.mode.All
            ...
            $scope.vc.createViewState({
                id: "CM_TASSTSRB_NMS",
                componentStyle: [],
                label: "ASSTS.LBL_ASSTS_AUTORIZAT_59366",
                enabled: designer.constants.mode.All,
                visible: designer.constants.mode.All
            });
            ...
            $scope.vc.createViewState({
                id: "CM_TASSTSRB_N1N",
                componentStyle: [],
                label: "ASSTS.LBL_ASSTS_BLOQUEARR_90407",
                enabled: designer.constants.mode.All,
                visible: designer.constants.mode.All
            });
        ...
        $scope._initPage_ProcessRender = function(page) {
            if (page.hasSearchRenderEvent) {
                $scope.vc.render('VC_CREDITBLOC_747144');
            }
            return page;
        };
...
if (typeof cobisMainModule === "undefined") {
    var cobisMainModule = cobis.createModule("VC_CREDITBLOC_747144", ["ngResource", "ngRoute", "kendo.directives", "ui.bootstrap", "oc.lazyLoad", "pascalprecht.translate", cobis.modules.CONTAINER, "designerModule"], ["DSGNR", "ASSTS"]);
    ...
    function($controllerProvider, $compileProvider, $filterProvider, $locationProvider, $routeProvider, $provide, $translateProvider, $translatePartialLoaderProvider, $ocLazyLoadProvider) {
        ...
        $routeProvider.when("/VC_CREDITBLOC_747144", {
            templateUrl: "VC_CREDITBLOC_747144_FORM.html",
            controller: "VC_CREDITBLOC_747144_CTRL",
            label: "ViewContainerBase",
            resolve: {
            ...
            redirectTo: function(routeParams, path, search) {
                return "/VC_CREDITBLOC_747144?" + $.param(search);
            }
        });
        VC_CREDITBLOC_747144(cobisMainModule);
    }]);
} else {
    VC_CREDITBLOC_747144(cobisMainModule);
}
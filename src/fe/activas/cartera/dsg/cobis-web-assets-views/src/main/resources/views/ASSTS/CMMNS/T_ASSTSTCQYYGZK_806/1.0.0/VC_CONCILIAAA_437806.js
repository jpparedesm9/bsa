...
designerEvents.api.conciliationmanualobservationmodal = designerEvents.api.conciliationmanualobservationmodal || designer.dsgEvents();

function VC_CONCILIAAA_437806(cobisMainModule) {
    cobisMainModule.controllerProvider.register("VC_CONCILIAAA_437806_MAIN_CTRL", ["$scope", "breadcrumbs",

    function($scope, breadcrumbs) {
        $scope.breadcrumbs = breadcrumbs;
    }]);
    cobisMainModule.controllerProvider.register("VC_CONCILIAAA_437806_CTRL", ["cobisMessage", cobis.modules.CONTAINER + ".preferencesService", "dsgnrUtils", "designer", "$scope", "$location", "$document", "$parse", "$filter", "$modal", "$q", "$compile", "$timeout", "$translate",
    ...
    function(cobisMessage, preferencesService, dsgnrUtils, designer, $scope, $location, $document, $parse, $filter, $modal, $q, $compile, $timeout, $translate) {
        ...
        $scope.vc = designer.initViewContainer({
            ...
            "${contextPath}/resources/ASSTS/CMMNS/T_ASSTSTCQYYGZK_806",
        designerEvents.api.conciliationmanualobservationmodal,
        $scope.rowData);
        ...
        if (!$scope.vc.loaded) {
            ...
            $scope.vc.temporarySave = function() {
                ...
                $scope.vc.execute("temporarySave", VC_CONCILIAAA_437806, data, function() {});
            };
            $scope.vc.temporaryRead = function() {
                if (page.hasTemporaryDataSupport) {
                    ...
                    return $scope.vc.executeService("readTemporaryData", VC_CONCILIAAA_437806, data).then(

                    function(response) {
                        var result = $scope.vc.processTemporaryResponse(response);
                        if (result) {
                            $scope.vc.execute("deleteTemporaryData", VC_CONCILIAAA_437806, data, function() {});
            ...
            $scope.vc.viewState.VC_CONCILIAAA_437806 = {
                style: []
            }
            ...
            //ViewState - Group: Group1558
            $scope.vc.createViewState({
                id: "G_CONCILIAAV_827442",
                hasId: true,
                componentStyle: [],
                label: 'Group1558',
            ...
            //ViewState - Entity: ConciliationManualSearchFilter, Attribute: observation
            $scope.vc.createViewState({
                id: "VA_OBSERVATIONCENO_166442",
                componentStyle: [],
                label: "ASSTS.LBL_ASSTS_OBSERVAIC_59962",
                validationCode: 32,
        ...
        $scope._initPage_ProcessRender = function(page) {
            if (page.hasSearchRenderEvent) {
                $scope.vc.render('VC_CONCILIAAA_437806');
            }
            return page;
        };
...
if (typeof cobisMainModule === "undefined") {
    var cobisMainModule = cobis.createModule("VC_CONCILIAAA_437806", ["ngResource", "ngRoute", "kendo.directives", "ui.bootstrap", "oc.lazyLoad", "pascalprecht.translate", cobis.modules.CONTAINER, "designerModule"], ["DSGNR", "ASSTS"]);
    ...
    function($controllerProvider, $compileProvider, $filterProvider, $locationProvider, $routeProvider, $provide, $translateProvider, $translatePartialLoaderProvider, $ocLazyLoadProvider) {
        ...
        $routeProvider.when("/VC_CONCILIAAA_437806", {
            templateUrl: "VC_CONCILIAAA_437806_FORM.html",
            controller: "VC_CONCILIAAA_437806_CTRL",
            label: "ConciliationManualObservationModal",
            resolve: {
            ...
            redirectTo: function(routeParams, path, search) {
                return "/VC_CONCILIAAA_437806?" + $.param(search);
            }
        });
        VC_CONCILIAAA_437806(cobisMainModule);
    }]);
} else {
    VC_CONCILIAAA_437806(cobisMainModule);
}
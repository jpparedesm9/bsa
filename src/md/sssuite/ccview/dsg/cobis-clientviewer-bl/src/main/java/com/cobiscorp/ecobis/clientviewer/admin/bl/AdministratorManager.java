package com.cobiscorp.ecobis.clientviewer.admin.bl;
...
/**
 * Business layer Interface, exposes methods for administrator of consolidated
 * view of customers
 * 
 * @author dcumbal
 */
public interface AdministratorManager {
	...
	void updateProductAdministrator(
			ProductAdministratorDTO objProductAdministrator);
	...
	/**
	 * Method for get the dinamic information por menu
	 * 
	 * @return
	 * @author mcabay
	 */

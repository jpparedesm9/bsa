...
public class DraftInManagerImpl extends ServiceBase implements IExternalService {
	private static ILogger logger = LogFactory.getLogger(DraftInManagerImpl.class);
	private ICTSServiceIntegration serviceIntegration;

	@Override
	public Object executeService(Object... values) {
		logger.logDebug("Starts execute in DraftInManagerImpl");
		...
		try {
			...
			logger.logDebug("Finish execute in DraftInManagerImpl");
	...
	private List<Remittance> getDrafts(Integer customer) {
		try {
			...
			remittance.setBeneficiaryId(customer);

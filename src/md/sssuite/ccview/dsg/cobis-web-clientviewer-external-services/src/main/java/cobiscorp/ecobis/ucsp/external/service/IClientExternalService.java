...
package cobiscorp.ecobis.ucsp.external.service;
...
public interface IClientExternalService
{
	...
	/**
	 * Method for exception client
	 * @return ServiceResponse
	 */
	ServiceResponse queryClientException(Integer customerCode);
	
	/**
	 * Method for get customer visits
	 * @return ServiceResponse
	 */
	ServiceResponse queryCustomerVisits(Integer customerCode);
}
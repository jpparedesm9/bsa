...
public class ClientRatingCollection implements Serializable {
	private ClientRating[] ratesClient;

	public ClientRating[] getRatesClient() {
		return this.ratesClient;
	}

	public void setRatesClient(ClientRating[] ratesClient) {

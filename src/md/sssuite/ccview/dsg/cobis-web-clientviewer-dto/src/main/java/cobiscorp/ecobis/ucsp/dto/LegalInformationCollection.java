...
public class LegalInformationCollection implements Serializable {
	private LegalInformation[] legalInformations;

	public LegalInformation[] getLegalInformations() {
		return this.legalInformations;
	}

	public void setLegalInformations(LegalInformation[] legalInformations) {

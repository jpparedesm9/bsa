...
public class FuncionalityCollection implements Serializable {
	private Funcionality[] funcionalities;

	public Funcionality[] getFuncionalities() {
		return this.funcionalities;
	}

	public void setFuncionalities(Funcionality[] funcionalities) {

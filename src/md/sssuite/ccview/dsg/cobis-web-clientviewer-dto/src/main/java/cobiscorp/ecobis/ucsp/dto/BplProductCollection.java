...
public class BplProductCollection implements Serializable {
	private BplProduct[] products;

	public BplProduct[] getProducts() {
		return this.products;
	}

	public void setProducts(BplProduct[] products) {

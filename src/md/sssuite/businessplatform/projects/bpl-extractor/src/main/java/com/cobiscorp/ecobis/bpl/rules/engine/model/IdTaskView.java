 ...
 */
@Embeddable
public class IdTaskView implements Serializable {
	...
	public IdTaskView(Integer idActivity, Integer idProcess, Short versionProcess) {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		IdTaskView other = (IdTaskView) obj;
		if (idActivity == null) {

...
/**
 * The primary key class for the wf_actividad_proc database table.
 * 
 */
@Embeddable
public class IdProcessActivity implements Serializable {
	...
	public IdProcessActivity() {
	}

	public IdProcessActivity(Integer idActivity, Integer idProcess, Short versionProcess) {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		IdProcessActivity other = (IdProcessActivity) obj;
		if (idActivity == null) {

/*
 * Archivo: T_RELATIONAJNQY_494.java
 * Fecha: 2017-02-16T17:07:52Z
 *
 ...
 * T_RELATIONAJNQY_494 - RelationForm 
 *
 * @autor designer
 */
@Path("/CSTMR/CSTMR/T_RELATIONAJNQY_494")
@Component
@Service({T_RELATIONAJNQY_494.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=CSTMR)(task.submodule=CSTMR)(task.id=T_RELATIONAJNQY_494)(task.version=1.0.0))")
...
public class T_RELATIONAJNQY_494 {

/*
 * Archivo: T_CSTMRTVGMFYGK_259.java
 * Fecha: 2018-07-30T16:02:31Z
 *
 ...
 * T_CSTMRTVGMFYGK_259 - AuthorizationTransferForm 
 *
 * @autor designer
 */
@Path("/CSTMR/CSTMR/T_CSTMRTVGMFYGK_259")
@Component
@Service({T_CSTMRTVGMFYGK_259.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=CSTMR)(task.submodule=CSTMR)(task.id=T_CSTMRTVGMFYGK_259)(task.version=1.0.0))")
,@Reference(name="VW_AUTHORIZRA_576", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_AUTHORIZRA_576)(view.version=1.0.0))")
,@Reference (name="QV_8174_44016",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_8174_44016)")
,@Reference(name="Q_AUTHORRN_8174",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_AUTHORRN_8174)(query.version=1.0.0))")
...
public class T_CSTMRTVGMFYGK_259 {

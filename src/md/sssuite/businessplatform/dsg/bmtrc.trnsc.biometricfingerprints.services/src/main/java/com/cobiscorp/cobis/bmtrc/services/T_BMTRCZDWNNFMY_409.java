/*
 * Archivo: T_BMTRCZDWNNFMY_409.java
 * Fecha: 2022-07-21T04:46:11Z
 *
 ...
 * T_BMTRCZDWNNFMY_409 - BiometricFingerprints 
 *
 * @autor designer
 */
@Path("/BMTRC/TRNSC/T_BMTRCZDWNNFMY_409")
@Component
@Service({T_BMTRCZDWNNFMY_409.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BMTRC)(task.submodule=TRNSC)(task.id=T_BMTRCZDWNNFMY_409)(task.version=1.0.0))")
,@Reference(name="VW_BIOMETRIRR_166", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_BIOMETRIRR_166)(view.version=1.0.0))")
...
public class T_BMTRCZDWNNFMY_409 {

/*
 * Archivo: T_BSSNSKNPPLXIB_479.java
 * Fecha: 2020-01-16T17:14:06Z
 *
 ...
 */
package com.cobiscorp.cobis.bssns.services;
 ...
 * T_BSSNSKNPPLXIB_479 - GeneralBusinessData 
 *
 * @autor designer
 */
@Path("/BSSNS/CSTMR/T_BSSNSKNPPLXIB_479")
@Component
@Service({T_BSSNSKNPPLXIB_479.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BSSNS)(task.submodule=CSTMR)(task.id=T_BSSNSKNPPLXIB_479)(task.version=1.0.0))")
,@Reference(name="VW_GENERALBSS_568", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_GENERALBSS_568)(view.version=1.0.0))")
...
public class T_BSSNSKNPPLXIB_479 {

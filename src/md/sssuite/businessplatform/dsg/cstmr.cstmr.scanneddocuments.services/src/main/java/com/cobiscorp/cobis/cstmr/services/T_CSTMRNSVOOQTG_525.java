/*
 * Archivo: T_CSTMRNSVOOQTG_525.java
 * Fecha: 2017-07-25T14:07:23Z
 *
 ...
 * T_CSTMRNSVOOQTG_525 - ScannedDocuments 
 *
 * @autor designer
 */
@Path("/CSTMR/CSTMR/T_CSTMRNSVOOQTG_525")
@Component
@Service({T_CSTMRNSVOOQTG_525.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=CSTMR)(task.submodule=CSTMR)(task.id=T_CSTMRNSVOOQTG_525)(task.version=1.0.0))")
...
public class T_CSTMRNSVOOQTG_525 {

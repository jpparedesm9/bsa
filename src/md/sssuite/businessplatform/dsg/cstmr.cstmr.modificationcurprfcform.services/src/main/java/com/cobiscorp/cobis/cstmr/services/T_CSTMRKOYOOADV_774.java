/*
 * Archivo: T_CSTMRKOYOOADV_774.java
 * Fecha: 2018-01-17T19:11:59Z
 *
 ...
 * T_CSTMRKOYOOADV_774 - ModificationCURPRFCForm 
 *
 * @autor designer
 */
@Path("/CSTMR/CSTMR/T_CSTMRKOYOOADV_774")
@Component
@Service({T_CSTMRKOYOOADV_774.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=CSTMR)(task.submodule=CSTMR)(task.id=T_CSTMRKOYOOADV_774)(task.version=1.0.0))")
,@Reference(name="VW_MODIFICACC_882", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_MODIFICACC_882)(view.version=1.0.0))")
...
public class T_CSTMRKOYOOADV_774 {

/*
 * Archivo: T_CSTMRVFHHHDDJ_341.java
 * Fecha: 2018-08-06T17:45:29Z
 *
 ...
 * T_CSTMRVFHHHDDJ_341 - ViewAlertsEditForm 
 *
 * @autor designer
 */
@Path("/CSTMR/CSTMR/T_CSTMRVFHHHDDJ_341")
@Component
@Service({T_CSTMRVFHHHDDJ_341.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=CSTMR)(task.submodule=CSTMR)(task.id=T_CSTMRVFHHHDDJ_341)(task.version=1.0.0))")
,@Reference(name="VW_VIEWALERTS_173", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_VIEWALERTS_173)(view.version=1.0.0))")
...
public class T_CSTMRVFHHHDDJ_341 {

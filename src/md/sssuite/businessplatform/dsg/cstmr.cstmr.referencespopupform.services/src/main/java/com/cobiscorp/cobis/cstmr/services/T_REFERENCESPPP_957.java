/*
 * Archivo: T_REFERENCESPPP_957.java
 * Fecha: 2017-05-16T18:54:01Z
 *
 ...
 * T_REFERENCESPPP_957 - ReferencesPopupForm 
 *
 * @autor designer
 */
@Path("/CSTMR/CSTMR/T_REFERENCESPPP_957")
@Component
@Service({T_REFERENCESPPP_957.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=CSTMR)(task.submodule=CSTMR)(task.id=T_REFERENCESPPP_957)(task.version=1.0.0))")
,@Reference(name="VW_REFERENCEP_331", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_REFERENCEP_331)(view.version=1.0.0))")
...
public class T_REFERENCESPPP_957 {

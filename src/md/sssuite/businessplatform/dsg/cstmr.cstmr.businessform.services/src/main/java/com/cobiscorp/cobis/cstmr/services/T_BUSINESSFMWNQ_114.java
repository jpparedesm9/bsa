/*
 * Archivo: T_BUSINESSFMWNQ_114.java
 * Fecha: 2017-05-03T21:26:39Z
 *
 ...
 * T_BUSINESSFMWNQ_114 - BusinessForm 
 *
 * @autor designer
 */
@Path("/CSTMR/CSTMR/T_BUSINESSFMWNQ_114")
@Component
@Service({T_BUSINESSFMWNQ_114.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=CSTMR)(task.submodule=CSTMR)(task.id=T_BUSINESSFMWNQ_114)(task.version=1.0.0))")
...
public class T_BUSINESSFMWNQ_114 {

/*
 * Archivo: T_LEGALPERSOCCN_665.java
 * Fecha: 2017-02-09T19:39:52Z
 *
 ...
 * T_LEGALPERSOCCN_665 - LegalPersonComposite 
 *
 * @autor designer
 */
@Path("/CSTMR/CSTMR/T_LEGALPERSOCCN_665")
@Component
@Service({T_LEGALPERSOCCN_665.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=CSTMR)(task.submodule=CSTMR)(task.id=T_LEGALPERSOCCN_665)(task.version=1.0.0))")
,@Reference(name="VW_GENERALLRL_218", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_GENERALLRL_218)(view.version=1.0.0))")
,@Reference(name="VW_LEGALREPVE_183", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_LEGALREPVE_183)(view.version=1.0.0))")
,@Reference(name="VW_ECONOMICPE_907", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_ECONOMICPE_907)(view.version=1.0.0))")
...
public class T_LEGALPERSOCCN_665 {

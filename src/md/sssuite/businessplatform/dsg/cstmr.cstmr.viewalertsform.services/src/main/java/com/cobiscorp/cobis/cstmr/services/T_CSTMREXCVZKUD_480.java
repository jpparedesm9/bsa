/*
 * Archivo: T_CSTMREXCVZKUD_480.java
 * Fecha: 2018-08-01T16:24:38Z
 *
 ...
 * T_CSTMREXCVZKUD_480 - ViewAlertsForm 
 *
 * @autor designer
 */
@Path("/CSTMR/CSTMR/T_CSTMREXCVZKUD_480")
@Component
@Service({T_CSTMREXCVZKUD_480.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=CSTMR)(task.submodule=CSTMR)(task.id=T_CSTMREXCVZKUD_480)(task.version=1.0.0))")
,@Reference(name="VW_VIEWALERSS_760", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_VIEWALERSS_760)(view.version=1.0.0))")
,@Reference (name="QV_3983_71432",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_3983_71432)")
,@Reference(name="Q_WARNINGK_3983",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_WARNINGK_3983)(query.version=1.0.0))")
...
public class T_CSTMREXCVZKUD_480 {

/*
 * Archivo: T_CSTMRZIMDHJYH_829.java
 * Fecha: 2018-07-31T15:14:37Z
 *
 ...
 * T_CSTMRZIMDHJYH_829 - AddAlertsForm 
 *
 * @autor designer
 */
@Path("/CSTMR/CSTMR/T_CSTMRZIMDHJYH_829")
@Component
@Service({T_CSTMRZIMDHJYH_829.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=CSTMR)(task.submodule=CSTMR)(task.id=T_CSTMRZIMDHJYH_829)(task.version=1.0.0))")
,@Reference(name="VW_ADDALERTSS_527", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_ADDALERTSS_527)(view.version=1.0.0))")
,@Reference (name="QV_1129_31576",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_1129_31576)")
,@Reference(name="Q_UNUSUAPO_1129",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_UNUSUAPO_1129)(query.version=1.0.0))")
...
public class T_CSTMRZIMDHJYH_829 {

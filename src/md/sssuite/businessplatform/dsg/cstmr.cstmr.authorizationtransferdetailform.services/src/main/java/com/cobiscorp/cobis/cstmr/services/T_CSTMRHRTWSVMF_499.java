/*
 * Archivo: T_CSTMRHRTWSVMF_499.java
 * Fecha: 2018-07-31T15:54:46Z
 *
 ...
 * T_CSTMRHRTWSVMF_499 - AuthorizationTransferDetailForm 
 *
 * @autor designer
 */
@Path("/CSTMR/CSTMR/T_CSTMRHRTWSVMF_499")
@Component
@Service({T_CSTMRHRTWSVMF_499.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=CSTMR)(task.submodule=CSTMR)(task.id=T_CSTMRHRTWSVMF_499)(task.version=1.0.0))")
,@Reference(name="VW_AUTHORIZAA_854", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_AUTHORIZAA_854)(view.version=1.0.0))")
,@Reference (name="QV_2985_77623",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_2985_77623)")
,@Reference(name="Q_AUTHORTD_2985",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_AUTHORTD_2985)(query.version=1.0.0))")
...
public class T_CSTMRHRTWSVMF_499 {

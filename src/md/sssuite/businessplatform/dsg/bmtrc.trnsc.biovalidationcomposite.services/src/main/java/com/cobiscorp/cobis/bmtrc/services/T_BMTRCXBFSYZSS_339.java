/*
 * Archivo: T_BMTRCXBFSYZSS_339.java
 * Fecha: 2020-02-11T19:25:06Z
 *
 ...
 */
package com.cobiscorp.cobis.bmtrc.services;
 ...
 * T_BMTRCXBFSYZSS_339 - BioValidationComposite 
 *
 * @autor designer
 */
@Path("/BMTRC/TRNSC/T_BMTRCXBFSYZSS_339")
@Component
@Service({T_BMTRCXBFSYZSS_339.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BMTRC)(task.submodule=TRNSC)(task.id=T_BMTRCXBFSYZSS_339)(task.version=1.0.0))")
,@Reference(name="VW_HEADEROTCU_967", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_HEADEROTCU_967)(view.version=1.0.0))")
,@Reference(name="VW_BIOMETRICD_515", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_BIOMETRICD_515)(view.version=1.0.0))")
,@Reference (name="QV_6806_82610",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_6806_82610)")
,@Reference(name="Q_CUSTOMEE_6806",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_CUSTOMEE_6806)(query.version=1.0.0))")
...
public class T_BMTRCXBFSYZSS_339 {

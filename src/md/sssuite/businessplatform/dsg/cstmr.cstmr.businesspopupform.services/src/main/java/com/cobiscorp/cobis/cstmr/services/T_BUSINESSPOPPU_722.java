/*
 * Archivo: T_BUSINESSPOPPU_722.java
 * Fecha: 2017-09-25T19:23:52Z
 *
 ...
 * T_BUSINESSPOPPU_722 - BusinessPopupForm 
 *
 * @autor designer
 */
@Path("/CSTMR/CSTMR/T_BUSINESSPOPPU_722")
@Component
@Service({T_BUSINESSPOPPU_722.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=CSTMR)(task.submodule=CSTMR)(task.id=T_BUSINESSPOPPU_722)(task.version=1.0.0))")
,@Reference(name="VW_BUSINESSOP_246", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_BUSINESSOP_246)(view.version=1.0.0))")
...
public class T_BUSINESSPOPPU_722 {

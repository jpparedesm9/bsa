/*
 * Archivo: T_CSTMRNJOIOJFD_116.java
 * Fecha: 2019-04-23T14:03:25Z
 *
 ...
 * T_CSTMRNJOIOJFD_116 - ReplaceAltairAccount 
 *
 * @autor designer
 */
@Path("/CSTMR/CSTMR/T_CSTMRNJOIOJFD_116")
@Component
@Service({T_CSTMRNJOIOJFD_116.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=CSTMR)(task.submodule=CSTMR)(task.id=T_CSTMRNJOIOJFD_116)(task.version=1.0.0))")
,@Reference(name="VW_REPLACEACU_715", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_REPLACEACU_715)(view.version=1.0.0))")
...
public class T_CSTMRNJOIOJFD_116 {

/*
 * Archivo: T_CSTMRAUGMCYDF_966.java
 * Fecha: 2017-07-18T22:33:15Z
 *
 ...
 * T_CSTMRAUGMCYDF_966 - ScannedDocumentsDetail 
 *
 * @autor designer
 */
@Path("/CSTMR/CSTMR/T_CSTMRAUGMCYDF_966")
@Component
@Service({T_CSTMRAUGMCYDF_966.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=CSTMR)(task.submodule=CSTMR)(task.id=T_CSTMRAUGMCYDF_966)(task.version=1.0.0))")
...
public class T_CSTMRAUGMCYDF_966 {

/*
 * Archivo: T_ECONOMICACPOT_751.java
 * Fecha: 2017-02-01T17:19:57Z
 *
 ...
 * T_ECONOMICACPOT_751 - EconomicActivityPopupForm 
 *
 * @autor designer
 */
@Path("/CSTMR/CSTMR/T_ECONOMICACPOT_751")
@Component
@Service({T_ECONOMICACPOT_751.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=CSTMR)(task.submodule=CSTMR)(task.id=T_ECONOMICACPOT_751)(task.version=1.0.0))")
,@Reference(name="VW_ECONOMICUI_887", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_ECONOMICUI_887)(view.version=1.0.0))")
...
public class T_ECONOMICACPOT_751 {

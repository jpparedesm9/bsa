/*
 * Archivo: T_CSTMRKRGHIVHP_582.java
 * Fecha: 2021-10-06T20:18:10Z
 *
 ...
 * T_CSTMRKRGHIVHP_582 - ValidateReferenceForm 
 *
 * @autor designer
 */
@Path("/CSTMR/CSTMR/T_CSTMRKRGHIVHP_582")
@Component
@Service({T_CSTMRKRGHIVHP_582.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=CSTMR)(task.submodule=CSTMR)(task.id=T_CSTMRKRGHIVHP_582)(task.version=1.0.0))")
,@Reference(name="VW_VALIDATERE_945", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_VALIDATERE_945)(view.version=1.0.0))")
...
public class T_CSTMRKRGHIVHP_582 {

/*
 * Archivo: T_CSTMRGAPGAKXO_726.java
 * Fecha: 2023-04-19T08:50:41Z
 *
 ...
 * T_CSTMRGAPGAKXO_726 - CodeVerificationPopupForm 
 *
 * @autor designer
 */
@Path("/CSTMR/CSTMR/T_CSTMRGAPGAKXO_726")
@Component
@Service({T_CSTMRGAPGAKXO_726.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=CSTMR)(task.submodule=CSTMR)(task.id=T_CSTMRGAPGAKXO_726)(task.version=1.0.0))")
,@Reference(name="VW_CODEVERIUN_339", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_CODEVERIUN_339)(view.version=1.0.0))")
...
public class T_CSTMRGAPGAKXO_726 {

/*
 * Archivo: T_CSTMRTCAJUPXM_188.java
 * Fecha: 2018-06-26T23:49:52Z
 *
 ...
 * T_CSTMRTCAJUPXM_188 - TransferRequestForm 
 *
 * @autor designer
 */
@Path("/CSTMR/CSTMR/T_CSTMRTCAJUPXM_188")
@Component
@Service({T_CSTMRTCAJUPXM_188.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=CSTMR)(task.submodule=CSTMR)(task.id=T_CSTMRTCAJUPXM_188)(task.version=1.0.0))")
,@Reference(name="VW_TRANSFERSE_231", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_TRANSFERSE_231)(view.version=1.0.0))")
,@Reference (name="QV_9850_34524",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_9850_34524)")
,@Reference(name="Q_OFFICERJ_1253",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_OFFICERJ_1253)(query.version=1.0.0))")
,@Reference(name="Q_OFFICILA_1541",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_OFFICILA_1541)(query.version=1.0.0))")
,@Reference(name="Q_CUSTOMNS_9850",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_CUSTOMNS_9850)(query.version=1.0.0))")
...
public class T_CSTMRTCAJUPXM_188 {

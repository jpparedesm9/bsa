/*
 * Archivo: T_BMTRCNYSSKGHD_541.java
 * Fecha: 2023-07-06T17:09:24Z
 *
 ...
 * T_BMTRCNYSSKGHD_541 - DocumentGrid 
 *
 * @autor designer
 */
@Path("/BMTRC/TRNSC/T_BMTRCNYSSKGHD_541")
@Component
@Service({T_BMTRCNYSSKGHD_541.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BMTRC)(task.submodule=TRNSC)(task.id=T_BMTRCNYSSKGHD_541)(task.version=1.0.0))")
,@Reference(name="VW_DOCUMENTDD_731", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_DOCUMENTDD_731)(view.version=1.0.0))")
,@Reference (name="QV_7504_88001",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_7504_88001)")
,@Reference(name="Q_DOCUMENN_7504",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_DOCUMENN_7504)(query.version=1.0.0))")
...
public class T_BMTRCNYSSKGHD_541 {

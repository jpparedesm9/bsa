/*
 * Archivo: T_REFERENCESOWS_647.java
 * Fecha: 2017-05-15T21:41:29Z
 *
 ...
 * T_REFERENCESOWS_647 - ReferencesForm 
 *
 * @autor designer
 */
@Path("/CSTMR/CSTMR/T_REFERENCESOWS_647")
@Component
@Service({T_REFERENCESOWS_647.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=CSTMR)(task.submodule=CSTMR)(task.id=T_REFERENCESOWS_647)(task.version=1.0.0))")
,@Reference(name="VW_REFERENCSE_576", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_REFERENCSE_576)(view.version=1.0.0))")
,@Reference (name="QV_7269_22799",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_7269_22799)")
,@Reference(name="Q_REFEREEN_7269",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_REFEREEN_7269)(query.version=1.0.0))")
...
public class T_REFERENCESOWS_647 {

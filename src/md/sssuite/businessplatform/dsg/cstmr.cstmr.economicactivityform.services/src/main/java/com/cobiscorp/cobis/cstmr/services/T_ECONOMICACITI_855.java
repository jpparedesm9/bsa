/*
 * Archivo: T_ECONOMICACITI_855.java
 * Fecha: 2017-02-09T16:10:10Z
 *
 ...
 * T_ECONOMICACITI_855 - EconomicActivityForm 
 *
 * @autor designer
 */
@Path("/CSTMR/CSTMR/T_ECONOMICACITI_855")
@Component
@Service({T_ECONOMICACITI_855.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=CSTMR)(task.submodule=CSTMR)(task.id=T_ECONOMICACITI_855)(task.version=1.0.0))")
,@Reference(name="VW_ECONOMICCI_376", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_ECONOMICCI_376)(view.version=1.0.0))")
,@Reference (name="QV_2856_77023",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_2856_77023)")
,@Reference(name="Q_ECONOMIC_2856",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_ECONOMIC_2856)(query.version=1.0.0))")
...
public class T_ECONOMICACITI_855 {

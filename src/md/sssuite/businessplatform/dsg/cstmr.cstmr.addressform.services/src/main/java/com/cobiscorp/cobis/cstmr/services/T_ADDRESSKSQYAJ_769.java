/*
 * Archivo: T_ADDRESSKSQYAJ_769.java
 * Fecha: 2017-06-04T17:01:39Z
 *
 ...
 * T_ADDRESSKSQYAJ_769 - AddressForm 
 *
 * @autor designer
 */
@Path("/CSTMR/CSTMR/T_ADDRESSKSQYAJ_769")
@Component
@Service({T_ADDRESSKSQYAJ_769.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=CSTMR)(task.submodule=CSTMR)(task.id=T_ADDRESSKSQYAJ_769)(task.version=1.0.0))")
...
public class T_ADDRESSKSQYAJ_769 {

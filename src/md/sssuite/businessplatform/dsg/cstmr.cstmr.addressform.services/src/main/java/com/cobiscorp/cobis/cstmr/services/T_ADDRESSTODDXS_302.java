/*
 * Archivo: T_ADDRESSTODDXS_302.java
 * Fecha: 2017-02-10T05:35:27Z
 *
 ...
 * T_ADDRESSTODDXS_302 - AddressPopupForm 
 *
 * @autor designer
 */
@Path("/CSTMR/CSTMR/T_ADDRESSTODDXS_302")
@Component
@Service({T_ADDRESSTODDXS_302.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=CSTMR)(task.submodule=CSTMR)(task.id=T_ADDRESSTODDXS_302)(task.version=1.0.0))")
,@Reference(name="VW_ADDRESSCTX_436", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_ADDRESSCTX_436)(view.version=1.0.0))")
,@Reference (name="QV_9891_52790",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_9891_52790)")
,@Reference(name="Q_PHONERJD_9891",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_PHONERJD_9891)(query.version=1.0.0))")
...
public class T_ADDRESSTODDXS_302 {

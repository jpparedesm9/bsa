/*
 * Archivo: T_FLCRE_01_EJTDI03.java
 * Fecha: 2017-01-07T02:43:01Z
 *
 ...
 * T_FLCRE_01_EJTDI03 - RejectedApplication 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_01_EJTDI03")
@Component
@Service({T_FLCRE_01_EJTDI03.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_01_EJTDI03)(task.version=1.0.0))")
...
,@Reference(name="VW_EECTEDVIEW38", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_EECTEDVIEW38)(view.version=1.0.0))")
...
public class T_FLCRE_01_EJTDI03 {

/*
 * Archivo: T_FLCRE_08_TKOFL79.java
 * Fecha: 2015-11-24T20:58:36Z
 *
 ...
 * T_FLCRE_08_TKOFL79 - TaskOfficialAnalisysLine 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_08_TKOFL79")
@Component
@Service({T_FLCRE_08_TKOFL79.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_08_TKOFL79)(task.version=1.0.0))")
...
,@Reference(name="VW_OFCIALODEW43", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_OFCIALODEW43)(view.version=1.0.0))")
,@Reference (name="QV_OFFIA3873_31",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_OFFIA3873_31)")
,@Reference (name="QV_NUTER6889_40",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_NUTER6889_40)")
...
,@Reference(name="Q_OFFIALOA_3873",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_OFFIALOA_3873)(query.version=1.0.0))")
,@Reference(name="Q_NUTERNAS_6889",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_NUTERNAS_6889)(query.version=1.0.0))")
...
public class T_FLCRE_08_TKOFL79 {

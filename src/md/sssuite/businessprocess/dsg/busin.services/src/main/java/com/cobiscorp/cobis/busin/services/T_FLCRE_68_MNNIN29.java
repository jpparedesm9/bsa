/*
 * Archivo: T_FLCRE_68_MNNIN29.java
 * Fecha: 2015-12-15T19:55:11Z
 *
 ...
 * T_FLCRE_68_MNNIN29 - TMatrizFuenteFinan 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_68_MNNIN29")
@Component
@Service({T_FLCRE_68_MNNIN29.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_68_MNNIN29)(task.version=1.0.0))")
,@Reference(name="VW_IEWMAIZFNE81", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_IEWMAIZFNE81)(view.version=1.0.0))")
...
public class T_FLCRE_68_MNNIN29 {

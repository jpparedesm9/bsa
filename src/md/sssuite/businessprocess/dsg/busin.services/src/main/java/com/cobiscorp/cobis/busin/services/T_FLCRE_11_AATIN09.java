/*
 * Archivo: T_FLCRE_11_AATIN09.java
 * Fecha: 2015-07-30T15:57:27Z
 *
 ...
 * T_FLCRE_11_AATIN09 - TaskConsultationAccounts 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_11_AATIN09")
@Component
@Service({T_FLCRE_11_AATIN09.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_11_AATIN09)(task.version=1.0.0))")
,@Reference(name="VW_COSIONUTIW10", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_COSIONUTIW10)(view.version=1.0.0))")
,@Reference (name="QV_QUEYC0398_15",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_QUEYC0398_15)")
,@Reference(name="Q_QUEYCNTA_0398",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_QUEYCNTA_0398)(query.version=1.0.0))")
...
public class T_FLCRE_11_AATIN09 {

/*
 * Archivo: T_FLCRE_67_ECSTS94.java
 * Fecha: 2015-11-11T20:14:02Z
 *
 ...
 * T_FLCRE_67_ECSTS94 - ReportCreditApplicationStatus 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_67_ECSTS94")
@Component
@Service({T_FLCRE_67_ECSTS94.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_67_ECSTS94)(task.version=1.0.0))")
,@Reference(name="VW_ERREPIATNA79", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_ERREPIATNA79)(view.version=1.0.0))")
...
public class T_FLCRE_67_ECSTS94 {

/*
 * Archivo: T_FLCRE_83_OCIPA21.java
 * Fecha: 2015-07-30T15:59:52Z
 *
 ...
 * T_FLCRE_83_OCIPA21 - ReallocationApplication 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_83_OCIPA21")
@Component
@Service({T_FLCRE_83_OCIPA21.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_83_OCIPA21)(task.version=1.0.0))")
,@Reference(name="VW_RALLTIPLAI74", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_RALLTIPLAI74)(view.version=1.0.0))")
,@Reference (name="QV_ERPLI1480_27",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_ERPLI1480_27)")
...
public class T_FLCRE_83_OCIPA21 {

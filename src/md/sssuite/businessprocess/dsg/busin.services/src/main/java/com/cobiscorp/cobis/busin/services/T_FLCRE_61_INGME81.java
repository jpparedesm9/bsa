/*
 * Archivo: T_FLCRE_61_INGME81.java
 * Fecha: 2015-07-30T16:07:03Z
 *
 ...
 * T_FLCRE_61_INGME81 - PrintingDocuments 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_61_INGME81")
@Component
@Service({T_FLCRE_61_INGME81.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_61_INGME81)(task.version=1.0.0))")
...
public class T_FLCRE_61_INGME81 {

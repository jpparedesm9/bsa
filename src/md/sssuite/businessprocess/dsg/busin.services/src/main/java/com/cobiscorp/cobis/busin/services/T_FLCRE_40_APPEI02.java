/*
 * Archivo: T_FLCRE_40_APPEI02.java
 * Fecha: 2015-11-18T17:29:51Z
 *
 ...
 * T_FLCRE_40_APPEI02 - TaskApplicationCreditLine 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_40_APPEI02")
@Component
@Service({T_FLCRE_40_APPEI02.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_40_APPEI02)(task.version=1.0.0))")
...
,@Reference(name="VW_RIOTRDTAVI49", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_RIOTRDTAVI49)(view.version=1.0.0))")
...
,@Reference (name="QV_QUERV3248_81",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_QUERV3248_81)")
...
,@Reference(name="Q_QUERVILE_3248",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_QUERVILE_3248)(query.version=1.0.0))")
...
public class T_FLCRE_40_APPEI02 {

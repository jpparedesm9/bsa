/*
 * Archivo: T_FLCRE_62_SUMNF62.java
 * Fecha: 2015-07-30T16:07:21Z
 *
 ...
 * T_FLCRE_62_SUMNF62 - TaskExpDisbursementForm 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_62_SUMNF62")
@Component
@Service({T_FLCRE_62_SUMNF62.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_62_SUMNF62)(task.version=1.0.0))")
...
public class T_FLCRE_62_SUMNF62 {

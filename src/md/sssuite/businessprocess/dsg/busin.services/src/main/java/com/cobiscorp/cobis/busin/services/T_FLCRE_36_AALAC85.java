/*
 * Archivo: T_FLCRE_36_AALAC85.java
 * Fecha: 2015-07-30T16:03:00Z
 *
 ...
 * T_FLCRE_36_AALAC85 - QuotaVsAvailableBalanceModifyLC 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_36_AALAC85")
@Component
@Service({T_FLCRE_36_AALAC85.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_36_AALAC85)(task.version=1.0.0))")
...
public class T_FLCRE_36_AALAC85 {

/*
 * Archivo: T_FLCRE_28_RREAR10.java
 * Fecha: 2015-07-30T16:07:49Z
 *
 ...
 * T_FLCRE_28_RREAR10 - Arrears 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_28_RREAR10")
@Component
@Service({T_FLCRE_28_RREAR10.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_28_RREAR10)(task.version=1.0.0))")
,@Reference(name="VW_AREARSVIEW39", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_AREARSVIEW39)(view.version=1.0.0))")
...
,@Reference (name="QV_LTETA7447_41",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_LTETA7447_41)")
...
,@Reference(name="Q_LTETAEYN_7447",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_LTETAEYN_7447)(query.version=1.0.0))")
...
public class T_FLCRE_28_RREAR10 {

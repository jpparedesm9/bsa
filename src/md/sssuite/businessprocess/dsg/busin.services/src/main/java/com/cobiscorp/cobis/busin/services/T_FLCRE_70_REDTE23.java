/*
 * Archivo: T_FLCRE_70_REDTE23.java
 * Fecha: 2015-11-25T20:02:20Z
 *
 ...
 * T_FLCRE_70_REDTE23 - taskExtendedCreditLine 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_70_REDTE23")
@Component
@Service({T_FLCRE_70_REDTE23.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_70_REDTE23)(task.version=1.0.0))")
...
public class T_FLCRE_70_REDTE23 {

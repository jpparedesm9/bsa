/*
 * Archivo: T_FLCRE_10_RESNT00.java
 * Fecha: 2015-07-30T15:57:21Z
 *
 ...
 * T_FLCRE_10_RESNT00 - AprovalCriteriaQuestionTarea 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_10_RESNT00")
@Component
@Service({T_FLCRE_10_RESNT00.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_10_RESNT00)(task.version=1.0.0))")
,@Reference(name="VW_PROVTRIUST57", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_PROVTRIUST57)(view.version=1.0.0))")
...
public class T_FLCRE_10_RESNT00 {

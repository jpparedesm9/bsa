/*
 * Archivo: T_FLCRE_24_LNRDT96.java
 * Fecha: 2015-07-30T15:59:31Z
 *
 ...
 * T_FLCRE_24_LNRDT96 - TaskRevolvingCreditLine 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_24_LNRDT96")
@Component
@Service({T_FLCRE_24_LNRDT96.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_24_LNRDT96)(task.version=1.0.0))")
...
public class T_FLCRE_24_LNRDT96 {

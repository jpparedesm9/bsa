/*
 * Archivo: T_FLCRE_63_TAKNO30.java
 * Fecha: 2015-08-14T19:06:37Z
 *
 ...
 * T_FLCRE_63_TAKNO30 - TaskSindicos 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_63_TAKNO30")
@Component
@Service({T_FLCRE_63_TAKNO30.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_63_TAKNO30)(task.version=1.0.0))")
,@Reference(name="VW_SIDICSVIEW91", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_SIDICSVIEW91)(view.version=1.0.0))")
...
public class T_FLCRE_63_TAKNO30 {

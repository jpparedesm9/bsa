/*
 * Archivo: T_FLCRE_52_TSAFA58.java
 * Fecha: 2015-07-30T16:06:29Z
 *
 ...
 * T_FLCRE_52_TSAFA58 - TaskExpAsigOffcial 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_52_TSAFA58")
@Component
@Service({T_FLCRE_52_TSAFA58.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_52_TSAFA58)(task.version=1.0.0))")
...
public class T_FLCRE_52_TSAFA58 {

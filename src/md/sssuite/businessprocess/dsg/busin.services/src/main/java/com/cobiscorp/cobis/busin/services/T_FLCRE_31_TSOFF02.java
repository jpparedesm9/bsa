/*
 * Archivo: T_FLCRE_31_TSOFF02.java
 * Fecha: 2015-07-30T16:03:47Z
 *
 ...
 * T_FLCRE_31_TSOFF02 - taskProofOfLien 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_31_TSOFF02")
@Component
@Service({T_FLCRE_31_TSOFF02.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_31_TSOFF02)(task.version=1.0.0))")
...
public class T_FLCRE_31_TSOFF02 {

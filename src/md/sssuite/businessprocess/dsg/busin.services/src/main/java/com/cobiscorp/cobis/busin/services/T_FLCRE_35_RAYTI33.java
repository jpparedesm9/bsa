/*
 * Archivo: T_FLCRE_35_RAYTI33.java
 * Fecha: 2015-09-17T16:25:58Z
 *
 ...
 * T_FLCRE_35_RAYTI33 - WarrantyModifyDetail 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_35_RAYTI33")
@Component
@Service({T_FLCRE_35_RAYTI33.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_35_RAYTI33)(task.version=1.0.0))")
,@Reference(name="VW_VWNDETAILW30", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_VWNDETAILW30)(view.version=1.0.0))")
,@Reference (name="QV_WANTY5919_76",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_WANTY5919_76)")
,@Reference(name="Q_WANTYDIL_5919",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_WANTYDIL_5919)(query.version=1.0.0))")
...
public class T_FLCRE_35_RAYTI33 {

/*
 * Archivo: T_FLCRE_69_SKVEW14.java
 * Fecha: 2015-07-30T16:02:32Z
 *
 ...
 * T_FLCRE_69_SKVEW14 - taskAprovedView 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_69_SKVEW14")
@Component
@Service({T_FLCRE_69_SKVEW14.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_69_SKVEW14)(task.version=1.0.0))")
,@Reference(name="VW_APITONEAEE55", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_APITONEAEE55)(view.version=1.0.0))")
...
public class T_FLCRE_69_SKVEW14 {

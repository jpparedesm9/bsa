/*
 * Archivo: T_FLCRE_04_INLYS21.java
 * Fecha: 2015-07-30T15:51:35Z
 *
 ...
 * T_FLCRE_04_INLYS21 - ApplicationAnalysis 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_04_INLYS21")
@Component
@Service({T_FLCRE_04_INLYS21.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_04_INLYS21)(task.version=1.0.0))")
...
,@Reference(name="VW_POMSSOEATO98", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_POMSSOEATO98)(view.version=1.0.0))")
,@Reference (name="QV_ITRIC1523_37",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_ITRIC1523_37)")
...
public class T_FLCRE_04_INLYS21 {

/*
 * Archivo: T_FLCRE_00_CCOVI89.java
 * Fecha: 2015-10-16T20:13:59Z
 *
 ...
 * T_FLCRE_00_CCOVI89 - TaskSearchEconomicActivity 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_00_CCOVI89")
@Component
@Service({T_FLCRE_00_CCOVI89.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_00_CCOVI89)(task.version=1.0.0))")
,@Reference(name="VW_SEOOICIIIW10", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_SEOOICIIIW10)(view.version=1.0.0))")
,@Reference (name="QV_ECONC3050_94",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_ECONC3050_94)")
,@Reference(name="Q_ECONCATI_3050",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_ECONCATI_3050)(query.version=1.0.0))")
...
public class T_FLCRE_00_CCOVI89 {

/*
 * Archivo: T_FLCRE_41_CTVIS61.java
 * Fecha: 2015-07-30T15:58:21Z
 *
 ...
 * T_FLCRE_41_CTVIS61 - Tarea de la vista ViewActivitiesList 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_41_CTVIS61")
@Component
@Service({T_FLCRE_41_CTVIS61.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_41_CTVIS61)(task.version=1.0.0))")
,@Reference(name="VW_VEACITESIT42", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_VEACITESIT42)(view.version=1.0.0))")
,@Reference (name="QV_CIVII5836_15",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_CIVII5836_15)")
,@Reference(name="Q_CIVIILIS_5836",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_CIVIILIS_5836)(query.version=1.0.0))")
...
public class T_FLCRE_41_CTVIS61 {

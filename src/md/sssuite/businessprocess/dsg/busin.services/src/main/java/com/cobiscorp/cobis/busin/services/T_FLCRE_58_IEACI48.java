/*
 * Archivo: T_FLCRE_58_IEACI48.java
 * Fecha: 2016-04-01T19:46:48Z
 *
 ...
 * T_FLCRE_58_IEACI48 - ValidaFechaCICtask 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_58_IEACI48")
@Component
@Service({T_FLCRE_58_IEACI48.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_58_IEACI48)(task.version=1.0.0))")
,@Reference(name="VW_VIEWFECHCC44", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_VIEWFECHCC44)(view.version=1.0.0))")
...
public class T_FLCRE_58_IEACI48 {

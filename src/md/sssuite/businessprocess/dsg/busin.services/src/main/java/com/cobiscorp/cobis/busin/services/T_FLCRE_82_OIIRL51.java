/*
 * Archivo: T_FLCRE_82_OIIRL51.java
 * Fecha: 2016-08-10T01:22:46Z
 *
 ...
 * T_FLCRE_82_OIIRL51 - GenericApplication 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_82_OIIRL51")
@Component
@Service({T_FLCRE_82_OIIRL51.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_82_OIIRL51)(task.version=1.0.0))")
...
,@Reference(name="VW_AIUTOAVIEW91", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_AIUTOAVIEW91)(view.version=1.0.0))")
...
public class T_FLCRE_82_OIIRL51 {

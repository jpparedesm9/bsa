/*
 * Archivo: T_FLCRE_99_AKIUE81.java
 * Fecha: 2015-10-01T15:30:39Z
 *
 ...
 * T_FLCRE_99_AKIUE81 - TaskPrintGuaranteeTickets 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_99_AKIUE81")
@Component
@Service({T_FLCRE_99_AKIUE81.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_99_AKIUE81)(task.version=1.0.0))")
...
public class T_FLCRE_99_AKIUE81 {

/*
 * Archivo: T_FLCRE_21_EYWRY63.java
 * Fecha: 2015-07-30T15:56:05Z
 *
 ...
 * T_FLCRE_21_EYWRY63 - EntryWarranty 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_21_EYWRY63")
@Component
@Service({T_FLCRE_21_EYWRY63.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_21_EYWRY63)(task.version=1.0.0))")
...
public class T_FLCRE_21_EYWRY63 {

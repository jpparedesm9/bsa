/*
 * Archivo: T_FLCRE_87_TRCOR12.java
 * Fecha: 2015-07-30T15:53:17Z
 *
 ...
 * T_FLCRE_87_TRCOR12 - TaskRevenueCustomer 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_87_TRCOR12")
@Component
@Service({T_FLCRE_87_TRCOR12.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_87_TRCOR12)(task.version=1.0.0))")
,@Reference(name="VW_VENUECUSOE18", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_VENUECUSOE18)(view.version=1.0.0))")
...
public class T_FLCRE_87_TRCOR12 {

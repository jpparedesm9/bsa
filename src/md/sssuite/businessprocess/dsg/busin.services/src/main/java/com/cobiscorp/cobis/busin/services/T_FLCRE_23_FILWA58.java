/*
 * Archivo: T_FLCRE_23_FILWA58.java
 * Fecha: 2015-09-22T15:52:19Z
 *
 ...
 * T_FLCRE_23_FILWA58 - OfficialAssigWarrantiesTicket 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_23_FILWA58")
@Component
@Service({T_FLCRE_23_FILWA58.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_23_FILWA58)(task.version=1.0.0))")
...
public class T_FLCRE_23_FILWA58 {

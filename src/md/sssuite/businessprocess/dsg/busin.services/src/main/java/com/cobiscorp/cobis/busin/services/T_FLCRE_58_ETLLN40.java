/*
 * Archivo: T_FLCRE_58_ETLLN40.java
 * Fecha: 2015-08-14T18:44:18Z
 *
 ...
 * T_FLCRE_58_ETLLN40 - TDetailPenalization 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_58_ETLLN40")
@Component
@Service({T_FLCRE_58_ETLLN40.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_58_ETLLN40)(task.version=1.0.0))")
,@Reference(name="VW_VDAILNAIIN43", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_VDAILNAIIN43)(view.version=1.0.0))")
,@Reference (name="QV_EQUET4811_32",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_EQUET4811_32)")
,@Reference(name="Q_EQUETATO_4811",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_EQUETATO_4811)(query.version=1.0.0))")
...
public class T_FLCRE_58_ETLLN40 {

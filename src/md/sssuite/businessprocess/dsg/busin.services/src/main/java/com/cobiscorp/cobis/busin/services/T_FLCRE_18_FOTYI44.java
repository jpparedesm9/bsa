/*
 * Archivo: T_FLCRE_18_FOTYI44.java
 * Fecha: 2015-11-12T23:41:12Z
 *
 ...
 * T_FLCRE_18_FOTYI44 - InfocredEntityManagement 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_18_FOTYI44")
@Component
@Service({T_FLCRE_18_FOTYI44.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_18_FOTYI44)(task.version=1.0.0))")
,@Reference(name="VW_IFOCREEYEW02", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_IFOCREEYEW02)(view.version=1.0.0))")
,@Reference (name="QV_IRENT5951_45",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_IRENT5951_45)")
,@Reference(name="Q_IRENTYQR_5951",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_IRENTYQR_5951)(query.version=1.0.0))")
...
public class T_FLCRE_18_FOTYI44 {

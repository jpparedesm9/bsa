/*
 * Archivo: T_FLCRE_52_VREDE97.java
 * Fecha: 2015-08-13T17:27:14Z
 *
 ...
 * T_FLCRE_52_VREDE97 - TSendRecommended 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_52_VREDE97")
@Component
@Service({T_FLCRE_52_VREDE97.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_52_VREDE97)(task.version=1.0.0))")
,@Reference(name="VW_SEDCMMENED30", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_SEDCMMENED30)(view.version=1.0.0))")
...
public class T_FLCRE_52_VREDE97 {

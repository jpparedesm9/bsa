/*
 * Archivo: T_FLCRE_74_EPISR89.java
 * Fecha: 2015-07-30T16:06:50Z
 *
 ...
 * T_FLCRE_74_EPISR89 - ExpromisionGuarantee 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_74_EPISR89")
@Component
@Service({T_FLCRE_74_EPISR89.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_74_EPISR89)(task.version=1.0.0))")
...
public class T_FLCRE_74_EPISR89 {

/*
 * Archivo: T_FLCRE_57_VXEOU08.java
 * Fecha: 2015-09-04T22:29:21Z
 *
 ...
 * T_FLCRE_57_VXEOU08 - ExecutiveBonusRisk 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_57_VXEOU08")
@Component
@Service({T_FLCRE_57_VXEOU08.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_57_VXEOU08)(task.version=1.0.0))")
,@Reference(name="VW_XCUTVUSRIS90", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_XCUTVUSRIS90)(view.version=1.0.0))")
,@Reference (name="QV_QRYXU8599_55",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_QRYXU8599_55)")
,@Reference (name="QV_CECVO1975_71",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_CECVO1975_71)")
,@Reference(name="Q_CECVORIK_1975",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_CECVORIK_1975)(query.version=1.0.0))")
,@Reference(name="Q_QRYXUBON_8599",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_QRYXUBON_8599)(query.version=1.0.0))")
...
public class T_FLCRE_57_VXEOU08 {

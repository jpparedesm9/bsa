/*
 * Archivo: T_FLCRE_16_NTATT53.java
 * Fecha: 2015-09-22T16:39:23Z
 *
 ...
 * T_FLCRE_16_NTATT53 - EntryWarrantyTicket 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_16_NTATT53")
@Component
@Service({T_FLCRE_16_NTATT53.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_16_NTATT53)(task.version=1.0.0))")
...
public class T_FLCRE_16_NTATT53 {

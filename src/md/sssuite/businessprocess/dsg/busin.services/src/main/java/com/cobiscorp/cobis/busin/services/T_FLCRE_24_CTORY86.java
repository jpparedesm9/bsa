/*
 * Archivo: T_FLCRE_24_CTORY86.java
 * Fecha: 2016-01-27T20:37:42Z
 *
 ...
 * T_FLCRE_24_CTORY86 - Category 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_24_CTORY86")
@Component
@Service({T_FLCRE_24_CTORY86.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_24_CTORY86)(task.version=1.0.0))")
,@Reference(name="VW_ATACATEGRY19", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_ATACATEGRY19)(view.version=1.0.0))")
...
public class T_FLCRE_24_CTORY86 {

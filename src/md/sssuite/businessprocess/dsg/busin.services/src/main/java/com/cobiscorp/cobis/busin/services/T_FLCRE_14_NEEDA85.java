/*
 * Archivo: T_FLCRE_14_NEEDA85.java
 * Fecha: 2015-07-30T16:01:14Z
 *
 ...
 * T_FLCRE_14_NEEDA85 - TLineHeaderDetail 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_14_NEEDA85")
@Component
@Service({T_FLCRE_14_NEEDA85.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_14_NEEDA85)(task.version=1.0.0))")
,@Reference(name="VW_LIHDETLVIW14", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_LIHDETLVIW14)(view.version=1.0.0))")
...
public class T_FLCRE_14_NEEDA85 {

/*
 * Archivo: T_FLCRE_97_EXOSO06.java
 * Fecha: 2015-07-30T16:05:03Z
 *
 ...
 * T_FLCRE_97_EXOSO06 - GenericExpromission 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_97_EXOSO06")
@Component
@Service({T_FLCRE_97_EXOSO06.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_97_EXOSO06)(task.version=1.0.0))")
...
,@Reference(name="VW_RDIHONLYVE38", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_RDIHONLYVE38)(view.version=1.0.0))")
...
public class T_FLCRE_97_EXOSO06 {

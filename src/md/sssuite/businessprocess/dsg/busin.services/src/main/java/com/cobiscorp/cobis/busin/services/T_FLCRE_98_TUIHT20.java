/*
 * Archivo: T_FLCRE_98_TUIHT20.java
 * Fecha: 2015-08-06T21:23:43Z
 *
 ...
 * T_FLCRE_98_TUIHT20 - TPunishment 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_98_TUIHT20")
@Component
@Service({T_FLCRE_98_TUIHT20.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_98_TUIHT20)(task.version=1.0.0))")
,@Reference(name="VW_VIWPUISHMN43", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_VIWPUISHMN43)(view.version=1.0.0))")
,@Reference (name="QV_URPUH4848_33",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_URPUH4848_33)")
,@Reference(name="Q_URPUHENT_4848",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_URPUHENT_4848)(query.version=1.0.0))")
...
public class T_FLCRE_98_TUIHT20 {

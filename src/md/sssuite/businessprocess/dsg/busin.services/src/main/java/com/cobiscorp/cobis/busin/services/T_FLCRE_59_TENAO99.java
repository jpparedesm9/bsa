/*
 * Archivo: T_FLCRE_59_TENAO99.java
 * Fecha: 2015-07-30T15:58:38Z
 *
 ...
 * T_FLCRE_59_TENAO99 - TaskMaintenanceCatalog 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_59_TENAO99")
@Component
@Service({T_FLCRE_59_TENAO99.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_59_TENAO99)(task.version=1.0.0))")
...
public class T_FLCRE_59_TENAO99 {

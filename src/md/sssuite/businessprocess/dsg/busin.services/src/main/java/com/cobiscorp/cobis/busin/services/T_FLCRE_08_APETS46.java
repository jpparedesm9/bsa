/*
 * Archivo: T_FLCRE_08_APETS46.java
 * Fecha: 2015-09-25T22:22:59Z
 *
 ...
 * T_FLCRE_08_APETS46 - ApproveWarrantiesTicket 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_08_APETS46")
@Component
@Service({T_FLCRE_08_APETS46.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_08_APETS46)(task.version=1.0.0))")
,@Reference(name="VW_IEWGUARNTK68", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_IEWGUARNTK68)(view.version=1.0.0))")
...
public class T_FLCRE_08_APETS46 {

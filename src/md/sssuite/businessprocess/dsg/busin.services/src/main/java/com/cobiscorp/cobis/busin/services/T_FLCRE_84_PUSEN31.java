/*
 * Archivo: T_FLCRE_84_PUSEN31.java
 * Fecha: 2015-08-08T07:56:06Z
 *
 ...
 * T_FLCRE_84_PUSEN31 - TPunishmentPlan 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_84_PUSEN31")
@Component
@Service({T_FLCRE_84_PUSEN31.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_84_PUSEN31)(task.version=1.0.0))")
,@Reference(name="VW_VIEANSHMET72", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_VIEANSHMET72)(view.version=1.0.0))")
...
,@Reference(name="VW_VIEWAMOUNT61", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_VIEWAMOUNT61)(view.version=1.0.0))")
,@Reference (name="QV_UERMO1513_46",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_UERMO1513_46)")
...
,@Reference(name="Q_UERMOUNT_1513",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_UERMOUNT_1513)(query.version=1.0.0))")
...
public class T_FLCRE_84_PUSEN31 {

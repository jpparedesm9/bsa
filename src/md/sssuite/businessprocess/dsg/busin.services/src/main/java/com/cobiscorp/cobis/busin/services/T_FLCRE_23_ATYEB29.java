/*
 * Archivo: T_FLCRE_23_ATYEB29.java
 * Fecha: 2015-09-25T19:34:42Z
 *
 ...
 * T_FLCRE_23_ATYEB29 - OfficialActivityCollateralBallots 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_23_ATYEB29")
@Component
@Service({T_FLCRE_23_ATYEB29.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_23_ATYEB29)(task.version=1.0.0))")
,@Reference(name="VW_OFICIALOBG21", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_OFICIALOBG21)(view.version=1.0.0))")
...
public class T_FLCRE_23_ATYEB29 {

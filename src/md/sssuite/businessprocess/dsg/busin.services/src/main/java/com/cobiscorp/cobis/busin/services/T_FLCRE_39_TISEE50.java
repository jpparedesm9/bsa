/*
 * Archivo: T_FLCRE_39_TISEE50.java
 * Fecha: 2015-07-30T15:57:42Z
 *
 ...
 * T_FLCRE_39_TISEE50 - TaskDisbursementIncome 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_39_TISEE50")
@Component
@Service({T_FLCRE_39_TISEE50.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_39_TISEE50)(task.version=1.0.0))")
...
public class T_FLCRE_39_TISEE50 {

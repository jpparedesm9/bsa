/*
 * Archivo: T_FLCRE_94_BYLET28.java
 * Fecha: 2016-08-25T18:34:49Z
 *
 ...
 * T_FLCRE_94_BYLET28 - Plazo Fijo por Cliente 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_94_BYLET28")
@Component
@Service({T_FLCRE_94_BYLET28.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_94_BYLET28)(task.version=1.0.0))")
,@Reference(name="VW_IEDMBENTEW96", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_IEDMBENTEW96)(view.version=1.0.0))")
,@Reference (name="QV_FDMYL8126_98",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_FDMYL8126_98)")
,@Reference(name="Q_FDMYLINR_8126",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_FDMYLINR_8126)(query.version=1.0.0))")
...
public class T_FLCRE_94_BYLET28 {

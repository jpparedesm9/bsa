/*
 * Archivo: T_FLCRE_17_CAAIL82.java
 * Fecha: 2015-07-30T15:54:55Z
 *
 ...
 * T_FLCRE_17_CAAIL82 - OfficialActivityAllocation 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_17_CAAIL82")
@Component
@Service({T_FLCRE_17_CAAIL82.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_17_CAAIL82)(task.version=1.0.0))")
...
public class T_FLCRE_17_CAAIL82 {

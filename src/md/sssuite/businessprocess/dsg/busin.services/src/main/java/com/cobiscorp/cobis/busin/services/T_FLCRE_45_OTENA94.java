/*
 * Archivo: T_FLCRE_45_OTENA94.java
 * Fecha: 2015-09-30T00:06:46Z
 *
 ...
 * T_FLCRE_45_OTENA94 - TConsolidatePenalization 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_45_OTENA94")
@Component
@Service({T_FLCRE_45_OTENA94.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_45_OTENA94)(task.version=1.0.0))")
,@Reference(name="VW_HEAPNAIION05", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_HEAPNAIION05)(view.version=1.0.0))")
,@Reference(name="VW_VOSOLDTENI35", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_VOSOLDTENI35)(view.version=1.0.0))")
,@Reference (name="QV_DTPEA0472_42",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_DTPEA0472_42)")
,@Reference(name="VW_SUMARYAMNT49", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_SUMARYAMNT49)(view.version=1.0.0))")
,@Reference (name="QV_UMMAY4215_41",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_UMMAY4215_41)")
,@Reference(name="Q_UMMAYOUT_4215",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_UMMAYOUT_4215)(query.version=1.0.0))")
,@Reference(name="Q_DTPEAZAT_0472",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_DTPEAZAT_0472)(query.version=1.0.0))")
...
public class T_FLCRE_45_OTENA94 {

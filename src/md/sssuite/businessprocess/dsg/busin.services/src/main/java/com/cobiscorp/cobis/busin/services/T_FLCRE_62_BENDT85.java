/*
 * Archivo: T_FLCRE_62_BENDT85.java
 * Fecha: 2015-07-30T15:59:42Z
 *
 ...
 * T_FLCRE_62_BENDT85 - CreditLineDisbursementDataEntry 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_62_BENDT85")
@Component
@Service({T_FLCRE_62_BENDT85.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_62_BENDT85)(task.version=1.0.0))")
,@Reference(name="VW_HEDRCRILIW98", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_HEDRCRILIW98)(view.version=1.0.0))")
...
public class T_FLCRE_62_BENDT85 {

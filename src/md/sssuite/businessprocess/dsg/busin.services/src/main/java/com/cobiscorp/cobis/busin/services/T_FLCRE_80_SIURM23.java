/*
 * Archivo: T_FLCRE_80_SIURM23.java
 * Fecha: 2015-07-30T15:59:17Z
 *
 ...
 * T_FLCRE_80_SIURM23 - TaskDisbursementFormExecution 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_80_SIURM23")
@Component
@Service({T_FLCRE_80_SIURM23.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_80_SIURM23)(task.version=1.0.0))")
...
public class T_FLCRE_80_SIURM23 {

/*
 * Archivo: T_FLCRE_08_TAKRR10.java
 * Fecha: 2015-07-30T15:59:11Z
 *
 ...
 * T_FLCRE_08_TAKRR10 - TaskProductDistributionLine 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_08_TAKRR10")
@Component
@Service({T_FLCRE_08_TAKRR10.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_08_TAKRR10)(task.version=1.0.0))")
...
public class T_FLCRE_08_TAKRR10 {

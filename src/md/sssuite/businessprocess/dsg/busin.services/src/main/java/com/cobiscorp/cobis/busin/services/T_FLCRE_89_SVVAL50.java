/*
 * Archivo: T_FLCRE_89_SVVAL50.java
 * Fecha: 2015-07-30T16:01:09Z
 *
 ...
 * T_FLCRE_89_SVVAL50 - TaskValidationQuotaVsAvailableBalance 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_89_SVVAL50")
@Component
@Service({T_FLCRE_89_SVVAL50.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_89_SVVAL50)(task.version=1.0.0))")
,@Reference(name="VW_HEDELNEVIE13", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_HEDELNEVIE13)(view.version=1.0.0))")
...
public class T_FLCRE_89_SVVAL50 {

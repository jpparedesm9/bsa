/*
 * Archivo: T_FLCRE_19_KARAI97.java
 * Fecha: 2015-09-09T15:36:29Z
 *
 ...
 * T_FLCRE_19_KARAI97 - TGuaranteesTicket 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_19_KARAI97")
@Component
@Service({T_FLCRE_19_KARAI97.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_19_KARAI97)(task.version=1.0.0))")
...
,@Reference(name="VW_OHRWARAYIE87", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_OHRWARAYIE87)(view.version=1.0.0))")
,@Reference (name="QV_URYTH5890_66",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_URYTH5890_66)")
...
,@Reference(name="Q_URYTHAAN_5890",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_URYTHAAN_5890)(query.version=1.0.0))")
...
public class T_FLCRE_19_KARAI97 {

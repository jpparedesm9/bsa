/*
 * Archivo: T_FLCRE_69_EFNCY93.java
 * Fecha: 2015-07-30T16:04:29Z
 *
 ...
 * T_FLCRE_69_EFNCY93 - RefinancingDataEntry 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_69_EFNCY93")
@Component
@Service({T_FLCRE_69_EFNCY93.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_69_EFNCY93)(task.version=1.0.0))")
...
public class T_FLCRE_69_EFNCY93 {

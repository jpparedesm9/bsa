/*
 * Archivo: T_FLCRE_54_EATLI88.java
 * Fecha: 2015-07-30T16:01:52Z
 *
 ...
 * T_FLCRE_54_EATLI88 - EntryWarrantyModifyLine 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_54_EATLI88")
@Component
@Service({T_FLCRE_54_EATLI88.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_54_EATLI88)(task.version=1.0.0))")
...
,@Reference(name="VW_UARNTEESEW96", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_UARNTEESEW96)(view.version=1.0.0))")
,@Reference(name="VW_PRSAUARNTE35", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_PRSAUARNTE35)(view.version=1.0.0))")
,@Reference (name="QV_PESAU2317_81",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_PESAU2317_81)")
...
public class T_FLCRE_54_EATLI88 {

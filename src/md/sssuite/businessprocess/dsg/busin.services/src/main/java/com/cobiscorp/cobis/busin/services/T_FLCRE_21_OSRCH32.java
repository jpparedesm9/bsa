/*
 * Archivo: T_FLCRE_21_OSRCH32.java
 * Fecha: 2015-07-30T16:05:12Z
 *
 ...
 * T_FLCRE_21_OSRCH32 - OperationSearch 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_21_OSRCH32")
@Component
@Service({T_FLCRE_21_OSRCH32.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_21_OSRCH32)(task.version=1.0.0))")
,@Reference(name="VW_TOMERSHVIW60", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_TOMERSHVIW60)(view.version=1.0.0))")
,@Reference(name="VW_EINNIETODA34", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_EINNIETODA34)(view.version=1.0.0))")
,@Reference (name="QV_ITRIC1523_25",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_ITRIC1523_25)")
...
public class T_FLCRE_21_OSRCH32 {

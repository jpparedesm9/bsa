/*
 * Archivo: T_FLCRE_37_NYAST96.java
 * Fecha: 2015-07-30T16:07:15Z
 *
 ...
 * T_FLCRE_37_NYAST96 - constancyAssessment 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_37_NYAST96")
@Component
@Service({T_FLCRE_37_NYAST96.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_37_NYAST96)(task.version=1.0.0))")
...
public class T_FLCRE_37_NYAST96 {

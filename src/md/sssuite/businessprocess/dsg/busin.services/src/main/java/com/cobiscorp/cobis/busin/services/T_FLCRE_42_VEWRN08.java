/*
 * Archivo: T_FLCRE_42_VEWRN08.java
 * Fecha: 2015-07-30T15:58:32Z
 *
 ...
 * T_FLCRE_42_VEWRN08 - Tarea de la vista ViewEmergentList 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_42_VEWRN08")
@Component
@Service({T_FLCRE_42_VEWRN08.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_42_VEWRN08)(task.version=1.0.0))")
,@Reference(name="VW_EMEGENTLIT48", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_EMEGENTLIT48)(view.version=1.0.0))")
,@Reference (name="QV_QEYME5063_04",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_QEYME5063_04)")
,@Reference(name="Q_QEYMERET_5063",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_QEYMERET_5063)(query.version=1.0.0))")
...
public class T_FLCRE_42_VEWRN08 {

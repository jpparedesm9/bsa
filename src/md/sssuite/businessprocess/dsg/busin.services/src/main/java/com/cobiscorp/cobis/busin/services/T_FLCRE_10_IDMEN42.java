/*
 * Archivo: T_FLCRE_10_IDMEN42.java
 * Fecha: 2015-11-12T23:25:44Z
 *
 ...
 * T_FLCRE_10_IDMEN42 - InfocredManagement 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_10_IDMEN42")
@Component
@Service({T_FLCRE_10_IDMEN42.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_10_IDMEN42)(task.version=1.0.0))")
,@Reference(name="VW_CEDNAGMTIE21", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_CEDNAGMTIE21)(view.version=1.0.0))")
,@Reference (name="QV_ODTEQ9197_14",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_ODTEQ9197_14)")
,@Reference(name="Q_ODTEQERY_9197",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_ODTEQERY_9197)(query.version=1.0.0))")
...
public class T_FLCRE_10_IDMEN42 {

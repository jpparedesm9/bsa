/*
 * Archivo: T_FLCRE_26_KMRCT63.java
 * Fecha: 2015-07-30T15:58:44Z
 *
 ...
 * T_FLCRE_26_KMRCT63 - TaskEmergentCatalog 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_26_KMRCT63")
@Component
@Service({T_FLCRE_26_KMRCT63.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_26_KMRCT63)(task.version=1.0.0))")
...
public class T_FLCRE_26_KMRCT63 {

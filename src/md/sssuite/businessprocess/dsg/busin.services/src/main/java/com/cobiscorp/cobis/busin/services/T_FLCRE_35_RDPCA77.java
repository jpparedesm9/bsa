/*
 * Archivo: T_FLCRE_35_RDPCA77.java
 * Fecha: 2016-06-07T18:25:03Z
 *
 ...
 * T_FLCRE_35_RDPCA77 - ApprovedApplication 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_35_RDPCA77")
@Component
@Service({T_FLCRE_35_RDPCA77.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_35_RDPCA77)(task.version=1.0.0))")
,@Reference(name="VW_WTTTEPRCES08", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_WTTTEPRCES08)(view.version=1.0.0))")
,@Reference(name="VW_POLCIESVEW32", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_POLCIESVEW32)(view.version=1.0.0))")
...
,@Reference(name="VW_EEPTIONVIW22", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_EEPTIONVIW22)(view.version=1.0.0))")
...
public class T_FLCRE_35_RDPCA77 {

/*
 * Archivo: T_FLCRE_64_XCUTL59.java
 * Fecha: 2015-09-02T17:21:30Z
 *
 ...
 * T_FLCRE_64_XCUTL59 - TaskExecutiveBonusInital 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_64_XCUTL59")
@Component
@Service({T_FLCRE_64_XCUTL59.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_64_XCUTL59)(task.version=1.0.0))")
,@Reference(name="VW_EXECEBONUS69", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_EXECEBONUS69)(view.version=1.0.0))")
...
public class T_FLCRE_64_XCUTL59 {

/*
 * Archivo: T_FLCRE_38_EENSS78.java
 * Fecha: 2015-08-20T16:02:50Z
 *
 ...
 * T_FLCRE_38_EENSS78 - TaskExecutiveBonusRisk 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_38_EENSS78")
@Component
@Service({T_FLCRE_38_EENSS78.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_38_EENSS78)(task.version=1.0.0))")
,@Reference(name="VW_IEWEUTEBSK00", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_IEWEUTEBSK00)(view.version=1.0.0))")
,@Reference (name="QV_ECTIB5101_92",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_ECTIB5101_92)")
,@Reference(name="Q_ECTIBOSD_5101",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_ECTIBOSD_5101)(query.version=1.0.0))")
...
public class T_FLCRE_38_EENSS78 {

/*
 * Archivo: T_FLCRE_35_AITIV39.java
 * Fecha: 2015-10-13T20:08:20Z
 *
 ...
 * T_FLCRE_35_AITIV39 - LegalAnalysisActivity 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_35_AITIV39")
@Component
@Service({T_FLCRE_35_AITIV39.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_35_AITIV39)(task.version=1.0.0))")
...
public class T_FLCRE_35_AITIV39 {

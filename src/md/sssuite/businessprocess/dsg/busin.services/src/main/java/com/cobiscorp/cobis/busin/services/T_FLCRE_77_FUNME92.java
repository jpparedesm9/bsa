/*
 * Archivo: T_FLCRE_77_FUNME92.java
 * Fecha: 2015-12-11T20:19:21Z
 *
 ...
 * T_FLCRE_77_FUNME92 - TFuenteFinanciamiento 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_77_FUNME92")
@Component
@Service({T_FLCRE_77_FUNME92.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_77_FUNME92)(task.version=1.0.0))")
,@Reference(name="VW_IWSORCENIN87", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_IWSORCENIN87)(view.version=1.0.0))")
...
public class T_FLCRE_77_FUNME92 {

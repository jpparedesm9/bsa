/*
 * Archivo: T_FLCRE_32_ACRLN02.java
 * Fecha: 2015-07-30T15:58:02Z
 *
 ...
 * T_FLCRE_32_ACRLN02 - TaskCreditLine 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_32_ACRLN02")
@Component
@Service({T_FLCRE_32_ACRLN02.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_32_ACRLN02)(task.version=1.0.0))")
...
public class T_FLCRE_32_ACRLN02 {

/*
 * Archivo: T_FLCRE_50_VPLIC33.java
 * Fecha: 2015-07-30T15:57:51Z
 *
 ...
 * T_FLCRE_50_VPLIC33 - VariablePolicy 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_50_VPLIC33")
@Component
@Service({T_FLCRE_50_VPLIC33.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_50_VPLIC33)(task.version=1.0.0))")
,@Reference(name="VW_VARABLOIYW12", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_VARABLOIYW12)(view.version=1.0.0))")
...
public class T_FLCRE_50_VPLIC33 {

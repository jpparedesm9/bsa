/*
 * Archivo: T_FLCRE_68_ITCII49.java
 * Fecha: 2017-01-03T21:40:52Z
 *
 ...
 * T_FLCRE_68_ITCII49 - PrintingActivity 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_68_ITCII49")
@Component
@Service({T_FLCRE_68_ITCII49.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_68_ITCII49)(task.version=1.0.0))")
...
public class T_FLCRE_68_ITCII49 {

...
public class ReprintClientTeamServices extends BaseEvent implements IServicesConsultingClientsPrints {

	public ReprintClientTeamServices(ICTSServiceIntegration serviceIntegration) {
		super(serviceIntegration);
	}

	private static final ILogger logger = LogFactory.getLogger(ReprintClientTeamServices.class);

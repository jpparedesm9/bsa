/*
 * Archivo: T_FLCRE_53_TKCSO26.java
 * Fecha: 2017-04-17T04:16:39Z
 *
 ...
 * T_FLCRE_53_TKCSO26 - TaskConsultDisbursementForms 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_53_TKCSO26")
@Component
@Service({T_FLCRE_53_TKCSO26.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_53_TKCSO26)(task.version=1.0.0))")
,@Reference(name="VW_UTDSRMNSVW70", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_UTDSRMNSVW70)(view.version=1.0.0))")
,@Reference (name="QV_EULDB5756_37",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_EULDB5756_37)")
,@Reference(name="Q_EULDBSTM_5756",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_EULDBSTM_5756)(query.version=1.0.0))")
...
public class T_FLCRE_53_TKCSO26 {

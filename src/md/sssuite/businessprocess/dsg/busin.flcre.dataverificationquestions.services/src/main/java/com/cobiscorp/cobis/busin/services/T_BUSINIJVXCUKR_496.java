/*
 * Archivo: T_BUSINIJVXCUKR_496.java
 * Fecha: 2017-06-21T15:07:16Z
 *
 ...
 * T_BUSINIJVXCUKR_496 - DataVerificationQuestions 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_BUSINIJVXCUKR_496")
@Component
@Service({T_BUSINIJVXCUKR_496.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_BUSINIJVXCUKR_496)(task.version=1.0.0))")
,@Reference(name="VW_DATAVERIUT_108", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_DATAVERIUT_108)(view.version=1.0.0))")
,@Reference (name="QV_5932_10558",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_5932_10558)")
,@Reference (name="QV_7780_54457",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_7780_54457)")
,@Reference(name="Q_QUESTINO_5932",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_QUESTINO_5932)(query.version=1.0.0))")
,@Reference(name="Q_QUESTIRO_7780",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_QUESTIRO_7780)(query.version=1.0.0))")
...
public class T_BUSINIJVXCUKR_496 {

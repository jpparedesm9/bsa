/*
 * Archivo: T_BUSINSFKMIYJN_838.java
 * Fecha: 2017-06-21T15:08:48Z
 *
 ...
 * T_BUSINSFKMIYJN_838 - DataVerificationQuestionsCompound 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_BUSINSFKMIYJN_838")
@Component
@Service({T_BUSINSFKMIYJN_838.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_BUSINSFKMIYJN_838)(task.version=1.0.0))")
,@Reference(name="VW_HEADERDZGH_263", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_HEADERDZGH_263)(view.version=1.0.0))")
,@Reference(name="VW_QUESTIONSB_304", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_QUESTIONSB_304)(view.version=1.0.0))")
,@Reference (name="QV_7029_28177",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_7029_28177)")
,@Reference(name="Q_MEMBEREN_7029",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_MEMBEREN_7029)(query.version=1.0.0))")
...
public class T_BUSINSFKMIYJN_838 {

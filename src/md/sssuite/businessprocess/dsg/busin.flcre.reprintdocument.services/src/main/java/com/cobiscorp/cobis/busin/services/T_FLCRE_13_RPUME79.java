/*
 * Archivo: T_FLCRE_13_RPUME79.java
 * Fecha: 2017-06-30T19:28:19Z
 *
 ...
 * T_FLCRE_13_RPUME79 - RePrintDocument 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_13_RPUME79")
@Component
@Service({T_FLCRE_13_RPUME79.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_13_RPUME79)(task.version=1.0.0))")
,@Reference(name="VW_SHCTRATNIW77", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_SHCTRATNIW77)(view.version=1.0.0))")
,@Reference (name="QV_ERPLI1480_97",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_ERPLI1480_97)")
...
public class T_FLCRE_13_RPUME79 {
	...
	public cobiscorp.ecobis.designer.transaction.dto.QueryExecResponse executeAutocrudQueryWithEntities(cobiscorp.ecobis.designer.transaction.dto.QueryExecByEntitiesRequest queryRequest){
	...
	@POST
	@Path("/crudQueryId")
	public cobiscorp.ecobis.designer.transaction.dto.QueryExecResponse executeAutocrudQueryWithQueryId(cobiscorp.ecobis.designer.transaction.dto.QueryExecByQueryIdRequest queryRequest){

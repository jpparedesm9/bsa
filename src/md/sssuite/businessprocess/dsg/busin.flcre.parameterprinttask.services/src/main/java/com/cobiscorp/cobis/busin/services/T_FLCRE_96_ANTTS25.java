/*
 * Archivo: T_FLCRE_96_ANTTS25.java
 * Fecha: 2017-01-18T21:16:07Z
 *
 ...
 * T_FLCRE_96_ANTTS25 - parameterPrintTask 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_96_ANTTS25")
@Component
@Service({T_FLCRE_96_ANTTS25.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_96_ANTTS25)(task.version=1.0.0))")
,@Reference(name="VW_PAMERPRTIE35", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_PAMERPRTIE35)(view.version=1.0.0))")
...
public class T_FLCRE_96_ANTTS25 {

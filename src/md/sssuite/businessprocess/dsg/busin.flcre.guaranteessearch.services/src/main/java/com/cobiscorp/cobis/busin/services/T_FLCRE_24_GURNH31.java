/*
 * Archivo: T_FLCRE_24_GURNH31.java
 * Fecha: 2016-12-29T00:31:17Z
 *
 ...
 * T_FLCRE_24_GURNH31 - GuaranteesSearch 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_24_GURNH31")
@Component
@Service({T_FLCRE_24_GURNH31.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_24_GURNH31)(task.version=1.0.0))")
,@Reference(name="VW_WRRNTSEACH85", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_WRRNTSEACH85)(view.version=1.0.0))")
,@Reference (name="QV_QURAR0892_86",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_QURAR0892_86)")
,@Reference(name="Q_QURARRNT_0892",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_QURARRNT_0892)(query.version=1.0.0))")
...
public class T_FLCRE_24_GURNH31 {

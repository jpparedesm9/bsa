 ...
 * 
 */
public class CommonServiceEntryWarrantyModifyLine extends BaseEvent {
	private final static ILogger logger = LogFactory.getLogger(CommonServiceEntryWarrantyModifyLine.class);
	...
	public CommonServiceEntryWarrantyModifyLine(ICTSServiceIntegration serviceIntegration) {

/*
 * Archivo: T_FLCRE_76_SDEEF25.java
 * Fecha: 2017-04-12T16:11:38Z
 *
 ...
 * T_FLCRE_76_SDEEF25 - taskDisbursementForm 
 *
 * @autor designer
 */
@Path("/BUSIN/FLCRE/T_FLCRE_76_SDEEF25")
@Component
@Service({T_FLCRE_76_SDEEF25.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=BUSIN)(task.submodule=FLCRE)(task.id=T_FLCRE_76_SDEEF25)(task.version=1.0.0))")
...
,@Reference(name="VW_DISURMETFR51", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_DISURMETFR51)(view.version=1.0.0))")
,@Reference (name="QV_TDLIA9011_50",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_TDLIA9011_50)")
,@Reference (name="QV_TSRSE1342_26",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_TSRSE1342_26)")
,@Reference(name="Q_TSRSEENL_1342",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_TSRSEENL_1342)(query.version=1.0.0))")
,@Reference(name="Q_TDLIAEAL_9011",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_TDLIAEAL_9011)(query.version=1.0.0))")
...
public class T_FLCRE_76_SDEEF25 {

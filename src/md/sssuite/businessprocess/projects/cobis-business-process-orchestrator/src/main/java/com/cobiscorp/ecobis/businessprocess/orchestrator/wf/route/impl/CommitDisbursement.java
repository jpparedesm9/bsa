...
import com.cobiscorp.ecobis.businessprocess.orchestrator.wf.route.ICommitDisbursement;

@Component(name = "CommitDisbursement", immediate = false)
@Service({ com.cobiscorp.ecobis.businessprocess.orchestrator.wf.route.ICommitDisbursement.class })
@Properties({ 
	@Property(name = "service.description", value = "CommitDisbursement"), 
	@Property(name = "service.vendor", value = "COBISCORP"),
	@Property(name = "service.version", value = "1.0.0"),
	@Property(name = "service.identifier", value = "CommitDisbursement") })
public class CommitDisbursement implements ICommitDisbursement{

	private static final ILogger LOGGER = LogFactory.getLogger(CommitDisbursement.class);

	private static final String ORCHESTRATOR_NAME = "cob_procesador..commitDisbursement";
	...
	public boolean commitDisbursement(String processInstanceIdentifier, String field1, String field2, Integer field3, String field4) throws CTSServiceException, CTSInfrastructureException {
		...
		if (LOGGER.isDebugEnabled()) {
			LOGGER.logDebug("ProcedureResponse from commitDisbursementOrchestration " + CommonCharacter.convertKParameter(procedureResponse.getProcedureResponseAsString()));
		    }

...
public class KeepSecurity {
    ...
    private byte[] encryptWithPublicKey(byte[] publicBytes, byte[] bytesToEncrypt) throws NoSuchAlgorithmException, InvalidKeySpecException, NoSuchPaddingException, InvalidKeyException, BadPaddingException, IllegalBlockSizeException {

/*
 * Archivo: T_MBILEHJPNKLMQ_522.java
 * Fecha: 2017-11-14T21:37:17Z
 *
 ...
 */
package com.cobiscorp.cobis.mbile.services;
 ...
 * T_MBILEHJPNKLMQ_522 - TerminalManagementForm 
 *
 * @autor designer
 */
@Path("/MBILE/ADMIN/T_MBILEHJPNKLMQ_522")
@Component
@Service({T_MBILEHJPNKLMQ_522.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=MBILE)(task.submodule=ADMIN)(task.id=T_MBILEHJPNKLMQ_522)(task.version=1.0.0))")
,@Reference(name="VW_TERMINALEN_748", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_TERMINALEN_748)(view.version=1.0.0))")
,@Reference (name="QV_5241_65721",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_5241_65721)")
,@Reference(name="Q_TERMINLA_5241",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_TERMINLA_5241)(query.version=1.0.0))")
...
public class T_MBILEHJPNKLMQ_522 {

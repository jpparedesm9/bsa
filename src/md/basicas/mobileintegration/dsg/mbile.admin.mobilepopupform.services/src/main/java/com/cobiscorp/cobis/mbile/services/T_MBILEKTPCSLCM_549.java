/*
 * Archivo: T_MBILEKTPCSLCM_549.java
 * Fecha: 2017-07-31T17:44:22Z
 *
 ...
 * T_MBILEKTPCSLCM_549 - MobilePopUpForm 
 *
 * @autor designer
 */
@Path("/MBILE/ADMIN/T_MBILEKTPCSLCM_549")
@Component
@Service({T_MBILEKTPCSLCM_549.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=MBILE)(task.submodule=ADMIN)(task.id=T_MBILEKTPCSLCM_549)(task.version=1.0.0))")
,@Reference(name="VW_MOBILEPOPU_864", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_MOBILEPOPU_864)(view.version=1.0.0))")
...
public class T_MBILEKTPCSLCM_549 {

...
public class Sync {
	...
	public static final String EN_SYNCIBECQ_858 = "EN_SYNCIBECQ_858";
	
	public static final String VERSION = "1.0.0";
	
	public static final String ENTITY_NAME = "Sync";
	
	
	public static final Property<String> USER = new Property<String>("user", String.class, false);
	
	public static final Property<String> ENTITYDESCRIPTION = new Property<String>("entityDescription", String.class, false);
	
	public static final Property<String> ENTIY = new Property<String>("entiy", String.class, false);

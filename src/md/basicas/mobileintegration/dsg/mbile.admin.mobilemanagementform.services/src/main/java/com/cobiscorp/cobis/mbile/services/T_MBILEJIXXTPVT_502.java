/*
 * Archivo: T_MBILEJIXXTPVT_502.java
 * Fecha: 2017-07-31T17:44:48Z
 *
 ...
 * T_MBILEJIXXTPVT_502 - MobileManagementForm 
 *
 * @autor designer
 */
@Path("/MBILE/ADMIN/T_MBILEJIXXTPVT_502")
@Component
@Service({T_MBILEJIXXTPVT_502.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=MBILE)(task.submodule=ADMIN)(task.id=T_MBILEJIXXTPVT_502)(task.version=1.0.0))")
,@Reference(name="VW_MOBILEMANA_846", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_MOBILEMANA_846)(view.version=1.0.0))")
,@Reference (name="QV_5973_95309",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_5973_95309)")
,@Reference(name="Q_MOBILEVP_5973",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_MOBILEVP_5973)(query.version=1.0.0))")
...
public class T_MBILEJIXXTPVT_502 {

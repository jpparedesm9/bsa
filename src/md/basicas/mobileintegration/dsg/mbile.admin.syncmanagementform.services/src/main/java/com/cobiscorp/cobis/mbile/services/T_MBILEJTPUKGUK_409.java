/*
 * Archivo: T_MBILEJTPUKGUK_409.java
 * Fecha: 2017-11-27T16:58:30Z
 *
 ...
 * T_MBILEJTPUKGUK_409 - SyncManagementForm 
 *
 * @autor designer
 */
@Path("/MBILE/ADMIN/T_MBILEJTPUKGUK_409")
@Component
@Service({T_MBILEJTPUKGUK_409.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=MBILE)(task.submodule=ADMIN)(task.id=T_MBILEJTPUKGUK_409)(task.version=1.0.0))")
,@Reference(name="VW_SYNCMANANN_984", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_SYNCMANANN_984)(view.version=1.0.0))")
,@Reference (name="QV_5753_91072",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_5753_91072)")
,@Reference(name="Q_SYNCITAR_5753",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_SYNCITAR_5753)(query.version=1.0.0))")
...
public class T_MBILEJTPUKGUK_409 {

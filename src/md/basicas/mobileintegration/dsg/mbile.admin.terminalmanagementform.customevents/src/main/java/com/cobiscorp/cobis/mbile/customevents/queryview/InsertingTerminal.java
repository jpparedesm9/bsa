...
public class InsertingTerminal extends BaseEvent implements IGridRowInserting {

    private static final ILogger LOGGER = LogFactory.getLogger(InsertingTerminal.class);

    public InsertingTerminal(ICTSServiceIntegration serviceIntegration) {
    ...
    public void rowAction(DataEntity dataEntity, IGridRowActionEventArgs iGridRowActionEventArgs) {
        ...
        terminalManager.createTerminal(request, iGridRowActionEventArgs);
    }
}

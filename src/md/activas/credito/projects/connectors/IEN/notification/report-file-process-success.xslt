  ...
  <xsl:template match="/data">
    <html xmlns="http://www.w3.org/1999/xhtml">
      <head>
        ...
        <title>
          Procesamiento del Archivo <xsl:value-of select="file_name" /> Exitoso
        </title>
        <style type="text/css">
          .main
          {
            ...
            <td>
              ...
              <div id="content" class="content">
                <div id="transacrion-content" class="transaction-zone">
                  ...
                  <p>
                    Le informamos que el archivo 
                    <strong>
                      <xsl:value-of select="file_name" />
                    </strong> fue procesado exit&#243;samente con el siguiente detalle:.
                  </p>
                  <hr></hr>
                  <p>
                    <strong>
                  ...
                  <p>
                    <strong>
                      Filas Exitosas :
                      <xsl:value-of select="rows_success" />
                    </strong>
                  </p>
                  <p>
                    <strong>
                      Filas Fallidas :
                      <xsl:value-of select="rows_failed" />
                    </strong>
                  </p>
                  <hr></hr>

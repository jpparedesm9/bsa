...
import static com.cobis.cloud.sofom.service.oxxo.common.DataTypeTool.convertType;
...
public class ServiceResponseTool {
	...
	public static <T> T extractOutputValue(ServiceResponse response, String value, Class<T> clazz) {
		...
		if (output != null && output.containsKey(value) && output.get(value) != null) {

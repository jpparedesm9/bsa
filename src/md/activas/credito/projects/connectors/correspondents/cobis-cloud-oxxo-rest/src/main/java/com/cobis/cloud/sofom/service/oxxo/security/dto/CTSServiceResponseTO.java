package com.cobis.cloud.sofom.service.oxxo.security.dto;
...
/**
 * <p>
 * Java class for CTSServiceResponseTO complex type.
 * <p>
 * <p>
...
@XmlType(name = "CTSServiceResponseTO", namespace = "http://dto2.sdf.cts.cobis.cobiscorp.com", propOrder = { "success", "messages" })
@XmlSeeAlso({})
public class CTSServiceResponseTO implements Serializable {
	...
	/**
	 * @return array of {@link MessageTO }
	 */
	...
	/**
	 * @param values
	 *            allowed objects are {@link MessageTO }
	 */
	public void setMessages(MessageTO[] values) {
		int len = values.length;
		this.messages = new MessageTO[len];
		for (int i = 0; (i < len); i++) {
	...
	/**
	 * @param value
	 *            allowed object is {@link MessageTO }
	 */

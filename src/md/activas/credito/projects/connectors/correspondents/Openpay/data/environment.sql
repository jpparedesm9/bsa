...
----------------------------------------------------------------------------------
-- Eliminación de: Loan.ConciliationManagement.RegisterLoanPayment
----------------------------------------------------------------------------------
PRINT '--- Eliminación de servicio Loan.ConciliationManagement.RegisterLoanPayment'
...
PRINT '--- Creación de servicio Loan.ConciliationManagement.RegisterLoanPayment'
...
(
	...
	'registerLoanPayment',								'Servicio de escucha de notificación de Openpay',  
	NULL,                                               NULL,
	NULL,												'N'
)   

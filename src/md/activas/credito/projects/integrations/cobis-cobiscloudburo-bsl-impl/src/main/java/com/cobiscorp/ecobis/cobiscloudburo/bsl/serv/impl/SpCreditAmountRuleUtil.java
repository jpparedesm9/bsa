...
public class SpCreditAmountRuleUtil extends SpUtil {

	private static ILogger logger = LogFactory.getLogger(SpCreditAmountRuleUtil.class);

	private SpCreditAmountRuleUtil() {
	 ...
	 * @return
	 */
	private static void initializeCreditAmountRule(IProcedureRequest aProcedureRequest, Request aParameter) {
	 ...
	 * @return
	 */
	public static void executeCreditAmountRule(com.cobiscorp.ecobis.cobiscloudburo.bsl.dto.Request aParameter, ISPOrchestrator aSpOrchestrator) {
		String wInfo = "[cobiscloudburo][executeCreditAmountRule]";
		...
		initializeCreditAmountRule(wProcedureRequest, aParameter);
		...
		logger.logDebug(wInfo + "aResultCreditAmountRule: " + wLResult);
		logger.logDebug(wInfo + "aParamCreditAmountRule: " + wLParams);

		aParameter.getInfo().put("statusCode", wProcedureResponse.getReturnCode());
		aParameter.getInfo().put("aResultCreditAmountRule", wLResult);
		aParameter.getInfo().put("aParamCreditAmountRule", wLParams);

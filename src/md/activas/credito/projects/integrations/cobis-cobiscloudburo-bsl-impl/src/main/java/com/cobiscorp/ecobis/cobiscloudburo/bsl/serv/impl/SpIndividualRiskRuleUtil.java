...
public class SpIndividualRiskRuleUtil extends SpUtil {

	private static ILogger logger = LogFactory.getLogger(SpIndividualRiskRuleUtil.class);

	private SpIndividualRiskRuleUtil() {
	 ...
	 * @return
	 */
	private static void initializeIndividualRiskRule(IProcedureRequest aProcedureRequest, Request aParameter) {
	 ...
	 * @return
	 */
	public static void executeIndividualRiskRule(com.cobiscorp.ecobis.cobiscloudburo.bsl.dto.Request aParameter, ISPOrchestrator aSpOrchestrator) {
		...
		initializeIndividualRiskRule(wProcedureRequest, aParameter);
		...
		logger.logDebug(wInfo + "aResultIndividualRiskRule: " + wLResult);
		logger.logDebug(wInfo + "aParamIndividualRiskRule: " + wLParams);

		aParameter.getInfo().put("statusCode", wProcedureResponse.getReturnCode());
		aParameter.getInfo().put("aResultIndividualRiskRule", wLResult);
		aParameter.getInfo().put("aParamIndividualRiskRule", wLParams);

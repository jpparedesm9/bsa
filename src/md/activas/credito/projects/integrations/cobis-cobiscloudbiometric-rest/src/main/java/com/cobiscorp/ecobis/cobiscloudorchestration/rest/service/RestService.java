...
public abstract class RestService extends ServiceBase {

    private static final String PRINT_MESSAGE_CODE = "0";
    private final ILogger logger = LogFactory.getLogger(RestService.class);
    private static Pattern pattern = Pattern.compile("(\\[.*?\\])");
    private ICTSServiceIntegration integration;

    public RestService(ICTSServiceIntegration integration) {

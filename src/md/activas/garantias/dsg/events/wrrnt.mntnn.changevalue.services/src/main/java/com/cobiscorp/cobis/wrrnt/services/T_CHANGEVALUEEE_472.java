/*
 * Archivo: T_CHANGEVALUEEE_472.java
 * Fecha: 2017-04-27T22:03:41Z
 *
 ...
 */
package com.cobiscorp.cobis.wrrnt.services;
 ...
 * T_CHANGEVALUEEE_472 - ChangeValue 
 *
 * @autor designer
 */
@Path("/WRRNT/MNTNN/T_CHANGEVALUEEE_472")
@Component
@Service({T_CHANGEVALUEEE_472.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=WRRNT)(task.submodule=MNTNN)(task.id=T_CHANGEVALUEEE_472)(task.version=1.0.0))")
,@Reference(name="VW_CHANGEVAUE_420", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_CHANGEVAUE_420)(view.version=1.0.0))")
...
public class T_CHANGEVALUEEE_472 {

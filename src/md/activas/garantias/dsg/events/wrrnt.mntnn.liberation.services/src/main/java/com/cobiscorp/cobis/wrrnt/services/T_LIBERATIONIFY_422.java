/*
 * Archivo: T_LIBERATIONIFY_422.java
 * Fecha: 2017-04-21T17:15:18Z
 *
 ...
 * T_LIBERATIONIFY_422 - Liberation 
 *
 * @autor designer
 */
@Path("/WRRNT/MNTNN/T_LIBERATIONIFY_422")
@Component
@Service({T_LIBERATIONIFY_422.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=WRRNT)(task.submodule=MNTNN)(task.id=T_LIBERATIONIFY_422)(task.version=1.0.0))")
,@Reference(name="VW_LIBERATINN_804", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_LIBERATINN_804)(view.version=1.0.0))")
...
public class T_LIBERATIONIFY_422 {

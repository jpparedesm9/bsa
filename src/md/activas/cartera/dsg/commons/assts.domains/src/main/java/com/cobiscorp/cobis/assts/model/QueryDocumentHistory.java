...
public class QueryDocumentHistory {

	public static final String EN_DOCUMENYI_280 = "EN_DOCUMENYI_280";
	
	public static final String VERSION = "1.0.0";
	
	public static final String ENTITY_NAME = "QueryDocumentHistory";
	...
	public static final Property<String> DOCUMENTVERSION = new Property<String>("documentVersion", String.class, false);
	
	public static final Property<String> FOLDER = new Property<String>("folder", String.class, false);
	
	public static final Property<Date> DATEVERSION = new Property<Date>("dateVersion", Date.class, false);

...
public class QueryDocumentGridDetail {

	public static final String EN_SCANNEDDS_448 = "EN_SCANNEDDS_448";
	
	public static final String VERSION = "1.0.0";
	
	public static final String ENTITY_NAME = "QueryDocumentGridDetail";

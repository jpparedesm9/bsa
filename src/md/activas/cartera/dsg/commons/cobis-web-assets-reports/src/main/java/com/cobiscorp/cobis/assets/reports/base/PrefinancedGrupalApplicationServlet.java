...
@Properties({ @Property(name = ICOBISReportResourcesService.REPORTING_MODULE_FILTER, value = "cartera"),
		@Property(name = ICOBISReportResourcesService.REPORTING_NAME_FILTER, value = "solicitudCreditoGrupalPrellenada") })
public class PrefinancedGrupalApplicationServlet implements ICOBISReportResourcesService<JRBeanCollectionDataSource> {

	private static final ILogger logger = LogFactory.getLogger(PrefinancedGrupalApplicationServlet.class);
	...
	public JRBeanCollectionDataSource getDatasourceReport(Map<String, Object> params) {
		logger.logError("----->>>> Reporte Solicitud Credito Grupal Inicio Listado");
		...
		try {		
			...
			preFilledApplicationRequest.setIsItaRenovation('N');
			...
			logger.logError("------>>> Reporte Solicitud Credito Grupal Fin Listado:", e);
	...
	public Map<String, Object> getParamsReport(Map<String, Object> params) {
		...
		try {
			...
			logger.logDebug("----->>>> Classs PrefinancedGrupalApplicationServlet:", e);
			throw new RuntimeException("----->>>> Classs PrefinancedGrupalApplicationServlet", e);
		}
	...
	public String getReportLocation(Map<String, Object> parameters) {
		return getFileLocationReport(ConstantValue.PREFINANCED_GRUPAL_APPLICATION);
	}

	private String getFileLocationReport(String planPagosReportJasper) {
		return ConstantValue.PREFINANCED_GRUPAL_APPLICATION;
	}

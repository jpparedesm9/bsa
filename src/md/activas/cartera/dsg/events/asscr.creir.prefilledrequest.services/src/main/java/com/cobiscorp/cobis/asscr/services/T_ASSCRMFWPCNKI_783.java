/*
 * Archivo: T_ASSCRMFWPCNKI_783.java
 * Fecha: 2021-09-30T22:52:37Z
 *
 ...
 * T_ASSCRMFWPCNKI_783 - prefilledRequest 
 *
 * @autor designer
 */
@Path("/ASSCR/CREIR/T_ASSCRMFWPCNKI_783")
@Component
@Service({T_ASSCRMFWPCNKI_783.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSCR)(task.submodule=CREIR)(task.id=T_ASSCRMFWPCNKI_783)(task.version=1.0.0))")
,@Reference(name="VW_PREFILLEST_167", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_PREFILLEST_167)(view.version=1.0.0))")
...
public class T_ASSCRMFWPCNKI_783 {

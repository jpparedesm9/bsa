/*
 * Archivo: T_ASSTSCJVXOOMB_486.java
 * Fecha: 2019-05-15T04:01:13Z
 *
 ...
 * T_ASSTSCJVXOOMB_486 - TransactionDetailForm 
 *
 * @autor designer
 */
@Path("/ASSTS/QERYS/T_ASSTSCJVXOOMB_486")
@Component
@Service({T_ASSTSCJVXOOMB_486.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=QERYS)(task.id=T_ASSTSCJVXOOMB_486)(task.version=1.0.0))")
,@Reference(name="VW_TRANSACTDI_566", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_TRANSACTDI_566)(view.version=1.0.0))")
,@Reference (name="QV_8690_22996",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_8690_22996)")
,@Reference(name="Q_TRANSAOI_8690",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_TRANSAOI_8690)(query.version=1.0.0))")
...
public class T_ASSTSCJVXOOMB_486 {

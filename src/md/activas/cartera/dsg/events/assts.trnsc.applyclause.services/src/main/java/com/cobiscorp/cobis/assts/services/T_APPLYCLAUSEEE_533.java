/*
 * Archivo: T_APPLYCLAUSEEE_533.java
 * Fecha: 2016-11-15T15:54:27Z
 *
 ...
 * T_APPLYCLAUSEEE_533 - ApplyClause 
 *
 * @autor designer
 */
@Path("/ASSTS/TRNSC/T_APPLYCLAUSEEE_533")
@Component
@Service({T_APPLYCLAUSEEE_533.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=TRNSC)(task.id=T_APPLYCLAUSEEE_533)(task.version=1.0.0))")
...
public class T_APPLYCLAUSEEE_533 {

/*
 * Archivo: T_PROJECTIONNQI_244.java
 * Fecha: 2016-11-24T15:32:47Z
 *
 ...
 * T_PROJECTIONNQI_244 - ProjectionQuotaFormMain 
 *
 * @autor designer
 */
@Path("/ASSTS/MNTNN/T_PROJECTIONNQI_244")
@Component
@Service({T_PROJECTIONNQI_244.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=MNTNN)(task.id=T_PROJECTIONNQI_244)(task.version=1.0.0))")
...
,@Reference(name="VW_PROJECTIUO_517", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_PROJECTIUO_517)(view.version=1.0.0))")
...
public class T_PROJECTIONNQI_244 {

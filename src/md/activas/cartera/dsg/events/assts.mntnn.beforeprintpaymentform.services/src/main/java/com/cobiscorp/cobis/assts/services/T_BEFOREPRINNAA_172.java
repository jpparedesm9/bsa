/*
 * Archivo: T_BEFOREPRINNAA_172.java
 * Fecha: 2016-12-30T14:35:23Z
 *
 ...
 * T_BEFOREPRINNAA_172 - BeforePrintPaymentForm 
 *
 * @autor designer
 */
@Path("/ASSTS/MNTNN/T_BEFOREPRINNAA_172")
@Component
@Service({T_BEFOREPRINNAA_172.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=MNTNN)(task.id=T_BEFOREPRINNAA_172)(task.version=1.0.0))")
,@Reference(name="VW_BEFOREPREN_811", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_BEFOREPREN_811)(view.version=1.0.0))")
,@Reference (name="QV_5858_58779",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_5858_58779)")
,@Reference(name="Q_PRINTIEF_5858",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_PRINTIEF_5858)(query.version=1.0.0))")
...
public class T_BEFOREPRINNAA_172 {

/*
 * Archivo: T_PAYMENTMAIDLT_828.java
 * Fecha: 2017-01-13T18:43:58Z
 *
 ...
 * T_PAYMENTMAIDLT_828 - PaymentMaintenanceModal 
 *
 * @autor designer
 */
@Path("/ASSTS/MNTNN/T_PAYMENTMAIDLT_828")
@Component
@Service({T_PAYMENTMAIDLT_828.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=MNTNN)(task.id=T_PAYMENTMAIDLT_828)(task.version=1.0.0))")
,@Reference(name="VW_PAYMENTMTI_701", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_PAYMENTMTI_701)(view.version=1.0.0))")
...
public class T_PAYMENTMAIDLT_828 {

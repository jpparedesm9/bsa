/*
 * Archivo: T_PAYMENTSMANII_157.java
 * Fecha: 2016-12-05T19:18:55Z
 *
 ...
 * T_PAYMENTSMANII_157 - PaymentsMain 
 *
 * @autor designer
 */
@Path("/ASSTS/TRNSC/T_PAYMENTSMANII_157")
@Component
@Service({T_PAYMENTSMANII_157.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=TRNSC)(task.id=T_PAYMENTSMANII_157)(task.version=1.0.0))")
...
,@Reference(name="VW_PAYMENTSFI_141", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_PAYMENTSFI_141)(view.version=1.0.0))")
,@Reference (name="QV_2540_50573",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_2540_50573)")
,@Reference(name="Q_QUOTEDLA_2540",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_QUOTEDLA_2540)(query.version=1.0.0))")
...
public class T_PAYMENTSMANII_157 {

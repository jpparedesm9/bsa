/*
 * Archivo: T_SOLIDARITYYPN_463.java
 * Fecha: 2017-05-24T14:41:50Z
 *
 ...
 * T_SOLIDARITYYPN_463 - SolidarityPaymentForm 
 *
 * @autor designer
 */
@Path("/ASSTS/MNTNN/T_SOLIDARITYYPN_463")
@Component
@Service({T_SOLIDARITYYPN_463.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=MNTNN)(task.id=T_SOLIDARITYYPN_463)(task.version=1.0.0))")
,@Reference(name="VW_SOLIDARITT_860", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_SOLIDARITT_860)(view.version=1.0.0))")
,@Reference (name="QV_6669_21119",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_6669_21119)")
,@Reference(name="Q_SOLIDAEA_6669",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_SOLIDAEA_6669)(query.version=1.0.0))")
...
public class T_SOLIDARITYYPN_463 {

/*
 * Archivo: T_VALUEDATEMINN_689.java
 * Fecha: 2016-11-09T16:59:44Z
 *
 ...
 * T_VALUEDATEMINN_689 - ValueDateMain 
 *
 * @autor designer
 */
@Path("/ASSTS/TRNSC/T_VALUEDATEMINN_689")
@Component
@Service({T_VALUEDATEMINN_689.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=TRNSC)(task.id=T_VALUEDATEMINN_689)(task.version=1.0.0))")
...
,@Reference(name="VW_VALUEDATEE_866", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_VALUEDATEE_866)(view.version=1.0.0))")
,@Reference (name="QV_1244_89323",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_1244_89323)")
,@Reference(name="Q_TRANSACO_1244",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_TRANSACO_1244)(query.version=1.0.0))")
...
public class T_VALUEDATEMINN_689 {

...
public class CanalLoadCatalogEvent extends BaseEvent implements
ILoadCatalog{
	private static final ILogger logger = LogFactory
			.getLogger(CategoryProductsLoadCatalogEvent.class);
	public CanalLoadCatalogEvent(ICTSServiceIntegration serviceIntegration) {
	...
	public List<?> executeDataEvent(DynamicRequest arg0,
		...
		List<ItemDTO> canalList = new ArrayList<ItemDTO>();
		
				
		PaidCategoryRequest paidCategoryRequest = new PaidCategoryRequest();
		paidCategoryRequest.setMode(2);

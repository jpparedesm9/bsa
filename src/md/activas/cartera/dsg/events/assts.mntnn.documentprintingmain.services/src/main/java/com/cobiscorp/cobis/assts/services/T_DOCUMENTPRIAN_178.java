/*
 * Archivo: T_DOCUMENTPRIAN_178.java
 * Fecha: 2016-12-28T20:16:10Z
 *
 ...
 * T_DOCUMENTPRIAN_178 - DocumentPrintingMain 
 *
 * @autor designer
 */
@Path("/ASSTS/MNTNN/T_DOCUMENTPRIAN_178")
@Component
@Service({T_DOCUMENTPRIAN_178.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=MNTNN)(task.id=T_DOCUMENTPRIAN_178)(task.version=1.0.0))")
...
,@Reference(name="VW_DOCUMENTPG_334", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_DOCUMENTPG_334)(view.version=1.0.0))")
,@Reference (name="QV_3105_20065",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_3105_20065)")
,@Reference(name="Q_PRINTICM_3105",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_PRINTICM_3105)(query.version=1.0.0))")
...
public class T_DOCUMENTPRIAN_178 {

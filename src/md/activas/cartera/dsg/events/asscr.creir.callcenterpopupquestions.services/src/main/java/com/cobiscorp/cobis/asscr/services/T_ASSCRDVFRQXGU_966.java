/*
 * Archivo: T_ASSCRDVFRQXGU_966.java
 * Fecha: 2019-06-13T21:46:38Z
 *
 ...
 */
package com.cobiscorp.cobis.asscr.services;
 ...
 * T_ASSCRDVFRQXGU_966 - CallCenterPopupQuestions 
 *
 * @autor designer
 */
@Path("/ASSCR/CREIR/T_ASSCRDVFRQXGU_966")
@Component
@Service({T_ASSCRDVFRQXGU_966.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSCR)(task.submodule=CREIR)(task.id=T_ASSCRDVFRQXGU_966)(task.version=1.0.0))")
,@Reference(name="VW_CALLCENTIU_912", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_CALLCENTIU_912)(view.version=1.0.0))")
,@Reference (name="QV_7316_54056",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_7316_54056)")
,@Reference(name="Q_CALLCEII_7316",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_CALLCEII_7316)(query.version=1.0.0))")
...
public class T_ASSCRDVFRQXGU_966 {

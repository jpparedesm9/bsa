/*
 * Archivo: T_LOANHEADERNFI_316.java
 * Fecha: 2016-10-21T22:46:51Z
 *
 ...
 * T_LOANHEADERNFI_316 - LoanHeaderInfoForm 
 *
 * @autor designer
 */
@Path("/ASSTS/CMMNS/T_LOANHEADERNFI_316")
@Component
@Service({T_LOANHEADERNFI_316.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=CMMNS)(task.id=T_LOANHEADERNFI_316)(task.version=1.0.0))")
...
public class T_LOANHEADERNFI_316 {

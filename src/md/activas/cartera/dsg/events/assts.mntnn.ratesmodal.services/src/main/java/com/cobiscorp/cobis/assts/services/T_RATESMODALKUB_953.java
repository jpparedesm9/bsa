/*
 * Archivo: T_RATESMODALKUB_953.java
 * Fecha: 2017-01-21T16:16:03Z
 *
 ...
 * T_RATESMODALKUB_953 - RatesModal 
 *
 * @autor designer
 */
@Path("/ASSTS/MNTNN/T_RATESMODALKUB_953")
@Component
@Service({T_RATESMODALKUB_953.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=MNTNN)(task.id=T_RATESMODALKUB_953)(task.version=1.0.0))")
,@Reference(name="VW_RATESMODLL_778", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_RATESMODLL_778)(view.version=1.0.0))")
...
public class T_RATESMODALKUB_953 {

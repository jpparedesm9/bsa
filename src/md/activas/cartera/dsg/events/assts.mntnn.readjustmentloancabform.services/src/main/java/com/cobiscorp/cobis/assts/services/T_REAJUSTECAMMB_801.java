/*
 * Archivo: T_REAJUSTECAMMB_801.java
 * Fecha: 2016-10-25T15:21:23Z
 *
 ...
 * T_REAJUSTECAMMB_801 - ReadjustmentLoanCabForm 
 *
 * @autor designer
 */
@Path("/ASSTS/MNTNN/T_REAJUSTECAMMB_801")
@Component
@Service({T_REAJUSTECAMMB_801.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=MNTNN)(task.id=T_REAJUSTECAMMB_801)(task.version=1.0.0))")
...
public class T_REAJUSTECAMMB_801 {

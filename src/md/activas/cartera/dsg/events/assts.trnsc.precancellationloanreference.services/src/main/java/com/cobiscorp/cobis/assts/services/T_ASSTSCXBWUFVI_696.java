/*
 * Archivo: T_ASSTSCXBWUFVI_696.java
 * Fecha: 2017-12-19T22:51:04Z
 *
 ...
 * T_ASSTSCXBWUFVI_696 - PreCancellationLoanReference 
 *
 * @autor designer
 */
@Path("/ASSTS/TRNSC/T_ASSTSCXBWUFVI_696")
@Component
@Service({T_ASSTSCXBWUFVI_696.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=TRNSC)(task.id=T_ASSTSCXBWUFVI_696)(task.version=1.0.0))")
,@Reference(name="VW_PRECANCEIA_796", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_PRECANCEIA_796)(view.version=1.0.0))")
...
public class T_ASSTSCXBWUFVI_696 {

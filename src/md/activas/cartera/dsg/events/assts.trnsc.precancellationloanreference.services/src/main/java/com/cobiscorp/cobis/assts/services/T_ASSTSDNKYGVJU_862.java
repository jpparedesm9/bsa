/*
 * Archivo: T_ASSTSDNKYGVJU_862.java
 * Fecha: 2017-12-12T21:11:38Z
 *
 ...
 * T_ASSTSDNKYGVJU_862 - PreCancellationLoanReference 
 *
 * @autor designer
 */
@Path("/ASSTS/TRNSC/T_ASSTSDNKYGVJU_862")
@Component
@Service({T_ASSTSDNKYGVJU_862.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=TRNSC)(task.id=T_ASSTSDNKYGVJU_862)(task.version=1.0.0))")
,@Reference(name="VW_PRECANCEOA_581", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_PRECANCEOA_581)(view.version=1.0.0))")
...
public class T_ASSTSDNKYGVJU_862 {

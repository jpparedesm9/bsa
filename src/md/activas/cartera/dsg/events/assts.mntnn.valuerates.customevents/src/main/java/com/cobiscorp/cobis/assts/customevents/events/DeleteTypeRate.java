...
public class DeleteTypeRate extends BaseEvent implements IGridRowDeleting {

	private static final ILogger logger = LogFactory.getLogger(DeleteTypeRate.class);
	
	public DeleteTypeRate(ICTSServiceIntegration serviceIntegration) {
	...
	public void rowAction(DataEntity entities, IGridRowActionEventArgs eventArgs) {
		...
		rateRequest.setOption(0);
		rateRequest.setRateType(entities.get(TypeRates.IDENTIFIER));

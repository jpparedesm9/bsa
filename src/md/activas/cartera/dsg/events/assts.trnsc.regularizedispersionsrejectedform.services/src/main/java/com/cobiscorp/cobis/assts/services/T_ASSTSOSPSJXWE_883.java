/*
 * Archivo: T_ASSTSOSPSJXWE_883.java
 * Fecha: 2018-07-30T21:25:03Z
 *
 ...
 * T_ASSTSOSPSJXWE_883 - RegularizeDispersionsRejectedForm 
 *
 * @autor designer
 */
@Path("/ASSTS/TRNSC/T_ASSTSOSPSJXWE_883")
@Component
@Service({T_ASSTSOSPSJXWE_883.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=TRNSC)(task.id=T_ASSTSOSPSJXWE_883)(task.version=1.0.0))")
,@Reference(name="VW_REGULARIZJ_759", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_REGULARIZJ_759)(view.version=1.0.0))")
,@Reference (name="QV_3655_99787",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_3655_99787)")
,@Reference(name="Q_DETAILTI_3655",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_DETAILTI_3655)(query.version=1.0.0))")
...
public class T_ASSTSOSPSJXWE_883 {

/*
 * Archivo: T_ASSCRLLURZAUF_274.java
 * Fecha: 2019-06-28T13:35:10Z
 *
 ...
 * T_ASSCRLLURZAUF_274 - ResetMessageImage 
 *
 * @autor designer
 */
@Path("/ASSCR/CREIR/T_ASSCRLLURZAUF_274")
@Component
@Service({T_ASSCRLLURZAUF_274.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSCR)(task.submodule=CREIR)(task.id=T_ASSCRLLURZAUF_274)(task.version=1.0.0))")
,@Reference(name="VW_RESETMESGA_225", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_RESETMESGA_225)(view.version=1.0.0))")
...
public class T_ASSCRLLURZAUF_274 {

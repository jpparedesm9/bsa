/*
 * Archivo: T_PAYMENTMAIETA_586.java
 * Fecha: 2017-01-16T23:07:00Z
 *
 ...
 * T_PAYMENTMAIETA_586 - Payment maintenance 
 *
 * @autor designer
 */
@Path("/ASSTS/MNTNN/T_PAYMENTMAIETA_586")
@Component
@Service({T_PAYMENTMAIETA_586.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=MNTNN)(task.id=T_PAYMENTMAIETA_586)(task.version=1.0.0))")
,@Reference(name="VW_PAYMENTMCI_448", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_PAYMENTMCI_448)(view.version=1.0.0))")
,@Reference (name="QV_7546_25470",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_7546_25470)")
,@Reference(name="Q_METHODIR_7546",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_METHODIR_7546)(query.version=1.0.0))")
...
public class T_PAYMENTMAIETA_586 {

/*
 * Archivo: T_ASSTSTCUPYEAZ_925.java
 * Fecha: 2019-01-10T17:29:39Z
 *
 ...
 * T_ASSTSTCUPYEAZ_925 - CreditCandidates 
 *
 * @autor designer
 */
@Path("/ASSTS/QERYS/T_ASSTSTCUPYEAZ_925")
@Component
@Service({T_ASSTSTCUPYEAZ_925.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=QERYS)(task.id=T_ASSTSTCUPYEAZ_925)(task.version=1.0.0))")
,@Reference(name="VW_CREDITCATS_782", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_CREDITCATS_782)(view.version=1.0.0))")
,@Reference (name="QV_9492_89518",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_9492_89518)")
,@Reference(name="Q_CREDITNT_9492",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_CREDITNT_9492)(query.version=1.0.0))")
...
public class T_ASSTSTCUPYEAZ_925 {

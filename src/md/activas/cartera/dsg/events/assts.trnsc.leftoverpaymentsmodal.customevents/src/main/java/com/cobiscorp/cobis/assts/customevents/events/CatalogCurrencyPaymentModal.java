 ...
 * 
 */
public class CatalogCurrencyPaymentModal extends BaseEvent implements
		ILoadCatalog {

	private static final ILogger logger = LogFactory
			.getLogger(CatalogCurrencyPaymentModal.class);

	public CatalogCurrencyPaymentModal(ICTSServiceIntegration serviceIntegration) {

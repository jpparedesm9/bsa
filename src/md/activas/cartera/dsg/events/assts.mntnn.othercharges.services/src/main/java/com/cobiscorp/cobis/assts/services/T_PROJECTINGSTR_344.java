/*
 * Archivo: T_PROJECTINGSTR_344.java
 * Fecha: 2016-11-17T15:32:10Z
 *
 ...
 * T_PROJECTINGSTR_344 - OtherCharges 
 *
 * @autor designer
 */
@Path("/ASSTS/MNTNN/T_PROJECTINGSTR_344")
@Component
@Service({T_PROJECTINGSTR_344.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=MNTNN)(task.id=T_PROJECTINGSTR_344)(task.version=1.0.0))")
...
,@Reference(name="VW_PROJECTISR_888", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_PROJECTISR_888)(view.version=1.0.0))")
,@Reference (name="QV_8396_63374",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_8396_63374)")
,@Reference(name="Q_INGOTRSR_8396",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_INGOTRSR_8396)(query.version=1.0.0))")
...
public class T_PROJECTINGSTR_344 {

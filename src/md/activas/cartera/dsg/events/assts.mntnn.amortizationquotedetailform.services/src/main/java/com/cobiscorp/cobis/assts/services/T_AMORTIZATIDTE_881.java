/*
 * Archivo: T_AMORTIZATIDTE_881.java
 * Fecha: 2016-11-23T16:33:04Z
 *
 ...
 * T_AMORTIZATIDTE_881 - AmortizationQuoteDetailForm 
 *
 * @autor designer
 */
@Path("/ASSTS/MNTNN/T_AMORTIZATIDTE_881")
@Component
@Service({T_AMORTIZATIDTE_881.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=MNTNN)(task.id=T_AMORTIZATIDTE_881)(task.version=1.0.0))")
,@Reference(name="VW_AMORTIZAQA_813", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_AMORTIZAQA_813)(view.version=1.0.0))")
,@Reference (name="QV_8477_65404",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_8477_65404)")
,@Reference(name="Q_AMORTITT_8477",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_AMORTITT_8477)(query.version=1.0.0))")
...
public class T_AMORTIZATIDTE_881 {

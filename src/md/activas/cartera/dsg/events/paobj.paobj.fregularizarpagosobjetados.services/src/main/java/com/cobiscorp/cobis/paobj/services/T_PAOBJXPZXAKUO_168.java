/*
 * Archivo: T_PAOBJXPZXAKUO_168.java
 * Fecha: 2019-08-06T22:20:26Z
 *
 ...
 */
package com.cobiscorp.cobis.paobj.services;
 ...
 * T_PAOBJXPZXAKUO_168 - FRegularizarPagosObjetados 
 *
 * @autor designer
 */
@Path("/PAOBJ/PAOBJ/T_PAOBJXPZXAKUO_168")
@Component
@Service({T_PAOBJXPZXAKUO_168.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=PAOBJ)(task.submodule=PAOBJ)(task.id=T_PAOBJXPZXAKUO_168)(task.version=1.0.0))")
,@Reference(name="VW_FREGULARSP_505", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_FREGULARSP_505)(view.version=1.0.0))")
,@Reference (name="QV_3724_71065",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_3724_71065)")
,@Reference(name="Q_RESULTTO_3724",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_RESULTTO_3724)(query.version=1.0.0))")
...
public class T_PAOBJXPZXAKUO_168 {

/*
 * Archivo: T_ASSTSLBVYTVMM_226.java
 * Fecha: 2017-06-16T22:39:57Z
 *
 ...
 * T_ASSTSLBVYTVMM_226 - DetailFund 
 *
 * @autor designer
 */
@Path("/ASSTS/MNTNN/T_ASSTSLBVYTVMM_226")
@Component
@Service({T_ASSTSLBVYTVMM_226.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=MNTNN)(task.id=T_ASSTSLBVYTVMM_226)(task.version=1.0.0))")
,@Reference(name="VW_DETAILFUND_140", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_DETAILFUND_140)(view.version=1.0.0))")
...
public class T_ASSTSLBVYTVMM_226 {

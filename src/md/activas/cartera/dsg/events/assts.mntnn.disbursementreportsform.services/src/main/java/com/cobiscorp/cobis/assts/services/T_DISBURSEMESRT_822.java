/*
 * Archivo: T_DISBURSEMESRT_822.java
 * Fecha: 2018-02-21T19:39:30Z
 *
 ...
 * T_DISBURSEMESRT_822 - DisbursementReportsForm 
 *
 * @autor designer
 */
@Path("/ASSTS/MNTNN/T_DISBURSEMESRT_822")
@Component
@Service({T_DISBURSEMESRT_822.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=MNTNN)(task.id=T_DISBURSEMESRT_822)(task.version=1.0.0))")
,@Reference(name="VW_DISBURSETR_245", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_DISBURSETR_245)(view.version=1.0.0))")
...
public class T_DISBURSEMESRT_822 {

/*
 * Archivo: T_ASSCRRXGVRPHC_165.java
 * Fecha: 2019-01-16T20:52:26Z
 *
 ...
 * T_ASSCRRXGVRPHC_165 - CallCenterQuestions 
 *
 * @autor designer
 */
@Path("/ASSCR/CREIR/T_ASSCRRXGVRPHC_165")
@Component
@Service({T_ASSCRRXGVRPHC_165.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSCR)(task.submodule=CREIR)(task.id=T_ASSCRRXGVRPHC_165)(task.version=1.0.0))")
,@Reference(name="VW_CALLCENTIR_769", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_CALLCENTIR_769)(view.version=1.0.0))")
,@Reference (name="QV_7316_82692",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_7316_82692)")
...
public class T_ASSCRRXGVRPHC_165 {

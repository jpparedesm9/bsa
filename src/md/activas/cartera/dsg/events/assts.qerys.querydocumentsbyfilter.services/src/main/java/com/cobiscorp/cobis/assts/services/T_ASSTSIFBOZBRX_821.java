/*
 * Archivo: T_ASSTSIFBOZBRX_821.java
 * Fecha: 2019-01-10T15:11:44Z
 *
 ...
 * T_ASSTSIFBOZBRX_821 - QueryDocumentsByFilter 
 *
 * @autor designer
 */
@Path("/ASSTS/QERYS/T_ASSTSIFBOZBRX_821")
@Component
@Service({T_ASSTSIFBOZBRX_821.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=QERYS)(task.id=T_ASSTSIFBOZBRX_821)(task.version=1.0.0))")
,@Reference(name="VW_DOCUMENTYI_698", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_DOCUMENTYI_698)(view.version=1.0.0))")
,@Reference (name="QV_9784_36547",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_9784_36547)")
,@Reference(name="Q_RESULTYR_9784",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_RESULTYR_9784)(query.version=1.0.0))")
...
public class T_ASSTSIFBOZBRX_821 {

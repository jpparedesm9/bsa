/*
 * Archivo: T_ASSTSEWQQZQBV_441.java
 * Fecha: 2019-02-28T15:04:17Z
 *
 ...
 * T_ASSTSEWQQZQBV_441 - CreditCandidatesPopUpForm 
 *
 * @autor designer
 */
@Path("/ASSTS/QERYS/T_ASSTSEWQQZQBV_441")
@Component
@Service({T_ASSTSEWQQZQBV_441.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=QERYS)(task.id=T_ASSTSEWQQZQBV_441)(task.version=1.0.0))")
,@Reference(name="VW_CREDITCAIA_342", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_CREDITCAIA_342)(view.version=1.0.0))")
...
public class T_ASSTSEWQQZQBV_441 {

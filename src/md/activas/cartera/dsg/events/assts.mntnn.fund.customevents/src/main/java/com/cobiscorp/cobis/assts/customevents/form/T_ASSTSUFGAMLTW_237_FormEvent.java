/*
 * Archivo: T_ASSTSUFGAMLTW_237_FormEvent.java
 ...
 * 
 * T_ASSTSUFGAMLTW_237_FormEvent - Fund 
 *
 * @autor designer
 */
@Component
...
@Properties({ @Property(name = "task.module", value = "ASSTS"),
             ...
             @Property(name = "task.id", value = "T_ASSTSUFGAMLTW_237"),
             @Property(name = "task.version", value = "1.0.0") })
public class T_ASSTSUFGAMLTW_237_FormEvent extends FormEventBuilder {
	/**
	 * Instancia de Logger
	 */
	private static final ILogger logger = LogFactory.getLogger(T_ASSTSUFGAMLTW_237_FormEvent.class);

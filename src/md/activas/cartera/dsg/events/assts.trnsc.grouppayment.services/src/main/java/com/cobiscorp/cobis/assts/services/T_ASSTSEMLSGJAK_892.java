/*
 * Archivo: T_ASSTSEMLSGJAK_892.java
 * Fecha: 2017-07-03T15:37:01Z
 *
 ...
 * T_ASSTSEMLSGJAK_892 - GroupPayment 
 *
 * @autor designer
 */
@Path("/ASSTS/TRNSC/T_ASSTSEMLSGJAK_892")
@Component
@Service({T_ASSTSEMLSGJAK_892.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=TRNSC)(task.id=T_ASSTSEMLSGJAK_892)(task.version=1.0.0))")
,@Reference(name="VW_GROUPPAYNT_946", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_GROUPPAYNT_946)(view.version=1.0.0))")
,@Reference (name="QV_9025_57410",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_9025_57410)")
,@Reference(name="Q_GROUPPTY_9025",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_GROUPPTY_9025)(query.version=1.0.0))")
...
public class T_ASSTSEMLSGJAK_892 {

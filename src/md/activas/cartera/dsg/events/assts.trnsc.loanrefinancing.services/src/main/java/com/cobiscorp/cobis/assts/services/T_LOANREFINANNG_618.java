/*
 * Archivo: T_LOANREFINANNG_618.java
 * Fecha: 2016-11-17T22:28:11Z
 *
 ...
 * T_LOANREFINANNG_618 - LoanRefinancing 
 *
 * @autor designer
 */
@Path("/ASSTS/TRNSC/T_LOANREFINANNG_618")
@Component
@Service({T_LOANREFINANNG_618.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=TRNSC)(task.id=T_LOANREFINANNG_618)(task.version=1.0.0))")
...
,@Reference(name="VW_REFINANCOL_881", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_REFINANCOL_881)(view.version=1.0.0))")
,@Reference (name="QV_2890_45043",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_2890_45043)")
,@Reference (name="QV_6687_51127",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_6687_51127)")
,@Reference(name="Q_REFINANE_6687",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_REFINANE_6687)(query.version=1.0.0))")
,@Reference(name="Q_REFINACL_2890",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_REFINACL_2890)(query.version=1.0.0))")
...
public class T_LOANREFINANNG_618 {

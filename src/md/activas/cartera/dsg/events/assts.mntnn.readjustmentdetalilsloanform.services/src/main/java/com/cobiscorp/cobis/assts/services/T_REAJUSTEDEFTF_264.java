/*
 * Archivo: T_REAJUSTEDEFTF_264.java
 * Fecha: 2016-10-28T19:56:42Z
 *
 ...
 * T_REAJUSTEDEFTF_264 - ReadjustmentDetalilsLoanForm 
 *
 * @autor designer
 */
@Path("/ASSTS/MNTNN/T_REAJUSTEDEFTF_264")
@Component
@Service({T_REAJUSTEDEFTF_264.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=MNTNN)(task.id=T_REAJUSTEDEFTF_264)(task.version=1.0.0))")
,@Reference(name="VW_REAJUSTEDT_141", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_REAJUSTEDT_141)(view.version=1.0.0))")
,@Reference (name="QV_2618_23821",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_2618_23821)")
,@Reference(name="Q_REAJUSTE_2618",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_REAJUSTE_2618)(query.version=1.0.0))")
...
public class T_REAJUSTEDEFTF_264 {

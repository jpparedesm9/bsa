/*
 * Archivo: T_DOCUMENTPRIII_678.java
 * Fecha: 2016-11-25T15:19:30Z
 *
 ...
 * T_DOCUMENTPRIII_678 - DocumentPrinting 
 *
 * @autor designer
 */
@Path("/ASSTS/MNTNN/T_DOCUMENTPRIII_678")
@Component
@Service({T_DOCUMENTPRIII_678.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=MNTNN)(task.id=T_DOCUMENTPRIII_678)(task.version=1.0.0))")
...
public class T_DOCUMENTPRIII_678 {

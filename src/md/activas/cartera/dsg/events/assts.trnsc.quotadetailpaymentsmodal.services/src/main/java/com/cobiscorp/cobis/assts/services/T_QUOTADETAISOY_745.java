/*
 * Archivo: T_QUOTADETAISOY_745.java
 * Fecha: 2016-11-18T17:00:58Z
 *
 ...
 * T_QUOTADETAISOY_745 - QuotaDetailPaymentsModal 
 *
 * @autor designer
 */
@Path("/ASSTS/TRNSC/T_QUOTADETAISOY_745")
@Component
@Service({T_QUOTADETAISOY_745.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=TRNSC)(task.id=T_QUOTADETAISOY_745)(task.version=1.0.0))")
,@Reference(name="VW_QUOTADETOM_925", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_QUOTADETOM_925)(view.version=1.0.0))")
,@Reference (name="QV_4705_99765",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_4705_99765)")
,@Reference(name="Q_QUOTEDPM_4705",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_QUOTEDPM_4705)(query.version=1.0.0))")
...
public class T_QUOTADETAISOY_745 {

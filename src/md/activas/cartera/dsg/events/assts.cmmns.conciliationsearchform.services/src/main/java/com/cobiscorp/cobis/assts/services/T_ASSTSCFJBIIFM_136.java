/*
 * Archivo: T_ASSTSCFJBIIFM_136.java
 * Fecha: 2017-07-07T21:00:40Z
 *
 ...
 * T_ASSTSCFJBIIFM_136 - ConciliationSearchForm 
 *
 * @autor designer
 */
@Path("/ASSTS/CMMNS/T_ASSTSCFJBIIFM_136")
@Component
@Service({T_ASSTSCFJBIIFM_136.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=CMMNS)(task.id=T_ASSTSCFJBIIFM_136)(task.version=1.0.0))")
,@Reference(name="VW_CONCILIARH_314", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_CONCILIARH_314)(view.version=1.0.0))")
,@Reference (name="QV_9564_85454",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_9564_85454)")
,@Reference(name="Q_CONCILOA_9564",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_CONCILOA_9564)(query.version=1.0.0))")
...
public class T_ASSTSCFJBIIFM_136 {

/*
 * Archivo: T_ASSTSDOHFZMES_451.java
 * Fecha: 2017-11-10T17:39:04Z
 *
 ...
 * T_ASSTSDOHFZMES_451 - LoanSearchGroupForm 
 *
 * @autor designer
 */
@Path("/ASSTS/CMMNS/T_ASSTSDOHFZMES_451")
@Component
@Service({T_ASSTSDOHFZMES_451.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=CMMNS)(task.id=T_ASSTSDOHFZMES_451)(task.version=1.0.0))")
,@Reference(name="VW_LOANSEARCO_549", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_LOANSEARCO_549)(view.version=1.0.0))")
,@Reference (name="QV_3992_44545",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_3992_44545)")
,@Reference(name="Q_LOANIBUZ_3992",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_LOANIBUZ_3992)(query.version=1.0.0))")
...
public class T_ASSTSDOHFZMES_451 {

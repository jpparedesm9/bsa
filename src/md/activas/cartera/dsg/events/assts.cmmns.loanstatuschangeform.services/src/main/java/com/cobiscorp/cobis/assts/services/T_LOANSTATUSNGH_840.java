/*
 * Archivo: T_LOANSTATUSNGH_840.java
 * Fecha: 2016-10-26T22:39:47Z
 *
 ...
 * T_LOANSTATUSNGH_840 - LoanStatusChangeForm 
 *
 * @autor designer
 */
@Path("/ASSTS/CMMNS/T_LOANSTATUSNGH_840")
@Component
@Service({T_LOANSTATUSNGH_840.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=CMMNS)(task.id=T_LOANSTATUSNGH_840)(task.version=1.0.0))")
...
public class T_LOANSTATUSNGH_840 {

/*
 * Archivo: T_BANKACCOUNTOA_777.java
 * Fecha: 2017-02-08T16:16:38Z
 *
 ...
 * T_BANKACCOUNTOA_777 - BankAccountsModal 
 *
 * @autor designer
 */
@Path("/ASSTS/TRNSC/T_BANKACCOUNTOA_777")
@Component
@Service({T_BANKACCOUNTOA_777.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=TRNSC)(task.id=T_BANKACCOUNTOA_777)(task.version=1.0.0))")
,@Reference(name="VW_BANKACCOUU_523", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_BANKACCOUU_523)(view.version=1.0.0))")
,@Reference (name="QV_1987_24851",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_1987_24851)")
...
public class T_BANKACCOUNTOA_777 {

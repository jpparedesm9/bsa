/*
 * Archivo: T_ASSTSRBSDDMKT_144.java
 * Fecha: 2020-11-10T17:18:49Z
 *
 ...
 * T_ASSTSRBSDDMKT_144 - CreditBlockComposite 
 *
 * @autor designer
 */
@Path("/ASSTS/MNTNN/T_ASSTSRBSDDMKT_144")
@Component
@Service({T_ASSTSRBSDDMKT_144.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=MNTNN)(task.id=T_ASSTSRBSDDMKT_144)(task.version=1.0.0))")
...
,@Reference(name="VW_CREDITBLKO_902", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_CREDITBLKO_902)(view.version=1.0.0))")
...
public class T_ASSTSRBSDDMKT_144 {

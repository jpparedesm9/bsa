/*
 * Archivo: T_REFINANCELISS_781.java
 * Fecha: 2017-01-10T23:20:23Z
 *
 ...
 * T_REFINANCELISS_781 - RefinanceLoansFilter 
 *
 * @autor designer
 */
@Path("/ASSTS/TRNSC/T_REFINANCELISS_781")
@Component
@Service({T_REFINANCELISS_781.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=TRNSC)(task.id=T_REFINANCELISS_781)(task.version=1.0.0))")
,@Reference(name="VW_REFINANCIT_515", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_REFINANCIT_515)(view.version=1.0.0))")
,@Reference (name="QV_3375_11342",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_3375_11342)")
,@Reference(name="Q_REFINAAA_3375",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_REFINAAA_3375)(query.version=1.0.0))")
...
public class T_REFINANCELISS_781 {

/*
 * Archivo: T_NEGOTIATIOTML_700.java
 * Fecha: 2016-11-18T16:59:44Z
 *
 ...
 * T_NEGOTIATIOTML_700 - NegotiationPaymentsModal 
 *
 * @autor designer
 */
@Path("/ASSTS/TRNSC/T_NEGOTIATIOTML_700")
@Component
@Service({T_NEGOTIATIOTML_700.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=TRNSC)(task.id=T_NEGOTIATIOTML_700)(task.version=1.0.0))")
,@Reference(name="VW_NEGOTIATYP_225", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_NEGOTIATYP_225)(view.version=1.0.0))")
...
public class T_NEGOTIATIOTML_700 {

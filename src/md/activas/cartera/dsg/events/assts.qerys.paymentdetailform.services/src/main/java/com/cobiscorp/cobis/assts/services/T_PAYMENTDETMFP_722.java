/*
 * Archivo: T_PAYMENTDETMFP_722.java
 * Fecha: 2016-11-28T19:30:29Z
 *
 ...
 * T_PAYMENTDETMFP_722 - PaymentDetailForm 
 *
 * @autor designer
 */
@Path("/ASSTS/QERYS/T_PAYMENTDETMFP_722")
@Component
@Service({T_PAYMENTDETMFP_722.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=QERYS)(task.id=T_PAYMENTDETMFP_722)(task.version=1.0.0))")
,@Reference(name="VW_PAYMENTDEE_485", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_PAYMENTDEE_485)(view.version=1.0.0))")
,@Reference (name="QV_1707_26229",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_1707_26229)")
,@Reference(name="Q_PAYMENTT_1707",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_PAYMENTT_1707)(query.version=1.0.0))")
...
public class T_PAYMENTDETMFP_722 {

/*
 * Archivo: T_CONDONATIOSNN_532.java
 * Fecha: 2016-12-08T05:54:52Z
 *
 ...
 * T_CONDONATIOSNN_532 - CondonationDetailForm 
 *
 * @autor designer
 */
@Path("/ASSTS/TRNSC/T_CONDONATIOSNN_532")
@Component
@Service({T_CONDONATIOSNN_532.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=TRNSC)(task.id=T_CONDONATIOSNN_532)(task.version=1.0.0))")
,@Reference(name="VW_CONDONATSN_764", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_CONDONATSN_764)(view.version=1.0.0))")
,@Reference (name="QV_7324_98967",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_7324_98967)")
,@Reference(name="Q_CONDONDE_7324",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_CONDONDE_7324)(query.version=1.0.0))")
...
public class T_CONDONATIOSNN_532 {

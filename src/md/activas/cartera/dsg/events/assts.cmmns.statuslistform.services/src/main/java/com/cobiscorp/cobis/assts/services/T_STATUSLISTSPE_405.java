/*
 * Archivo: T_STATUSLISTSPE_405.java
 * Fecha: 2016-10-28T00:41:05Z
 *
 ...
 * T_STATUSLISTSPE_405 - StatusListForm 
 *
 * @autor designer
 */
@Path("/ASSTS/CMMNS/T_STATUSLISTSPE_405")
@Component
@Service({T_STATUSLISTSPE_405.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=CMMNS)(task.id=T_STATUSLISTSPE_405)(task.version=1.0.0))")
,@Reference(name="VW_STATUSLISS_707", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_STATUSLISS_707)(view.version=1.0.0))")
,@Reference (name="QV_5541_56326",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_5541_56326)")
,@Reference(name="Q_LOANSTNN_5541",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_LOANSTNN_5541)(query.version=1.0.0))")
...
public class T_STATUSLISTSPE_405 {

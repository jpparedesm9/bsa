/*
 * Archivo: T_ASSTSDVYDGJCT_107.java
 * Fecha: 2018-05-31T01:44:52Z
 *
 ...
 * T_ASSTSDVYDGJCT_107 - QueryDocumentsGridDetail 
 *
 * @autor designer
 */
@Path("/ASSTS/QERYS/T_ASSTSDVYDGJCT_107")
@Component
@Service({T_ASSTSDVYDGJCT_107.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=QERYS)(task.id=T_ASSTSDVYDGJCT_107)(task.version=1.0.0))")
,@Reference(name="VW_DOCUMENTDD_831", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_DOCUMENTDD_831)(view.version=1.0.0))")
,@Reference (name="QV_2153_73215",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_2153_73215)")
,@Reference (name="QV_3671_84200",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_3671_84200)")
,@Reference(name="Q_SCANNEEE_2153",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_SCANNEEE_2153)(query.version=1.0.0))")
,@Reference(name="Q_DOCUMEAL_3671",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_DOCUMEAL_3671)(query.version=1.0.0))")
...
public class T_ASSTSDVYDGJCT_107 {

/*
 * Archivo: T_EXTENDSQUONTA_926.java
 * Fecha: 2016-12-05T22:27:16Z
 *
 ...
 * T_EXTENDSQUONTA_926 - ExtendsQuotaFormMain 
 *
 * @autor designer
 */
@Path("/ASSTS/MNTNN/T_EXTENDSQUONTA_926")
@Component
@Service({T_EXTENDSQUONTA_926.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=MNTNN)(task.id=T_EXTENDSQUONTA_926)(task.version=1.0.0))")
...
,@Reference(name="VW_EXTENDSQOT_662", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_EXTENDSQOT_662)(view.version=1.0.0))")
,@Reference (name="QV_2921_98487",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_2921_98487)")
,@Reference (name="QV_5312_48027",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_5312_48027)")
,@Reference(name="Q_CURRENAT_2921",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_CURRENAT_2921)(query.version=1.0.0))")
,@Reference(name="Q_EXTENDEX_5312",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_EXTENDEX_5312)(query.version=1.0.0))")
...
public class T_EXTENDSQUONTA_926 {

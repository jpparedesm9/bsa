/*
 * Archivo: T_VALUERATESFBO_932.java
 * Fecha: 2017-01-18T22:43:32Z
 *
 ...
 * T_VALUERATESFBO_932 - ValueRates 
 *
 * @autor designer
 */
@Path("/ASSTS/MNTNN/T_VALUERATESFBO_932")
@Component
@Service({T_VALUERATESFBO_932.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=MNTNN)(task.id=T_VALUERATESFBO_932)(task.version=1.0.0))")
,@Reference(name="VW_VALUERATES_476", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_VALUERATES_476)(view.version=1.0.0))")
,@Reference (name="QV_1722_99596",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_1722_99596)")
,@Reference (name="QV_5693_54772",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_5693_54772)")
,@Reference(name="Q_RATESEXU_5693",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_RATESEXU_5693)(query.version=1.0.0))")
,@Reference(name="Q_TYPERASE_1722",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_TYPERASE_1722)(query.version=1.0.0))")
...
public class T_VALUERATESFBO_932 {

/*
 * Archivo: T_PAYMENTMODEEE_368.java
 * Fecha: 2017-01-11T16:50:38Z
 *
 ...
 * T_PAYMENTMODEEE_368 - PaymentModeForm 
 *
 * @autor designer
 */
@Path("/ASSTS/TRNSC/T_PAYMENTMODEEE_368")
@Component
@Service({T_PAYMENTMODEEE_368.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=TRNSC)(task.id=T_PAYMENTMODEEE_368)(task.version=1.0.0))")
,@Reference(name="VW_PAYMENTMOO_216", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_PAYMENTMOO_216)(view.version=1.0.0))")
...
public class T_PAYMENTMODEEE_368 {

/*
 * Archivo: T_PRIORITIESENY_489.java
 * Fecha: 2016-12-12T12:08:11Z
 *
 ...
 * T_PRIORITIESENY_489 - PrioritiesPaymentsModal 
 *
 * @autor designer
 */
@Path("/ASSTS/TRNSC/T_PRIORITIESENY_489")
@Component
@Service({T_PRIORITIESENY_489.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=TRNSC)(task.id=T_PRIORITIESENY_489)(task.version=1.0.0))")
,@Reference(name="VW_PRIORITIAP_545", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_PRIORITIAP_545)(view.version=1.0.0))")
,@Reference (name="QV_3510_83627",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_3510_83627)")
,@Reference(name="Q_PRIORIIT_3510",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_PRIORIIT_3510)(query.version=1.0.0))")
...
public class T_PRIORITIESENY_489 {

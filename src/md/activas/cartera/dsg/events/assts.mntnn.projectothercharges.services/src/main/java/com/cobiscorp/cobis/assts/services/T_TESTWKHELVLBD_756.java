/*
 * Archivo: T_TESTWKHELVLBD_756.java
 * Fecha: 2016-11-17T19:39:07Z
 *
 ...
 * T_TESTWKHELVLBD_756 - ProjectOtherCharges 
 *
 * @autor designer
 */
@Path("/ASSTS/MNTNN/T_TESTWKHELVLBD_756")
@Component
@Service({T_TESTWKHELVLBD_756.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=MNTNN)(task.id=T_TESTWKHELVLBD_756)(task.version=1.0.0))")
,@Reference(name="VW_TESTNYYYII_872", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_TESTNYYYII_872)(view.version=1.0.0))")
...
public class T_TESTWKHELVLBD_756 {

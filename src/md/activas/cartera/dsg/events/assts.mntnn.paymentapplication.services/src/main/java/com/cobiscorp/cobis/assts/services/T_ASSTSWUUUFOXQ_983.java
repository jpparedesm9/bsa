/*
 * Archivo: T_ASSTSWUUUFOXQ_983.java
 * Fecha: 2017-05-25T20:09:57Z
 *
 ...
 * T_ASSTSWUUUFOXQ_983 - PaymentApplication 
 *
 * @autor designer
 */
@Path("/ASSTS/MNTNN/T_ASSTSWUUUFOXQ_983")
@Component
@Service({T_ASSTSWUUUFOXQ_983.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=MNTNN)(task.id=T_ASSTSWUUUFOXQ_983)(task.version=1.0.0))")
,@Reference(name="VW_PAYMENTAAN_131", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_PAYMENTAAN_131)(view.version=1.0.0))")
,@Reference (name="QV_8495_46282",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_8495_46282)")
,@Reference(name="Q_PAYMENII_8495",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_PAYMENII_8495)(query.version=1.0.0))")
...
public class T_ASSTSWUUUFOXQ_983 {

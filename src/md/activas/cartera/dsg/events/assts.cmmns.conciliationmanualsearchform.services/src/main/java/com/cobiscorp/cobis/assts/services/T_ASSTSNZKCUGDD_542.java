/*
 * Archivo: T_ASSTSNZKCUGDD_542.java
 * Fecha: 2019-04-01T20:53:04Z
 *
 ...
 * T_ASSTSNZKCUGDD_542 - ConciliationManualSearchForm 
 *
 * @autor designer
 */
@Path("/ASSTS/CMMNS/T_ASSTSNZKCUGDD_542")
@Component
@Service({T_ASSTSNZKCUGDD_542.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=CMMNS)(task.id=T_ASSTSNZKCUGDD_542)(task.version=1.0.0))")
,@Reference(name="VW_CONCILIACS_547", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_CONCILIACS_547)(view.version=1.0.0))")
,@Reference (name="QV_9498_31225",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_9498_31225)")
,@Reference(name="Q_CONCILNH_9498",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_CONCILNH_9498)(query.version=1.0.0))")
...
public class T_ASSTSNZKCUGDD_542 {

/*
 * Archivo: T_DETAILSAHOANJ_635.java
 * Fecha: 2017-03-31T17:29:33Z
 *
 ...
 * T_DETAILSAHOANJ_635 - DetailsAho 
 *
 * @autor designer
 */
@Path("/ASSTS/MNTNN/T_DETAILSAHOANJ_635")
@Component
@Service({T_DETAILSAHOANJ_635.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=MNTNN)(task.id=T_DETAILSAHOANJ_635)(task.version=1.0.0))")
,@Reference(name="VW_DETAILSAOO_444", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_DETAILSAOO_444)(view.version=1.0.0))")
,@Reference (name="QV_3162_24937",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_3162_24937)")
,@Reference(name="Q_DETAILSA_3162",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_DETAILSA_3162)(query.version=1.0.0))")
...
public class T_DETAILSAHOANJ_635 {

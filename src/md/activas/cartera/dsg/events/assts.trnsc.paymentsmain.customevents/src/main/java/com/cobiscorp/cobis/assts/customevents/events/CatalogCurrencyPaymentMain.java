 ...
 * 
 */
public class CatalogCurrencyPaymentMain extends BaseEvent implements
		ILoadCatalog {

	private static final ILogger logger = LogFactory
			.getLogger(CatalogCurrencyPaymentMain.class);

	public CatalogCurrencyPaymentMain(ICTSServiceIntegration serviceIntegration) {

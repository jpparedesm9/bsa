/*
 * Archivo: T_ASSTSUFGAMLTW_237.java
 * Fecha: 2017-06-16T21:53:54Z
 *
 ...
 * T_ASSTSUFGAMLTW_237 - Fund 
 *
 * @autor designer
 */
@Path("/ASSTS/MNTNN/T_ASSTSUFGAMLTW_237")
@Component
@Service({T_ASSTSUFGAMLTW_237.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=MNTNN)(task.id=T_ASSTSUFGAMLTW_237)(task.version=1.0.0))")
,@Reference(name="VW_FUNDYDHWEI_448", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_FUNDYDHWEI_448)(view.version=1.0.0))")
,@Reference (name="QV_8975_37395",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_8975_37395)")
,@Reference(name="Q_FUNDQJFL_8975",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_FUNDQJFL_8975)(query.version=1.0.0))")
...
public class T_ASSTSUFGAMLTW_237 {

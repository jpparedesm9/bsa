/*
 * Archivo: T_BANKACCOUNTIS_944.java
 * Fecha: 2017-01-03T23:45:16Z
 *
 ...
 * T_BANKACCOUNTIS_944 - BankAccountsListForm 
 *
 * @autor designer
 */
@Path("/ASSTS/TRNSC/T_BANKACCOUNTIS_944")
@Component
@Service({T_BANKACCOUNTIS_944.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=TRNSC)(task.id=T_BANKACCOUNTIS_944)(task.version=1.0.0))")
,@Reference(name="VW_BANKACCONS_561", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_BANKACCONS_561)(view.version=1.0.0))")
,@Reference (name="QV_1987_42894",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_1987_42894)")
,@Reference(name="Q_BANKACUC_1987",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_BANKACUC_1987)(query.version=1.0.0))")
...
public class T_BANKACCOUNTIS_944 {

/*
 * Archivo: T_ASSTSKUSBXHZA_608.java
 * Fecha: 2017-07-28T16:34:07Z
 *
 ...
 * T_ASSTSKUSBXHZA_608 - DebitOrderProcessingLog 
 *
 * @autor designer
 */
@Path("/ASSTS/QERYS/T_ASSTSKUSBXHZA_608")
@Component
@Service({T_ASSTSKUSBXHZA_608.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=QERYS)(task.id=T_ASSTSKUSBXHZA_608)(task.version=1.0.0))")
,@Reference(name="VW_DEBITORDPN_643", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_DEBITORDPN_643)(view.version=1.0.0))")
,@Reference (name="QV_1156_57465",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_1156_57465)")
,@Reference(name="Q_DEBITOOI_1156",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_DEBITOOI_1156)(query.version=1.0.0))")
...
public class T_ASSTSKUSBXHZA_608 {

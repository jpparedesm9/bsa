/*
 * Archivo: T_ASSTSODKKUGLX_678.java
 * Fecha: 2017-07-07T21:18:36Z
 *
 ...
 * T_ASSTSODKKUGLX_678 - ManualConciliation 
 *
 * @autor designer
 */
@Path("/ASSTS/TRNSC/T_ASSTSODKKUGLX_678")
@Component
@Service({T_ASSTSODKKUGLX_678.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=TRNSC)(task.id=T_ASSTSODKKUGLX_678)(task.version=1.0.0))")
,@Reference(name="VW_MANUALCOII_939", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_MANUALCOII_939)(view.version=1.0.0))")
...
public class T_ASSTSODKKUGLX_678 {

/*
 * Archivo: T_LEFTOVERPALDD_459.java
 * Fecha: 2016-12-02T22:04:29Z
 *
 ...
 * T_LEFTOVERPALDD_459 - LeftoverPaymentsModal 
 *
 * @autor designer
 */
@Path("/ASSTS/TRNSC/T_LEFTOVERPALDD_459")
@Component
@Service({T_LEFTOVERPALDD_459.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=TRNSC)(task.id=T_LEFTOVERPALDD_459)(task.version=1.0.0))")
,@Reference(name="VW_LEFTOVERLA_369", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_LEFTOVERLA_369)(view.version=1.0.0))")
...
public class T_LEFTOVERPALDD_459 {

/*
 * Archivo: T_ASSTSHPXNSQZA_469.java
 * Fecha: 2017-08-24T22:42:02Z
 *
 ...
 * T_ASSTSHPXNSQZA_469 - VoucherPaymentMail 
 *
 * @autor designer
 */
@Path("/ASSTS/TRNSC/T_ASSTSHPXNSQZA_469")
@Component
@Service({T_ASSTSHPXNSQZA_469.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=TRNSC)(task.id=T_ASSTSHPXNSQZA_469)(task.version=1.0.0))")
,@Reference(name="VW_VOUCHERPMN_873", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_VOUCHERPMN_873)(view.version=1.0.0))")
...
public class T_ASSTSHPXNSQZA_469 {

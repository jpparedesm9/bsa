/*
 * Archivo: T_LOANDISBURSAA_275.java
 * Fecha: 2017-01-11T16:36:30Z
 *
 ...
 * T_LOANDISBURSAA_275 - LoanDisbursementMain 
 *
 * @autor designer
 */
@Path("/ASSTS/TRNSC/T_LOANDISBURSAA_275")
@Component
@Service({T_LOANDISBURSAA_275.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=TRNSC)(task.id=T_LOANDISBURSAA_275)(task.version=1.0.0))")
...
,@Reference(name="VW_DISBURSEME_405", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_DISBURSEME_405)(view.version=1.0.0))")
,@Reference (name="QV_1603_21320",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_1603_21320)")
,@Reference (name="QV_5973_48889",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_5973_48889)")
,@Reference(name="Q_DETAILTM_1603",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_DETAILTM_1603)(query.version=1.0.0))")
,@Reference(name="Q_DETAILAP_5973",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_DETAILAP_5973)(query.version=1.0.0))")
...
public class T_LOANDISBURSAA_275 {

/*
 * Archivo: T_ASSTSNMDWVMHP_252.java
 * Fecha: 2018-06-08T17:01:02Z
 *
 ...
 * T_ASSTSNMDWVMHP_252 - QueryDocumentsHistory 
 *
 * @autor designer
 */
@Path("/ASSTS/QERYS/T_ASSTSNMDWVMHP_252")
@Component
@Service({T_ASSTSNMDWVMHP_252.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=QERYS)(task.id=T_ASSTSNMDWVMHP_252)(task.version=1.0.0))")
,@Reference(name="VW_CREDITDOEM_376", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_CREDITDOEM_376)(view.version=1.0.0))")
,@Reference (name="QV_4555_93830",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_4555_93830)")
,@Reference(name="Q_DOCUMERR_4555",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_DOCUMERR_4555)(query.version=1.0.0))")
...
public class T_ASSTSNMDWVMHP_252 {

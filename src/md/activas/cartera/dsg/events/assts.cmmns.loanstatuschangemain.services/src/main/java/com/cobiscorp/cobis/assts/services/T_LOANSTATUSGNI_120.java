/*
 * Archivo: T_LOANSTATUSGNI_120.java
 * Fecha: 2016-11-28T19:24:08Z
 *
 ...
 * T_LOANSTATUSGNI_120 - LoanStatusChangeMain 
 *
 * @autor designer
 */
@Path("/ASSTS/CMMNS/T_LOANSTATUSGNI_120")
@Component
@Service({T_LOANSTATUSGNI_120.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=CMMNS)(task.id=T_LOANSTATUSGNI_120)(task.version=1.0.0))")
...
,@Reference(name="VW_LOANSTATSC_722", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_LOANSTATSC_722)(view.version=1.0.0))")
,@Reference(name="VW_AMORTIZAOI_871", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_AMORTIZAOI_871)(view.version=1.0.0))")
,@Reference (name="QV_8237_80795",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_8237_80795)")
,@Reference(name="Q_AMORTIAN_8237",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_AMORTIAN_8237)(query.version=1.0.0))")
...
public class T_LOANSTATUSGNI_120 {

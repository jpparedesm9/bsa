/*
 * Archivo: T_ASSTSRQAOEXFY_252.java
 * Fecha: 2018-06-11T17:31:17Z
 *
 ...
 * T_ASSTSRQAOEXFY_252 - QueryDocumentsCycle 
 *
 * @autor designer
 */
@Path("/ASSTS/QERYS/T_ASSTSRQAOEXFY_252")
@Component
@Service({T_ASSTSRQAOEXFY_252.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=QERYS)(task.id=T_ASSTSRQAOEXFY_252)(task.version=1.0.0))")
,@Reference(name="VW_DOCUMENTCL_645", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_DOCUMENTCL_645)(view.version=1.0.0))")
,@Reference (name="QV_9533_13855",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_9533_13855)")
,@Reference(name="Q_DOCUMETN_9533",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_DOCUMETN_9533)(query.version=1.0.0))")
...
public class T_ASSTSRQAOEXFY_252 {

/*
 * Archivo: T_ASSTSEUQOESBB_349.java
 * Fecha: 2019-04-15T20:40:22Z
 *
 ...
 * T_ASSTSEUQOESBB_349 - MassivePayment 
 *
 * @autor designer
 */
@Path("/ASSTS/MNTNN/T_ASSTSEUQOESBB_349")
@Component
@Service({T_ASSTSEUQOESBB_349.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=MNTNN)(task.id=T_ASSTSEUQOESBB_349)(task.version=1.0.0))")
,@Reference(name="VW_MASSIVEPAN_263", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_MASSIVEPAN_263)(view.version=1.0.0))")
,@Reference (name="QV_3035_86132",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_3035_86132)")
,@Reference(name="Q_MASSIVEE_3035",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_MASSIVEE_3035)(query.version=1.0.0))")
...
public class T_ASSTSEUQOESBB_349 {

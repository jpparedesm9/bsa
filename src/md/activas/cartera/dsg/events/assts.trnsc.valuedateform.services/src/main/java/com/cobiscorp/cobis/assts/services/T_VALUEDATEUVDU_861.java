/*
 * Archivo: T_VALUEDATEUVDU_861.java
 * Fecha: 2016-10-25T15:21:48Z
 *
 ...
 * T_VALUEDATEUVDU_861 - ValueDateForm 
 *
 * @autor designer
 */
@Path("/ASSTS/TRNSC/T_VALUEDATEUVDU_861")
@Component
@Service({T_VALUEDATEUVDU_861.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=TRNSC)(task.id=T_VALUEDATEUVDU_861)(task.version=1.0.0))")
...
public class T_VALUEDATEUVDU_861 {

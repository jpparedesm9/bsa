/*
 * Archivo: T_LOANSEARCHSWA_959.java
 * Fecha: 2016-11-21T21:55:40Z
 *
 ...
 * T_LOANSEARCHSWA_959 - LoanSearchForm 
 *
 * @autor designer
 */
@Path("/ASSTS/CMMNS/T_LOANSEARCHSWA_959")
@Component
@Service({T_LOANSEARCHSWA_959.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=CMMNS)(task.id=T_LOANSEARCHSWA_959)(task.version=1.0.0))")
,@Reference(name="VW_LOANSEARCH_508", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_LOANSEARCH_508)(view.version=1.0.0))")
,@Reference (name="QV_3009_96085",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_3009_96085)")
,@Reference(name="Q_LOANDPQM_3009",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_LOANDPQM_3009)(query.version=1.0.0))")
...
public class T_LOANSEARCHSWA_959 {

/*
 * Archivo: T_ASSTSFIQJZFID_726.java
 * Fecha: 2018-01-26T20:38:46Z
 *
 ...
 * T_ASSTSFIQJZFID_726 - AccountStatusForm 
 *
 * @autor designer
 */
@Path("/ASSTS/TRNSC/T_ASSTSFIQJZFID_726")
@Component
@Service({T_ASSTSFIQJZFID_726.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=TRNSC)(task.id=T_ASSTSFIQJZFID_726)(task.version=1.0.0))")
,@Reference(name="VW_ACCOUNTSUS_859", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_ACCOUNTSUS_859)(view.version=1.0.0))")
,@Reference (name="QV_3580_21558",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_3580_21558)")
,@Reference(name="Q_ACCOUNSS_3580",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_ACCOUNSS_3580)(query.version=1.0.0))")
...
public class T_ASSTSFIQJZFID_726 {

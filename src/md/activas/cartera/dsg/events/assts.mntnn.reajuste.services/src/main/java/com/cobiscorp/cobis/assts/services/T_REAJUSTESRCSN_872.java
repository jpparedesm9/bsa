/*
 * Archivo: T_REAJUSTESRCSN_872.java
 * Fecha: 2016-10-28T14:30:41Z
 *
 ...
 * T_REAJUSTESRCSN_872 - REAJUSTE 
 *
 * @autor designer
 */
@Path("/ASSTS/MNTNN/T_REAJUSTESRCSN_872")
@Component
@Service({T_REAJUSTESRCSN_872.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=MNTNN)(task.id=T_REAJUSTESRCSN_872)(task.version=1.0.0))")
...
,@Reference(name="VW_REAJUSTECA_319", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_REAJUSTECA_319)(view.version=1.0.0))")
,@Reference (name="QV_5831_17646",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_5831_17646)")
,@Reference(name="Q_REAJUSBC_5831",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_REAJUSBC_5831)(query.version=1.0.0))")
...
public class T_REAJUSTESRCSN_872 {

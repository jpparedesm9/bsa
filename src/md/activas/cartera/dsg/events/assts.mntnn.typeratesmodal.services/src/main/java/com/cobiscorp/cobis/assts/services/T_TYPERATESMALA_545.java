/*
 * Archivo: T_TYPERATESMALA_545.java
 * Fecha: 2017-01-20T19:25:28Z
 *
 ...
 * T_TYPERATESMALA_545 - TypeRatesModal 
 *
 * @autor designer
 */
@Path("/ASSTS/MNTNN/T_TYPERATESMALA_545")
@Component
@Service({T_TYPERATESMALA_545.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=ASSTS)(task.submodule=MNTNN)(task.id=T_TYPERATESMALA_545)(task.version=1.0.0))")
,@Reference(name="VW_TYPERATESD_908", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_TYPERATESD_908)(view.version=1.0.0))")
...
public class T_TYPERATESMALA_545 {

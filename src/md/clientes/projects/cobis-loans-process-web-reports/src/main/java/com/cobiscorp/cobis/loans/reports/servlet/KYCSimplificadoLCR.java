...
@Properties({ @Property(name = ICOBISReportResourcesService.REPORTING_MODULE_FILTER, value = "cartera"), @Property(name = ICOBISReportResourcesService.REPORTING_NAME_FILTER, value = "kYCSimplificadoLCR") })
public class KYCSimplificadoLCR implements ICOBISReportResourcesService<JRBeanCollectionDataSource> {

	private static final ILogger logger = LogFactory.getLogger(KYCSimplificadoLCR.class);
	...
	public JRBeanCollectionDataSource getDatasourceReport(Map<String, Object> params) {
		logger.logError("*****>>Inicia - Reporte - kYCSimplificadoLCR Detalle");
		...
		try {
			logger.logError("*****>>Reporte - kYCSimplificadoLCR idTramite:" + applicationIn);
			...
			logger.logError("*****>>Error - Reporte - kYCSimplificadoLCR Detalle", e);
	...
	public Map<String, Object> getParamsReport(Map<String, Object> params) {
		logger.logError("*****>>Inicia - Reporte - kYCSimplificadoLCR");
	...
	public String getReportLocation(Map<String, Object> parameters) {
		return getFileLocationReport(ConstantValue.JasperPath.KYC_SIMP_LCR);
	}

	private String getFileLocationReport(String planPagosReportJasper) {
		return ConstantValue.JasperPath.KYC_SIMP_LCR;
	}

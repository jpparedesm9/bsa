...
@Properties({ @Property(name = ICOBISReportResourcesService.REPORTING_MODULE_FILTER, value = "cartera"),
		@Property(name = ICOBISReportResourcesService.REPORTING_NAME_FILTER, value = "SecureConsentInd") })
public class SecureConsentServletInd implements ICOBISReportResourcesService<JRBeanCollectionDataSource>, AssembleDataBean {

	private static final ILogger logger = LogFactory.getLogger(SecureConsentServletInd.class);
	...
	public String getReportLocation(Map<String, Object> params) {
		return getFileLocationReport(ConstantValue.JasperPath.PATH_SECURE_CONSENT_PRU_IND);
	}
	...
	private String getFileLocationReport(String jasperFile) {
		...
		return ConstantValue.JasperPath.PATH_SECURE_CONSENT_PRU_IND;
	}
	...
	public Map<String, Object> getParamsReport(Map<String, Object> params) {
		logger.logDebug("----->>>> SecureConsentServletInd -getParamsReport ");
		Method method = new Method();
		method.setPrmMain(params);
		try {
			params.put("urlPathWhatsapp", ConstantValue.Params.URLIMAG_WHATSAPP);
		} catch (Exception e) {
			logger.logDebug("Error SecureConsentServletInd -getParamsReport:", e);
			throw new RuntimeException("Error: SecureConsentServletInd -getParamsReport", e);
		}

/*
 * Archivo: T_CLCOLIQAJNDTG_333.java
 * Fecha: 2019-07-31T22:08:38Z
 *
 ...
 * T_CLCOLIQAJNDTG_333 - LoadCollectivePerson 
 *
 * @autor designer
 */
@Path("/CLCOL/CLTVO/T_CLCOLIQAJNDTG_333")
@Component
@Service({T_CLCOLIQAJNDTG_333.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=CLCOL)(task.submodule=CLTVO)(task.id=T_CLCOLIQAJNDTG_333)(task.version=1.0.0))")
,@Reference(name="VW_LOADCOLLEE_908", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_LOADCOLLEE_908)(view.version=1.0.0))")
,@Reference (name="QV_8718_49718",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_8718_49718)")
,@Reference(name="Q_COLLECON_8718",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_COLLECON_8718)(query.version=1.0.0))")
...
public class T_CLCOLIQAJNDTG_333 {

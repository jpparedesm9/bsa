...
import com.cobiscorp.ecobis.collective.commons.constants.Outputs;
...
public class CallServices extends BaseEvent {
	...
	public Map<String, Object> callServiceWithOutput(String requestName, Object object, String serviceId, ICommonEventArgs arg1) throws BusinessException {
		...
		try {
			...
			if (serviceResponse != null) {
				if (serviceResponse.isResult()) {
					...
					HashMap<String, Object> outputs = (HashMap<String, Object>) serviceResponseTO.getValue(Outputs.OUTPUT);
	...
	public Map<String, Object> callServiceWithOutputWithoutShowErrorMsg(String requestName, Object object, String serviceId, ICommonEventArgs arg1) throws BusinessException {
		if (LOGGER.isDebugEnabled())
			LOGGER.logDebug("Start callServiceWithOutput");
		try {
			ServiceRequestTO serviceRequestTO = new ServiceRequestTO();
			...
			if (serviceResponse != null) {
				if (serviceResponse.isResult()) {
					...
					for (Message message : serviceResponse.getMessages()) {
						LOGGER.logError("Error al procesar la informacion: "+message.getMessage());
						outputs = new HashMap<String, Object>();
						outputs.put("@o_msg", "Error al procesar la información. Por favor contacte al Administrador del Sistema");
					}
					return outputs;
				}
			}
	...
	public Object callServiceWithReturn(String requestName, Object object, String requestName1, Object object1, String serviceId, String returnValue, ICommonEventArgs arg1)
	...
	public <T> T[] callServiceWithReturnArray(String requestName, Object object, String requestName1, Object object1, String serviceId, String returnValue, ICommonEventArgs arg1)
			throws BusinessException {
		if (LOGGER.isDebugEnabled())
			LOGGER.logDebug("Start callServiceWithReturnArray");
		try {

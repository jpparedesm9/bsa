/*
 * Archivo: T_CLCOLWGNHFDMI_872.java
 * Fecha: 2019-12-03T20:44:50Z
 *
 ...
 */
package com.cobiscorp.cobis.clcol.services;
 ...
 * T_CLCOLWGNHFDMI_872 - CollectiveAdvisorsRoles 
 *
 * @autor designer
 */
@Path("/CLCOL/CLTVO/T_CLCOLWGNHFDMI_872")
@Component
@Service({T_CLCOLWGNHFDMI_872.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=CLCOL)(task.submodule=CLTVO)(task.id=T_CLCOLWGNHFDMI_872)(task.version=1.0.0))")
,@Reference(name="VW_COLLECTIVR_380", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_COLLECTIVR_380)(view.version=1.0.0))")
,@Reference (name="QV_7238_33339",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_7238_33339)")
,@Reference(name="Q_COLLECER_7238",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_COLLECER_7238)(query.version=1.0.0))")
...
public class T_CLCOLWGNHFDMI_872 {

/*
 * Archivo: T_REPORTGROUMTA_266.java
 * Fecha: 2017-04-03T19:08:51Z
 *
 ...
 * T_REPORTGROUMTA_266 - ReportGroupAccountStatement 
 *
 * @autor designer
 */
@Path("/LOANS/GROUP/T_REPORTGROUMTA_266")
@Component
@Service({T_REPORTGROUMTA_266.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=LOANS)(task.submodule=GROUP)(task.id=T_REPORTGROUMTA_266)(task.version=1.0.0))")
,@Reference(name="VW_REPORTGRTU_585", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_REPORTGRTU_585)(view.version=1.0.0))")
,@Reference (name="QV_4263_54550",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_4263_54550)")
,@Reference (name="QV_6897_70628",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_6897_70628)")
,@Reference(name="Q_CREDITYS_4263",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_CREDITYS_4263)(query.version=1.0.0))")
,@Reference(name="Q_PAYMENLA_6897",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_PAYMENLA_6897)(query.version=1.0.0))")
...
public class T_REPORTGROUMTA_266 {

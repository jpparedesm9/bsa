/*
 * Archivo: T_MEMBERQZIZWFM_852.java
 * Fecha: 2017-03-27T18:37:03Z
 *
 ...
 * T_MEMBERQZIZWFM_852 - MemberPopPupForm 
 *
 * @autor designer
 */
@Path("/LOANS/GROUP/T_MEMBERQZIZWFM_852")
@Component
@Service({T_MEMBERQZIZWFM_852.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=LOANS)(task.submodule=GROUP)(task.id=T_MEMBERQZIZWFM_852)(task.version=1.0.0))")
,@Reference(name="VW_MEMBERSSSM_132", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_MEMBERSSSM_132)(view.version=1.0.0))")
...
public class T_MEMBERQZIZWFM_852 {

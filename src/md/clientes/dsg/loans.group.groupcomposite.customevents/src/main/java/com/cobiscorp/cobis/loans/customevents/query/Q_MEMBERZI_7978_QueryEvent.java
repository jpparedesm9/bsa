/*
 * Archivo: Q_MEMBERZI_7978_QueryEvent.java
 ...
 * 
 * Q_MEMBERZI_7978_QueryEvent - MemberQuery
 * 
 * @autor designer
 */
@Component
@Service({ QueryEventBuilder.class })
@Properties(value = { @Property(name = "query.id", value = "Q_MEMBERZI_7978"), @Property(name = "query.version", value = "1.0.0") })
public class Q_MEMBERZI_7978_QueryEvent extends QueryEventBuilder {

	/**
	 * Instancia de Logger
	 */
	private static final ILogger logger = LogFactory.getLogger(Q_MEMBERZI_7978_QueryEvent.class);

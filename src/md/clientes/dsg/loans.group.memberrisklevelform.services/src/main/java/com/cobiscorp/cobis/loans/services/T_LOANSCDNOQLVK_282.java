/*
 * Archivo: T_LOANSCDNOQLVK_282.java
 * Fecha: 2018-05-08T23:17:35Z
 *
 ...
 * T_LOANSCDNOQLVK_282 - MemberRiskLevelForm 
 *
 * @autor designer
 */
@Path("/LOANS/GROUP/T_LOANSCDNOQLVK_282")
@Component
@Service({T_LOANSCDNOQLVK_282.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=LOANS)(task.submodule=GROUP)(task.id=T_LOANSCDNOQLVK_282)(task.version=1.0.0))")
,@Reference(name="VW_MEMBERRILL_911", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_MEMBERRILL_911)(view.version=1.0.0))")
,@Reference (name="QV_4750_20700",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_4750_20700)")
,@Reference (name="QV_2992_92227",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_2992_92227)")
,@Reference (name="QV_7416_36634",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_7416_36634)")
,@Reference(name="Q_QUALIFEL_7416",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_QUALIFEL_7416)(query.version=1.0.0))")
,@Reference(name="Q_QUALIFTC_2992",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_QUALIFTC_2992)(query.version=1.0.0))")
,@Reference(name="Q_RISKLELL_4750",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_RISKLELL_4750)(query.version=1.0.0))")
...
public class T_LOANSCDNOQLVK_282 {

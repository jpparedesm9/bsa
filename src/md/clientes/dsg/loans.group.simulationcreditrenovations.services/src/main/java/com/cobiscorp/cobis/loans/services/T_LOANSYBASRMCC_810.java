/*
 * Archivo: T_LOANSYBASRMCC_810.java
 * Fecha: 2021-02-17T20:59:28Z
 *
 ...
 * T_LOANSYBASRMCC_810 - SimulationCreditRenovations 
 *
 * @autor designer
 */
@Path("/LOANS/GROUP/T_LOANSYBASRMCC_810")
@Component
@Service({T_LOANSYBASRMCC_810.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=LOANS)(task.submodule=GROUP)(task.id=T_LOANSYBASRMCC_810)(task.version=1.0.0))")
,@Reference(name="VW_SIMULATISN_753", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_SIMULATISN_753)(view.version=1.0.0))")
,@Reference (name="QV_2798_99321",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_2798_99321)")
,@Reference(name="Q_INATIOOM_2798",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_INATIOOM_2798)(query.version=1.0.0))")
...
public class T_LOANSYBASRMCC_810 {

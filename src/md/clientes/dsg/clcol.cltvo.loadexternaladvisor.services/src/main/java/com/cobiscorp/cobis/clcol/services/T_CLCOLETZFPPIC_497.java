/*
 * Archivo: T_CLCOLETZFPPIC_497.java
 * Fecha: 2019-08-19T15:58:52Z
 *
 ...
 * T_CLCOLETZFPPIC_497 - LoadExternalAdvisor 
 *
 * @autor designer
 */
@Path("/CLCOL/CLTVO/T_CLCOLETZFPPIC_497")
@Component
@Service({T_CLCOLETZFPPIC_497.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=CLCOL)(task.submodule=CLTVO)(task.id=T_CLCOLETZFPPIC_497)(task.version=1.0.0))")
,@Reference(name="VW_LOADEXTEVA_757", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_LOADEXTEVA_757)(view.version=1.0.0))")
,@Reference (name="QV_3718_27394",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_3718_27394)")
,@Reference(name="Q_COLLECRT_3718",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_COLLECRT_3718)(query.version=1.0.0))")
...
public class T_CLCOLETZFPPIC_497 {

/*
 * Archivo: T_LOANSKVAEOTPS_336.java
 * Fecha: 2021-01-12T15:48:06Z
 *
 ...
 * T_LOANSKVAEOTPS_336 - AmortizationTable 
 *
 * @autor designer
 */
@Path("/LOANS/GROUP/T_LOANSKVAEOTPS_336")
@Component
@Service({T_LOANSKVAEOTPS_336.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=LOANS)(task.submodule=GROUP)(task.id=T_LOANSKVAEOTPS_336)(task.version=1.0.0))")
,@Reference(name="VW_AMORTIZAII_796", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_AMORTIZAII_796)(view.version=1.0.0))")
,@Reference (name="QV_6763_19315",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_6763_19315)")
,@Reference(name="Q_AMORTIOZ_6763",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_AMORTIOZ_6763)(query.version=1.0.0))")
...
public class T_LOANSKVAEOTPS_336 {

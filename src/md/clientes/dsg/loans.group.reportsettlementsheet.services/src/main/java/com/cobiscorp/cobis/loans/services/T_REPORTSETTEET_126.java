/*
 * Archivo: T_REPORTSETTEET_126.java
 * Fecha: 2017-04-03T20:29:24Z
 *
 ...
 * T_REPORTSETTEET_126 - ReportSettlementSheet 
 *
 * @autor designer
 */
@Path("/LOANS/GROUP/T_REPORTSETTEET_126")
@Component
@Service({T_REPORTSETTEET_126.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=LOANS)(task.submodule=GROUP)(task.id=T_REPORTSETTEET_126)(task.version=1.0.0))")
,@Reference(name="VW_REPORTSEEL_621", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_REPORTSEEL_621)(view.version=1.0.0))")
,@Reference (name="QV_4247_30477",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_4247_30477)")
,@Reference(name="Q_CLEARATE_4247",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_CLEARATE_4247)(query.version=1.0.0))")
...
public class T_REPORTSETTEET_126 {

/*
 * Archivo: T_GROUPCOMPOIET_974.java
 * Fecha: 2017-05-17T16:31:53Z
 *
 ...
 * T_GROUPCOMPOIET_974 - GroupComposite 
 *
 * @autor designer
 */
@Path("/LOANS/GROUP/T_GROUPCOMPOIET_974")
@Component
@Service({T_GROUPCOMPOIET_974.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=LOANS)(task.submodule=GROUP)(task.id=T_GROUPCOMPOIET_974)(task.version=1.0.0))")
,@Reference(name="VW_HEADERGROO_993", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_HEADERGROO_993)(view.version=1.0.0))")
,@Reference(name="VW_GROUPPIPQE_725", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_GROUPPIPQE_725)(view.version=1.0.0))")
,@Reference(name="VW_MEMBERGQEI_848", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_MEMBERGQEI_848)(view.version=1.0.0))")
,@Reference (name="QV_7978_25243",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_7978_25243)")
,@Reference(name="VW_AMOUNTPOKC_190", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_AMOUNTPOKC_190)(view.version=1.0.0))")
,@Reference (name="QV_6248_19660",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_6248_19660)")
,@Reference(name="Q_MEMBERZI_7978",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_MEMBERZI_7978)(query.version=1.0.0))")
,@Reference(name="Q_AMOUNTKL_6248",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_AMOUNTKL_6248)(query.version=1.0.0))")
...
public class T_GROUPCOMPOIET_974 {

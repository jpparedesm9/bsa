/*
 * Archivo: T_LOANSUAYYOAVM_556.java
 * Fecha: 2019-12-19T22:31:23Z
 *
 ...
 * T_LOANSUAYYOAVM_556 - ExclusionList 
 *
 * @autor designer
 */
@Path("/LOANS/GROUP/T_LOANSUAYYOAVM_556")
@Component
@Service({T_LOANSUAYYOAVM_556.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=LOANS)(task.submodule=GROUP)(task.id=T_LOANSUAYYOAVM_556)(task.version=1.0.0))")
,@Reference(name="VW_EXCLUSIOTS_111", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_EXCLUSIOTS_111)(view.version=1.0.0))")
,@Reference (name="QV_9905_87019",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_9905_87019)")
,@Reference(name="Q_EXCLUSIR_9905",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_EXCLUSIR_9905)(query.version=1.0.0))")
...
public class T_LOANSUAYYOAVM_556 {

/*
 * Archivo: T_LOANSCAIEJKDY_486.java
 * Fecha: 2017-06-28T16:57:19Z
 *
 ...
 * T_LOANSCAIEJKDY_486 - ScannedDocuments 
 *
 * @autor designer
 */
@Path("/LOANS/GROUP/T_LOANSCAIEJKDY_486")
@Component
@Service({T_LOANSCAIEJKDY_486.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=LOANS)(task.submodule=GROUP)(task.id=T_LOANSCAIEJKDY_486)(task.version=1.0.0))")
...
,@Reference(name="VW_SCANNEDDCS_539", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_SCANNEDDCS_539)(view.version=1.0.0))")
,@Reference (name="QV_1763_79525",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_1763_79525)")
,@Reference(name="Q_DEBTORJD_1763",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_DEBTORJD_1763)(query.version=1.0.0))")
...
public class T_LOANSCAIEJKDY_486 {

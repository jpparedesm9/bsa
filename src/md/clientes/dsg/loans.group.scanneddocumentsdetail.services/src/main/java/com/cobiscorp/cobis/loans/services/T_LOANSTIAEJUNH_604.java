/*
 * Archivo: T_LOANSTIAEJUNH_604.java
 * Fecha: 2017-06-27T22:08:39Z
 *
 ...
 * T_LOANSTIAEJUNH_604 - ScannedDocumentsDetail 
 *
 * @autor designer
 */
@Path("/LOANS/GROUP/T_LOANSTIAEJUNH_604")
@Component
@Service({T_LOANSTIAEJUNH_604.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=LOANS)(task.submodule=GROUP)(task.id=T_LOANSTIAEJUNH_604)(task.version=1.0.0))")
,@Reference(name="VW_SCANNEDDUE_904", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_SCANNEDDUE_904)(view.version=1.0.0))")
,@Reference (name="QV_6397_58590",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_6397_58590)")
,@Reference(name="Q_SCANNEDD_6397",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_SCANNEDD_6397)(query.version=1.0.0))")
...
public class T_LOANSTIAEJUNH_604 {

    ...
    <html xmlns="http://www.w3.org/1999/xhtml">
      ...
      <body>
        <div id="main">
          ...
          <div id="content">
            <p>
              Estimado <xsl:value-of select="asesor"/>
            </p>
            <br/>
            <br/>
            <p>
              Te informamos que se autorizó por verificación biométrica, la contratación del crédito
              <xsl:value-of select="tipoCredito"/><a> </a>
              <strong><xsl:value-of select="numeroCredito"/></strong> del cliente <strong><xsl:value-of select="cliente"/></strong> con id <strong><xsl:value-of select="documento"/></strong>, el <xsl:value-of select="fechaHora"/> hrs, en la sucursal Tuiio Santander <xsl:value-of select="sucursal"/>.
            </p>
            <br/>
            <br/>
            <p>Para dudas o aclaraciones contacta nuestro centro de contacto Tuiio: 

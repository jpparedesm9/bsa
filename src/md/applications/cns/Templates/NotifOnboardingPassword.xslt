            ...
            <td>
              ...
              <div id="content" class="content">
                <div id="transaction-content" class="transaction-zone">				
				  ...
				  <br></br>				  
                  <p>
                    <i>Es un gusto informarte que la formalización de tu 
				       <span>
				  ...
				  <br></br>
				  <p> <i>Derivado de lo anterior, por este medio te compartimos la contraseña que le servirá para abrir los archivos que le llegarán en un correo posterior</i></p>
				  <br></br>
				  <div  id="title" class="title">
				    <span> CONTRASEÑA: 
                      <xsl:value-of select="buc" />
                    </span>
				  </div>
				  <br></br>
                  <p><i>En caso de cualquier duda o aclaración ponemos a tu disposición nuestro centro de contacto TUIIO: 5551694363</i></p>
				  <br></br>					  
                </div>	     
              </div>
			</td>		

      ...
      <body>
        <div id="main">
          ...
          <div id="content">
            ...
            <br/>
            <p>
              Queremos ayudarte con el control de tu crédito, por ello te informamos  el monto que tienes que pagar por tu crédito de manera <xsl:value-of select="cab/dividendo"/>, mismo que debes depositar antes del día <xsl:value-of select="cab/dia"/>, recuerda que tu cumplimiento te abre nuevas oportunidades de créditos y beneficios únicos para ti. 
            </p>
			<br/>
			<p>
              En Tuiio agradecemos tu esfuerzo y responsabilidad.

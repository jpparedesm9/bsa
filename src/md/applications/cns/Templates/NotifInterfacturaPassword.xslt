            ...
            <td>
              ...
              <div id="content" class="content">
                <div id="transaction-content" class="transaction-zone">
				  ...
				  <br></br>				  
                  <p>
                    A continuación se encuentra la contraseña que le servirá para abrir el archivo de Estado de Cuenta que le llegará en un correo posterior.
                  </p>
				  <br></br>
				  <p> De no llegarle el Estado de Cuenta, por favor comuníquese con su Asesor de Crédito.</p>
				  <br></br>

      ...
      <body>
        <div id="main">
          ...
          <div id="content">
            ...
            <br/>
            <p>
              En Tuiio reconocemos el esfuerzo que has realizado hasta el día de hoy para lograr cumplir tus metas diarias, es momento de realizar el depósito de tu ahorro mismo que será solo el inicio, recuerda que este ahorro es tuyo y será para que cumplas lo que ya te propusiste.
            </p>
			<br/>
			<p>
              Tu aportación inicial lo debes depositar en los medios donde te informaron en el espacio Tuiio, ten a la mano o imprime la referencia que se incluye en este correo para realizarlo
			</p>
            <br/>            
            <br/>
            <p>

...
public class CopiaReportesInclusionFiancieraB extends NotificationGeneric implements Job {
	private static final Logger LOGGER = Logger.getLogger(CopiaReportesInclusionFiancieraB.class);
    ...
    public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
		CopyFileJob copyFileJob = new CopyFileJob(FileJob.Job.CPYINFB);
		try {
			...
			LOGGER.error("Error al copiar Reportes Inclusion Financiera B FileShare: ", ex);
		}
    }

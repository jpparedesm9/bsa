...
public class AccountStatusMovementDTO {
	...
	private Double ivacomisionGastoCobranza;
	private Double ivacomisionDisposicion;
	...
	public Double getIvacomisionGastoCobranza() {
		return ivacomisionGastoCobranza;
	}

	public void setIvacomisionGastoCobranza(Double ivacomisionGastoCobranza) {
		this.ivacomisionGastoCobranza = ivacomisionGastoCobranza;
	}

	public Double getIvacomisionDisposicion() {
		return ivacomisionDisposicion;
	}

	public void setIvacomisionDisposicion(Double ivacomisionDisposicion) {
		this.ivacomisionDisposicion = ivacomisionDisposicion;
	}

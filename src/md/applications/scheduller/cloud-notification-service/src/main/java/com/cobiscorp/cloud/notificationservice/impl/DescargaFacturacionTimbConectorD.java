...
public class DescargaFacturacionTimbConectorD extends NotificationGeneric implements Job {
	private static final Logger LOGGER = Logger.getLogger(DescargaFacturacionTimbConectorD.class);
	...
	private void downloadDirectDebits() {
		...
		DownloadMultiFileJob downloadDirectDebitsJob = new DownloadMultiFileJob(FileExchangeJob.Job.DAFACCD);

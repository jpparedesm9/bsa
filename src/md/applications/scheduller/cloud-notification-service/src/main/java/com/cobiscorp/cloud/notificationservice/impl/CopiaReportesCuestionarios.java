...
/* REQ#1538743 */
public class CopiaReportesCuestionarios extends NotificationGeneric implements Job {
	private static final Logger LOGGER = Logger.getLogger(CopiaReportesCuestionarios.class);
    private static final String messageOk = "COPIA EXITOSA ARCHIVOS REPORTES CUESTIONARIOS!!";
    ...
    public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
		CopyFileJob copyFileJob = new CopyFileJob(FileJob.Job.CPYRCU);
		try {
			...
			LOGGER.error("Error al copiar Reportes Cuestionarios: ", ex);
		}
    }

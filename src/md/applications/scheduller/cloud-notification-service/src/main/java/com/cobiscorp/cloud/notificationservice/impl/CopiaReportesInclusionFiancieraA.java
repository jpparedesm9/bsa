...
public class CopiaReportesInclusionFiancieraA extends NotificationGeneric implements Job {
	private static final Logger LOGGER = Logger.getLogger(CopiaReportesInclusionFiancieraA.class);
    private static final String messageOk = "COPIA EXITOSA ARCHIVOS REPORTES DE INCLUSION FINANCIRA FILESHARE!!";
    ...
    public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
		CopyFileJob copyFileJob = new CopyFileJob(FileJob.Job.CPYINFA);
		try {
			...
			LOGGER.error("Error al copiar Reportes Inclusion Financiera A FileShare: ", ex);
		}
    }

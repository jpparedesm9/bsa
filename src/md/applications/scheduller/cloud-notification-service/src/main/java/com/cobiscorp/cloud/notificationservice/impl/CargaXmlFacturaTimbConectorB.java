...
public class CargaXmlFacturaTimbConectorB extends NotificationGeneric implements Job {
	private static final Logger LOGGER = Logger.getLogger(CargaXmlFacturaTimbConectorB.class);
	...
	private void loadInsuranceReports() {
		...
		UploadFileJob uploadFileJob = new UploadFileJob(FileExchangeJob.Job.CAFACCB);

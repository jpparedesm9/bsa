...
public class CopiaReporteGeolocalizacion extends NotificationGeneric implements Job {
	private static final Logger LOGGER = Logger.getLogger(CopiaReporteGeolocalizacion.class);
    private static final String messageOk = "COPIA EXITOSA ARCHIVOS REPORTE GEOLOCALIZACION FILESHARE!!";
    ...
    public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
		CopyFileJob copyFileJob = new CopyFileJob(FileJob.Job.CPYRGE);
		try {
			...
			LOGGER.error("Error al copiar Reporte Geolocalizacion FileShare: ", ex);
		}
    }

...
public class CopiaReporteMovtosContab extends NotificationGeneric implements Job {
	private static final Logger LOGGER = Logger.getLogger(CopiaReporteMovtosContab.class);
    private static final String messageOk = "CARGA EXITOSA DEL ARCHIVO REPORTE MOVIMIENTOS CONTABLES!!!";
    ...
    public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
		CopyFileJob copyFileJob = new CopyFileJob(FileJob.Job.CPYMC);
		try {
			...
			LOGGER.error("Error al copiar Reportes Movimientos Contables: ", ex);
		}
    }

...
public class CargaXmlFacturaTimbConectorD extends NotificationGeneric implements Job {
	private static final Logger LOGGER = Logger.getLogger(CargaXmlFacturaTimbConectorD.class);
	...
	private void loadInsuranceReports() {
		...
		UploadFileJob uploadFileJob = new UploadFileJob(FileExchangeJob.Job.CAFACCD);

...
public class CargaReporteSeguros extends NotificationGeneric implements Job {
    private static final Logger LOGGER = Logger.getLogger(CargaReporteSeguros.class);
    private static final String messageOk = "CARGA EXITOSA DEL ARCHIVO DE REPORTE DE SEGUROS !!";
    ...
    public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
        try {
            ...
            LOGGER.error("Error al ejecutar Carga de Reporte de Seguros: ", ex);
    ...
    private void loadInsuranceReports() {
        ...
        UploadFileJob uploadFileJob = new UploadFileJob(FileExchangeJob.Job.CRGRS);
...
*/
            ...
            while (retry <= uploadFileJob.getRetryUpload()) {
                LOGGER.debug("Intento de carga de Reporte de Seguros #" + retry);

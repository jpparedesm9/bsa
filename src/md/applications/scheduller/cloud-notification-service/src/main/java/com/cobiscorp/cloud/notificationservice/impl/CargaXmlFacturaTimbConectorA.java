...
public class CargaXmlFacturaTimbConectorA extends NotificationGeneric implements Job {
	private static final Logger LOGGER = Logger.getLogger(CargaXmlFacturaTimbConectorA.class);
	...
	private void loadInsuranceReports() {
		...
		UploadFileJob uploadFileJob = new UploadFileJob(FileExchangeJob.Job.CAFACCA);

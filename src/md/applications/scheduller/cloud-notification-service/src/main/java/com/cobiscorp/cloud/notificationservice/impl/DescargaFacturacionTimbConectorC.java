...
public class DescargaFacturacionTimbConectorC extends NotificationGeneric implements Job {
	private static final Logger LOGGER = Logger.getLogger(DescargaFacturacionTimbConectorC.class);
	...
	private void downloadDirectDebits() {
		...
		DownloadMultiFileJob downloadDirectDebitsJob = new DownloadMultiFileJob(FileExchangeJob.Job.DAFACCC);

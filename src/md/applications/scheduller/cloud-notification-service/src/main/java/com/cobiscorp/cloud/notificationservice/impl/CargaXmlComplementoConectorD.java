...
public class CargaXmlComplementoConectorD extends NotificationGeneric implements Job {
    private static final Logger LOGGER = Logger.getLogger(CargaXmlComplementoConectorD.class);

...
public class EnvioSmsCobranzas extends NotificationGeneric implements Job {

	private static final Logger LOGGER = Logger.getLogger(EnvioSmsCobranzas.class);
	...
	public void executeNotification(Connection cn, CallableStatement executeSP) throws Exception {
		...
		String query = "{ call cob_cartera..sp_envio_sms_cobranza() }";

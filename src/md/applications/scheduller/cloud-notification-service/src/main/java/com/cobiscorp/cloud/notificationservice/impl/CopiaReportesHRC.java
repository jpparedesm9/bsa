...
public class CopiaReportesHRC extends NotificationGeneric implements Job {
	private static final Logger LOGGER = Logger.getLogger(CopiaReportesHRC.class);
    private static final String messageOk = "COPIA EXITOSA ARCHIVOS REPORTES HRC FILESHARE!!";
    ...
    public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
		CopyFileJob copyFileJob = new CopyFileJob(FileJob.Job.CPYHRC);
		try {
			...
			LOGGER.error("Error al copiar Reportes HRC FileShare: ", ex);
		}
    }

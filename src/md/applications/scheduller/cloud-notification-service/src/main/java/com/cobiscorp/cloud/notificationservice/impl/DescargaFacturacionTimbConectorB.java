...
public class DescargaFacturacionTimbConectorB extends NotificationGeneric implements Job {
	private static final Logger LOGGER = Logger.getLogger(DescargaFacturacionTimbConectorB.class);
	...
	private void downloadDirectDebits() {
		...
		DownloadMultiFileJob downloadDirectDebitsJob = new DownloadMultiFileJob(FileExchangeJob.Job.DAFACCB);

...
public class CopiaReportesContabilidad extends NotificationGeneric implements Job {
	private static final Logger LOGGER = Logger.getLogger(CopiaReportesContabilidad.class);
    private static final String messageOk = "COPIA EXITOSA ARCHIVOS REPORTES DE CONTABILIDAD FILESHARE!!";
    ...
    public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
		CopyFileJob copyFileJob = new CopyFileJob(FileJob.Job.CPYCTFS);
		try {
			...
			LOGGER.error("Error al copiar Reportes Contabilidad FileShare: ", ex);
		}
    }

/*****************************************************************/
/*   ARCHIVO:       sp_ing_info_gen_xml_refacturacion_timbrado.sp*/
/*   NOMBRE LOGICO: sp_ing_info_gen_xml_refacturacion_timbrado.sp*/
/*   PRODUCTO:        		                                     */
/*****************************************************************/
/*                     IMPORTANTE                                */
...
if exists(select 1 from sysobjects where name = 'sp_ing_info_gen_xml_refacturacion_timbrado')
    drop proc sp_ing_info_gen_xml_refacturacion_timbrado
go

create proc sp_ing_info_gen_xml_refacturacion_timbrado (
...
print 'Inicio proceso sp_ing_info_gen_xml_refacturacion_timbrado para: Anio:' + convert(varchar(4), year(@i_param1)) 
...
print 'Continua-sp_ing_info_gen_xml_refacturacion_timbrado'

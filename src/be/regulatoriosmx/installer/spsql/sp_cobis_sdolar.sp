/*************************************************************************/
/*   Archivo:              sp_cobis_sdolar.sp		                     */
/*   Stored procedure:     sp_cobis_sdolar                               */
...
/*************************************************************************/
/*                                   PROPOSITO                           */
/*   Genera reporte COBIS_SDOLAR_AAAAMMDD.txt del requerimiento 172199   */
/*                                                                       */
...
IF OBJECT_ID ('dbo.sp_cobis_sdolar') IS NOT NULL
	DROP PROCEDURE dbo.sp_cobis_sdolar
GO

CREATE proc [dbo].[sp_cobis_sdolar](
   @i_param1  DATETIME
)
AS
...
--Reporte 6.10 COBIS_SDOLAR_AAAAMMDD.txt
...
IF OBJECT_ID('tempdb..##tmp_cobis_sdolar') IS NOT NULL DROP TABLE ##tmp_cobis_sdolar
...
DELETE FROM ##tmp_cobis_sdolar
WHERE datos IS NULL

select @w_reporte = 'COBIS_SDOLAR_'
select @w_sql = 'select * from ##tmp_cobis_sdolar'

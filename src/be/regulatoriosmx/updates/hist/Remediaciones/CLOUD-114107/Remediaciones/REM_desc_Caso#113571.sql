...
and bo_cliente in (986,1613) --- AQUI COLOCAR LA LISTA DE CLIENTES A ALINEAR PREVIO A ANALISIS DE CADA CASO
...
WHERE tr_ofi_usu IN (9002, 9001, 1) AND tr_estado = 'ING'
go

use cob_cartera
go
SELECT cp_producto_reversa, * 
from cob_cartera..ca_producto where cp_producto in ('GAR_DEB')

UPDATE cob_cartera..ca_producto
SET    cp_producto_reversa = 'GAR_DEB'
WHERE  cp_producto in ('GAR_DEB')

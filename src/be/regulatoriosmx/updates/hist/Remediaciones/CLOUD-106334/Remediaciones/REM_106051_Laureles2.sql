...
--SOLICITO DE SU APOYO PARA REALIZAR LA CORRECCIO EN REPORTE LA OFICINA 
--QUE APARECE ES INCORRECTA,ESTÁ ASIGNADA A RENACIMIENTO Y LA CORRECTA ES 
--YAUTEPEC, ANEXO  LAS PANTALLAS.
...
-- no aplica 'antes (1037 como oficina y 267 como oficial cuando este oficial es de la ofi 1039 )' por que la data esta mezclada 
insert into #grupos values (1587,267) 

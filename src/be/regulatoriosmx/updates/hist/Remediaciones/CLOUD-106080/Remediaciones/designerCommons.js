        ...
        function ($q, $window, $rootScope) {
            return {
                response: function (response) {
                    if (angular.isDefined(response.data) && response.data !== null && angular.isDefined(response.data.success)) {
                ...
                responseError: function (response) {
                    ...
                    } else if (angular.isDefined(response.data) && response.data !== null && angular.isDefined(response.data.success)) {
                        hideLoader();
                    }

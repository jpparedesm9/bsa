...
create table #clientes ( cliente int null) 


insert into #clientes values (2894)
insert into #clientes values (5707)
insert into #clientes values (5735)
insert into #clientes values (5911)
insert into #clientes values (6042)
insert into #clientes values (6343)
insert into #clientes values (6348)
insert into #clientes values (6402)
insert into #clientes values (3528)
...
while (1=1) begin 
   ...
   --
   if   (select  abs(sum(bo_diferencia)) from cb_boc  where bo_cliente =  @w_cliente ) > 0.03 begin 

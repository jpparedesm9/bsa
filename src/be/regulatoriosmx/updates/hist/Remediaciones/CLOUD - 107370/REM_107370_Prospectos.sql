...
--ASESOR ACTUAL: Karla Rosas Gonzalez krosasgo 222
--ASESOR PARA REASIGNAR: Jesús Juárez Peña jjuarezpe  164
--
--PROSPECTO:
--
--Rocio Reyes Rivera (22254)
--Elisa Francisco Chávez (26258)
...
select @w_funcionario_dest =  164

create table #prospectos(ente int)

insert into #prospectos values (22254),(26258)

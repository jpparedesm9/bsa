...
where  fu_login = 'yyortega'

if @@rowcount > 0 begin
   insert into #grupos values (511, @w_oficial_dest)
end


select @w_oficial_dest = fu_funcionario  
from  cobis..cl_funcionario
where  fu_login = 'ejjimenez'

if @@rowcount > 0 begin
   insert into #grupos values (1413, @w_oficial_dest)
   insert into #grupos values (1408, @w_oficial_dest)
end

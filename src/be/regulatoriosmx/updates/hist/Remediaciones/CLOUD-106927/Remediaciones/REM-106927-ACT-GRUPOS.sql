--ASESOR ASIGNADO: BERTHA CORINA LIRA DE LA CRUZ USUARIO: bclira
--ASESOR A REASIGNAR: CLAUDIA IVET LOPEZ NAVA USUARIO: clopez
--
--GRUPO:
--902 - AMISTAD
--872 - CAMINO AL ÉXITO
...
--687 - MAR DE ROSAS
--685 - REENCUENTRO
--854 - UNION Y ESFUERZO
--951 - RANCHITO
--
--ASESOR ASIGNADO: BERTHA CORINA LIRA DE LA CRUZ USUARIO: bclira
--ASESOR A REASIGNAR: YOSHIO CESAR RAMIREZ PEXO USUARIO: ycramirez
--
--904- -ALMAS ALEGRES
--598 - BELLAS FLORECITAS
--721 - LA ASUNCION
--730 - NEPO
--599 -SAN MIGUE
...
where  fu_login = 'clopez'

if @@rowcount > 0 begin
   insert into #grupos values (902, @w_oficial_dest)
   insert into #grupos values (872, @w_oficial_dest)
   insert into #grupos values (1392, @w_oficial_dest)
   insert into #grupos values (808, @w_oficial_dest)
   insert into #grupos values (687, @w_oficial_dest)
   insert into #grupos values (685, @w_oficial_dest)
   insert into #grupos values (854, @w_oficial_dest)
   insert into #grupos values (951, @w_oficial_dest)
...
select @w_oficial_dest = fu_funcionario  
from  cobis..cl_funcionario
where  fu_login = 'ycramirez'

if @@rowcount > 0 begin
   insert into #grupos values (904, @w_oficial_dest)
   insert into #grupos values (598, @w_oficial_dest)
   insert into #grupos values (721, @w_oficial_dest)
   insert into #grupos values (730, @w_oficial_dest)
   insert into #grupos values (599, @w_oficial_dest)
end

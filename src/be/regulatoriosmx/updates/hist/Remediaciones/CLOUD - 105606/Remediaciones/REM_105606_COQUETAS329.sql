...
--SOLICITAMOS DE SU APOYO PARA LA REASIGNACION DE DEL GRUPO:
--ASESOR ASIGNADO: FELIPE ALEJANDRO JACOBO TAPIA  Usuario: fjacobo
--ASESOR A REASIGNAR: JHONATAN ANTONIO RIVERA NUÑEZ  Usuario: jarivera --249
--GRUPOS:
--329 — LAS COQUETAS

insert into #grupos values (329, 249)-- antes 135

...
--ASESOR ASIGNADO: ALBERTO SANDOVAL BARRIOS USUARIO: asandovalba  58
--ASESOR A REASIGNAR: JUAN RICARDO ESPINOSA DE LA ROSA USUARIO: jrespinosa 316
--
--PROSPECTO:
--
--4588 - JUANA BAUTISTA RAMÍREZ
...
select @w_funcionario_dest =  316

create table #prospectos(ente int)

insert into #prospectos values (4588)

...
/*
ASESOR ASIGNADO: JAVIER GARCIA LORENZO  USUARIO: FJGARCIALO (34)
ASESOR A REASIGNAR: ESPINOSA DE LA ROSA JUAN RICARDO USUARIO: JRESPINOSA (316)

GRUPOS:
907 - DUMMY
650 - ESTRELLAS DORADAS
232 - FE Y ESPERANZA
414 - GRANDES ESPERANZAS
1123 - KIKAS
383 - LUCERO 
434 - LUNA MIMI
2 - MUJERES GUERRERAS
...
insert into #grupos values (907  ,316)
insert into #grupos values (650  ,316)
insert into #grupos values (232  ,316)
insert into #grupos values (414  ,316)
insert into #grupos values (1123 ,316)
insert into #grupos values (383  ,316)
insert into #grupos values (434  ,316)
insert into #grupos values (2    ,316)

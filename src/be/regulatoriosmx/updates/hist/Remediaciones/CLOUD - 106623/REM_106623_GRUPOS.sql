--ASESOR ACTUAL: MONICA MONSERRAT LANDA ALARCON (mmlanda) --141
--ASESOR PARA REASIGNAR: YAMIDT ITZEL CEDILLO SANCHEZ (yicedillo) --189
--
--753 AZLAN
--587 ERANDI NEZA
--638 JHESUA
...
insert into #grupos values (753,189)
insert into #grupos values (587,189)
insert into #grupos values (638,189)
insert into #grupos values (524,189)

--ASESOR ASIGNADO: URBANO CONCHILLOS HERNANDEZ USUARIO: uconchillos -- 156
--ASESOR A REASIGNAR: YAMIDT ITZEL CEDILLOS SANCHEZ USUARIO: yicedillo -- 189
--CLIENTE:
--5636 - MARLENE HERNANDEZ MIRANDA --prospecto
--22332 - DIANA FLORES GUZMAN --prospecto
--19193 - MIRIAM LARA MORALES --prospecto
...
select @w_funcionario_dest =  189 -- antes 156
   ...
   where  en_ente in (5636, 22332, 19193)

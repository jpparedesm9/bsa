--ASESOR ASIGNADO: RAFAEL ROBERTO GARCÍA SÁNCHEZ USUARIO: rrgarciasa 152
--ASESOR A REASIGNAR: KARLA ROSAS GONZÁLEZ USUARIO: krosasgo 222
--
--PROSPECTO:
--17516 - EVELIA NAVOR REYES 
--17753 - EFRAIN VENTURA REYES
...
select @w_funcionario_dest =  152

create table #prospectos(ente int)

insert into #prospectos values (17516),(17753)

--ASESOR ASIGNADO: MARTHA GUADALUPE NOLASCO USUARIO: mgnolasco -- 185
--ASESOR A REASIGNAR: GUADALUPE SUSANA ROSALES PEREZ USUARIO: gsrosales -- 171
--CLIENTE:
--31128 - FRANCISCA AVILA BRAVO
...
select @w_funcionario_dest =  171 -- antes 185

/************************************************************************/
/*   Archivo:              riesgo_mora_95539.sp                         */
/*   Stored procedure:     sp_riesgo_mora_95539                         */
...
create proc sp_riesgo_mora_95539
(
...
select @w_sp_name = 'sp_riesgo_mora_95539',
       @w_fecha_ini = @i_fecha_ini,
       @w_fecha_fin = @i_fecha_fin
...
if datediff(dd,@w_fecha_ini, @w_fecha_fin) < 0
   return 0

select
@w_ruta_arch    = ba_path_destino,
@w_nombre_arch  = ba_arch_resultado + '_95539_' + replace(convert(varchar(10), @w_fecha_fin, 127), '-', '_')
from cobis..ba_batch
...
group by tr_operacion, di_dividendo
...
and   di_dividendo = ult_dividendo
and   tr_operacion = operacion
...
sa_dividendo  = di_dividendo,
sa_saldo = isnull(sum(case when (am_dividendo >= di_dividendo) then am_cuota - am_pagado else 0 end),0)
into #saldocapital
from cob_cartera..ca_amortizacion, #saldos
where am_operacion  = operacion
and   am_concepto   = 'CAP'
group by operacion, di_dividendo
...
seginire       = '0000000000000.00',                                                  --12
gasinire       = '0000000000000.00',                                                  --13
...
ivagasinire    = '0000000000000.00',                                                  --16
ivaseginire    = '0000000000000.00',                                                  --17
...
segrecre       = '0000000000000.00',                                                  --21
gasrecre       = '0000000000000.00',                                                  --22
...
ivagasrecre    = '0000000000000.00',                                                  --25
ivasegrecre    = '0000000000000.00',                                                  --26
coemora        = '0000000000000.00',                                                  --27
coemosus       = '00000.00',                                                          --28
coemopen       = '0000000.00',                                                        --29
...
morapend       = '0000000000000.00',                                                  --38
intrefin       = '0000000000000.00',                                                  --39
tipcamb        = '00000000.00',                                                       --40
...
capinirea      = '0000000000000.00',                                                  --46
intinirea      = '0000000000000.00',                                                  --47
pagogob        = '0000000000000.00',                                                  --48
pagban         = '0000000000000.00',                                                  --49
intrefina      = '0000000000000.00',                                                  --50
salteora       = '0000000000000.00',                                                  --51
intmora        = '0000000000000.00',                                                  --52
intmoran       = '0000000000000.00',                                                  --53
intmorac       = '0000000000000.00',                                                  --54
ivamora        = '0000000000000.00',                                                  --55
...
combcoini      = '0000000000000.00',                                                  --60
comfovini      = '0000000000000.00',                                                  --61
combcorec      = '0000000000000.00',                                                  --62
comfovrec      = '0000000000000.00',                                                  --63
sitpago        = case di_estado when @w_est_cancelado then '0' else '1' end,          --64
grupoid        = cob_cartera.dbo.LlenarI(cast(cast(grupoid as int) as varchar),  '0', 16),
nrociclo       = cob_cartera.dbo.LlenarI(cast(cast(nrociclo as int) as varchar), '0', 4),
grupoint       = cob_cartera.dbo.LlenarI(cast(cast(grupoint as int) as varchar), '0', 4)
from #saldos
...
select @w_destino = @w_ruta_arch + @w_nombre_arch + '.txt',
       @w_errores = @w_nombre_arch + @w_nombre_arch + '.err'

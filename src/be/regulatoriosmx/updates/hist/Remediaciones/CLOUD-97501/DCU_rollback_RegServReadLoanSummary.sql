...
/*DeleteRelation*/
	...
	if exists (select 1 from cts_serv_catalog where csc_service_id = 'Loan.LoansQueries.ReadLoanSummary')
	    DELETE cts_serv_catalog where csc_service_id = 'Loan.LoansQueries.ReadLoanSummary'			
end
else
begin

...
select @w_grupo = 173
select @w_oficial_login = 'erlino' -- antes erlino
select @w_oficial_cod = 99 -- 99 antes
select @w_oficina = 3351 -- 3351 antes
...
set tr_gerente = 99 
where tr_operacion in (47423,47426,47429,
47432,47435,47438,47441,47444
)
go

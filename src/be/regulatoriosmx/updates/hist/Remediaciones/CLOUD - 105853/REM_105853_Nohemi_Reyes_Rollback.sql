--ASESOR ASIGNADO: MONICA JOCELYN CRUZ REYES  USUARIO: mjcruz  -- 62
--ASESOR A REASIGNAR: JEIMY MIJANGOS DOMINGUEZ   USUARIO: jmijangos -- 31
--
--CLIENTE:
--220 - NOHEMI REYES BENITEZ
...
select @w_funcionario_dest =  62 -- antes 62

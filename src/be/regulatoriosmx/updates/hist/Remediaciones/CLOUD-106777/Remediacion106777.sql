...
update ca_garantia_liquida set gl_monto_garantia= 800, gl_pag_estado = 'CB',gl_pag_valor = 800 where gl_grupo = 579	and gl_cliente =2105  and gl_tramite =5345
update ca_garantia_liquida set                         gl_pag_estado = 'CB',gl_pag_valor = 600 where gl_grupo = 579	and gl_cliente =15841 and gl_tramite =5345
go

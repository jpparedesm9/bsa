--ASESOR ASIGNADO: JONATHAN EDUARDO ZALDO PEREZ USUARIO: jezaldo --232
--ASESOR A REASIGNAR: FELIPE FACUNDO ADÁN USUARIO: ffacundo -- 180
--CLIENTES:
--44214 - YESENIA ROSAS URIBE
...
select @w_funcionario_dest =  232 -- antes 232

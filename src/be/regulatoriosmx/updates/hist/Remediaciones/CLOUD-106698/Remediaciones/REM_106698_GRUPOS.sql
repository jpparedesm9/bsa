--ASESOR ASIGNADO: JANETH ALONSO MORENO USUARIO: jalonsom --181
--ASESOR A REASIGNAR: MA CRUZ MONROY QUINTANA USUARIO: mcmonroy --213
--
--GRUPO:
--1462 SATELITE
--
--ASESOR ASIGNADO: JANETH ALONSO MORENO USUARIO: jalonsom --181
--ASESOR A REASIGNAR: ELIZABETH MORENO BARRERA USUARIO: emorenoba --176
--
--GRUPO:
--1689 SOLECITO AMADO
--
--ASESOR ASIGNADO: FERNANDO ANDRÉS OJEDA CHÁVEZ USUARIO: faojeda --312
--ASESOR A REASIGNAR: ROCIÓ HERNÁNDEZ GALINDO USUARIO: rhernandezg --144
--
--GRUPO:
--1310 ALFAREROS
--1375 PASTORES
...
insert into #grupos values (1462,213)
insert into #grupos values (1689,176)
insert into #grupos values (1310,144)
insert into #grupos values (1375,144)
insert into #grupos values (1354,144)
insert into #grupos values (1282,144)

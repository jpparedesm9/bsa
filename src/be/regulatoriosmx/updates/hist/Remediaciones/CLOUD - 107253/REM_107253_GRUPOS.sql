...
--ASESOR ASIGNADO: ATALÍA BETZABE CAMACHO MARTÍNEZ USUARIO: abcamachom -- 183 
--ASESOR A REASIGNAR: LILIANA LIBERTAD FIGUEROA MEDINA USUARIO: llfigueroa -- 147
--GRUPO: 1302 AZULES
--GRUPO: 584 LAS BOVEDAS

--ASESOR ASIGNADO: ATALÍA BETZABE CAMACHO MARTÍNEZ USUARIO: abcamachom -- 183
--ASESOR A REASIGNAR: JOSE GABRIEL BELLO CUEVAS USUARIO: jgbello -- 334
--GRUPOS
-- 504 VICENTE
-- 777 ESTRELLITAS DEL JICARERO
-- 1429 NICOLAS
-- 1254 BLACK FUSION
-- 1543 LAS LUNAS
-- 897 SOLECITOS
-- 1034 JAZMINEZ CONSTITUCION
-- 1053 JICARERO

--ASESOR ASIGNADO: Dennis Rea Alvarez USUARIO: dreaalvarez -- 168
--ASESOR A REASIGNAR: JOSE GABRIEL BELLO CUEVAS USUARIO: jgbello -- 334
--GRUPOS
-- 1131 FROZEN
-- 1072 INDE2018
...
--ASESOR ASIGNADO: Mario Quintero Casarrubias USUARIO: dreaalvarez -- 187
--ASESOR A REASIGNAR: JDennis Rea Alvarez USUARIO: dreaalvarez -- 168
--GRUPOS
-- 701 AZUL CELESTE
-- 1054 LA VIA
-- 834 CAMPOSANTO
...
--ASESOR ASIGNADO: Dennis Rea Alvarez USUARIO: dreaalvarez -- 168
--ASESOR A REASIGNAR: Jeraldine Trujillo Avelar USUARIO: jtrujilloav -- 244
--GRUPOS
-- 911 ACA2018
-- 860 EL ESFUERZO
...
insert into #grupos values (1302, 147)-- antes 183
insert into #grupos values (584, 147)-- antes 183
insert into #grupos values (504, 334)-- antes 183
insert into #grupos values (777, 334)-- antes 183
insert into #grupos values (1429, 334)-- antes 183
insert into #grupos values (1254, 334)-- antes 183
insert into #grupos values (1543, 334)-- antes 183
insert into #grupos values (897, 334)-- antes 183
insert into #grupos values (1034, 334)-- antes 183
insert into #grupos values (1053, 334)-- antes 183
insert into #grupos values (1131, 334)-- antes 168
insert into #grupos values (1072, 334)-- antes 168
insert into #grupos values (1069, 334)-- antes 168
insert into #grupos values (656, 334)-- antes 168
insert into #grupos values (3938, 334)-- antes 168
insert into #grupos values (531, 334)-- antes 168
insert into #grupos values (699, 334)-- antes 168
insert into #grupos values (1114, 334)-- antes 168
insert into #grupos values (1365, 334)-- antes 168
insert into #grupos values (701, 168)-- antes 187
insert into #grupos values (1054, 168)-- antes 187
insert into #grupos values (834, 168)-- antes 187
insert into #grupos values (736, 168)-- antes 187
insert into #grupos values (773, 168)-- antes 187
insert into #grupos values (1022, 168)-- antes 187
insert into #grupos values (1535, 168)-- antes 187
insert into #grupos values (911, 244)-- antes 168
insert into #grupos values (860, 244)-- antes 168

...
--
--ASESOR ASIGNADO: ZAYRA TURINCIO PASCUAL USUARIO: zturincio --51
--ASESOR A REASIGNAR: ERIKA MONTES BAZ USUARIO: emontesba --229
--
--CLIENTE:
--
--62 - MARIA ISABEL OSORIO VALDEZ
...
select @w_funcionario_dest =  229

create table #prospectos(ente int)

insert into #prospectos values (62)

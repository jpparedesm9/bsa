...
begin
	...
	if not exists (select 1 from cts_serv_catalog where csc_service_id = 'CustomerDataManagementService.CustomerManagement.DeleteRelation')
    ...
    values('CustomerDataManagementService.CustomerManagement.DeleteRelation', @w_producto, 'R', @w_moneda, getdate(), @w_rol, 'V', getdate())

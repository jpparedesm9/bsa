--CLIENTE: MA. DE LOURDES CASIANO PEÑA
--ID: 19161 
--ASESOR ASIGNADO:    YOSHIO CESAR RAMIREZ PEXO USUARIO: ycramirez    --> 242
--ASESOR A REASIGNAR: JUANA BEATRIZ PINEDA ENRÍQUEZ USUARIO: jbpineda --> 288
...
select @w_funcionario_dest =  288

create table #prospectos(ente int)

insert into #prospectos values (19161)

...
/*
Solicito su apoyo para la reasignación del grupo Diamant ID 1008

ASESOR ACTUAL: Emmanuel Guzmán Alonso (usuario: eguzman) -> 200
ASESOR PARA REASIGNAR:Julio Cesar Flores Amezcua (usuario: jcfloresam) -> 201
...
select @w_codigo_grupo  = 1008,
       @w_codigo_oficial= 201,
       @w_login_oficial = 'jcfloresam',
       @w_oficina       = 1036

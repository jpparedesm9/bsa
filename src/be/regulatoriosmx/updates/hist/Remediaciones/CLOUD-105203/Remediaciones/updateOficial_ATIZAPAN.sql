...
--ASESOR ASIGNADO: Mónica Soto  Usuario: msotov
--ASESOR A REASIGNAR: German López Martínez Usuario glopezma
--GRUPO:
--925--Kantaro

--ASESOR ASIGNADO: Ángel Josué Sosa   Usuario: ajsosa
--ASESOR A REASIGNAR: German López Martínez Usuario glopezma
--GRUPO:
--779—Diamantes Tuiio

--ASESOR ASIGNADO: Ángel Josué Sosa   Usuario: ajsosa
--ASESOR A REASIGNAR: María Guadalupe Landin Lora Usuario mglandin
--GRUPO:
--848--Tráfico

insert into #grupos values (925, 279) -- antes 145
insert into #grupos values (779, 279) -- antes 118
insert into #grupos values (848, 284) -- antes 118

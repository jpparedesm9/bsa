...
--/////////////////////// ESTA VALOR ES LA CLAVE PARA RESTAURAR
                          @w_fecha_gen    = '2018/05/25 16:01:01',   -- **************
--/////////////////////// ESTA VALOR ES LA CLAVE PARA RESTAURAR
...
SELECT @w_tipo         = 'R'
insert into cobis..ba_tab_tmp values (@w_tipo, @w_fecha_sys, @w_fecha_gen, 'INICIO',      'INICIO')
insert into cobis..ba_tab_tmp values (@w_tipo, @w_fecha_sys, @w_fecha_gen, @w_batch,      'cobis..ba_batch ')
insert into cobis..ba_tab_tmp values (@w_tipo, @w_fecha_sys, @w_fecha_gen, @w_sarta,      'cobis..ba_sarta ')
insert into cobis..ba_tab_tmp values (@w_tipo, @w_fecha_sys, @w_fecha_gen, @w_sarta_batch,'cobis..ba_sarta_batch ')
insert into cobis..ba_tab_tmp values (@w_tipo, @w_fecha_sys, @w_fecha_gen, @w_enlace,     'cobis..ba_enlace ')
insert into cobis..ba_tab_tmp values (@w_tipo, @w_fecha_sys, @w_fecha_gen, @w_parametro,  'cobis..ba_parametro')

insert into cobis..ba_tab_tmp values (@w_tipo, @w_fecha_sys, @w_fecha_gen, 'FIN',         'FIN')
...
SELECT * FROM ba_tab_tmp WHERE fecha_gen = @w_fecha_gen
	AND fecha_sys = @w_fecha_sys

...
UPDATE cobis..cl_ente SET en_oficial=117,
c_funcionario='bdelacruz' WHERE en_ente 
IN (6781,6783,6785,6789,6791,6796,6804,6845,6874,
 6879,6883,6893,6894,7006,7013,7227)


UPDATE cobis..cl_grupo SET gr_oficial=117
WHERE gr_grupo IN (257,261)

UPDATE cobis..cl_cliente_grupo SET cg_usuario='bdelacruz'

...
--SOLICITAMOS DE SU APOYO PARA LA SIGUIENTE REASIGNACION:
--ASESOR ASIGNADO: JESSYCA LOZADA CERVANTES  USUARIO: JLOZADACE-jlozadace	90
--ASESOR A REASIGNAR: JORGE ARMANDO PIÑA SALAZAR   USUARIO: JAPINA-japina	160
--GRUPOS:
--421 - PEQUES IXTA
--

--NOS CONFIRMAN QUE LA SOLICITUD ORIGINAL VIENE INCORRECTO EL GRUPO:
--INCORRECTO 421 - PEQUES IXTA
--CORRECTO 494 - ESMERALDA IXTA.


insert into #grupos values (494,160)-- antes 90

...
--SOLICITAMOS DE SU APOYO PARA REGRESAR TAREA AL ASESOR Y REALICE CAMBIOS DE CLIENTES. SE ANEXA PANTALLA
...
select @w_actividad = 'REVISAR Y VALIDAR INFORMACIÓN'
select @w_inst_proceso = 3159

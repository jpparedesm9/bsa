...
--Solicito de su apoyo para la reasignación de los siguientes grupos:
--
--ASESOR ACTUAL: Mirna Ivonne Valdez Ascensión Usuario (mivaldez) -- 106
--ASESOR A ASIGNAR: Jesus González Álvarez Usuario (jgonzalezal) --210
--ALCATRAZ DE SAN ANTONIO ID 324
--
--ASESOR ACTUAL: Jesús González Álvarez Usuario (jgonzalezal)--210
--ASESOR A ASIGNAR: Carina León Dávila Usuario (cleon) -- 303
--CRISTALES ID 1272

--ASESOR ACTUAL: Mirna Ivonne Valdez Ascensión Usuario (mivaldez) - 106
--ASESOR A ASIGNAR: Carina León Dávila Usuario (cleon) -- 303
--ESPERANZA DE SAN PEDRO ID 1331

insert into #grupos values (324, 210)  -- antes 106
insert into #grupos values (1272, 303) -- antes 210
insert into #grupos values (1331, 303) -- antes 106

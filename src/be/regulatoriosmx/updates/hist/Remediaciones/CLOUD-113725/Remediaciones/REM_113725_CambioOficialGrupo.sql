...
create table #prospecto (prospecto int , funcionario_dest int)

insert into #prospecto values (630,340)  --rdiazme
insert into #prospecto values (21111,38) --magijon
insert into #prospecto values (46833,250)--clestrada
insert into #prospecto values (48057,232)--jezaldo
insert into #prospecto values (35716,499)--euribem - clietne
...
while(1=1) begin 
   ...
   select top 1  
   @w_prospecto        = prospecto,
   @w_funcionario_dest = funcionario_dest	
   from #prospecto
   where prospecto > @w_prospecto 
   order by prospecto 

   select @w_fila = @@rowcount, @w_error = @@error    
   if @w_fila = 0 begin 
      print 'TERMINA LAZO DE prospectoS'
      break
   end 
...
insert into #grupos values (31,35)--scruzgo
insert into #grupos values (72,35)--scruzgo
insert into #grupos values (98,38)--magijon
insert into #grupos values (116,48)--ncastillora
insert into #grupos values (122,68)--jherrerame
insert into #grupos values (153,513)--crojasg
insert into #grupos values (217,48)--ncastillora
insert into #grupos values (230,62)--mjcruz
insert into #grupos values (269,35)--scruzgo
insert into #grupos values (296,43)--jcorona
insert into #grupos values (310,35)--scruzgo
insert into #grupos values (356,48)--ncastillora
insert into #grupos values (357,40)--jgsoto
insert into #grupos values (365,120)--jclucio
insert into #grupos values (392,99)--erlino
insert into #grupos values (471,122)--ucvelasco
insert into #grupos values (566,43)--jcorona
insert into #grupos values (579,48)--ncastillora
insert into #grupos values (638,358)--aarzola
insert into #grupos values (657,453)--jrezam
insert into #grupos values (821,43)--jcorona
insert into #grupos values (822,35)--scruzgo
insert into #grupos values (829,35)--scruzgo
insert into #grupos values (931,231)--lemartinez
insert into #grupos values (1013,262)--raquino
insert into #grupos values (1032,231)--lemartinez
insert into #grupos values (1045,50)--davazquezsa
insert into #grupos values (1064,98)--dvarela
insert into #grupos values (1090,159)--sperezte
insert into #grupos values (1117,231)--lemartinez
insert into #grupos values (1168,188)--emorelos
insert into #grupos values (1172,47)--oamendozavi
insert into #grupos values (1234,260)--rmartinezrio
insert into #grupos values (1270,188)--emorelos
insert into #grupos values (1397,260)--rmartinezrio
insert into #grupos values (1404,99)--erlino
insert into #grupos values (1625,271)--ilmartinez
insert into #grupos values (1711,160)--japina
insert into #grupos values (1738,35)--scruzgo
insert into #grupos values (1785,43)--jcorona
insert into #grupos values (1895,48)--ncastillora
insert into #grupos values (2055,38)--magijon
insert into #grupos values (2444,459)--asanchezs
insert into #grupos values (2497,461)--rmezara
insert into #grupos values (2517,262)--raquino
insert into #grupos values (2529,231)--lemartinez
insert into #grupos values (2609,308)--gulinares
insert into #grupos values (2641,259)--mmoralesno
insert into #grupos values (2763,436)--eoguerrero
insert into #grupos values (3144,401)--vhcinto
insert into #grupos values (3234,35)--scruzgo
insert into #grupos values (3239,462)--mpalomares
insert into #grupos values (3337,35)--scruzgo
insert into #grupos values (3347,48)--ncastillora

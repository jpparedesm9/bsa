--ASESOR ACTUAL: Yamidt Itzel Cedillo Sánchez (yicedillo) --189
--ASESOR PARA REASIGNAR: Urbano Conchillos Ramírez (uconchillos) --156
--13168 Juana Montoya Martínez 
--14708 Miriam Guadalupe Calva Ortiz
--15463 Pula Líbier Vázquez Nolasco.
...
select @w_funcionario_dest =  156

create table #prospectos(ente int)

insert into #prospectos values (13168),(14708),(15463)

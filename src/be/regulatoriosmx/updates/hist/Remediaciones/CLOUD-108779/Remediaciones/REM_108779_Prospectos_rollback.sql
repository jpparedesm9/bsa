--CLIENTE 20367 - MARIA OTILIA PALO ALTO CORTES
--
--ASESOR ORIGEN ARTURO ARCOS FLORES USUARIO AARCOSFL --157
--ASESOR DESTINO JUAN CARLOS ROSALES ROLDAN USUARIO JCROSALESRO --264
...
select @w_funcionario_dest =  157

create table #prospectos(ente int)

insert into #prospectos values (20367)

--ASESOR ASIGNADO: MÓNICA MONSERRAT  LANDA ALARCÓN USUARIO: mmlanda --141
--ASESOR A REASIGNAR: YAMIDT ITZEL CEDILLO SÁNCHEZ USUARIO: yicedillo --189
--
--CLIENTE:
--39909 - MARCELA SÁNCHEZ ORTIZ 
--37247 - KELLY BALDERAS SÁNCHEZ
--39897 - ELIZABETH LÓPEZ FIGUEROA
--41182 - ANDREA CHÁVEZ VALDÉS
--13740 - MOISÉS TAPIA LÓPEZ
...
select @w_funcionario_dest =  189

create table #prospectos(ente int)

insert into #prospectos values (39909),(37247),(39897),(41182),(13740)

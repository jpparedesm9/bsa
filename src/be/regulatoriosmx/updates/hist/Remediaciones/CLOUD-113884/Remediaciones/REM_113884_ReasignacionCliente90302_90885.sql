--90302 ROSA MARIA AIDE DURAN LOPEZ
--ANGELICA LOZA HERNANDEZ CODIGO CLIENTE 90885 ASIGNAR A EORTEGA
--OFICINA VIRTUAL - USUARIO "0" 
--ASESOR CORRECTO ELOIZA ORTEGA,  USUARIO EORTEGA --268
...
select @w_funcionario_dest =  268

create table #prospectos(ente int)

insert into #prospectos values (90302)
insert into #prospectos values (90885)

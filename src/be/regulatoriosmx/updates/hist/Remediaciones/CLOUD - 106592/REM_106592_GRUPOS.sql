...
--ASESOR ASIGNADO: EFREN GONZALEZ ORNELAS USUARIO: egonzalezor --96
--ASESOR A REASIGNAR: RAUL SUAREZ BERNANDEZ USUARIO: rsuarez --326
--GRUPO:
--1122 - CACALOMACAN TUIIO
...
--340 - COMETA AZUL
--436 - LA CRUZ SAN BARTOLO
--500 - CARMINA CALI
--661 - ALEGRIAS
--702 - ATARDECER SAN BARTOLO
--791 - INICORNIO 
--943 - CAMPANITAS
--1127 - CELESTE SN BAR
--1341 - NATIVIDAD

--ASESOR ASIGNADO: MARIA ELIZABETH GONZALEZ ORTEGA USUARIO: megonzalezor --254
--ASESOR A REASIGNAR: MARIA JULIETA PEÑA MARTINEZ USUARIO: mjpenam --309
--GRUPO:
--66 - ROSAS

--ASESOR ASIGNADO: GEOVANI DANIEL NEGRETE PINA USUARIO: gdnegrete --97
--ASESOR A REASIGNAR: MARIA JULIETA PEÑA MARTINEZ USUARIO: mjpenam --309
--GRUPO:
--108 - GOLONDRINAS
--114 - LUNA NUEVA
...
--ASESOR ASIGNADO: BENITO DE LA CRUZ POZOS USUARIO: bdelacruz --117
--ASESOR A REASIGNAR: EFREN GONZALEZ ORNELAS USUARIO: rsuarez --96
--GRUPO:
--1503 - SUTEYM

insert into #grupos values (1122, 326)-- antes 96
insert into #grupos values (74, 326)-- antes 116
insert into #grupos values (134, 326)-- antes 116
insert into #grupos values (199, 326)-- antes 116
insert into #grupos values (265, 326)-- antes 116
insert into #grupos values (282, 326)-- antes 116
insert into #grupos values (305, 326)-- antes 116
insert into #grupos values (340, 326)-- antes 116
insert into #grupos values (436, 326)-- antes 116
insert into #grupos values (500, 326)-- antes 116
insert into #grupos values (661, 326)-- antes 116
insert into #grupos values (702, 326)-- antes 116
insert into #grupos values (791, 326)-- antes 116
insert into #grupos values (943, 326)-- antes 116
insert into #grupos values (1127, 326)-- antes 116
insert into #grupos values (1341, 326)-- antes 116
insert into #grupos values (66, 309)-- antes 254
insert into #grupos values (108, 309)-- antes 97
insert into #grupos values (114, 309)-- antes 97
insert into #grupos values (170, 309)-- antes 97
insert into #grupos values (304, 309)-- antes 97
insert into #grupos values (326, 309)-- antes 97
insert into #grupos values (733, 309)-- antes 97
insert into #grupos values (851, 309)-- antes 97
insert into #grupos values (886, 309)-- antes 97
insert into #grupos values (1344, 309)-- antes 97
insert into #grupos values (1345, 309)-- antes 97
insert into #grupos values (1503, 96)-- antes 117

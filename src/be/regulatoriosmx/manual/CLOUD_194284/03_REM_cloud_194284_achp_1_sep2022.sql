...
select @w_fecha_ini = '09/01/2022'
select @w_fecha_fin = '09/30/2022'

select 'Hora_Ini' = getdate()
/****** DIA DE PAGO  ******/--3minutos
select 
banco       = do_banco , 
...
select 'num_reg_a_act' = count(1) from #act_dia_pago_sep
...
from #act_dia_pago_sep
where do_fecha between @w_fecha_ini and @w_fecha_fin
and operacion = do_operacion

drop table #act_dia_pago_sep

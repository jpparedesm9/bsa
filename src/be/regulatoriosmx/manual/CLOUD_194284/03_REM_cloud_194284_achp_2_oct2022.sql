...
select @w_fecha_ini = '10/01/2022'
select @w_fecha_fin = '10/31/2022'
...
select 'num_reg_a_act' = count(1) from #act_dia_pago_oct
...
from #act_dia_pago_oct
where do_fecha between @w_fecha_ini and @w_fecha_fin
and operacion   = do_operacion

drop table #act_dia_pago_oct

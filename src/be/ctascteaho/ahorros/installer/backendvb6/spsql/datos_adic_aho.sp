...
/************************************************/
  ...
  begin
    select
      ...
      @w_dep_inicial = isnull(da_dep_inicial,
                              0.00),

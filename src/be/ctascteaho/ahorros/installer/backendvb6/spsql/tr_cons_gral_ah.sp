...
/************************************************************************/
/*  Archivo:            tr_cons_gral_ah.sp                              */
/*  Stored procedure:   sp_tr_cons_gral_ah                              */
...
if exists (select
             1
           from   sysobjects
           where  name = 'sp_tr_cons_gral_ah')
  drop proc sp_tr_cons_gral_ah
go

create proc sp_tr_cons_gral_ah
(
  @s_ssn           int,

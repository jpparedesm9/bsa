...
/************************************************************************/
/*      Archivo:                ahtotser_INC_116217.sp                  */
...
if exists (select
             1
           from   sysobjects
           where  name = 'sp_totaliza_tran_serv_ah_inc_116217')
  drop proc sp_totaliza_tran_serv_ah_inc_116217
go

create proc sp_totaliza_tran_serv_ah_inc_116217
(
  @i_filial       tinyint = 1,
...
as
  ...
  select
    @w_sp_name = 'sp_totaliza_tran_serv_ah_INC_116217'
      ...
      begin
        ...
        insert into #re_trn_contable
          ...
          from   cob_ahorros..ah_tran_servicio_tmp t,
                 #cotizacion
          where  ts_tipo_transaccion = 271 --@w_tipo_tran
             and ts_terminal         <> 'efectiviza'

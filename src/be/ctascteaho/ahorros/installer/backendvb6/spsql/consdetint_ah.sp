...
begin
   ...
   select 'FECHA'           = convert(varchar(10), sd_fecha, 103),
          'SDO. DISPONIBLE' = sd_saldo_disponible,
          'SDO. RETENIDO'   = sd_12h + sd_24h + sd_48h + sd_remesas,
          'SDO. PROMDISP'   = sd_prom_disponible,
          'VALOR TASA INT.' = sd_tasa_disponible,
          'VALOR INT.'      = sd_int_hoy,
          'DIAS'            = sd_dias

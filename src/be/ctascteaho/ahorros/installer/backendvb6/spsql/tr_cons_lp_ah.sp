...
/************************************************************************/
/*  Archivo:            tr_cons_lp_ah.sp                                */
/*  Stored procedure:   sp_tr_cons_lp_ah                                */
...
/*                                     la Produccion                    */
/*      05/05/2006      pedro coello   Añadir parametro de fecha        */
...
if exists (select
             1
           from   sysobjects
           where  name = 'sp_tr_cons_lp_ah')
  drop proc sp_tr_cons_lp_ah
go

create proc sp_tr_cons_lp_ah
(
  @s_ssn           int,
  @s_srv           varchar(30),
  @s_lsrv          varchar(30),

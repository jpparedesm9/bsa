...
as
  ...
  begin
    ...
    begin
      ...
      select
        'Id' = Id,
        'Producto Id' = eq_modulo,
        'Producto' = c.valor,
        'Prod. Equiv. Id' = eq_mod_int,
        'Producto Equivalente' = c1.valor,
        'Codigo Tabla' = eq_cod_tabla,
        'Tabla' = eq_tabla,
        'Valor Cobis' = eq_val_cfijo,
        'Valor Inicial' = eq_val_num_ini,
        'Valor Final' = eq_val_num_fin,
        'Valor Interfaz' = eq_val_interfaz,

...
CREATE TABLE cl_det_producto
    ...
    dp_fecha          DATETIME2 NOT NULL,
    dp_comentario     VARCHAR (64) NULL,
    dp_monto          MONEY NULL,
    dp_tiempo         SMALLINT NULL,
    dp_cuenta         VARCHAR (24) NULL,
    ...
    dp_descripcion_ec VARCHAR (255) NULL,
    ...
    dp_saldo          MONEY NULL,
    dp_fecha_cambio   DATETIME2 NULL,
    dp_fecha_prox_ven DATETIME2 NULL,

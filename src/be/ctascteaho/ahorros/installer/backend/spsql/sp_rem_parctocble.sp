...
/************************************************************************/
/*                            PROPOSITO                                 */
/*  Stored Procedure para realizar la parametrizacion contable          */
/*                                                                      */
/************************************************************************/
/*                              MODIFICACIONES                          */
/*      FECHA           AUTOR             RAZON                         */
/*    17/05/2016   Kmeza                   Migración a CEN               */
/************************************************************************/
use cob_remesas
go
...
if @i_oper = 'S' or  @i_oper = 'C' or @i_oper = 'T' or @i_oper = 'P'
 ...
 begin
     ...
     begin
          ...
          select @w_secuencial= isnull(max(cc_secuencial)+1,1) from cob_remesas..re_concepto_contable

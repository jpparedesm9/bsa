...
/* 08/Jul/2016          J. Tagle        Notas de Débito/Crédito    */
/*******************************************************************/
...
begin -- nombre ocx
    ...
    begin -- Operacion S
		set rowcount 20
		select
		'20011'  = an_producto,  --Producto
		'501058' = an_cuenta,    --Cuenta
		'5250'   = an_causa,     --Causa
		'502417' = an_valor,     --Valor
		'5251'   = an_nombre_ocx,--Nombre OCX
		'5252'   = an_boleta,    --Boleta
		'20002'  = an_concepto,  --Concepto
		'501633' = an_ssn,       --Secuencial
		'5253'   = an_trn        --Transaccion
	...
	begin -- Operacion D
		...
		begin
			...
			begin
				...
				@t_file  = @t_file,
				@t_from  = @w_sp_name,
				@i_msg   = 'ERROR EN ELIMINACION DE REGISTRO DE AUTORIZACION DE NOTA CREDITO / NOTA DEBITO',
				@i_num   = 357015
				return 357015
			end
		end
		...
		begin
			...
			@t_file  = @t_file,
			@t_from  = @w_sp_name,
			@i_msg   = 'TRANSACCION DE NOTA DE DEBITO / CREDITO NO PUEDE SER REVERSADA',
			@i_num   = 351088
			return 351088
		end
	end -- Operacion D
...
begin -- Operacion I
    ...
    if not exists (select
                   ...
                   from   cobis..cl_funcionario,
                          cob_cuentas..cc_funcionario_autoriz
	...
	begin
		...
		@t_file  = @t_file,
		@t_from  = @w_sp_name,
		@i_msg   = 'FUNCIONARIO NO ESTA DEFINIDO COMO EJECUTOR DE ND/NC',
		@i_num   = 201330
		return 1
	end
    ...
    begin
		...
		begin
			...
			begin
				...
				@t_file  = @t_file,
				@t_from  = @w_sp_name,
				@i_msg   = 'CAUSA NO PERMITIDA EN ND/NC POR TERMINAL ADMINISTRATIVA',
				@i_num   = 201332
				return 201332
			end
		end
    ...
    begin -- nombre ocx
		begin tran
			...
			begin
				...
				@t_file  = @t_file,
				@t_from  = @w_sp_name,
				@i_msg   = 'ERROR AL INSERTAR REGISTRO DE AUTORIZACION DE NOTA CREDITO / NOTA DEBITO',
				@i_num   = 353035
				return 353035
			end
			else
	...
	begin -- nombre ocx <>
		...
		begin
			...
			@t_file  = @t_file,
			@t_from  = @w_sp_name,
			@i_msg   = 'ERROR EN ACTUALIZACION DE CAJERO REMOTO',
			@i_num   = 205000
			return 205000
		end
	end -- nombre ocx <>

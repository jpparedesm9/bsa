/************************************************************************/
/*  Archivo:        ah_actlib.sp                                        */
/*  Stored procedure:   sp_ah_actlib                                    */
...
/*  2003/01/08  Carlos Cruz D.  Branch III                              */
/*  2005/11/08  Pedro Coello R. Actualizacion de totales                */
...
if exists (select
             1
           from   sysobjects
           where  name = 'sp_ah_actlib')
  drop proc sp_ah_actlib
go
...
(
  ...
  @o_sldlib       money=0 out,
  @o_num          int=0 out,
  @o_nctrl        smallint=0 out,
...
as
  ...
  begin
    exec @w_return = @w_rpc
      ...
      @i_primera_ejec = @i_primera_ejec,
      @i_cant_lineas  = @i_cant_lineas,--PCOELLO CANTIDAD DE LINEAS A IMPRIMIR

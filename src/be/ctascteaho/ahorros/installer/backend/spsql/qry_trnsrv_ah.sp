...
select @w_query2 = "'FECHA'=ts_tsfecha,
                    'HORA'=concat(FORMAT(datepart(hh,ts_hora),'00'),':',FORMAT(datepart(mi,ts_hora),'00'),':',FORMAT(datepart(s,ts_hora),'00')),
                    'SECUENCIAL' =ts_secuencial, 'CODIGO ALTERNO' =ts_cod_alterno from cob_ahorros..ah_tran_servicio d"

...
as
  ...
  select
              '9946'  = substring(A.valor,                                --  'DESCRIPCION BLOQUEO' 
                            1,                                                              
                            25),                                                            
              '9947'  = substring(B.valor,                                 -- 'CAUSA'               
                    1,                                                                        
                    30),                                                                      
              '9948' = cb_autorizante,                                    -- 'USUARIO'             
              '9949'  = convert(varchar(10), cb_fecha, @i_formato_fecha)   -- 'FECHA'               

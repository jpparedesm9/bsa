...
/************************************************************************/
/*  Archivo:            tr_query_gral_up_ah.sp                          */
/*  Stored procedure:   sp_tr_query_gral_up_ah                          */
/*      Base de datos:          cob_ahorros                             */
/*      Producto: Cuentas Corrientes                                    */
/*      Disenado por:  Mauricio Bayas/Sandra Ortiz                      */
/*  Fecha de escritura: 16-Nov-1993                                     */
/************************************************************************/
/*                              IMPORTANTE                              */
...
/*  permisibles para actualizacion general de una cuenta de ahorros.    */
/************************************************************************/
/*              MODIFICACIONES                                          */
/*      FECHA           AUTOR           RAZON                           */
/*  16/Nov/1993 P Mena         Emision inicial                          */
...
if exists (select
             1
           from   sysobjects
           where  name = 'sp_tr_query_gral_up_ah')
  drop proc sp_tr_query_gral_up_ah
go

create proc sp_tr_query_gral_up_ah
(
...
as
  ...
  select
    @w_sp_name = 'sp_tr_query_gral_up_ah'

/************************************************************************/
/*  Archivo:            ah_depdi_local_remoto.sp                        */
/*  Stored procedure:   sp_ah_depdi_local_remoto                        */
...
if exists (select
             1
           from   sysobjects
           where  name = 'sp_ah_depdi_local_remoto')
  drop proc sp_ah_depdi_local_remoto
go
...
create proc sp_ah_depdi_local_remoto
(
  @s_ssn           int,
  @s_srv           varchar(30),
  @s_lsrv          varchar(30),
...
as
  ...
  select
    @w_sp_name = 'sp_ah_depdi_local_remoto'
  ...
  begin
    if @t_trn = 207
      ...
      begin
        /* Los datos del reverso no coinciden con el original */
  ...
  exec @w_return = cob_ahorros..sp_dep_ncre_dif
    @s_ssn           = @s_ssn,
    @s_srv           = @s_srv,
    @s_lsrv          = @s_lsrv,
    @s_user          = @s_user,

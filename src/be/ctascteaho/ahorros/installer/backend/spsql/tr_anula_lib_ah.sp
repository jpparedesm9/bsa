...
/************************************************************************/
/*  Archivo:            tr_anula_lib_ah.sp                              */
/*  Stored procedure:   sp_tr_anula_lib_ah                              */
...
/************************************************************************/
/*                              PROPOSITO                               */
/*  Este programa realiza la transaccion de anulacion de libretas       */
/*  280 = Anulacion libreta ahorros/bloqueo de Movimientos Ret/Dep      */
/************************************************************************/
...
if exists (select
             1
           from   sysobjects
           where  name = 'sp_tr_anula_lib_ah')
  drop proc sp_tr_anula_lib_ah
go

create proc sp_tr_anula_lib_ah
(
  @s_ssn          int,

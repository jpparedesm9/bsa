...
/*    contables de MONEDA, CLASE CLIENTE, PRODUCTO, ESTADO              */
/************************************************************************/
/*                             MODIFICACION                             */
/*    FECHA                 AUTOR                 RAZON                 */
...
if exists (select
             1
           from   sysobjects
           where  name = 'sp_ah01_pf')
  drop proc sp_ah01_pf
go

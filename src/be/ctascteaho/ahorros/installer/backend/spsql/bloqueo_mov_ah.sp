...
as
  ...
  /* Verificacion de que el tipo de bloqueo ingresado no se encuentre */
    ...
    begin
      ...
      begin
        ...
        exec cobis..sp_cerror
          ...
          @t_from  = @w_sp_name,
          @i_num   = 201054,
		  @i_msg   = 'Tipo de bloqueo no ha sido levantado previamente'
        return 201054
      end
      select
        @w_t3 = 'S'
    ...
    begin
      ...
      exec cobis..sp_cerror
        ...
        @t_from  = @w_sp_name,
        @i_num   = 201085,
		@i_msg   = 'Cuenta esta bloqueada contra deposito y retiro'
      return 1
    end
    ...
    if exists (select
      ...
      begin
        ...
        exec cobis..sp_cerror
          ...
          @t_from  = @w_sp_name,
          @i_num   = 2600014,
		@i_msg   = 'Validacion no crear bloqueos igual oficio creacion y causa'
        return 2600014
      end
  ...
  begin
    ...
    if upper(@w_observacion) = 'EMBARGOS' and charindex ('EMBARGO',upper(isnull(@i_observacion,''))) = 0
    begin
	...
	-- Si producto bancario es de aporte social adicional no puede levantarse bloqueo tipo 2 (retiros o debitos) a menos que venga de 'SISTEMA' por el CIERRE
	if (@i_solicit <> 'SISTEMA') AND (@i_tbloq = 2) AND (@w_prod_banc in (select pa_int from   cobis..cl_parametro where  pa_producto = 'AHO' and  (pa_nemonico = 'PCAASO' OR pa_nemonico = 'PCAASA' )))
	begin
	  /* CUENTA DE APORTE SOCIAL, NO PUEDE REALIZARSE LEVANTAMIENTO */
      exec cobis..sp_cerror
        @t_debug = @t_debug,
        @t_file  = @t_file,
        @t_from  = @w_sp_name,
        @i_num   = 252078,
		@i_msg   = 'CUENTA DE APORTE SOCIAL, NO PUEDE REALIZARSE LEVANTAMIENTO'
      return 252078
	end

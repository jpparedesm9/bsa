...
/************************************************************************/
/*  Archivo:            tr_reapertura_ah.sp                             */
/*  Stored procedure:   sp_tr_reapertura_ah                             */
...
/*  204 = Reapertura de cuenta de ahorros.                              */
/************************************************************************/
/*                              MODIFICACIONES                          */
/*      FECHA           AUTOR           RAZON                           */
/*  07/Dic/1993 P Mena         Emision inicial                          */
/*      08/Ago/2006     A.Riggs        A¤adir variable de operacion y   */
/*                                     nombre                           */
...
if exists (select
             1
           from   sysobjects
           where  name = 'sp_tr_reapertura_ah')
  drop proc sp_tr_reapertura_ah
go

create proc sp_tr_reapertura_ah
(
  @s_ssn           int,
  @s_ssn_branch    int = 0,
...
as
  ...
  begin
    ...
    select
      ...
      i_cta = @i_cta,
      i_mon = @i_mon,
      i_operacion = @i_operacion,--ARiggs 08-29-06
      i_nombre = @i_nombre --ARiggs 08-29-06
  ...
  exec @w_return = @w_rpc
    ...
    @i_operacion     = @i_operacion,--ARiggs 08-29-06
    @i_nombre        = @i_nombre,--ARiggs 08-29-06
    @i_formato_fecha = @i_formato_fecha,--ARiggs 08-29-06

...
/************************************************************************/
/*  Archivo:            cons_saldos                                     */
/*  Stored procedure:   sp_tr_con_saldos                                */
/*  Base de datos:      cob_ahorros                                     */
/*  Producto:           Cuentas de Ahorros                              */
/*  Disenado por:       Roxana Sánchez                                  */
/*  Fecha de escritura: 2-Agos-2016                                     */
/************************************************************************/
/*                              IMPORTANTE                              */
...
/************************************************************************/
/*                              PROPOSITO                               */
/*  Este programa realiza la transaccion de consulta de saldos          */
/*  de ahorros.                                                         */
/************************************************************************/
/*                              MODIFICACIONES                          */
/*      FECHA           AUTOR           RAZON                           */
/*  03/Ago/2016      R. SANCHEZ        Emision inicial                  */
/************************************************************************/
...
if exists (select
             1
           from   sysobjects
           where  name = 'sp_tr_con_saldos')
  drop proc sp_tr_con_saldos
go

create proc sp_tr_con_saldos
(
  @s_ssn           int =null,
  @s_ssn_branch    int = 0,
...
as
  ...
  begin
   ...
   begin 
    ...
    if @i_cta is null 
      begin
       select @w_cuenta_cta = ca_cta_banco 
 ...
 if @t_trn <> 4169
  ...
  begin
    ...
    where  ah_cta_banco = @w_cuenta_cta
       and ah_moneda    = @i_mon
...
/* No se valida que la cuenta se encuentre activa */
  ...
  values      (@s_ssn,@s_ssn_branch,@t_trn,@s_date,@s_user,
               @s_term,@s_ofi,@t_rty,@s_org,@w_cuenta,
  ...
  if exists (select
             ...
             where  he_cta_banco = @w_cuenta_cta
  ...
  begin
    ...
    where  ca_tipo_proceso       = 'B'
       and ((ca_cuenta_especifica  = 'S'
             and ca_producto           = 'AHO'
             and ca_nro_cta_especifica = @w_cuenta_cta)
  ...
  if exists (select
             ...
             where  cc_cta_banco = @w_cuenta_cta
                and cc_estado    = 'A')
    select
      @w_contractual = 'S'
  else
  ...
  select
    'Moneda'=@w_moneda,
    'Des. Moneda'=@w_mon_des,
    'Cod. Estado'=@w_estado,
    'Des. Estado'=@w_estado_des,
    'Cod. Categoría'=@w_categoria,
    'Des. Categoría'=@w_categ_des,
    'Oficial de cta'=@w_oficial,
    'Nombre del oficial'=@w_oficial_des,
    'Cod. Tipo Promedio'=@w_tipo_promedio,
    'Des. Tipo Promedio'=@w_tpromedio_des,
    'Cod. Capitalización'=@w_capitalizacion,
    'Des. Capitalización'=@w_capit_des,
    'Cod. Prod. Bancario'=@w_prod_banc,
    'Des. Prod. Bancario'=@w_desc_prod_banc,
    'Contractual'=@w_contractual,
    'Tipo Cuenta'=@w_tipocta,
    ...
    'Promedio G' = ((@w_promedio1+@w_promedio2+@w_promedio3+@w_promedio4+@w_promedio5+@w_promedio6)/6),

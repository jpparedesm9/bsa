...
as
  ...
  begin
    select
      '501058' = ar_cta_banco,              --CUENTA
      'NOMBRE CUENTA' = convert(varchar(64), ah_nombre),   --NOMBRE CUENTA
      '508589' = ar_forma_pago,    --FORMA PAGO
      '9004' = ar_valor,    --VALOR
      '9019' = ar_estado,   --ESTADO
      'OFI. RADICADORA' = ar_oficina_radicadora,   --OFI. RADICADORA
      '9025' = ar_secuencial      --SECUENCIAL
    from   cob_ahorros..ah_aut_retiro_ofic,
  ...
  begin
    ...
    select
      ...
      '508589' = ar_forma_pago,
      '9004' = ar_valor,
      '9002' = convert(varchar, ar_fecha, 101),   --FECHA
      '9003' = convert(varchar,ar_hora,108),    --HORA
      '9019' = ar_estado,
  ...
  begin
    ...
    begin
      exec cobis..sp_cerror
        ...
        @t_from  = @w_sp_name,
        @i_num   = 2609863
      -- OPERACI-N NO VALIDA. PRODUCTO PERTENECE A CORRESPONSALES BANCARIOS REDES POSICIONADAS
      return 2609863
    end
  end

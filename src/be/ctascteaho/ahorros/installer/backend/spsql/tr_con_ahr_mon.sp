...
/************************************************************************/
/*  Archivo:            ahpcomon.sp                                     */
/*  Stored procedure:   sp_tr_con_ahr_mon                               */
...
/*                              MODIFICACIONES                          */
/*      FECHA           AUTOR           RAZON                           */
/*  18/Feb/1994      S Vinces         Emision inicial                   */
...
if exists (select
             1
           from   sysobjects
           where  name = 'sp_tr_con_ahr_mon')
  drop proc sp_tr_con_ahr_mon
go

create proc sp_tr_con_ahr_mon
(
  @s_ssn           int,

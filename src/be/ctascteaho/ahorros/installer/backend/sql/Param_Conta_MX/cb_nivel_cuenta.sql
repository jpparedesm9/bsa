...
begin
	...
	insert into cob_conta..cb_nivel_cuenta (nc_empresa, nc_nivel_cuenta, nc_longitud, nc_descripcion) values (@w_empresa, 5, 2, 'MONEDA')
	insert into cob_conta..cb_nivel_cuenta (nc_empresa, nc_nivel_cuenta, nc_longitud, nc_descripcion) values (@w_empresa, 6, 4, 'AUXILIAR')
end
else

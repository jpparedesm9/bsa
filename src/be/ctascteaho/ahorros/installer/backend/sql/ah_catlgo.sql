...
delete cl_catalogo_pro
 ...
 where tabla in ('ah_capitalizacion', 'ah_trn_offline', 'ah_talonarios', 'ah_causa_nc_data',
                 ...
                 're_equivalencias', 're_eq_tabla','cc_tipo_solicitud','cl_direccion_ec', 're_mes','re_tipo_transfer',
                 'cc_period_transfer','re_novedades_enroll','ah_tablas_causales_ndc',
                 're_estado_servicio', 'cl_moneda','ah_causa_bloq_contb','ah_causa_desbloq_contb','ah_transaccion_masiva',
				 'ah_ori_remesas')
  and codigo = cp_tabla
...
INSERT INTO dbo.cl_catalogo (tabla, codigo, valor, estado)VALUES (@w_codigo, '1', 'PAGO DE PLANILLA', 'V')
INSERT INTO dbo.cl_catalogo (tabla, codigo, valor, estado)VALUES (@w_codigo, '2', 'TRANSFERENCIA A CTA DE AHORRO', 'V')
INSERT INTO dbo.cl_catalogo (tabla, codigo, valor, estado)VALUES (@w_codigo, '3', 'TRANSFERENCIA A CTA CORRIENTE', 'V')

select @w_codigo = @w_codigo + 1
print 'Periodicidad de Transferencias Automaticas'
insert into cl_catalogo_pro values ('AHO', @w_codigo)
INSERT INTO dbo.cl_tabla (codigo, tabla, descripcion)VALUES (@w_codigo, 'cc_period_transfer', 'Periodicidad de Transferencias Automaticas')
INSERT INTO dbo.cl_catalogo (tabla, codigo, valor, estado)VALUES (@w_codigo, 'D', 'DIARIA', 'V')
INSERT INTO dbo.cl_catalogo (tabla, codigo, valor, estado)VALUES (@w_codigo, 'M', 'MENSUAL', 'V')
INSERT INTO dbo.cl_catalogo (tabla, codigo, valor, estado)VALUES (@w_codigo, 'Q', 'QUINCENAL', 'V')
...
insert into cl_catalogo_pro values ('PER', @w_codigo)
INSERT INTO dbo.cl_catalogo (tabla, codigo, valor, estado)VALUES (@w_codigo, '01', 'Asociacion Usuario', 'V')
INSERT INTO dbo.cl_catalogo (tabla, codigo, valor, estado)VALUES (@w_codigo, '02', 'Eliminacion de Usuario', 'V')
INSERT INTO dbo.cl_catalogo (tabla, codigo, valor, estado)VALUES (@w_codigo, '03', 'Reexpedicion', 'V')
INSERT INTO dbo.cl_catalogo (tabla, codigo, valor, estado)VALUES (@w_codigo, '04', 'Bloqueos', 'E')
INSERT INTO dbo.cl_catalogo (tabla, codigo, valor, estado)VALUES (@w_codigo, '05', 'Desbloqueos', 'E')
INSERT INTO dbo.cl_catalogo (tabla, codigo, valor, estado)VALUES (@w_codigo, '06', 'Actualizacion Datos Usuario', 'E')
INSERT INTO dbo.cl_catalogo (tabla, codigo, valor, estado)VALUES (@w_codigo, '07', 'Olvido de Clave', 'E')
INSERT INTO dbo.cl_catalogo (tabla, codigo, valor, estado)VALUES (@w_codigo, '14', 'Actualizacion Datos Localizacion', 'E')
INSERT INTO dbo.cl_catalogo (tabla, codigo, valor, estado)VALUES (@w_codigo, '15', 'Cambio Numero Celular', 'V')
...
insert into cl_tabla (codigo, tabla, descripcion) values (@w_codigo, 'cl_moneda', 'PRODUCTOS COBIS')
insert into cl_catalogo_pro values ('AHO', @w_codigo)

insert into cl_catalogo (tabla, codigo, valor, estado) values (@w_codigo, '0', 'PESOS MEXICANOS', 'V')
...
insert into cl_catalogo (tabla, codigo, valor, estado) values (@w_codigo, '5', 'UNIDADES DE INVERSION', 'V')

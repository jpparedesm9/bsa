...
/************************************************************************/
/*                              PROPOSITO                               */
/* Este programa fue tomado de la base cob_interfase por dependencia    */
/************************************************************************/
/*              MODIFICACIONES                                          */
/*      FECHA           AUTOR           RAZON                           */
/*  13/Jul/2016    T. Baidal     Llamada al sp_firmantes a la base      */
/*                               cob_interfase                          */
/************************************************************************/


if exists (select 1 from sysobjects where name = 'sp_icte_firmantes')
...
as
  ...
  exec @w_return = cob_interfase..sp_firmantes
    @s_ssn       = @s_ssn,
    @s_srv       = @s_srv,
    @s_lsrv      = @s_lsrv,
    @s_user      = @s_user,

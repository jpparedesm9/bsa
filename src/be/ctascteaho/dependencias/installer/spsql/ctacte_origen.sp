...
/*  02/Jul/2009 M.Velastegui  Tabla común re_conversion / Ahorros       */
/************************************************************************/
use cob_cuentas
go
if exists (select 1 from sysobjects where name = 'sp_cta_origen')
...
select  @w_sp_name = 'sp_cta_origen'
...
begin
   ...
   and   cv_moneda     = @i_mon
   and   cv_codigo_cta = substring(@i_cta, 1, 3)
...
begin
   ...
   where cv_producto = @i_producto
   and   cv_moneda = @i_mon
   and   cv_codigo_cta = substring(@i_cta, 1, 6)

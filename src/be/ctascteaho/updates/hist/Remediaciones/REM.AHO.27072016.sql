...
select @w_producto    = 4,
	   @w_transaccion = 734,
	   @w_descripcion = 'MANTENIMIENTO PRODUCTO AHORRO CONTRACTUAL',
	   @w_nemonico    = 'MAAH',
	   @w_desc_larga  = 'MANTENIMIENTO PRODUCTO AHORRO CONTRACTUAL',
	   @w_producsp    = 10,
	   @w_procedure   = 716,
	   @w_base        = 'cob_remesas',
	   @w_nombresp    = 'sp_mto_aho_contractual',
	   @w_filesp      = 'remaahco.sp'

...
-----------------------------------------------------------------------------------------
-----------------------------------------------------------------------------------------
--•   Mantenimiento de Equivalencias: No existen Datos para el catálogo de la tabla: cl_producto
-----------------------------------------------------------------------------------------
-----------------------------------------------------------------------------------------
delete cl_catalogo_pro from cl_tabla where tabla in ( 'cl_producto') and codigo = cp_tabla
go
delete cl_catalogo from cl_tabla where cl_tabla.tabla in ('cl_producto') and cl_tabla.codigo = cl_catalogo.tabla
go
delete cl_tabla where cl_tabla.tabla in ('cl_producto')
go
-----------------------------------------------
...
delete cl_catalogo_pro from cl_tabla where tabla = 're_signo_ndc' and codigo = cp_tabla
go
delete cl_catalogo from cl_tabla where cl_tabla.tabla = 're_signo_ndc' and cl_tabla.codigo = cl_catalogo.tabla
go
delete cl_tabla where cl_tabla.tabla = 're_signo_ndc'
go
--
declare @w_maxtabla smallint
select @w_maxtabla = max(codigo) + 1 from cl_tabla
--
update cl_seqnos set siguiente = @w_maxtabla where tabla = 'cl_tabla'
--
declare @w_codigo smallint
select @w_codigo = siguiente + 1 from cl_seqnos where tabla = 'cl_tabla'
--
select @w_codigo = @w_codigo + 1

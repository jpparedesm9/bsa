/***********************************************************************************************************/
---No Bug					: 77068
---Título del Bug			: Back Office - Consulta de Cheques por Oficina - Sp no autorizado
---Fecha					: 13/07/2016 
...
select @w_producto    = 10,
	   @w_transaccion = 429,
	   @w_descripcion = 'CONSULTA DE CHEQUES REMESA POR OFICINA',
	   @w_nemonico    = 'CRPO',
	   @w_desc_larga  = 'CONSULTA DE CHEQUES REMESA POR OFICINA',
	   @w_producsp    = 10,
	   @w_procedure   = 423,
	   @w_base        = 'cob_remesas',
	   @w_nombresp    = 'sp_rem_chequexofi',
	   @w_filesp      = 'rechqofi.sp'

/****************************************************************************/
/*     Archivo:     peheserv.sp                                             */
/*     Stored procedure: sp_help_serv_pe                                    */
...
if exists (select
             1
           from   sysobjects
           where  name = 'sp_help_serv_pe')
  drop proc sp_help_serv_pe
go
create proc sp_help_serv_pe
(
  @s_ssn          int,
  ...
  begin
    ...
    begin
      select
        ...
        '1896' = substring(sd_descripcion, 1, 40) --DESCRIPCION

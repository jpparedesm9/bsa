...
as
  ...
  begin
    ...
    select
      ...
      '502046' = substring(vs_descripcion, 1, 50),                   --DESCRIPCION DE SERVICIO
      '1945' = c.co_tipo_rango,                                    --TIPO DE RANGO
      '1894' = substring(tr_descripcion, 1, 50),                   --DESCRIPCION DE TIPO RANGO
      '1665' = sp_pro_final,                                       --PRODUCTO FINAL
      '1200' = substring(pf_descripcion, 1, 50),                   --DESCRIPCION DE PROD.FIN.
  ...
  begin
    ...
    select
      '1367' = convert(char(10), cc_fecha_vigencia, @i_formato_fecha), --FECHA DE VIGENCIA
      '502046' = substring(vs_descripcion, 1, 50),          --SERVICIO PERSONALIZABLE
      '1063' = substring(b.valor, 1, 35),                 --CATEGORIA
      '1945' = substring(tr_descripcion, 1, 50),          --TIPO DE RANGO
      '1382' = cc_grupo_rango,                            --GRUPO DE RANGO
      '1678' = cc_rango,                                  --RANGO
      '1213' = ra_desde,                                  --DESDE
      '1398' = ra_hasta,                                  --HASTA  
      '1478' = convert(money,cc_minimo),                                 --MINIMO
      '1026' = convert(money,cc_val_medio),                              --BASE
      '1471' = convert(money,cc_maximo),                                 --MAXIMO
      cc_secuencial

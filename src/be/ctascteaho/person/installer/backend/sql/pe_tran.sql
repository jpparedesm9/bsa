...
where tn_trn_code in (4000,4001,4002,4003,4004,4005,4006,4007,4008,4009
...
,4154,4155,4156,4157,4158,4159,4162,4163,4164,4165,4166,4167,424
,728, 729, 730, 731,732, 425, 426,2946)
go
...
insert into cl_ttransaccion values(424, 'CONSULTA DE PRODUCTOS BANCARIOS',    'COPB', 'CONSULTA DE PRODUCTOS BANCARIOS')
insert into cl_ttransaccion values(732, 'CONSULTA DE RANGOS DE EDAD',    'CORE', 'CONSULTA DE RANGOS DE EDAD')

insert into cl_ttransaccion values(425, 'CONSULTA CARACTERISTICAS ADICIONALES', 'PFCCA', 'CONSULTA CARACTERISTICAS ADICIONALES')
insert into cl_ttransaccion values(426, 'ACTUALIZACION CARACTERISTICAS ADICIONALES', 'PFACA', 'ACTUALIZACION CARACTERISTICAS ADICIONALES')

INSERT INTO cl_ttransaccion VALUES (2946, 'ASIOCIACION DE CONTRATO A PRODUCTO BANC', 'ACPB', 'ASIOCIACION DE CONTRATO A PRODUCTO BANCARIO')

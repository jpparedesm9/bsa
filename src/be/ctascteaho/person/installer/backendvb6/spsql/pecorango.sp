/****************************************************************************/
/*     Archivo:     pecorango.sp                                            */
/*     Stored procedure: sp_rango_co                                        */
...
if exists (select
             1
           from   sysobjects
           where  name = 'sp_corango_pe')
  drop proc sp_corango_pe
go

create proc sp_corango_pe
(
  @s_ssn          int,
...
/* Consulta tipo de rango para especiales */
  /* Query un solo tipo de rango */
  if @i_operacion = 'V'
  begin
    if @t_trn != 4047
    begin

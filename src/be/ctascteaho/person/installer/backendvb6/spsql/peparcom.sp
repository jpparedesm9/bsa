    ...
    begin
      ...
      if exists (select
                 ...
                 where  pct_profinal    = @i_profinal
                    ...
                    and pct_causa       = @i_causa
                    and pct_canal       = @i_canal
                    and pct_estado      <> 'E')
      ...
      begin
        select
          ...
          @w_msg = 'LA TRANSACCION ' + cast(@i_transaccion as varchar) +
                   ' DEL PRODUCTO '
                   + cast(@i_profinal as varchar) + '-' + @i_categoria +
                   'YA EXISTE'
        goto ERROR
      end
      begin tran
    ...
    /* VERIFICA EXISTENCIA DE LA TRANSACCION ASOCIADA AL TIPO DE COBRO */
      ...
      begin
        select
          ...
          --@w_msg   = 'LA TRANSACCION ' + cast(@i_transaccion as varchar) + ' DEL PRODUCTO ' + cast(@i_profinal as varchar) + '-' + @i_categoria + 'NO EXISTE'
          @w_msg =

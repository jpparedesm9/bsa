...
-- II ERP 31/May/2001
/****************************************************************/
/* AUTORIZACION DE TRXS AL ROL ADMINISTRADOR DE PERSONALIZACION */
/****************************************************************/
print 'Autorizaci¢n de transacciones al rol ADMINISTRADOR DE PERSONALIZACION'
declare @w_rol  int
select  @w_rol = ro_rol
  from  ad_rol
...
if @@rowcount = 0
   begin
     ...
     update  #ad_rol_tmp set ro_rol = @w_rol, ro_descripcion = 'ADMINISTRADOR'

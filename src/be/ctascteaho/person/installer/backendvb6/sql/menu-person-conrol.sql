...
begin
    ...
    where pa_name = 'PP.Parametrizacion de Productos'
...
where mo_filename = 'COBISCorp.tCOBIS.BCLI.Resources.dll'
...
if (@codigoDep is not null and @codigo is not null)
    ...
    begin
       print 'Ya existe dependencia registrada COBISCorp.tCOBIS.BCLI.Resources.dll'
    end
    else
    begin
       insert cobis..an_module_dependency  (md_mo_id, md_dependency_id ) values (@codigoDep, @codigo)
       print 'Dependencia registrada COBISCorp.tCOBIS.BCLI.Resources.dll'
    end
else

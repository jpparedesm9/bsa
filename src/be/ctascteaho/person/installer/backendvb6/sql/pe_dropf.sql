...
/* cb_balof_tmp_Key */
print 'cb_balof_tmp_Key'
if exists (select i.name from sysindexes i, sysobjects o
	where i.id = o.id and i.name = 'cb_balof_tmp_Key' and o.name = 'cb_balof_tmp')
drop index cb_balof_tmp.cb_balof_tmp_Key
go

/* i_mov_cb_mov_ant */
print 'i_mov_cb_mov_ant'
if exists (select i.name from sysindexes i, sysobjects o
	where i.id = o.id and i.name = 'i_mov_cb_mov_ant' and o.name = 'cb_mov_ant')
drop index cb_mov_ant.i_mov_cb_mov_ant
go

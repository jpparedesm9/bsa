/************************************************************************/
/*      Archivo:                cones_fu.sp 	                        */
/*      Stored procedure:       sp_conestado_fun                        */
/*      Base de datos:          cobis                                   */
/*      Producto:               Plazo Fijo                              */
...
/*                                    para nivel funcionario unicamente */
...
if object_id('sp_conestado_fun') is not null
   drop proc sp_conestado_fun
go

create proc sp_conestado_fun (
@s_ssn                  int             = NULL,
@s_user                 login           = NULL,
...
select @w_sp_name = 'sp_conestado_fun'

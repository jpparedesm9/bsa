/************************************************************************/
/*      Archivo:                cones_of.sp 	                        */
/*      Stored procedure:       sp_conestado_ofi                        */
/*      Base de datos:          cobis                                   */
/*      Producto:               Plazo Fijo                              */
...
if object_id('sp_conestado_ofi') is not null
   drop proc sp_conestado_ofi
go

create proc sp_conestado_ofi (
@s_ssn                  int             = NULL,
@s_user                 login           = NULL,
...
select @w_sp_name = 'sp_conestado_ofi'
...
from pf_operacion 
--, cobis..cl_direccion
where op_oficina = convert(int,@i_valor)

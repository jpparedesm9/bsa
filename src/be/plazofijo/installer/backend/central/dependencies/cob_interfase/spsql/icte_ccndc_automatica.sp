/************************************************************************/
/*  Archivo:              icte_ccndc_automatica.sp                      */
/*  Stored procedure: 	  sp_icte_ccndc_automatica                      */
...
if object_id('sp_icte_ccndc_automatica') is not null
   drop procedure sp_icte_ccndc_automatica
go

create proc sp_icte_ccndc_automatica(

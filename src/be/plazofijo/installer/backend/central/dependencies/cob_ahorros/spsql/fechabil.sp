...
/*     Fecha de escritura: 16-Feb-2010                                      */
/****************************************************************************/
/*                            IMPORTANTE                                    */
...
/*                           PROPOSITO                                      */
/*     Este programa se encarga de: Validar el siguiente dia habil a una    */
/*     fecha dada o incrementar en n dias una fecha y retornar la siguiente */
/*     fecha habil. Teniendo en cuenta que los sabados estan marcados como  */
/*     Habiles cuando No se compensa en el banco ese dia                    */
/****************************************************************************/ 
/*                           MODIFICACIONES                                 */
/*       FECHA          AUTOR           RAZON                               */
/*     16/Feb/10      J.Loyo          Emision Inicial                       */ 
/****************************************************************************/    
use cob_remesas
go

if exists (select * from sysobjects where name = 'sp_fecha_habil')

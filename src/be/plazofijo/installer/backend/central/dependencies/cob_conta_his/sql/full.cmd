...
echo Instalando Dependencias de Depositos a Plazo Fijo - Historico Contabilidad
echo -- CREACION DE TIPOS DE DATOS
sqlcmd -U%1 -P%2 -S%3 -i %5\cb_type.sql     -o %6\cb_type.out
echo -- CREACION DE TABLAS
sqlcmd -U%1 -P%2 -S%3 -i %5\cb_table.sql    -o %6\cb_table.out
echo -- CREACION DE CLAVES PRIMARIAS
sqlcmd -U%1 -P%2 -S%3 -i %5\cb_pkey.sql     -o %6\cb_pkey.out

/************************************************************************/
/*   Archivo:             sp_cons_hc.sp                                 */
/*   Stored procedure:    sp_consultarHC                                */
/*   Base de datos:  	  cobis                                         */
...
if exists (select 1 from sysobjects where name = 'sp_consultarHC')
   drop proc sp_consultarHC
go

create proc sp_consultarHC(

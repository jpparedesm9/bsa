...
echo Instalando Dependencias de Depositos a Plazo Fijo - Remesas
echo -- CREACION DE TIPOS DE DATOS
sqlcmd -U%1 -P%2 -S%3 -i %5\re_type.sql     -o %6\re_type.out
...
echo -- TRANSACCIONES AUTORIZADAS Y PARAMETRIZACION

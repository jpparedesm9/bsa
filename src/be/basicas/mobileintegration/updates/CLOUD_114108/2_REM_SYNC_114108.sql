...
values (1717,'sp_consultar_tipo_documento','cob_credito','V',getdate(),'constipodoc.sp')
...
delete from cl_parametro where pa_nemonico in ('ETACGR', 'ETARVI', 'ETACFD')
...
--Errores
delete from cl_errores where numero in (103192, 103193, 103194,103195, 2109106)

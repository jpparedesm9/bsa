...
if object_id('sp_ba_habilita_ej') is not null
begin
  drop procedure sp_ba_habilita_ej
  if object_id('sp_ba_habilita_ej') is not null
  begin
    print 'FALLO BORRADO DE PROCEDIMIENTO sp_ba_habilita_ej'
  end
end
go
create procedure sp_ba_habilita_ej
/************************************************************************/
/*      Archivo              :  ba_habilita_ej.sp                       */
/*      Base de datos        :  cobis                                   */
...
select @w_sp_name = 'sp_ba_habilita_ej'
...
begin
   exec @w_retorno_ej = cobis..sp_ba_error_log
        ...
        @i_intento    = @i_intento,
        @i_error      = @@error,
        @i_detalle    = 'ERROR EN HABILITACION DE PRODUCTOS'
   if @w_retorno_ej > 0
   begin
     return @w_retorno_ej 
   end
...
if object_id('sp_ba_habilita_ej') is null
begin
  print 'FALLO CREACION DE PROCEDIMIENTO sp_ba_habilita_ej'
end
go

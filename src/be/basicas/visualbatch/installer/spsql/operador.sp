...
/* Fecha de escritura:     05-Octubre-2001                              */
/************************************************************************/
/*                         IMPORTANTE                                   */
...
/*                        MODIFICACIONES                                */
/*    FECHA          AUTOR           RAZON                              */
/*    05-Oct-2001    C. Navas        Emision inicial                    */
/*    04-Jul-2012    J. Giler        Se aumento el parametro protocolo  */
/************************************************************************/
...
create proc sp_operador (
   ...
   @i_clogin      varchar(255) = NULL,
   @i_cpasswd     varchar(255) = NULL,
   @i_cip         varchar(255) = NULL,        
   @i_protocolo   varchar(10)  = NULL
)
as
declare
...
begin
    ...
    if exists (select 1 from ba_ftp)
        delete from ba_ftp

    insert into ba_ftp values (@i_clogin, @i_cpasswd, @i_cip, @i_protocolo)

...
/*    30-Jul-2009    S. Soto         Version exclusiva para CTS
         */ 
...
============================== */
   ...
   if @i_modo = 1 
      begin
            --SSO, el XPServer de CTS requiere explicitamente el nombre de los parametros @i_command y @i_param1
           exec @w_status  = ADMIN...rp_exec
                @i_command = @i_shell,
                @i_param1  = @i_param1

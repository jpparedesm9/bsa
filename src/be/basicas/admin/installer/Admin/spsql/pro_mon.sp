...
/*  20/Jul/2012 Miguel Aldaz En el insert y update se guarde en la tabla cl_pro_moneda la union del producto mas la moneda*/
/*  20/Jul/2012 Miguel Aldaz y el update si debe tener P y A en la clase*/
...
begin tran
	...
	values
		(@i_producto,@i_moneda, @i_tipo,
		 @i_descripcion, getdate(), @i_estado)
	if @@error != 0
	begin
		exec sp_cerror
		  @t_debug	 = @t_debug,
	...
	values (@s_ssn, 1524 , 'N', @s_date,
		...
		@i_producto, @i_moneda, @i_tipo, @i_descripcion, getdate(),
		@i_estado)
	if @@error != 0
	begin
	    exec sp_cerror
...
begin tran
        ...
        update cl_pro_moneda set  pm_estado   = @i_estado, 
                                  pm_descripcion  =@i_descripcion	--Inc 700 Miguel Aldaz HSBC 20-07-2012
	 where pm_producto = @i_producto
           and pm_tipo     = @i_tipo
           and pm_moneda   = @i_moneda 
	...
	insert into ts_pro_moneda (secuencia, tipo_transaccion, clase, fecha,
		    ...
		    estado)
	values (@s_ssn, 1524 , 'P', @s_date,					--Inc 700 Miguel Aldaz HSBC 20-07-2012 Cambia clase N por P
		@s_ofi, @s_user, @s_term, @s_srv, @s_lsrv,	
	...
	insert into ts_pro_moneda (secuencia, tipo_transaccion, clase, fecha,
		    ...
		    producto, moneda, tipo, descripcion,
		    estado)
	values (@s_ssn, 1524 , 'A', @s_date,					--Inc 700 Miguel Aldaz HSBC 20-07-2012 Cambia clase N por A
		@s_ofi, @s_user, @s_term, @s_srv, @s_lsrv,	

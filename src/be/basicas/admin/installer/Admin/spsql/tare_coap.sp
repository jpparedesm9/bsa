...
begin
  ...
  begin
    ...
    print "ALERTA: La fecha a ingresar es menor a la fecha de proceso ' + @w_date + ', sin embargo los datos seran ingresados"
  end
...
begin
  ...
  begin
    select @w_date = convert(char(10),@s_date,@i_formato_fecha)
    print "ALERTA: La fecha a modificar es menor a la fecha de proceso ' + @w_date + ' , sin embargo los datos seran modificados"
  end
...
begin
  ...
  begin
    select @w_date = convert(char(10),@s_date,@i_formato_fecha)
    print "ALERTA: La fecha a borrar es menor a la fecha de proceso ' + @w_date + ', sin embargo los datos seran borrados"
  end

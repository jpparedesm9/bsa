...
--===========================================================================
        ...
        begin
           ...
           where fu_login = @i_login
                ...
                if (@w_estado_fun != 'V')
           begin
                raiserror 900000 'Usuario esta bloqueado. Solicite AUTORIZACION'
                return 1
           end
       ...
       begin
          ...
          select @w_estado_fun = fu_estado
           ...
           if ((
              ...
              (
                   ...
                   begin
                        raiserror 900000 'El rol seleccionado esta caducado'
                        return 1
                   end
           end
           ...
           begin 
                if @i_campwd = 1
                  ...
                  begin
                        raiserror 900000 'Usuario tiene password caducado'
                        return 1
                  end
           end
         ...
         where  lo_login = @i_login 
           ...
           if (@@rowcount != 1)
           begin
                raiserror 900000 'Usuario no puede registrarse por error en la cl_funcionario'
                return 1
           end

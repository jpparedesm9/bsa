...
if @t_show_version = 1 
begin
      print 'Stored procedure sp_rolbusq_hsbc, version 4.0.0.1'
      return 0
end
...
if @i_modo = 0
    ...
    select fu_funcionario,
     ...
     where de_departamento = fu_departamento
       and de_oficina = fu_oficina
	   and fu_jefe = @i_funcionario
	   and fu_funcionario > @i_func_hijo
     order by fu_funcionario
	set rowcount 0    
end
else

...
-- print '%1!, %2!, %3!, %4!', @i_servidor, @i_direccion, @i_habilitado, @i_estado
...
begin
	...
	begin
			...
			select 
				...
				'Direcci¢n'	= ct_direccion,
				'Fecha'		= convert(varchar(10),ct_fecha,@i_formato_fecha),
...
begin
	...
	begin
		...
		Select 
			ct_direccion,
			convert(varchar(10),ct_fecha,@i_formato_fecha),
			ct_logid,
			ct_habilitado,
			ct_estado,
			ct_error,

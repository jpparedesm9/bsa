/* **********************************************************************/
/*      Archivo:                sp_usuario_fie.sp                       */
/*      Stored procedure:       sp_usuario_fie                          */
/*      Base de datos:          cobis                                   */
...
if exists (select * from sysobjects where name = 'sp_usuario_fie')
   drop proc sp_usuario_fie
go

create proc sp_usuario_fie (
	@s_ssn                  int = NULL,
	@s_user                 login = NULL,
	@s_sesn                 int = NULL,
...
select @w_sp_name = 'sp_usuario_fie'
...
if @t_show_version = 1 
begin
      print 'Stored procedure sp_usuario_fie, version 1.0.0.0'
      return 0
END

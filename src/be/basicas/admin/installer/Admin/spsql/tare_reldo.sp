...
/*      08/Ago/2012   J. Nieto              correciones ortograficas en */
/*                                           print                      */
...
begin
  ...
  if exists (select * 
	      ...
	      where @i_fechafin < rd_fecha_inicial
                and rd_cod_moneda = @i_moneda)
   begin
     print "ALERTA: Los datos ingresados tienen un rango de fecha anterior a otro ya ingresado, sin embargo los datos ser n ingresados"
   end
  ...
  begin
    ...
    print "ALERTA: El rango de fechas a ingresar es menor a la fecha de proceso ' + @w_date + ', sin embargo los datos ser n ingresados"
  end
...
begin
  ...
  and (rd_fecha_inicial >= @i_fechaini or @i_fechaini is null) 
  and (rd_fecha_final <= @i_fechafin or @i_fechafin is null)

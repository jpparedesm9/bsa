...
/************************************************************************/
/* 17/07/2012  PEDRO MONTENEGRO R INC-306       */
/* 11/09/2012  Ciro Rodriguez     INC-11        */
...
/*  'No existe funcionario'*/
  ...
  if not exists (
   ...
   if exists ( select * 
          ...
          where nl_filial = @i_filial and nl_oficina = @i_oficina and nl_nodo = @i_nodo) --PRMR (INC-306)
   begin

...
/*                MODIFICACIONES                */
/*    FECHA        AUTOR        RAZON                */
/*  19-04-2016  BBO         Migracion Sybase-Sqlserver FAL              */
/************************************************************************/

use cobis
go

if exists (select * from sysobjects where name = 'sp_interfaz_funcionalidad')
...
begin
    ...
    begin
        ...
        and ac_contexto=*cf_contexto
        and ac_idioma=@i_idioma
        and nc_contexto=*cf_contexto
        and nc_idioma=@i_idioma
        ******/

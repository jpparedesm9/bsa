...
/*	17/Julio/2012	Miguel. Aldaz  Incidencia 490  Validación si existe producto al insertar */
...
begin tran
	...
	if exists(select 1 from  cl_pro_oficina where pl_filial = @i_filial and  pl_oficina= @i_oficina
 	          and pl_producto= @i_producto  and pl_tipo = @i_tipo_r and  pl_moneda= @i_moneda)
	begin
	  exec sp_cerror
		@t_debug	= @t_debug,
		@t_file		= @t_file,
		@t_from		= @w_sp_name,
		@i_num		= 151174
	     /*"Error producto ya esta relacionado a oficina"*/
	  return 1
	end	

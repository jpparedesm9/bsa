...
create proc sp_busqueda_nodos (
    ...
    @i_oficina        tinyint = null,   --DAV 24100
    ...
    begin
        ...
        begin
                select  'Codigo nodo'            = nl_nodo,
                  ...
                  where convert(char,nl_nodo) like @i_valor
                    and    nl_estado = 'V'
                  order by  nl_nodo,nl_oficina                                                  --fin mig syb-sql 18042016
                  
                /********** MIGRACION SYB-SQL FAL 18-04-2016
        ...
        begin
            select  'Codigo nodo'            = nl_nodo,
              ...
              where convert(char,nl_nodo) like @i_valor
                and    nl_estado = 'V'
                and ((nl_nodo = @i_nodo and nl_oficina > @i_oficina) or nl_nodo > @i_nodo)
              order by  nl_nodo,nl_oficina                                                  --fin mig syb-sql 18042016
    ...
    begin
        ...
        begin
            select  'Codigo nodo'            = nl_nodo,
               ...
               from ad_nodo_oficina                                                         --inicio mig syb-sql 18042016
                    ...
                    inner join cl_funcionario X on nl_registrador = X.fu_funcionario
                    left outer join cl_funcionario Y on nl_habilitante = Y.fu_funcionario
              where left(nl_nombre, 20) like @i_valor
                and    nl_estado = 'V'                
              order by left(nl_nombre, 20)                                                  --fin mig syb-sql 18042016
        ...
        begin
            select  'Codigo nodo'           = nl_nodo,
              ...
              where left(nl_nombre, 20) like @i_valor
                and nl_estado = 'V'                
                and left(nl_nombre, 20) > @i_nombre 
              order by left(nl_nombre, 20)                                                  --fin mig syb-sql 18042016

/************************************************************************/
/*	Archivo: 		sp_cuentaesp_mig.sp			*/
/*	Stored procedure: 	sp_cu_especial_mig			*/
...
/*	cuentas asociadas al proceso 6029				*/
/*	Generando asi la funcion "int ctaespecial (char c[],char e[])" 	*/
...
if exists(select 1 from sysobjects where name = 'sp_cu_especial_mig')
   drop proc sp_cu_especial_mig
go

create proc sp_cu_especial_mig
as
declare 
...
print 'int ctaespecial (char c[], char e[])'
print '{'

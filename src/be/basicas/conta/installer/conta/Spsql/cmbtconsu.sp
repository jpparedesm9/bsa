/************************************************************************/
/*	Archivo: 		comprobt.sp			        */
/*	Stored procedure: 	sp_comprobt_consu			*/
...
if exists (select * from sysobjects where name = 'sp_comprobt_consu')
	drop proc sp_comprobt_consu  
go

create proc sp_comprobt_consu (
	@s_ssn			int = null,
...
select @w_sp_name = 'sp_comprobt_consu'

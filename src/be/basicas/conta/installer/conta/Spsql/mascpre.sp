/************************************************************************/
/*	Archivo: 		mascpre.sp 			        */
/*	Stored procedure: 	sp_mascara_pre 				*/
/*	Base de datos:  	cob_conta  				*/
/*	Producto:               contabilidad                		*/
/*	Disenado por:           Gonzalo Jaramillo          		*/
/*	Fecha de escritura:     11-Octubre-94 				*/
/************************************************************************/
/*				IMPORTANTE				*/
...
if exists (select * from sysobjects where name = 'sp_mascara_pre')
	drop proc sp_mascara_pre

go
create proc sp_mascara_pre (
	@s_ssn		int = null,
...
select @w_sp_name = 'sp_mascara_pre'
...
begin
	...
	while @w_flag1 > 0
	begin
		select @w_longitud = np_longitud
		from cob_conta..cb_nivel_presupuesto
		where np_empresa = @i_empresa and
			np_nivel_presupuesto = @w_contador

...
select *
from cl_codigo_postal_tmp_resp_204415
...
select *
from cl_codigo_postal_resp_204415
...
------------------------------------------------------------
delete cl_direccion
where di_ente in (select di_ente from cl_direccion_resp_204415) 
	
insert into cl_direccion
select *
from cl_direccion_resp_204415
...
select *
from cob_conta_super..sb_equivalencias_resp_204415
where eq_catalogo in ('ENT_FED','ENT_MUN','ENT_PARROQ')

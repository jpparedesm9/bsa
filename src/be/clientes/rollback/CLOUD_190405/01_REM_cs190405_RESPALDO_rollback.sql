...
select *
from cl_codigo_postal_tmp_resp_190405
...
select *
from cl_codigo_postal_resp_190405
...
------------------------------------------------------------
delete cl_direccion
where di_ente in (select di_ente from cl_direccion_resp_190405) 
	
insert into cl_direccion
select *
from cl_direccion_resp_190405
...
select *
from sb_equivalencias_resp_190405
where eq_catalogo in ('ENT_FED','ENT_MUN','ENT_PARROQ')

...
select *
from cl_codigo_postal_tmp_resp_145099
...
select *
from cl_codigo_postal_resp_145099
...
------------------------------------------------------------
delete cl_direccion
where di_direccion in (select di_direccion from cl_direccion_resp_145099) 
	
insert into cl_direccion
select *
from cl_direccion_resp_145099
...
select *
from sb_equivalencias_resp_145099
where eq_catalogo in ('ENT_FED','ENT_MUN','ENT_PARROQ')

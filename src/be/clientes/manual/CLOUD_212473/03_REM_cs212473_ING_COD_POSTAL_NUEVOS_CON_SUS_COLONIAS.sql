use cobis
go
print 'Inicio 03_REM_cs212473_ING_COD_POSTAL_NUEVOS_CON_SUS_COLONIAS:'+convert(varchar(30),getdate(),103)+'--'+convert(varchar(30),getdate(),108)
----------------
...
begin
    ...
    select @w_codigo_postal  = ltrim(rtrim(@w_codigo_postal)),
           @w_estado         = ltrim(rtrim(@w_estado))       ,
           @w_municipio      = ltrim(rtrim(@w_municipio))    ,
           @w_colonia        = ltrim(rtrim(@w_colonia))      ,
           @w_nombre_colonia = ltrim(rtrim(@w_nombre_colonia))
...
-- fin
print 'Fin 03_REM_cs212473_ING_COD_POSTAL_NUEVOS_CON_SUS_COLONIAS:'+convert(varchar(30),getdate(),103)+'--'+convert(varchar(30),getdate(),108)
-- 4s
go

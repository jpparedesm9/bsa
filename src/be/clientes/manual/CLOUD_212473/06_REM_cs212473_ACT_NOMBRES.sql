...
------------------------------------------------------UPDATE PROVINCIA----------------
print 'Inicio script 06_REM_cs212473_ACT_NOMBRES:'+convert(varchar(30),getdate(),103)+'--'+convert(varchar(30),getdate(),108)
...
print 'Fin script 06_REM_cs212473_ACT_NOMBRES:'+convert(varchar(30),getdate(),103)+'--'+convert(varchar(30),getdate(),108)

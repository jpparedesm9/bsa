...
--/*******************************************************************/
print 'Ini script 07_cs212473_CONSULTA_ANT_ELI_ENTREGAR_AL_DESARROLLADOR:'+convert(varchar(30),getdate(),103)+'--'+convert(varchar(30),getdate(),108)
...
select 'informacion_para_borrar' = 'informacion_para_borrar', * from #informacion_para_borrar
go
...
print 'Fin script 07_cs212473_CONSULTA_ANT_ELI_ENTREGAR_AL_DESARROLLADOR:'+convert(varchar(30),getdate(),103)+'--'+convert(varchar(30),getdate(),108)
--4s
go

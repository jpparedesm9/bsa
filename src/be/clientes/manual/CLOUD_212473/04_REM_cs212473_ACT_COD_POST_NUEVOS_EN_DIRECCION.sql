...
use cobis
go
print 'Inicio script 04_REM_cs212473_ACT_COD_POST_NUEVOS_EN_DIRECCION:'+convert(varchar(30),getdate(),103)+'--'+convert(varchar(30),getdate(),108)
--------------------
/*******************************************************************/
...
print 'Fin script 04_REM_cs212473_ACT_COD_POST_NUEVOS_EN_DIRECCION:'+convert(varchar(30),getdate(),103)+'--'+convert(varchar(30),getdate(),108)
go

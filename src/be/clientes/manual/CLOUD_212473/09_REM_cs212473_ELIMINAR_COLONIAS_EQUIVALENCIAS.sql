use cobis
go
print 'Ini script 09_REM_cs212473_ELIMINAR_COLONIAS: '+convert(varchar(30),getdate(),103)+'--'+convert(varchar(30),getdate(),108)
/***********************************************************************/
...
SELECT @w_max_parroquia = max(pq_parroquia) FROM cobis..cl_parroquia_resp_212473
...
DROP TABLE #consulta
DROP TABLE #para_eliminar_info
print 'Fin script 09_REM_cs212473_ELIMINAR_COLONIAS: '+convert(varchar(30),getdate(),103)+'--'+convert(varchar(30),getdate(),108)

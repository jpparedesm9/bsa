use cobis
go
print 'Ini script 10_REM_cs212473_ACTUALIZAR_EQUIVALENCIAS:'+convert(varchar(30),getdate(),103)+'--'+convert(varchar(30),getdate(),108)
----------------
...
--
print 'Fin script 10_REM_cs212473_ACTUALIZAR_EQUIVALENCIAS:'+convert(varchar(30),getdate(),103)+'--'+convert(varchar(30),getdate(),108)
go

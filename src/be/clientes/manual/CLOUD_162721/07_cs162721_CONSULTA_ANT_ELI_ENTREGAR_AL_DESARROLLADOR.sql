...
--/*******************************************************************/
print 'Inicio script 07 entregar_al_desarrollador:'+convert(varchar(30),getdate(),103)+'--'+convert(varchar(30),getdate(),108)
...
select distinct  -- este se envia 2045
       'ID_CLIENTE' = di_ente,
       'TIPO'       = tipo,
...
print 'Fin script 07 entregar_al_desarrollador:'+convert(varchar(30),getdate(),103)+'--'+convert(varchar(30),getdate(),108)
--4s
go
...
--278158
--4659 <>'CE'
--4657 sin where en di_codPostal

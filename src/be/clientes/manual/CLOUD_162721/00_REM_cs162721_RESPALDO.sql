...
use cobis
go
print 'Inicio script 00 respaldo:'+convert(varchar(30),getdate(),103)+'--'+convert(varchar(30),getdate(),108)
------------------------------------------------------------
--cl_codigo_postal_tmp_resp_162721
------------------------------------------------------------
IF OBJECT_ID ('dbo.cl_codigo_postal_tmp_resp_162721') IS NOT NULL
	DROP table dbo.cl_codigo_postal_tmp_resp_162721

select *
into cl_codigo_postal_tmp_resp_162721
...
select *
into cob_conta_super..sb_equivalencias_resp_162721

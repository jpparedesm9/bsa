...
go
----------------
print 'Inicio script 05_REM_cs174921_ING_NUEVAS_COLONIAS:'+convert(varchar(30),getdate(),103)+'--'+convert(varchar(30),getdate(),108)
...
print 'Fin script 05_REM_cs174921_ING_NUEVAS_COLONIAS:'+convert(varchar(30),getdate(),103)+'--'+convert(varchar(30),getdate(),108)
--24s
go
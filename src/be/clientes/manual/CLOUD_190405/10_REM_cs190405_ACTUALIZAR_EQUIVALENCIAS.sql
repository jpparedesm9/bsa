use cobis
go
print 'Inicio script 10 Actualizacion Equivalencias de Colonias: '+convert(varchar(30),getdate(),103)+'--'+convert(varchar(30),getdate(),108)
----------------
...
--
print 'Fin script 10 Actualizacion Equivalencias de Colonias: '+convert(varchar(30),getdate(),103)+'--'+convert(varchar(30),getdate(),108)

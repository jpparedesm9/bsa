use cobis
go
print 'Inicio script 02_REM_cs174921_ING_NUEVOS_MUNICIPIOS:'+convert(varchar(30),getdate(),103)+'--'+convert(varchar(30),getdate(),108)
--------------------
...
print 'Fin script 02_REM_cs174921_ING_NUEVOS_MUNICIPIOS:'+convert(varchar(30),getdate(),103)+'--'+convert(varchar(30),getdate(),108)
-- 4s
go

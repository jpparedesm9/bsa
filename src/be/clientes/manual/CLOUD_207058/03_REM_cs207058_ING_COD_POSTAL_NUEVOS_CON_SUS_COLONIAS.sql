use cobis
go
print 'Inicio 03_REM_cs204415_ING_COD_POSTAL_NUEVOS_CON_SUS_COLONIAS:'+convert(varchar(30),getdate(),103)+'--'+convert(varchar(30),getdate(),108)
----------------
...
-- fin
print 'Fin 03_REM_cs204415_ING_COD_POSTAL_NUEVOS_CON_SUS_COLONIAS:'+convert(varchar(30),getdate(),103)+'--'+convert(varchar(30),getdate(),108)
-- 4s
go

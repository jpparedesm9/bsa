...
------------------------------------------------------UPDATE PROVINCIA----------------
print 'Inicio script 06_REM_cs204415_ACT_NOMBRES:'+convert(varchar(30),getdate(),103)+'--'+convert(varchar(30),getdate(),108)
...
print 'Fin script 06_REM_cs204415_ACT_NOMBRES:'+convert(varchar(30),getdate(),103)+'--'+convert(varchar(30),getdate(),108)

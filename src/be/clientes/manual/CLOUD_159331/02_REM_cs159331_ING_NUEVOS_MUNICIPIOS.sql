use cobis
go
print 'Inicio script 03 codMunicipiosNuevos:'+convert(varchar(30),getdate(),103)+'--'+convert(varchar(30),getdate(),108)
----
...
print 'Fin script 03-a codMunicipiosNuevos:'+convert(varchar(30),getdate(),103)+'--'+convert(varchar(30),getdate(),108)
-- 4s
go

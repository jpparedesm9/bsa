...
begin
      ...
      begin
        print  'No existe @w_codigo_colonia: '  + convert(varchar(10),@w_cp_colonia)
     ...
     begin
           ...
           begin          
              ...
              insert into cl_codigo_postal(cp_codigo       , cp_estado       , cp_municipio       , cp_colonia       , cp_pais, cp_estado_h , cp_municipio_h , cp_colonia_h)
                                   values (@w_cp_codigo    , @w_codigo_estado, @w_codigo_municipio, @w_codigo_colonia, 484    , @w_cp_estado, @w_cp_municipio, @w_cp_colonia) 

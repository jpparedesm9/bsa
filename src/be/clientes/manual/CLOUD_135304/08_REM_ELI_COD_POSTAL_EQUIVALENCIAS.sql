...
SELECT '2_parte_a_eli', * FROM para_ingresar

--------------------------------------------------------------------------------------------------------------
------------------------------ hasta aca , si se ejecuta luego no habrá información luego
--------------------------------------------------------------------------------------------------------------
/****************************************************************************************/
...
select 'a_eliminar' = count(*) from #codigo_postal_eli---Ini: 3842
/****************************************************************************************/
/* SELECTS PARROQUIAS                                                                   */
/****************************************************************************************/

SELECT '#parroq_a_borrar' = count(*)---Ini: 3842-----------------Fin:
FROM cobis..cl_parroquia 
WHERE pq_parroquia IN (SELECT cp_colonia FROM #codigo_postal_eli)

SELECT '#equiv_a_borrar' = count(*)---Ini: 3842-----------------Fin:

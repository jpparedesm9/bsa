use cobis
go
print 'Inicio script 03 codPostalNuevosConSusColonias:'+convert(varchar(30),getdate(),103)+'--'+convert(varchar(30),getdate(),108)
--
...
begin
      ...
      select  'Secuencial: '  + convert(varchar,@w_secuencial) + '--codigo_postal: '+ convert(varchar, @w_codigo_postal)
...
print 'Fin script 03 codPostalNuevosConSusColonias:'+convert(varchar(30),getdate(),103)+'--'+convert(varchar(30),getdate(),108)
-- 4s
go

...
use cobis
go
print 'Inicio script 01 respaldo:'+convert(varchar(30),getdate(),103)+'--'+convert(varchar(30),getdate(),108)
------------------------------------------------------------
--cl_codigo_postal_tmp_resp_145099
------------------------------------------------------------
IF OBJECT_ID ('dbo.cl_codigo_postal_tmp_resp_145099') IS NOT NULL
	DROP table dbo.cl_codigo_postal_tmp_resp_145099

select *
into cl_codigo_postal_tmp_resp_145099
...
select *
into cob_conta_super..sb_equivalencias_resp_145099
...
print 'Fin script 01 respaldo:'+convert(varchar(30),getdate(),103)+'--'+convert(varchar(30),getdate(),108)

...
print 'Inicio script 05 ing_nuevas_colonias:'+convert(varchar(30),getdate(),103)+'--'+convert(varchar(30),getdate(),108)
...
select 'codPost_nuevos' = 'codPost_nuevos', * from #informacion_nueva
...
begin
      ...
      begin
        select  'No existe @w_codigo_colonia: '  +  convert(varchar(10),@w_cp_colonia) + ', se procede a insertar'
...
print 'Fin script 05 ing_nuevas_colonias:'+convert(varchar(30),getdate(),103)+'--'+convert(varchar(30),getdate(),108)
--24s
go
...
INSERT INTO cl_principal_notificador (pn_nemonico, pn_work_folder, pn_source_folder, pn_username, pn_password, pn_host, pn_port, pn_timeout, pn_key_path, pn_authentication_type, pn_type)
VALUES ('CHARITS', 'D:\\WorkFolder\\', null, 'gctrcobi', null, '107.119.145.79', 22, 60000, 'C:\\Notificador-PRE1\\notification\\keys\\SFTPFilesharePREPROD.ppk', 'PRIVATE_KEY', 'INTERNET')
...
begin
    ...
    VALUES ('COPYBTI','COBIS_CATAL_MOTV.txt','D:\\WorkFolder\\CC\\','C:\\Cobis\\vbatch\\regulatorios\\listados\\','\\\\10.160.38.4\\WorkFolder\\PRE1\\CC\\', null, null, null, null, null, null, null, null, null, null, null)
end
...
begin
    ...
    dn_remote_download_path, dn_remote_download_history_path, dn_retry_download, 
    dn_to_download_extract)
    VALUES ('CHARITS','COBIS_CATAL_MOTV.txt','D:\\WorkFolder\\PRE1\\CC\\',null,null, '\\planCOBIS\\procesos\\interfaces\\ODS\\', 'COBIS_CATAL_MOTV.txt', '/planCOBIS/procesos/interfaces/ODS', 3, 0, null, null, null, null, null, null)
end

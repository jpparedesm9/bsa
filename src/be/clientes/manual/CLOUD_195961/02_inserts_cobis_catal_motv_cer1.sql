...
begin
    ...
    VALUES ('COPYBTI','COBIS_CATAL_MOTV.txt','D:\\WorkFolder\\CC\\','C:\\Cobis\\vbatch\\regulatorios\\listados\\','\\\\10.160.38.4\\WorkFolder\\CER1\\CC\\', null, null, null, null, null, null, null, null, null, null, null)
end
...
begin
    ...
    dn_remote_download_path, dn_remote_download_history_path, dn_retry_download, 
    dn_to_download_extract)
    VALUES ('CHARITS','COBIS_CATAL_MOTV.txt','D:\\WorkFolder\\CER1\\CC\\',null,null, '\\planCOBIS\\procesos\\interfaces\\ODS\\', 'COBIS_CATAL_MOTV.txt', '/planCOBIS/procesos/interfaces/ODS', 3, 0, null, null, null, null, null, null)
end
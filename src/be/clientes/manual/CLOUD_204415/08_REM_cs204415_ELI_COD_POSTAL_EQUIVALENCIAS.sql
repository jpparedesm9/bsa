use cobis
go
print 'Ini script 08_REM_cs204415_ELI_COD_POSTAL_EQUIVALENCIAS:'+convert(varchar(30),getdate(),103)+'--'+convert(varchar(30),getdate(),108)
--------------------
/*****************************************************************************************/
...
print 'Fin script 08_REM_cs204415_ELI_COD_POSTAL_EQUIVALENCIAS:'+convert(varchar(30),getdate(),103)+'--'+convert(varchar(30),getdate(),108)
--1s
GO

--Codigo postales que cambiaron sin alterar los datos de estado, municipio, colonia
use cobis
go
print 'Inicio script 04_REM_cs204415_ACT_COD_POST_NUEVOS_EN_DIRECCION:'+convert(varchar(30),getdate(),103)+'--'+convert(varchar(30),getdate(),108)
--------------------
/*******************************************************************/
...
select * from #para_actualizacion_codigo
...
print 'Fin script 04_REM_cs204415_ACT_COD_POST_NUEVOS_EN_DIRECCION:'+convert(varchar(30),getdate(),103)+'--'+convert(varchar(30),getdate(),108)
go

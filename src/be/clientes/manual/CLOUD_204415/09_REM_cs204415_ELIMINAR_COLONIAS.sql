use cobis
go
print 'Ini script 09_REM_cs204415_ELIMINAR_COLONIAS: '+convert(varchar(30),getdate(),103)+'--'+convert(varchar(30),getdate(),108)
/***********************************************************************/
...
SELECT @w_max_parroquia = max(pq_parroquia) FROM cobis..cl_parroquia_resp_204415
...
print 'Fin script 09_REM_cs204415_ELIMINAR_COLONIAS: '+convert(varchar(30),getdate(),103)+'--'+convert(varchar(30),getdate(),108)

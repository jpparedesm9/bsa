...
delete from cl_frm_seccion_ctrl
...
insert into cl_frm_preguntas values(@w_id_pregunta,@w_id_seccion_dt,@w_id_frm,@w_version_frm,'1. PROPIEDAD DEL NEGOCIO','PROPIEDAD DEL NEGOCIO','C','N',null,null)
...
insert into cl_frm_preguntas values(@w_id_pregunta,@w_id_seccion_dt,@w_id_frm,@w_version_frm,'2. ¿CUANTOS SOCIOS CONFORMAN EL NEGOCIO?','¿CUANTOS SOCIOS CONFORMAN EL NEGOCIO?','C','N',null,null)
...
select @w_id_pregunta = @w_id_pregunta +1
insert into cl_frm_preguntas values(@w_id_pregunta,@w_id_seccion_dt,@w_id_frm,@w_version_frm,'3. TIPO DE LOCAL','TIPO DE LOCAL','C','N',null,null)
...
select @w_id_pregunta = @w_id_pregunta +1
insert into cl_frm_preguntas values(@w_id_pregunta,@w_id_seccion_dt,@w_id_frm,@w_version_frm,'4. PROPIEDAD DEL LOCAL','PROPIEDAD DEL LOCAL','C','N',null,null)
...
select @w_id_pregunta = @w_id_pregunta +1
insert into cl_frm_preguntas values(@w_id_pregunta,@w_id_seccion_dt,@w_id_frm,@w_version_frm,'5. ANTIGUEDAD DEL NEGOCIO (COMPROBABLE)','ANTIGUEDAD DEL NEGOCIO(COMPROBABLE)','C','N',null,null)
...
select @w_id_pregunta = @w_id_pregunta +1
insert into cl_frm_preguntas values(@w_id_pregunta,@w_id_seccion_dt,@w_id_frm,@w_version_frm,'6. ¿CUANTOS EMPLEADOS TIENE?','¿CUANTOS EMPLEADOS TIENE?','C','N',null,null)
...
select @w_id_pregunta = @w_id_pregunta +1
insert into cl_frm_preguntas values(@w_id_pregunta,@w_id_seccion_dt,@w_id_frm,@w_version_frm,'7. ¿CUENTA CON RFC?','¿CUENTA CON RFC?','C','N',null,null)
...
select @w_id_pregunta = @w_id_pregunta +1
insert into cl_frm_preguntas values(@w_id_pregunta,@w_id_seccion_dt,@w_id_frm,@w_version_frm,'8. ¿CUANTOS DIAS A LA SEMANA ABRE EL NEGOCIO?','¿CUANTOS DIAS A LA SEMANA ABRE EL NEGOCIO?','C','N',null,null)
...
select @w_id_pregunta = @w_id_pregunta +1
insert into cl_frm_preguntas values(@w_id_pregunta,@w_id_seccion_dt,@w_id_frm,@w_version_frm,'9. ¿CUANTAS HORAS AL DIA SE ENCUENTRA ABIERTO EL NEGOCIO?','¿CUANTAS HORAS AL DIA SE ENCUENTRA ABIERTO EL NEGOCIO?','C','N',null,null)
...
select @w_id_pregunta = @w_id_pregunta +1
insert into cl_frm_preguntas values(@w_id_pregunta,@w_id_seccion_dt,@w_id_frm,@w_version_frm,'10. ¿CUANTOS CREDITOS TIENE VIGENTES?','¿CUANTOS CREDITOS TIENE VIGENTES?','C','N',null,null)
...
select @w_id_pregunta = @w_id_pregunta +1
insert into cl_frm_preguntas values(@w_id_pregunta,@w_id_seccion_dt,@w_id_frm,@w_version_frm,'11. ¿TIENE AUTO?¿CUANTOS AÑOS TIENE DE USO?','¿TIENE AUTO?¿CUANTOS AÑOS TIENE DE USO?','C','N',null,null)
...
select @w_id_pregunta = @w_id_pregunta +1
insert into cl_frm_preguntas values(@w_id_pregunta,@w_id_seccion_dt,@w_id_frm,@w_version_frm,'12. ¿CON CUANTOS PROVEEDORES TRABAJA?','¿CON CUANTOS PROVEEDORES TRABAJA?','C','N',null,null)
...
select @w_id_pregunta = @w_id_pregunta +1
insert into cl_frm_preguntas values(@w_id_pregunta,@w_id_seccion_dt,@w_id_frm,@w_version_frm,'13. ¿CUANTOS DIAS DE CREDITO LE DAN SUS PROVEEDORES?','¿CUANTOS DIAS DE CREDITO LE DAN SUS PROVEEDORES?','C','N',null,null)
...
select @w_id_pregunta = @w_id_pregunta +1
insert into cl_frm_preguntas values(@w_id_pregunta,@w_id_seccion_dt,@w_id_frm,@w_version_frm,'14. ¿A QUE DESTINARA EL CREDITO QUE LE OTORGUEMOS?','¿A QUE DESTINARA EL CREDITO QUE LE OTORGUEMOS?','C','N',null,null)
...
select @w_id_pregunta = @w_id_pregunta +1
insert into cl_frm_preguntas values(@w_id_pregunta,@w_id_seccion_dt,@w_id_frm,@w_version_frm,'15. ¿CUENTA CON REGISTRO DE SUS INGRESOS Y GASTOS?','¿CUENTA CON REGISTRO DE SUS INGRESOS Y GASTOS?','C','N',null,null)
...
select @w_id_pregunta = @w_id_pregunta +1
insert into cl_frm_preguntas values(@w_id_pregunta,@w_id_seccion_dt,@w_id_frm,@w_version_frm,'16. ¿CUAL ES EL MONTO QUE SOLICITARA?','¿CUAL ES EL MONTO QUE SOLICITARA?','M','N',null,null)
select @w_id_pregunta = @w_id_pregunta +1
insert into cl_frm_preguntas values(@w_id_pregunta,@w_id_seccion_dt,@w_id_frm,@w_version_frm,'17. ¿PERIODICIDAD DEL PAGO DEL PRESTAMO?','¿PERIODICIDAD DEL PAGO DEL PRESTAMO?','C','N',null,null)
...
select @w_id_pregunta = @w_id_pregunta + 1
insert into cl_frm_preguntas values(@w_id_pregunta,@w_id_seccion_dt,@w_id_frm,@w_version_frm,'18. ¿CUAL ES EL PLAZO QUE LE GUSTARIA SOLICITAR?','¿CUAL ES EL PLAZO QUE LE GUSTARIA SOLICITAR?','C','N',null,null)
...
select @w_id_pregunta = @w_id_pregunta + 1
insert into cl_frm_preguntas values(@w_id_pregunta,@w_id_seccion_in,@w_id_frm,@w_version_frm,'','INGRESOS','T','N',3,'N')
...
select @w_id_pregunta = @w_id_pregunta + 1
insert into cl_frm_preguntas values(@w_id_pregunta,@w_id_seccion_ga,@w_id_frm,@w_version_frm,'','GASTOS','T','N',3,'N')
...
select @w_id_pregunta = @w_id_pregunta + 1
insert into cl_frm_preguntas values(@w_id_pregunta,@w_id_seccion_ci,@w_id_frm,@w_version_frm,'1. ¿LOS ERRORES ENCONTRADOS SON BLOQUEANTES?','¿LOS ERRORES ENCONTRADOS SON BLOQUEANTES?','C','N',null,null)

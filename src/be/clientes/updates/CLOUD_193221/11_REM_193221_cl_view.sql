...
-- Vista: ts_persona_prin.otro_profesion
IF OBJECT_ID ('ts_persona_prin') IS NOT NULL
...
-- ----------------------------------------------------------
-- Tabla: ts_negocio_cliente.ts_otro_recurso varchar(30)
IF NOT EXISTS (SELECT * FROM sys.columns 
               WHERE Name = 'ts_otro_recurso'
			   AND Object_ID = Object_ID('ts_negocio_cliente'))
BEGIN
	ALTER TABLE ts_negocio_cliente ADD ts_otro_recurso varchar(30) null
	-- ALTER TABLE ts_negocio_cliente DROP COLUMN ts_otro_recurso;
END

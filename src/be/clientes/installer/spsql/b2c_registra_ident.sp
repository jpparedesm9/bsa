...
/****************************************************************************/
/*  Archivo:            b2c_registra_ident                                  */
/*  Stored procedure:   sp_b2c_registra_ident.sp                            */
/*  Base de datos:      cobis                                               */
/*  Producto:           Clientes                                            */
...
/*                        MODIFICACIONES                                    */
/*  FECHA              AUTOR              RAZON                             */
/*  16-Feb-2022        Sonia Rojas        Emision Inicial                   */
/****************************************************************************/
use cobis
go

if exists (select * from sysobjects where name = 'sp_b2c_registra_ident')
   drop proc sp_b2c_registra_ident
go

create proc sp_b2c_registra_ident (  
@s_ssn                 int = null,             
@s_user                login = null,
@s_sesn                int = null,
...
select @w_sp_name   = 'sp_b2c_registra_ident'
...
if @i_operacion = 'I' 
 begin
   ...
   ------------------------------------------------------------------------------
   --* :: P e r s o n a s   n a t u r a l e s   o   J u r i d i c a s
   ------------------------------------------------------------------------------

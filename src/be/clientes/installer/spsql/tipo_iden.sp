use cobis
go
if not object_id('sp_tipo_iden') is null
...
--* VERSIONAMIENTO DEL PROGRAMA
  if @t_show_version = 1
  begin
    print 'Stored Procedure=sp_tipo_iden Version=4.0.6172.5341 TFS-ChangeSet=C147439 TFS-GetDate=2016-54-24'
    return 0
  end

/*Consulta para catalogos */
if @t_trn not in(1429,1430,1431,1445)
begin
   exec sp_cerror
      @t_debug      = @t_debug,
      @t_file       = @t_file,

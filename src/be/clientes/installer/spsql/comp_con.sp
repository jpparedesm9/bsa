...
/*  02/Mayo/2016     Roxana S·nchez       MigraciÛn a CEN               */
/************************************************************************/
...
/* VERSION    */
    ...
    begin
      ...
      */
      ...
      begin
        ...
        if @@rowcount = 0
        begin
          print cast(@w_ofi_prod as varchar)
          exec sp_cerror
            @t_debug = @t_debug,
            @t_file  = @t_file,
            @t_from  = @w_sp_name,
            @i_num   = 101016 /*  'No existe Oficina'*/
          return 1
        end
      end
  ...
  begin
    ...
    begin
      ...
      if @@rowcount = 0
      begin
        print 'Consulta Inical tiene error de catalogo'
        exec sp_cerror
          @t_debug = @t_debug,
          @t_file  = @t_file,
          @t_from  = @w_sp_name,

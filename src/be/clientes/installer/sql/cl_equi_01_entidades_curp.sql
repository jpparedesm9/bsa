...
--ENTIDADES FEDERATIVAS REGULATORIO VS BURO CREDITO
delete cob_conta_super..sb_equivalencias where eq_catalogo = 'ENT_BURO'
go
insert into cob_conta_super..sb_equivalencias values('ENT_BURO', '01','AGS', 'AGUASCALIENTES','V')
insert into cob_conta_super..sb_equivalencias values('ENT_BURO', '02','BCN', 'BAJA CALIFORNIA NTE.','V')
insert into cob_conta_super..sb_equivalencias values('ENT_BURO', '03','BCS', 'BAJA CALIFORNIA SUR','V')
insert into cob_conta_super..sb_equivalencias values('ENT_BURO', '04','CAM', 'CAMPECHE','V')
insert into cob_conta_super..sb_equivalencias values('ENT_BURO', '05','COA', 'COAHUILA','V')
insert into cob_conta_super..sb_equivalencias values('ENT_BURO', '06','COL', 'COLIMA','V')
insert into cob_conta_super..sb_equivalencias values('ENT_BURO', '07','CHS', 'CHIAPAS','V')
insert into cob_conta_super..sb_equivalencias values('ENT_BURO', '08','CHI', 'CHIHUAHUA','V')
insert into cob_conta_super..sb_equivalencias values('ENT_BURO', '09','CDMX','DISTRITO FEDERAL','V')
insert into cob_conta_super..sb_equivalencias values('ENT_BURO', '10','DGO', 'DURANGO','V')
insert into cob_conta_super..sb_equivalencias values('ENT_BURO', '11','GTO', 'GUANAJUATO','V')
insert into cob_conta_super..sb_equivalencias values('ENT_BURO', '12','GRO', 'GUERRERO','V')
insert into cob_conta_super..sb_equivalencias values('ENT_BURO', '13','HGO', 'HIDALGO','V')
insert into cob_conta_super..sb_equivalencias values('ENT_BURO', '14','JAL', 'JALISCO','V')
insert into cob_conta_super..sb_equivalencias values('ENT_BURO', '15','EM',  'MEXICO','V')
insert into cob_conta_super..sb_equivalencias values('ENT_BURO', '16','MICH','MICHOACAN','V')
insert into cob_conta_super..sb_equivalencias values('ENT_BURO', '17','MOR', 'MORELOS','V')
insert into cob_conta_super..sb_equivalencias values('ENT_BURO', '18','NAY', 'NAYARIT','V')
insert into cob_conta_super..sb_equivalencias values('ENT_BURO', '19','NL',  'NUEVO LEON','V')
insert into cob_conta_super..sb_equivalencias values('ENT_BURO', '20','OAX', 'OAXACA','V')
insert into cob_conta_super..sb_equivalencias values('ENT_BURO', '21','PUE', 'PUEBLA','V')
insert into cob_conta_super..sb_equivalencias values('ENT_BURO', '22','QRO', 'QUERETARO','V')
insert into cob_conta_super..sb_equivalencias values('ENT_BURO', '23','QR',  'QUINTANA ROO','V')
insert into cob_conta_super..sb_equivalencias values('ENT_BURO', '24','SLP', 'SAN LUIS POTOSI','V')
insert into cob_conta_super..sb_equivalencias values('ENT_BURO', '25','SIN', 'SINALOA','V')
insert into cob_conta_super..sb_equivalencias values('ENT_BURO', '26','SON', 'SONORA','V')
insert into cob_conta_super..sb_equivalencias values('ENT_BURO', '27','TAB', 'TABASCO','V')
insert into cob_conta_super..sb_equivalencias values('ENT_BURO', '28','TAM', 'TAMAULIPAS','V')
insert into cob_conta_super..sb_equivalencias values('ENT_BURO', '29','TLAX','TLAXCALA','V')
insert into cob_conta_super..sb_equivalencias values('ENT_BURO', '30','VER', 'VERACRUZ','V')
insert into cob_conta_super..sb_equivalencias values('ENT_BURO', '31','YUC', 'YUCATAN','V')
insert into cob_conta_super..sb_equivalencias values('ENT_BURO', '32','ZAC', 'ZACATECAS','V')

...
rem ***********************************************************************
rem *                     PROPOSITO
rem *   Instalacion para Migracion de Cuentas de Ahorros
rem ***********************************************************************
...
echo ------ CREANDO OBJETOS PARA MIGRACION DE AHORROS... ------
echo ah_batch.sql
sqlcmd -U%1 -P%2 -S%3 -i %4\ah_batch.sql  -o %5\ah_batch.out

echo ah_table_mig.sql
sqlcmd -U%1 -P%2 -S%3 -i %4\ah_table_mig.sql  -o %5\ah_table_mig.out

echo ah_errores_mig.sql
sqlcmd -U%1 -P%2 -S%3 -i %4\ah_errores_mig.sql  -o %5\ah_errores_mig.out

/************************************************************************/
/*      Archivo:                crear_contragarantias_interfase.sp      */
/*      Stored procedure:       sp_crear_contragarantias_interfase      */
...
use cob_interfase
go
if exists (select 1 from sysobjects where name = 'sp_crear_contragarantias_interfase')
   drop proc sp_crear_contragarantias_interfase 
go

create proc sp_crear_contragarantias_interfase(
   @i_cuenta        char(16),
   @i_operacion     char(4),
...
select @w_sp_name      =  'sp_crear_contragarantias_interfase'

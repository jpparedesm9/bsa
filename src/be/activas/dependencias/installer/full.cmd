...
rem ***********************************************************************
rem *                     PROPOSITO
rem *   Instalacion general de Dependencias de COB_CARTERA BackEnd Central
rem ***********************************************************************
rem *                     MODIFICACIONES
...
echo ------ EJECUCION DE DEPENDENCIAS\SQL ... ------
@echo off 
call .\sql\full.cmd %1 %2 %3 .\sql\ .\sql\log\
echo ------ FIN EJECUCION DE DEPENDENCIAS\SQL ... ------

echo ------ EJECUCION DE DEPENDENCIAS\SP ... ------
@echo off 
call .\spsql\full.cmd %1 %2 %3 .\spsql\ .\spsql\log\
echo ------ FIN EJECUCION DE DEPENDENCIAS\SP ... ------

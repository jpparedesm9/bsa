/************************************************************************/
/*	Archivo: 		cco_ingoperadet.sp 			*/
/*	Stored procedure: 	sp_ing_opera_det     			*/
...
/*	Sp de la Herramienta de Cuadre que debe ser llamado por los     */
/*      Aplicativos para alimentar la estructura de Saldos Operativos   */
/*				MODIFICACIONES				*/
/*	FECHA		AUTOR		RAZON				*/
/************************************************************************/
...
if exists (select * from sysobjects where name = 'sp_ing_opera_det')

/************************************************************************/
/*  Archivo:                         ecdatopem.sp                       */
/*  Stored procedure:                sp_datos_operacion_mes             */
/*  Base de datos:                   cob_conta_super                    */
/*  Producto:                        REC                                */
/*  Disenado por:                    Omar Usiña                         */
/*  Fecha de escritura:              06/05/2009                         */
/************************************************************************/
/*              IMPORTANTE                                              */
...
/*              MODIFICACIONES                                          */
/*  FECHA          AUTOR                    RAZON                       */
/* 05/12/2016      Nolberto Vite       COBIS CLOUD MEXICANIZACION       */
/* 21/05/2019      AGO                 HISTORICO CA_GARANTIA_LIQUIDA.    */
/************************************************************************/
use cob_conta_super
go
...
create proc sp_datos_operacion_mes
(
   ...
   if exists (select 1
    ...
    insert into cob_conta_super..sb_dato_custodia
       (dc_fecha,           dc_aplicativo,           dc_garantia,        dc_oficina,
        ...
        dc_valor_uti_opera,
		dc_gl_id,            dc_gl_tramite,           dc_gl_grupo,       dc_gl_monto_individual,
	    dc_gl_monto_garantia,dc_gl_fecha_vencimiento ,dc_gl_pag_estado,  dc_gl_pag_fecha         ,
	    dc_gl_pag_valor     ,dc_gl_dev_estado        ,dc_gl_dev_valor    ,dc_gl_dev_fecha         )
     select 
        dc_fecha,            dc_aplicativo,          dc_garantia,        dc_oficina,
        dc_cliente,          dc_categoria,           dc_tipo,            dc_idonea,
        dc_fecha_avaluo,     dc_moneda,              dc_valor_avaluo,    dc_valor_actual,

...
if exists (select 1 from cobis..cl_catalogo where tabla = @w_tabla and ltrim(rtrim(valor)) = 'DOCUMENTO PROBATORIO ANVERSO') begin
    update cobis..cl_catalogo set valor = 'DOCUMENTO PROBATORIO' where tabla = @w_tabla and ltrim(rtrim(valor)) = 'DOCUMENTO PROBATORIO ANVERSO'
end else 

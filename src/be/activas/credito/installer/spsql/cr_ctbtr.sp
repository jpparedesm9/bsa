...
/*      Fecha de Documentacion:         25/Ago/98                      */
/***********************************************************************/
/*                      IMPORTANTE                                     */
...
/***********************************************************************/
/*                      PROPOSITO                                      */
/*      Este stored procedure va ha registrar la contabilizaci¢n de    */ 
/*      de los tramites de Operaciones Especificas y Cupos cuando      */
/*      estos son aprobados.                                           */
/*      Tambien va aumentar o disminuir el monto contabilizado en la   */
/*      utilizado de cupos                                             */
/***********************************************************************/
/*                      MODIFICACIONES                                 */
/*      FECHA           AUTOR                   RAZON                  */
/*      25/Ago/98       Tatiana Granda          Emision Inicial        */
/*      19/Feb/01       Zulma Reyes             CD00105 tequENDama     */
/*      22/dic/2003     C. Ruiz                 agregar indicador i_pit*/
...
BEGIN
      ...
      exec cobis..sp_cerror
           ...
           @t_from  = @w_sp_name,
           @i_num   = @w_return,
           @i_msg   = 'Parametro MLOCR No Definido'
      return @w_return
END
...
BEGIN
      ...
      exec cobis..sp_cerror
           ...
           @t_from  = @w_sp_name,
           @i_num   = @w_return,
           @i_msg   = 'Parametro DCI Producto CTE No Definido'
      return @w_return
END

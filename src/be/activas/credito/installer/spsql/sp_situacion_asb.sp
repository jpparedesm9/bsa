...
if exists (select * from sysobjects where name = 'sp_situacion_asb')
   drop proc sp_situacion_asb
go


create procedure sp_situacion_asb (
   @s_ssn	    		int = null,
   @s_user				login = null,
   @s_sesn				int = null,
...
begin
   ...
   if  @i_cliente = null and @i_grupo = null and @i_tramite is null
   ...
   begin
      ...
      begin
         ...
         if exists( select 1 from cobis..cl_cliente_grupo where cg_ente = @i_cliente ) 
            ...
            select @i_grupo   = cg_grupo,
              ...
              from cobis..cl_cliente_grupo, cobis..cl_grupo
      ...
      begin
		 ...
		 --SRO Grupo Solidario
         select @w_tipo_con = gr_tipo from cobis..cl_grupo where gr_grupo = @i_grupo

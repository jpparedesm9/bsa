/************************************************************/
/*   ARCHIVO:         sp_buro_resumen_reporte.sp  			*/
/*   NOMBRE LOGICO:   sp_buro_resumen_reporte		        */
...
/*                     MODIFICACIONES                       */
/*   FECHA         AUTOR               RAZON                */
/* 21/Agosto/2017   NTR                Emision Inicial      */
/*  05-07-2019       srojas            Reestructuración Buro*/
/*                                     histórico            */
/************************************************************/
use cob_credito
GO
...
IF EXISTS (SELECT 1 FROM sysobjects o, sysusers u WHERE o.uid = u.uid AND o.name = 'sp_buro_resumen_reporte' AND u.name = 'dbo' AND o.type = 'P')
    DROP PROCEDURE sp_buro_resumen_reporte
GO
...
--begin
--
--	update cr_buro_resumen_reporte set br_fecha_ingreso_bd 									= isnull(@i_fecha_ingreso_b_d, br_fecha_ingreso_bd), 

...
/*  Fecha de escritura:              15-Jul-1998                        */
/************************************************************************/
/*              IMPORTANTE                                              */
...
/*  temporal de credito (cr_tmp_datooper) para registrar los datos de   */
/*  las operaciones de los clientes                                     */
/*									*/
/************************************************************************/
/*              MODIFICACIONES                                          */
/*  FECHA       AUTOR                    RAZON                          */
/*  15/Jul/98   Monica Vidal G.          Emision Inicial                */
/*  07/Mar/99	I.Ordoœez		 Revision version		*/
/*  19/Feb/01   Zulma Reyes       ZR     CD00105  TEQUENDAMA            */
/*  20/Mar/01   Sheela Burbano           Gap CD00106                    */
/*  23/May/01   Sheela Burbano           Interfaces                     */
/*  21/Jun/01   Sheela Burbano           Cambios consolidador           */
/*  08/Ene/06   SIlvia Portilla S.       Clausula Aceleratoria          */
/************************************************************************/
...
if @i_ccon is null begin
   ...
   begin
      ...
      @t_from  = @w_sp_name,
      @i_msg   = 'No existe parametro para clase de cartera consumo',
      @i_num   = 2101084
      return 1 
   end
end else
...
if @i_sit_castigo is null begin
   ...
   begin
      ...
      exec cobis..sp_cerror
      @t_from  = @w_sp_name,
      @i_msg   = 'No existe parametro de Situacion de castigo',
      @i_num   = 2101084
      return 1 
   end
end else

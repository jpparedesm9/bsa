/************************************************************************/
/*  Archivo:                sp_var_es_primera_vez.sp                    */
/*  Stored procedure:       sp_var_es_primera_vez                       */
...
/*          MODIFICACIONES                                              */
/*  FECHA       AUTOR           RAZON                                   */
/*  9/Ene/2019  VBR             Emision Inicial                         */
/* **********************************************************************/
USE cob_credito
GO

if exists(select 1 from sysobjects where name ='sp_var_es_primera_vez')
	drop proc sp_var_es_primera_vez
GO


CREATE PROC sp_var_es_primera_vez
		(@s_ssn        int         = null,
	     @s_ofi        smallint,
	     @s_user       login,
         @s_date       datetime,
...
SELECT @w_sp_name='sp_var_es_primera_vez'

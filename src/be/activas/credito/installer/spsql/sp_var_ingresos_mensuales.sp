/************************************************************************/
/*  Archivo:                sp_var_ingresos_mensuales.sp                */
/*  Stored procedure:       sp_var_ingresos_mensuales                   */
...
IF OBJECT_ID ('dbo.sp_var_ingresos_mensuales') IS NOT NULL
	DROP PROCEDURE dbo.sp_var_ingresos_mensuales
GO

create proc [dbo].[sp_var_ingresos_mensuales](
@s_ssn           int          = null,
@s_ofi           smallint     = null,
@s_user          login        = null,
...
select @w_sp_name 	= 'sp_var_ingresos_mensuales'
...
select @w_valor_nuevo = isnull(en_otros_ingresos,0)
from cobis..cl_ente

...
/***********************************************************************/
/*                                 PROPOSITO                           */
/*     Este stored procedure permite aprobar las excepciones,          */
/*      instrucciones y tramites, cambiando su estatus a A             */
/*                                                                     */
/***********************************************************************/
/*               MODIFICACIONES                                        */
/*     FECHA          AUTOR               RAZON                        */
/*     17/Ago/95     Ivonne Ordonez       Emision Inicial              */
/*     10/sep/96     F.Arellano           Optimizaciones               */
/*     16/Dic/96     Erick Canas          Aprobacion en comite         */
/*     06/ene/97     F.Arellano           Lin. cred. en histor.        */
/*                                        aumento de fecha venc.       */
/*     07/Ene/98     M.Davila             Upgrade Lin. Credito         */
/*     30/May/98     Augusto Montoya      Personalizacion Bco.Estado   */
/*     15/Ene/01     Zulma Reyes      ZR  Gap: CD00074 Tequendama      */
/*     27/Feb/01     Sheela Burbano       Gap CD00054                  */
/***********************************************************************/

use cob_credito
go
if exists (select * from sysobjects where name = 'sp_apr_excepcion')

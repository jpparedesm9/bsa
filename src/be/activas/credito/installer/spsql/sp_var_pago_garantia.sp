...
/************************************************************************/
/*                           PROPOSITO                                  */
/* Procedure tipo Variable, Retorna SI si existe un pago de garantía    */
/* líquida que debe cancelarse                                          */
/************************************************************************/
/*                         MODIFICACIONES                               */
/*  FECHA          AUTOR    RAZON                                       */
/*  11/Sep/2017    VBR      Emision Inicial                             */
/*  13/Jun/2022    ACH      REQ #185234-se quita el valor por defecto,  */
/*                          porque si hay algún error en el sp que es   */
...
@i_tramite         = @w_tramite, --Tramite (desde tabla de notificaciones de garantías líquidas)
@i_opcion          = 'Q',
@i_vista_previa    = '',

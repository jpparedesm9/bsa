/************************************************************************/
/*  Archivo:                SP_DISTRIBUIDOR_COOR.sp                     */
/*  Stored procedure:       SP_DISTRIBUIDOR_COOR                        */
/*  Base de Datos:          cob_workflow                                */
/*  Producto:               Credito                                     */
/*  Fecha de Documentacion: 25/Sept/2017                                */
/************************************************************************/
/*          IMPORTANTE                                                  */
...
if exists (select 1 from sysobjects where name = 'SP_DISTRIBUIDOR_COOR')
   drop proc SP_DISTRIBUIDOR_COOR
go

create proc SP_DISTRIBUIDOR_COOR
(
   @s_ssn        int         = null,
   @s_ofi        smallint    = null,
   @s_user       login       = null,
...
-- Selecciona el oficial del tramite 

/************************************************************************/
/*  Archivo:                sp_var_verificar_datos_ind.sp               */
/*  Stored procedure:       sp_var_verificar_datos_ind                  */
...
if exists(select 1 from sysobjects where name ='sp_var_verificar_datos_ind')
	drop proc sp_var_verificar_datos_ind
go

create proc [dbo].[sp_var_verificar_datos_ind](
	@t_debug       		char(1)     = 'N',
...
@o_resultado1       = @w_valor_nuevo  out  

if @w_error <> 0 begin
   select @w_msg = 'ERROR AL EJECUTAR REGLA Verificar Datos de la Solicitud LCR' 
   goto ERROR
end 

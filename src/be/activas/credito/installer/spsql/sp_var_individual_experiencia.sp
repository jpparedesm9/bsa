...
GO
/************************************************************/
/*   ARCHIVO:         sp_var_individual_experiencia.sp      */
/*   NOMBRE LOGICO:   sp_var_individual_experiencia         */
...
/************************************************************/
/*                     PROPOSITO                            */
/*  Obtiene la experiencia individual del cliente           */
/************************************************************/
/*                     MODIFICACIONES                       */
/*   FECHA         AUTOR               RAZON                */
...
IF OBJECT_ID ('dbo.sp_var_individual_experiencia') IS NOT NULL
    DROP PROCEDURE dbo.sp_var_individual_experiencia
GO

CREATE PROC dbo.sp_var_individual_experiencia(
    @s_ssn          int         = null,
    @s_ofi          smallint,
    @s_user         login,
    @s_date         datetime,

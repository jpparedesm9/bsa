/************************************************************************/
/*  Archivo:                sp_var_score_cl_verifica.sp                 */
/*  Stored procedure:       sp_var_score_cl_verifica                    */
/*  Base de Datos:          cob_credito                                 */
/*  Producto:               Credito                                     */
/*  Disenado por:           VBR                                         */
/*  Fecha de Documentacion: 19/Jun/2017                                 */
/************************************************************************/
/*          IMPORTANTE                                                  */
...
/************************************************************************/
/*          PROPOSITO                                                   */
/* Procedure tipo Variable, el valor del score de verificación de datos */
/* del Cliente                                                          */
/************************************************************************/
/*          MODIFICACIONES                                              */
/*  FECHA       AUTOR           RAZON                                   */
/*  19/Jun/2017 VBR             Emision Inicial                         */
/* **********************************************************************/
USE cob_credito
GO

if exists(select 1 from sysobjects where name ='sp_var_score_cl_verifica')
	drop proc sp_var_score_cl_verifica
GO


CREATE PROC sp_var_score_cl_verifica
		(@s_ssn        int             = null,
	         @s_ofi        smallint    = null,
	         @s_user       login       = null,
...
SELECT @w_sp_name='sp_var_score_cl_verifica'

/********************************************************************/
/*      Archivo:                cr_segtram.sp                       */
/*      Stored procedure:       sp_seguros_tramite                  */
/*      Base de datos:          cob_credito                         */
/*      Producto: 		CREDITO                                     */
/*      Disenado por:  		AZU                                     */
/*      Fecha de escritura: 	06-May-2008                         */
/********************************************************************/
/*				IMPORTANTE                                          */
...
/*				PROPOSITO                                           */
/*	Permite Paramtrizar las planes de los seguros                   */
/*				MODIFICACIONES                                      */
/*	FECHA		AUTOR		RAZON                                   */
/*	06-JUL-2013     AZU       Emision inicial                       */
/*  30-DIC-2013     LBernal   REQ 00404 - control ingreso S.vida    */
/*  15-ENE-2014     LBernal   REQ 00405 - control SEGUROS           */
/********************************************************************/
...
begin
   ...
   select
   @w_error = 2101006,
   @w_msg   = 'TRANSACCIONES NO CORRESPONDEN'
   goto ERROR
end
   ...
   begin
     ...
     begin
        ...
        begin
           select                                                                                                                                                                                                                                                 
           @w_error = @w_return,                                                                                                                                                                                                                                         
           @w_msg   = 'ERROR AL EJECUTAR LOS SEQNOS de cr_seguros_tramite'
           goto ERROR
        end
        ...
        begin
           select                                                                                                                                                                                                                                                 
           @w_error = 2103001,                                                                                                                                                                                                                                         
           @w_msg   = 'ERROR AL INGRESAR LOS SEGUROS DEL TRAMITE'
           goto ERROR
        end
        ...
        begin
           select
           @w_error = @w_error,                                                                                                                                                                                                                                         
           @w_msg   = 'ERROR EN EJECUCION DE sp_tran_servicio AL INGRESAR SEGUROS'                
           goto ERROR
        end
     ...
     begin
           ...
           begin
              ...
              begin
                 select @w_error = 2103001,
                        @w_msg   = 'TIPO DE PLAN INGRESADO DIFERENTE AL DEL PRIMER DEL ASEGURADO'
                 goto ERROR
              end
           end
           ...
           begin
              select                                                                                                                                                                                                                                                 
              @w_error = 2103001,                                                                                                                                                                                                                                         
              @w_msg   = 'ERROR AL INGRESAR LOS ASEGURADOS'
              goto ERROR
           end
           ...
           begin
              select
              @w_error = @w_error,                                                                                                                                                                                                                                         
              @w_msg   = 'ERROR EN EJECUCION DE sp_tran_servicio AL INGRESAR ASEGURADOS'                
              goto ERROR
           end
    ...
    begin
          ...
          begin
             select                                                                                                                                                                                                                                                 
             @w_error = 2103001,                                                                                                                                                                                                                                         
             @w_msg   = 'ERROR AL ACTUALIZAR LOS ASEGURADOS'
             goto ERROR
          end
        ...
        begin
           select
           @w_error = @w_error,                                                                                                                                                                                                                                         
           @w_msg   = 'ERROR EN EJECUCION DE sp_tran_servicio AL ACTUALIZAR ASEGURADOS'                
           goto ERROR
        end
     ...
     begin
       select                                                                                                                                                                                                                                                 
       @w_error = @w_error,                                                                                                                                                                                                                                         
       @w_msg   = 'ERROR AL ACTUALIZAR FECHAS DE COBERTURA DE LOS SEGUROS'
       goto ERROR
     end    
...
begin
   ...
   begin
     ...
     begin
       select                                                                                                                                                                                                                                                 
       @w_error = 2103001,                                                                                                                                                                                                                                         
       @w_msg   = 'DEBE ELIMINAR PRIMERO LOS BENEFICIARIOS DEL ASEGURADO'
       goto ERROR
     end
     ...
     begin
       select                                                                                                                                                                                                                                                 
       @w_error = 2103001,                                                                                                                                                                                                                                         
       @w_msg   = 'ERROR AL ELIMINAR EL ASEGURADO DEL SEGURO'
       goto ERROR
     end
     ...
     begin
        ...
        begin
          select                                                                                                                                                                                                                                                 
          @w_error = 2103001,                                                                                                                                                                                                                                         
          @w_msg   = 'ERROR AL ELIMINAR EL SEGURO DEL TRAMITE'
          goto ERROR
        end
      end
   end
   ...
   begin
      ...
      begin
         ...
         begin
            ...
            select                                                                                                                                                                                                                                                 
            @w_error = 2103001,                                                                                                                                                                                                                                         
            @w_msg   = 'EL TIPO DE SEGURO YA ESTA ASOCIADO AL TRAMITE. -> ' + @w_desc_tipo_seguro
            goto ERROR
         end
      end            
      ...
      begin
         ...
         begin
            select                                                                                                                                                                                                                                                 
            @w_error = 2103001,                                                                                                                                                                                                                                         
            @w_msg   = 'EL ASEGURADO YA ESTA ADJUNTO AL SEGURO'
            goto ERROR
         end          
      end
     ...
     begin
         ...
         begin
            ...
            begin
               select                                                                                                                                                                                                                                                 
               @w_error = 2103001,                                                                                                                                                                                                                                         
               @w_msg   = 'EXCEDE MAXIMO DE CANTIDAD DE ASEGURADOS PRINCIPALES (max=1) '
               goto ERROR
            end
         end
      end
      ...
      begin
         ...
         begin
            ...
            begin
               select                                                                                                                                                                                                                                                 
               @w_error = 2103001,                                                                                                                                                                                                                                         
               @w_msg   = 'EXCEDE MAXIMO DE CANTIDAD DE ASEGURADOS PADRES (max=2) '
               goto ERROR
            end
         end
         ...
         begin
            ...
            begin
               select                                                                                                                                                                                                                                                 
               @w_error = 2103001,                                                                                                                                                                                                                                         
               @w_msg   = 'EXCEDE MAXIMO DE CANTIDAD DE ASEGURADOS CONYUGE (max=1) '
               goto ERROR
            end
         end
         ...
         begin
            ...
            begin
               select                                                                                                                                                                                                                                                 
               @w_error = 2103001,                                                                                                                                                                                                                                         
               @w_msg   = 'EXCEDE MAXIMO DE CANTIDAD DE ASEGURADOS ADICIONALES'
               goto ERROR
            end
         end
         ...
         begin
            select                                                                                                                                                                                                                                                 
            @w_error = 2103001,                                                                                                                                                                                                                                         
            @w_msg   = 'EL ASEGURADO NO PUEDE SER INGRESADO POR CONDICIONES DE EDAD '
            goto ERROR
         end
         ...
         begin
            select                                                                                                                                                                                                                                                 
            @w_error = 2103001,                                                                                                                                                                                                                                         
            @w_msg   = 'EL ASEGURADO NO PUEDE SER INGRESADO POR CONDICIONES DE PERMANENCIA '
            goto ERROR
         end
      end
      ...
      begin
         ...
         begin
            select                                                                                                                                                                                                                                                 
            @w_error = 2103001,                                                                                                                                                                                                                                         
            @w_msg   = 'EL SEGURO DE DANOS SOLO ACEPTA COMO ASEGURADO EL DEUDOR DEL TRAMITE'
            goto ERROR
         end         
         ...
         begin
            select                                                                                                                                                                                                                                                 
            @w_error = 2103001,                                                                                                                                                                                                                                         
            @w_msg   = 'Cliente ya tiene el Tipo de Seguro a ingresar'
            goto ERROR
         end
      end
...
--          
         ...
         begin
            select                                                                                                                                                                                                                                                 
            @w_error = 2103001,                                                                                                                                                                                                                                         
            @w_msg   = 'EL ASEGURADO NO PUEDE SER INGRESADO POR CONDICIONES DE EDAD. EDAD:  ' + cast(@w_edad as varchar)  
            goto ERROR
         end
         ...
         begin
            select                                                                                                                                                                                                                                                 
            @w_error = 2103001,                                                                                                                                                                                                                                         
            @w_msg   = 'EL ASEGURADO NO PUEDE SER INGRESADO POR CONDICIONES DE PERMANENCIA.  EDAD:  ' + cast(@w_edad as varchar)
            goto ERROR
         end
      ...
      --VALIDA SI EL ASEGURADO PRINCIPAL ES EL MISMO DEUDOR REQ 00404
         ...
         begin
            ...
            begin     
               select                                                                                                                                                                                                                                                 
               @w_error = 2103121,                                                                                                                                                                                                                                         
               @w_msg   = 'EL ASEGURADO PRINCIPAL DEBE SER EL DEUDOR DEL CREDITO '--REQ 00404
               goto ERROR           
            end
         end    
         ...
         begin
            select
            @w_error = 2103002,
            @w_msg   = 'EL PARENTESCO NO CONCUERDA CON EL TIPO DE ASEGURADO (PRINCIPAL O CONYUGE)'
            goto ERROR            
         end
         ...
         begin
            select 
            @w_error = 2103002,
            @w_msg   = 'TITULAR DEL TRAMITE DEBE TENER CONYUGE REGISTRADO EN EL SISTEMA'
            goto ERROR
         end
         ...
         begin
            select 
            @w_error = 2103002,
            @w_msg   = 'NO ES EL CONYUGE DEL DEUDOR DEL CREDITO'
            goto ERROR
         end
      ...
      begin
         select                                                                                                                                                                                                                                                 
         @w_error = 2103001,                                                                                                                                                                                                                                         
         @w_msg   = 'ERROR AL INGRESAR TIPOS DE SEGUROS DEL CLIENTE EN OPERACIONES ANTERIORES PARA ESQUEMA NUEVO'
         goto ERROR
      end
      ...
      begin
         select                                                                                                                                                                                                                                                 
         @w_error = 2103001,                                                                                                                                                                                                                                         
         @w_msg   = 'ERROR AL INGRESAR TIPOS DE SEGUROS DEL CLIENTE EN OPERACIONES ANTERIORES PARA ESQUEMA ANTIGUO'
         goto ERROR
      end
      ...
      begin
         ...
         begin
            select                                                                                                                                                                                                                                                 
            @w_error = 2103001,                                                                                                                                                                                                                                         
            @w_msg   = 'ERROR AL ACTUALIZAR LAS COBERTURAS DE LOS SEGUROS DEL NUEVO CREDITO'
            goto ERROR
         end               
   ...
   begin      
      ...
      begin
         ...
         begin
           select                                                                                                                                                                                                                                                 
           @w_error = @w_error,                                                                                                                                                                                                                                         
           @w_msg   = 'ERROR AL ACTUALIZAR FECHAS DE COBERTURA DE LOS SEGUROS INGRESADOS DESDE EL DMO'
           goto ERROR
         end    
...
begin
   ...
   begin
      ...
      begin
         select
         @w_error = 2103005,
         @w_msg   = 'EL ASEGURADO: ' + cast(@w_sec_asegurado as varchar) + ' DEL SEGURO: ' + cast(@w_secuencial_seguro as varchar) + ' REQUIERE BENEFICIARIO'
         goto ERROR
      end
      ...
      begin
         ...
         begin
            select
            @w_error = 2103005,
            @w_msg   = 'EL SEGURO EXEQUIAL DEBE TENER ASEGURADO PRINCIPAL'
            goto ERROR
         end
      end
      ...
      begin
         ...
         begin
            select
            @w_error = 2103005,
            @w_msg   = 'EL SEGURO DE PRIMERA PERDIDA DEBE TENER LOS DOS ASEGURADOS'
            goto ERROR
         end
      end
   end
...
begin                  -- seguros cuyo tipo tambien se encuentre asociado a operaciones anteriores del Asegurado.
   ...
   begin
      ...
      begin
         select @w_error = 2103001,
                @w_msg   = 'DEBE TENER FLUJO DE DISPONIBLES PARA REALIZAR EL CALCULO DE LOS SEGUROS FINANCIADOS CON TABLA FLEXIBLE'
         goto ERROR
      end
   ...
   */                                                                 
   ...
   begin
      select                                                                                                                                                                                                                                                 
      @w_error = 2103001,                                                                                                                                                                                                                                         
      @w_msg   = 'ERROR AL INGRESAR TIPOS DE SEGUROS DEL CLIENTE EN EL CREDITO ACTUAL'
      goto ERROR
   end               
  ...
  /*Las fechas de cobertura del asegurado dependiente deben corresponder con las del asegurado principal.REQ405*/
   ...
   begin
      select                                                                                                                                                                                                                                                 
      @w_error = 2103001,                                                                                                                                                                                                                                         
      @w_msg   = 'ERROR AL ACTUALIZAR FECHAS DE COBERTURA DEL SEGURO DE PRIMERA PERDIDA'
      goto ERROR
   end    

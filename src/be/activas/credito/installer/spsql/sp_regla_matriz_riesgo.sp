...
go
/*************************************************************/
/*   ARCHIVO:         	sp_regla_matriz_riesgo.sp            */
/*   NOMBRE LOGICO:   	sp_regla_matriz_riesgo               */
/*   PRODUCTO:        	credito                              */
/*************************************************************/
/*                     IMPORTANTE                            */
...
IF OBJECT_ID ('dbo.sp_regla_matriz_riesgo') IS NOT NULL
	DROP PROCEDURE dbo.sp_regla_matriz_riesgo
GO

CREATE PROCEDURE sp_regla_matriz_riesgo (	
	@t_debug                   char(1) 	     = 'N',
	   ...
	   while (1 = 1) begin
	     ...
	     */			   
         ...
         values ( @i_ente,    '009',       @w_nivel_obtenido, convert(int ,@w_trans_internacionales_sum))	
			...
			PRINT 'REGLA NUMERO DE CONTRAPARTES - nivel_obtenido:' + convert(varchar(50), @w_nivel_obtenido)
       	    PRINT 'REGLA NUMERO DE CONTRAPARTES - @w_num_contrapartes:' + convert(varchar(50),@w_num_contrapartes)
			...
			PRINT 'REGLA CANAL DE CONTRATACION - nivel_obtenido:' + convert(varchar(50), @w_nivel_obtenido)
       	    PRINT 'REGLA CANAL DE CONTRATACION - @w_canal_contratacion:' + convert(varchar(50),@w_canal_contratacion)
			...
			PRINT 'REGLA FECHA DE NACIMIENTO - nivel_obtenido:' + convert(varchar(50), @w_nivel_obtenido)
       	    PRINT 'REGLA FECHA DE NACIMIENTO - @w_cal_fecha_nacimiento:' + convert(varchar(50),@w_cal_fecha_nacimiento)

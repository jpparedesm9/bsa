/***********************************************************************/
/*  Archivo:                    cr_cautra.sp                           */
/*  Stored procedure:           sp_causal_rechazo_tramite              */
/*  Base de Datos:              cob_credito                            */
/*  Producto:                   Credito	                               */
/*  Disenado por:               Gonzalo Solanilla                      */
/*  Fecha de Documentacion:     07/Ene/2003                            */
/***********************************************************************/
/*                            IMPORTANTE                               */
...
/***********************************************************************/
/*                             PROPOSITO                               */
/*  Este stored procedure permite Controlar el cumplimiento            */
/*  de rechazos por tramite                                            */
/*                                                                     */
/***********************************************************************/
/*                           MODIFICACIONES                            */
/*  FECHA             AUTOR              RAZON                         */
...
if exists (select 1 from sysobjects where name = 'sp_causal_rechazo_tramite')

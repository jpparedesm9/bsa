/************************************************************************/
/*  Archivo:                sp_var_valida_limite.sp                     */
...
/************************************************************************/
/*          PROPOSITO                                                   */
/* Procedure tipo Variable, Retorna SI si al menos un integrante tiene  */
/* un monto máximos propuestos mayor al monto autorizado                */
/************************************************************************/
/*          MODIFICACIONES                                              */
/*  FECHA       AUTOR                   RAZON                           */
...
if exists(select 1 from sysobjects where name ='sp_var_valida_limite')

/************************************************************************/
/*  Archivo:                sp_concentracion_capital.sp                 */
/*  Stored procedure:       sp_concentracion_capital                    */
/*  Base de Datos:          cob_credito                                 */
/*  Producto:               Credito                                     */
/*  Disenado por:           VBR                                         */
/*  Fecha de Documentacion: 20/Dic/2016                                 */
/************************************************************************/
/*          IMPORTANTE                                                  */
...
/************************************************************************/
/*          PROPOSITO                                                   */
/* Procedure tipo Variable, Retorna CC,CV si el cliente sobrepasa el    */
/* limite de concentración de capitales                                 */
/************************************************************************/
/*          MODIFICACIONES                                              */
/*  FECHA       AUTOR           RAZON                                   */
/*  20/Dic/2016 VBR             Emision Inicial                         */
/* **********************************************************************/
USE cob_credito
GO

if exists(select 1 from sysobjects where name ='sp_concentracion_capital')
...
@w_nro_operaciones = 0
  ...
  /****** REGLA - Retorna porcentaje de límite de concentración ***/
  SELECT @w_var_values = isnull(@w_param_nivef,' ') + '|' + isnull(@w_tipo_persona,' ')
    ...
    BEGIN
	    set @w_error = 2103018 --La regla no devolvio un resultado con la información(condiciones) proporcionada

use cob_credito
go
IF OBJECT_ID ('dbo.sp_var_matriz_pld') IS NOT NULL
	DROP PROCEDURE dbo.sp_var_matriz_pld
GO
/************************************************************************/
/*  Archivo:                sp_var_matriz_pld.sp                        */
/*  Stored procedure:       sp_var_matriz_pld                           */
...
SELECT @w_sp_name='sp_var_matriz_pld'
...
SELECT @w_valor_nuevo = isnull(ea_nivel_riesgo,'A1')
from cobis..cl_ente_aux
where ea_ente = @w_cliente


print 'Cliente: ' + convert(varchar,@w_cliente) + ', MATRIZ PLD: ' + @w_valor_nuevo 

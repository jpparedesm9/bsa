...
/*  Fecha de Documentacion:     11/Feb/03                              */
/***********************************************************************/
/*                             IMPORTANTE                              */
...
/*  en cr_arch_redes_tamortiz.                                         */
/*                                                                     */
/***********************************************************************/
/*                           MODIFICACIONES                            */
/*  FECHA       AUTOR               RAZON                              */
/*  11/Feb/03   Alfredo Zuluaga	    Emision Inicial                    */
/*  14nov2003   MD.Lopez 	        Eliminar opciones no utilizadas    */
/***********************************************************************/
use cob_credito
go

if exists (select 1 from sysobjects WHERE name = 'sp_archivo_redescuento_PA')

/**********************************************************************/
/*   ARCHIVO:         sp_buro_cuenta.sp  			                  */
/*   NOMBRE LOGICO:   sp_buro_cuenta		                          */
...
IF EXISTS (SELECT 1 FROM sysobjects o, sysusers u WHERE o.uid = u.uid AND o.name = 'sp_buro_cuenta' AND u.name = 'dbo' AND o.type = 'P')
    DROP PROCEDURE sp_buro_cuenta
GO
...
select @w_sp_name = 'sp_buro_cuenta'
...
begin
   ...
   (bc_ib_secuencial, bc_fecha_actualizacion, 
   ...
   VALUES (@w_secuencial, @i_fecha_actualizacion,

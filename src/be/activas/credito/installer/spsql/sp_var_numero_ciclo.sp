use cob_credito
go
IF OBJECT_ID ('dbo.sp_var_numero_ciclo') IS NOT NULL
	DROP PROCEDURE dbo.sp_var_numero_ciclo
GO
/************************************************************************/
/*  Archivo:                sp_var_numero_ciclo.sp                      */
/*  Stored procedure:       sp_var_numero_ciclo                         */
...
CREATE PROC sp_var_numero_ciclo(
   @s_ssn        int         = null,
   @s_ofi        smallint    = null,
   @s_user       login       = null,
...
SELECT @w_sp_name='sp_var_numero_ciclo'
...
SELECT @w_valor_nuevo = convert(varchar,en_nro_ciclo)
from cobis..cl_ente
where en_ente = @w_cliente


print 'Cliente: ' + convert(varchar,@w_cliente) + ', Nro Ciclo: ' + @w_valor_nuevo 

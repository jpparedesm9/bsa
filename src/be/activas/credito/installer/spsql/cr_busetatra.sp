...
/***********************************************************************/
/*                          PROPOSITO                                  */
/*    Este stored procedure nos permite buscar en que etapa del flujo  */
/*    se encuentra un tramite.                                         */
/*                                                                     */
/***********************************************************************/
...
if exists (select 1 from sysobjects where name = 'sp_busca_etapa_tramite')

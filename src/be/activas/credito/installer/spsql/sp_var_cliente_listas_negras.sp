/************************************************************************/
/*  Archivo:                sp_var_cliente_listas_negras.sp             */
...
/************************************************************************/
/*          PROPOSITO                                                   */
/* Procedure tipo Variable, Retorna SI si el cliente se encuentra       */
/* registrado en listas negras                                          */
/************************************************************************/
/*          MODIFICACIONES                                              */
/*  FECHA       AUTOR           RAZON                                   */
...
if exists(select 1 from sysobjects where name ='sp_var_cliente_listas_negras')

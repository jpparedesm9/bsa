/************************************************************************/
/*  Archivo:                sp_var_intentos_cta_buc.sp                  */
/*  Stored procedure:       sp_var_intentos_cta_buc                     */
...
if exists(select 1 from sysobjects where name ='sp_var_intentos_cta_buc')
	drop proc sp_var_intentos_cta_buc
go

create proc [dbo].[sp_var_intentos_cta_buc](
	@t_debug       		char(1)     = 'N',
...
select @w_valor_nuevo = convert(varchar,cbs_intentos)

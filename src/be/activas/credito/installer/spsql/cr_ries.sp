...
/***********************************************************************/
/*                           PROPOSITO                                 */
/*  Este procedimiento permite realizar una consulta de	               */
/*  los riesgos de un cliente en Cartera, Comercio Exterior            */
/*  Cuentas Corrientes y otros tramites individualmente.               */
/*                                                                     */
/***********************************************************************/
/*                         MODIFICACIONES                              */
/*	FECHA       AUTOR               RAZON		                       */
/*  20/Ago/98   T.Granda            Adaptaci¾n Bco Estado              */
/*	12/Mar/99	S. Hernandez		Cambio getdate GE1                 */
/*	21/jul/01	P. Garzon R.		Modificacion calculo               */
/*                                              del riesgo.            */
/*  14/oct/04   Luis Ponce          Optimizacion                       */
/*  07/oct/05   John Jairo Rendon   Optimizacion                       */
/***********************************************************************/
use cob_credito
go
...
declare
   ...
   BEGIN
      ...
      exec cobis..sp_cerror
           ...
           @t_from  = @w_sp_name,
           @i_num   = @w_return,
           @i_msg   = 'Parametro RIESIN No Definido'
      return @w_return
   END

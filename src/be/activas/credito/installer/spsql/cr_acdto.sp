...
/************************************************************************/
/*              PROPOSITO                                               */
/* Este programa es llamado por otros modulos para actualizar los datos */
/* del registro mensual de la tabla cr_dato_operacion                   */
/*									*/
/************************************************************************/
/*              MODIFICACIONES                                          */
/*  FECHA       AUTOR                    RAZON                          */
/*  14/Feb/01	Patricia Garzon		 Emision Inicial                */
/*  22/Jun/01	Sheela Burbano		 Cambios consolidador           */
/************************************************************************/
use cob_credito
go

if exists (select 1 from sysobjects where name = 'sp_act_datooper')
...
begin
   ...
   @t_from  = @w_sp_name,
   @i_msg   = 'No existe parametro de Proceso de Calificacion',
   @i_num   = 2101084
   return 1 
end
...
begin
   ...
   exec cobis..sp_cerror
   @t_from  = @w_sp_name,
   @i_msg   = 'No existe parametro de estado Suspenso de cartera',
   @i_num   = 2101084
   return 1 
end
...
begin
   ...
   exec cobis..sp_cerror
   @t_from  = @w_sp_name,
   @i_msg   = 'No existe parametro de Moneda Local',
   @i_num   = 2101084
   return 1 
end

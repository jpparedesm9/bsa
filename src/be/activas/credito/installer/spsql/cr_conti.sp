...
/*   Aprobados No Desembolsados y Cupos de Credito                      */
/*                                                                      */
/************************************************************************/
/*              MODIFICACIONES                                          */
/*  FECHA       AUTOR                    RAZON                          */
/*  04/20/2009  ALFREDO ZULUAGA          NUEVO ESQUEMA BANCAMIA         */
/*  08/Abr/2010 FDO CARVAJAL             cambios por consolidador CRE   */
/************************************************************************/

use cob_credito
go

if exists (select * from sysobjects where name = 'sp_contingencias')

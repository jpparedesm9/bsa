...
/***********************************************************************/
/*                          PROPOSITO                                  */
/*     Este stored procedure permite marcar la utilizacion             */
/*     de un cupo de credito.                                          */
/*                                                                     */
/*     Valida que exista disponibilidad de utilizacion para un tramite */
/*     asociado a un cupo                                              */
/***********************************************************************/
/*                         MODIFICACIONES                              */
/*     FECHA               AUTOR               RAZON                   */
/*     27/jul/01           Sheela Burbano      Interfaces              */
...
if exists (select 1 from sysobjects where name = 'sp_utiliz0')
   drop proc sp_utiliz0
go

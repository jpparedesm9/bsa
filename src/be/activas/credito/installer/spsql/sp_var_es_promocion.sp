/************************************************************************/
/*  Archivo:                sp_var_es_promocion.sp                        */
...
if exists(select 1 from sysobjects where name ='sp_var_es_promocion')
...
if @w_es_promo = 'S' select @w_valor_nuevo  = 'SI'
else select @w_valor_nuevo  = 'NO'

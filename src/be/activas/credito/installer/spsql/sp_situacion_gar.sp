...
if @i_vista_360 = 'S'
--print 'SRO --->@i_vista_360:'+@i_vista_360
begin
    ...
    begin
       ...
       begin
		 ...
		 --print 'SRO ---> 0 rowcount:'+convert(varchar, @@rowcount)
	...
	--print 'SRO ---> 1 rowcount:'+convert(varchar, @@rowcount)
       ...
       begin
          ...
          order by sc_cliente, a.sg_p_tipo_gar
			...
			--print 'SRO ---> 2 rowcount:'+convert(varchar, @@rowcount)
	  ...
	  from cr_gar_p_tmp LEFT JOIN cob_custodia..cu_estados_garantia ON ESTADO = eg_estado
		...
		--print 'SRO ---> 3 rowcount:'+convert(varchar, @@rowcount)
       ...
       begin
          ...
          select   'CLIENTE'          = CLIENTE,         'No. POLIZA'        = POLIZA,
            ...
            and spid = @w_spid 
			order by SEC
			--print 'SRO ---> 4 rowcount:'+convert(varchar, @@rowcount)
...
--Si vino por la VCC para histÂ¾ricos
...
begin
	...
	begin
		...
		cu_estado,    isnull( cu_plazo_fijo, cu_cuenta_hold),

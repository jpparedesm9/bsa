...
/*  NOMBRE LOGICO:   sp_aju_fuente_rec                                       */
/*  PRODUCTO:        Credito                                                 */
/*****************************************************************************/
/*                            IMPORTANTE                                     */
...
/*****************************************************************************/
/*                               PROPOSITO                                   */
/* Obtener el valor en Cartera y Tramites para las Fuentes de Recurso.       */
/*****************************************************************************/
...
if exists ( select name from sysobjects where type = 'P' and name = 'sp_aju_fuente_rec')

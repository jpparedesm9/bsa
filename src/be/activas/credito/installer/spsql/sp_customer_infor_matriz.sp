/************************************************************************/
/*  Archivo:                sp_customer_infor_matriz.sp                 */
...
USE cob_credito
go
IF OBJECT_ID ('dbo.sp_customer_infor_matriz') IS NOT NULL
	DROP PROCEDURE dbo.sp_customer_infor_matriz
GO
...
BEGIN
    ...
    BEGIN
	    ...
	    insert into cob_credito..cr_monto_num_riesgo (mnr_ente, mnr_num_op_env, mnr_mont_op_env, mnr_num_op_rec, mnr_mont_op_rec, mnr_num_dep_efec, mnr_mont_dep_efec, mnr_num_dep_noefec, mnr_mont_dep_noefec)

...
/*	Fecha de Documentacion: 29/Mar/96                                  */
/***********************************************************************/
/*                          IMPORTANTE                                 */
...
/***********************************************************************/
/*                           PROPOSITO                                 */
/*      Registrar la instrumentacion de un tramite, desde cartera o    */
/*      comercio exterior                                              */
/***********************************************************************/
/*                           MODIFICACIONES                            */
/*	FECHA		AUTOR			RAZON		                           */
/*  29/Mar/96	Ivonne Ordonez		Emision Inicial	                   */
/*  23/Abr/98	Augusto Montoya		Person. Banco Estado               */
/*  12/Feb/2009 Luis Ponce          EF-045 Version BancaMia            */
/***********************************************************************/

use cob_credito
go

if exists (select * from sysobjects where name = 'sp_int_credito1')

/************************************************************************/
/*  Archivo:                sp_var_lista_negra.sp                        */
/*  Stored procedure:       sp_var_lista_negra                           */
/*  Base de Datos:          cob_credito                                 */
/*  Producto:               Credito                                     */
/*  Disenado por:           M.Moya                                      */
/*  Fecha de Documentacion: 18/Jul/2017                                 */
/************************************************************************/
/*          IMPORTANTE                                                  */
...
/*          MODIFICACIONES                                              */
/*  FECHA       AUTOR                   RAZON                           */
/*  18/Jul/2017 M. Moya             Emision Inicial                    */
/* **********************************************************************/
USE cob_credito
GO

if exists(select 1 from sysobjects where name ='sp_var_lista_negra')
	drop proc sp_var_lista_negra
GO


CREATE PROC sp_var_lista_negra
		(@s_ssn        int         = null,
	     @s_ofi        smallint    = null,
	     @s_user       login       = null,
...
SELECT @w_sp_name='sp_var_lista_negra'
...
print 'INSTANCIA: ' + convert(VARCHAR,@i_id_inst_proc) + '- CLIENTE -' + convert(VARCHAR,@w_ente) +  ' ESTA EN LISTAS NEGRAS ' + @w_valor_nuevo 

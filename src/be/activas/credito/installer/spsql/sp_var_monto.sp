/************************************************************************/
/*  Archivo:                sp_var_monto.sp     	                    */
/*  Stored procedure:       sp_var_monto                                */
/*  Base de Datos:          cob_credito                                 */
/*  Producto:               Credito                                     */
/*  Disenado por:           VBR                                         */
/*  Fecha de Documentacion: 21/Dic/2016                                 */
/************************************************************************/
/*          IMPORTANTE                                                  */
...
/************************************************************************/
/*          PROPOSITO                                                   */
/*	Procedure tipo Variable, Retorna el monto del trámite que se está   */
/*  aprobanco.                                                          */
/************************************************************************/
/*          MODIFICACIONES                                              */
/*  FECHA       AUTOR           RAZON                                   */
/*  21/Dic/2016 VBR             Emision Inicial                         */
/* **********************************************************************/
USE cob_credito
GO

if exists(select 1 from sysobjects where name ='sp_var_monto')

...
GO
/*************************************************************/
/*   ARCHIVO:         	sp_xml_rfc_err_estd_cuenta.sp        */
/*   NOMBRE LOGICO:   	sp_xml_rfc_err_estd_cuenta           */
/*   PRODUCTO:        		CARTERA                          */
/*************************************************************/
/*                     IMPORTANTE                            */
...
/*                     MODIFICACIONES                        */
/*   FECHA         AUTOR               RAZON                 */
/*   13-Sep-2018  PXSG                Emision Inicial.       */
/*************************************************************/
IF OBJECT_ID ('dbo.sp_xml_rfc_err_estd_cuenta') IS NOT NULL
	DROP PROCEDURE dbo.sp_xml_rfc_err_estd_cuenta
GO

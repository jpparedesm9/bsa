/************************************************************************/
/*  Archivo:                sp_var_fecha_dispersion.sp                  */
/*  Stored procedure:       sp_var_fecha_dispersion                     */
/*  Base de Datos:          cob_credito                                 */
/*  Producto:               Credito                                     */
/*  Disenado por:           P. Ortiz                                    */
/*  Fecha de Documentacion: 30/Oct/2018                                 */
/************************************************************************/
/*          IMPORTANTE                                                  */
...
/************************************************************************/
/*          PROPOSITO                                                   */
/* Valida que la fecha de dispersión sea igual a la fecha de dispersion */
/* planificada                                                          */
/************************************************************************/
/*          MODIFICACIONES                                              */
/*  FECHA         AUTOR                   RAZON                         */
/* 30/Oct/2018   P. Ortiz             Emision Inicial                   */
/* **********************************************************************/

use cob_credito
go

if exists(select 1 from sysobjects where name ='sp_var_fecha_dispersion')
...
select @w_comentario = 'La fecha de dispersión para esta solicitud es el: ' 
...
begin
    ...
    and ol_texto like 'La fecha de dispersión para esta solicitud es el:%')
    
    delete cob_workflow..wf_ob_lineas 
    where ol_id_asig_act = @i_id_asig_act 
    and ol_texto like 'La fecha de dispersión para esta solicitud es el:%'
    
    select @w_comentario = @w_comentario + convert(varchar, isnull(@w_fecha_disp,''), 103)

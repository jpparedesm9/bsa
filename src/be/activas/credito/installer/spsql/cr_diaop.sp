...
exec sp_diario_operaciones
@i_fecha = '08/23/2010'

select * from cr_errorlog
where er_fecha_proc = '08/23/2010'

select count(1), do_tipo_reg, do_fecha, do_codigo_producto
from cob_credito..cr_dato_operacion
group by do_tipo_reg, do_fecha, do_codigo_producto

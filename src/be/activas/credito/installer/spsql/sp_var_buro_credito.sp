/****************************************************************/
/*   ARCHIVO:           sp_var_buro_credito.sp                  */
/*   NOMBRE LOGICO:     sp_var_buro_credito                     */
/*   PRODUCTO:              CARTERA                             */
/****************************************************************/
/*                     IMPORTANTE                               */
...
if exists (select 1 from sysobjects where name = 'sp_var_buro_credito')
   drop proc sp_var_buro_credito
go

create proc [dbo].[sp_var_buro_credito](
    @t_debug            char(1)     = 'N',

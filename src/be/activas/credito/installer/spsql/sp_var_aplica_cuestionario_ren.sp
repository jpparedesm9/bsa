/************************************************************************/
/*  Archivo:                sp_var_aplica_cuestionario_ren.sp           */
/*  Stored procedure:       sp_var_aplica_cuestionario_ren              */
/*  Base de Datos:          cob_credito                                 */
/*  Producto:               Credito                                     */
/*  Disenado por:           S.Rojas                                     */
/*  Fecha de Documentacion: 10/Feb/2021                                 */
/************************************************************************/
/*          IMPORTANTE                                                  */
...
/*          MODIFICACIONES                                              */
/*  FECHA       AUTOR                   RAZON                           */
/*  10/02/2021 S.Rojas             Emision Inicial                      */
/* **********************************************************************/
USE cob_credito
go

if exists(select 1 from sysobjects where name ='sp_var_aplica_cuestionario_ren')
	drop proc sp_var_aplica_cuestionario_ren
go


create proc sp_var_aplica_cuestionario_ren(
   @s_ssn      int          = null,
   @s_ofi      smallint     = null,
   @s_user     login        = null,

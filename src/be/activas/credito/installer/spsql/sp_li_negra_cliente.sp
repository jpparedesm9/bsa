...
/************************************************************************/
/*   Archivo:              sp_li_negra_cliente.sp                       */
/*   Stored procedure:     sp_li_negra_cliente                          */
/*   Base de datos:        cob_credito                                  */
/*   Producto:             CREDITO                                      */
/*   Disenado por:         PXSG                                         */
/*   Fecha de escritura:   22/08/2017                                   */
/************************************************************************/
/*                               IMPORTANTE                             */
...
/*                               CAMBIOS                                */
/*      FECHA          AUTOR            CAMBIO                          */
/*      22/08/2017     PXSG             Emision Inicial                 */
/*                                                                      */
/************************************************************************/
USE cob_credito
go
IF OBJECT_ID ('dbo.sp_li_negra_cliente') IS NOT NULL
	DROP PROCEDURE dbo.sp_li_negra_cliente
go

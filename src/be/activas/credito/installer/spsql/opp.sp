...
/*  Fecha de escritura: 17/Jul/2008                                     */
/************************************************************************/
/*              IMPORTANTE                                              */
...
/*              PROPOSITO                                               */
/*  Este programa realiza la consulta para el registro de garantias que */ 
/*  prepara la informacion de operaciones perfeccionadas                */
/*              MODIFICACIONES                                          */
/*  FECHA       AUTOR       RAZON                                       */
/*  18/Jul/08   M.Bernal    Emision Inicial                             */
/************************************************************************/
use cob_credito
go

if exists (select 1 from sysobjects where name = 'detalle_declar_jur')
   drop function detalle_declar_jur
go
---INC 116164 JUN.05.2014

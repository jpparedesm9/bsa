/************************************************************************/
/*   Archivo:                 sp_var_nro_ciclos_ind.sp				    */
/*   Stored procedure:        sp_var_nro_ciclos_ind					    */
/*   Base de Datos:           cob_credito                               */
/*   Producto:                Credito                                   */
/*   Disenado por:            A. Ortiz                                        */
...
/************************************************************************/
/*                         PROPOSITO                                    */
/*   Obtener el número de ciclos de los créditos individuales          	*/
/*	                     												*/
/************************************************************************/
/*                              MODIFICACIONES                          */
...
if not object_id('sp_var_nro_ciclos_ind') is null
   drop proc sp_var_nro_ciclos_ind
go

create proc sp_var_nro_ciclos_ind(
	@t_debug       		char(1)     = 'N',
...
declare	@w_sp_name 				varchar(64),
	...
	select @w_sp_name 	= 'sp_var_nro_ciclos_ind'
 
	select @w_cliente 		= io_campo_1 
	from cob_workflow..wf_inst_proceso
	where io_id_inst_proc 	= @i_id_inst_proc

	select @w_resultado = isnull(en_nro_ciclo,0) + 1 -- el ciclo minimo es 1

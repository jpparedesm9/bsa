-- RECARGAR DESDE HISTÓRICO BURO, DESPUES DE ALTER DE TABLAS
...
truncate table cr_buro_encabezado
...
insert into cr_interface_buro (ib_cliente, ib_fecha, ib_riesgo, ib_folio, ib_estado)
select ibh_cliente, ibh_fecha, ibh_riesgo, ibh_folio, 'V'
from cob_credito_his..cr_interface_buro_his
ORDER BY ibh_secuencial ASC
...
from cob_credito_his..cr_buro_cuenta_his WITH (NOLOCK),
cob_credito_his..cr_interface_buro_his WITH (NOLOCK),
cr_interface_buro WITH (NOLOCK)
where bch_ib_secuencial = ibh_secuencial
and   ibh_cliente       = ib_cliente
...
dbh_codigo_pais,
dbh_fecha_reporte
from  cob_credito_his..cr_direccion_buro_his WITH (NOLOCK),
cob_credito_his..cr_interface_buro_his WITH (NOLOCK),
cr_interface_buro WITH (NOLOCK)
where dbh_ib_secuencial = ibh_secuencial
and   ibh_cliente       = ib_cliente
...
from  cob_credito_his..cr_empleo_buro_his WITH (NOLOCK),
cob_credito_his..cr_interface_buro_his WITH (NOLOCK),
cr_interface_buro WITH (NOLOCK)
where ebh_ib_secuencial = ibh_secuencial
and   ibh_cliente       = ib_cliente
...
from  cob_credito_his..cr_consultas_buro_his WITH (NOLOCK),
cob_credito_his..cr_interface_buro_his WITH (NOLOCK),
cr_interface_buro WITH (NOLOCK)
where cbh_ib_secuencial = ibh_secuencial
and   ibh_cliente       = ib_cliente
...
sbh_codigo_razon, 
sbh_codigo_error
from  cob_credito_his..cr_score_buro_his WITH (NOLOCK),
cob_credito_his..cr_interface_buro_his WITH (NOLOCK),
cr_interface_buro WITH (NOLOCK)
where sbh_ib_secuencial = ibh_secuencial
and   ibh_cliente       = ib_cliente
...
from  cob_credito_his..cr_buro_resumen_reporte_his WITH (NOLOCK),
cob_credito_his..cr_interface_buro_his WITH (NOLOCK),
cr_interface_buro WITH (NOLOCK)
where brh_ib_secuencial = ibh_secuencial
and   ibh_cliente       = ib_cliente

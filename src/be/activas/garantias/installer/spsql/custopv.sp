...
/*	Descripcion / Tipo / Comprobacion de la existencia de una       */
/*	Garantia                                                        */
/*				MODIFICACIONES				*/
/*	FECHA		AUTOR		RAZON				*/
...
if exists (select 1 from sysobjects where name = 'sp_custopv')
    drop proc sp_custopv
go
...
begin
   ...
   from cu_custodia--,cobis..cl_ente

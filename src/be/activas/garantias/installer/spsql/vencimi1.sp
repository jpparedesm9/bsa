...
/*	Consulta de la Descripcion y Existencia de las Garantias para   */
/*      las Busquedas de los Vencimientos de la Garantia                */
/************************************************************************/
/*				MODIFICACIONES				*/
/*	FECHA		AUTOR		RAZON				*/
...
if exists (select 1 from sysobjects where name = 'sp_vencimi1')
    drop proc sp_vencimi1
go
create proc sp_vencimi1  (
   @s_ssn                int      = null,

...
if exists (select 1 from sysobjects where name = 'sp_garclien')
    drop proc sp_garclien
go
create proc sp_garclien  (
   @s_ssn                int         = null,
...
select @w_sp_name = 'sp_garclien'

/***********************************************************/
/* Codigos de Transacciones                                */

if (@t_trn <> 19254 and @i_operacion = 'S') 
...
begin
      ...
      if @i_modo = 1  -- TOTALES POR TIPO DE GARANTIA
         ...
         where cg_ente      = @i_cliente
          ...
          /**************************************************************
            from cu_custodia,cu_tipo_custodia,cob_conta..cb_vcotizacion,cu_cliente_garantia
           where cg_ente      = @i_cliente
             and cg_filial    = cu_filial
             and cg_sucursal  = cu_sucursal
             and cg_tipo_cust = cu_tipo

...
/*      Nov-15-2022    Dario Cumbal     Req #194284                     */
/************************************************************************/
...
@i_tasa             = @i_tasa,
@i_banca            = @i_banca,
@i_plazo            = @i_plazo,         --SRO 140073
@i_desplazamiento   = @i_desplazamiento,--SRO 140073
...
--SRO. DESPLAZAMIENTO		
if @i_desplazamiento > 0 begin
   print 'DESPLAZAMIENTO --- @w_banco' + @w_banco
   print 'DESPLAZAMIENTO --- @w_operacion' + convert(varchar,@w_operacion)
   print 'DESPLAZAMIENTO --- @w_cliente' + convert(varchar,@i_cliente)
   print 'DESPLAZAMIENTO --- @i_fecha_ini' + convert(varchar, @i_fecha_ini)
			   
   if (select datediff(dd, dit_fecha_ini, dit_fecha_ven) from ca_dividendo_tmp where dit_operacion = @w_operacion and dit_dividendo = 1) < @i_dias_desplazados begin

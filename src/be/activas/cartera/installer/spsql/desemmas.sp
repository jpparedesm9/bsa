...
into  @w_op_operacion_A,  @w_op_toperacion_A,       @w_op_banco_A,
      @w_op_tramite_A,    @w_op_estado_A,           @w_op_fecha_ini_A,
      @w_fecha_fin_A,     @w_op_codigo_externo_A,   @w_op_margen_redescuento_A,
...
begin
   ...
   begin
      ...
      if @w_op_tipo_linea_A =  @w_codigo_finagro and @w_op_codigo_externo_A is null
      begin
         --SACARLO DE TRAMITES
         update ca_operacion 
         ...
         select @w_op_codigo_externo_A = @w_llave_redescuento_a
      end  

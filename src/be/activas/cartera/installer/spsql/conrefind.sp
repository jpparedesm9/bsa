...
begin
  ...
  if @i_monto_pre = 0 begin
  
  	  exec @w_error          = sp_precancela_refer
        @s_user           = @s_user,
        @s_term           = @s_term,
        @i_operacion      = 'C', -- C =consulta montos // I = inserta tabla
        @i_fecha_proceso  = @w_fecha_proceso,
        @i_cliente        = @i_ente,
        @i_banco          = @i_banco,
        @i_monto_pre      = 0,
        ...
        select @i_monto_pre = @w_monto_pre 
  end
  ...
  IF @i_ente IS NULL OR @i_ente = 0 begin
   	  select 
      pr_monto_op,
      pr_monto_pre,
      pr_monto_seg,
      @w_fecha_proceso pr_fecha_liq,
      pr_nombre_cl,
      @w_fecha_proceso pr_fecha_ven,
      pr_nombre_of		

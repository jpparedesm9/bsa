...
begin
      select 
       ...
       'EstadoPrepago'       =  case  when  pp_estado_aplicar = 'N'  then  'No Aprobado' 
                                      when  pp_estado_aplicar = 'P'  then  'Rechazado' 
                                      when  pp_estado_aplicar = 'S'  then  'Aprobado'   
                                end,      
       'Estado Registro'     =  case  when  pp_estado_registro = 'I'  then  'Ingresado' 
                                      when  pp_estado_registro = 'P'  then  'Procesado' 
                                end,
       'Sec'                 =  pp_secuencial,

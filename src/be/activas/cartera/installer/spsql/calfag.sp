...
begin
   ...
   begin
      ...
      begin
         ...
         select @w_fecha_aux1 = dateadd(dd, -1, convert(varchar, datepart(MM, @w_fecha_aux)) + '/01/' + convert(varchar, datepart(YEAR, @w_fecha_aux)))

         /*** OBTIENE EL ULTIMO DIA DEL MES DE LA FECHA DESEMBOLSO ***/
         select @w_fecha_aux2 = dateadd(dd, -1, convert(varchar, datepart(MM, @w_fecha_aux1)) + '/01/' + convert(varchar, datepart(YEAR, @w_fecha_aux1)))

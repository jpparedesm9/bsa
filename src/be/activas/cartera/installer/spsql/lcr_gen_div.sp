...
/*    04/Ago/2022           DBM                   Cambio caso 189533     */
/* ********************************************************************* */
...
and   d.periodicidad    = 14
and   p.par = 'X'
and   d.fecha_fin       = DATEADD(dd,1,p.primer_ven)
...
if @i_debug = 'S' select '3.1.1',* from #dividendos where periodicidad = 14 and dia_fijo = 2 and evitar_feriados = 'S' and par = 'SI' order by fecha_fin
if @i_debug = 'S' select '3.1.2',* from #dividendos where periodicidad = 14 and dia_fijo = 2 and evitar_feriados = 'S' and par = 'NO' order by fecha_fin

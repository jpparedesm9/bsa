...
/* Producto:               Cartera                                      */
/* Archivo:                aplcnpto.sp                                  */
/* Procedimiento:          sp_aplicacion_concepto                       */
/* Disenado por:           MPO                                          */
...
select @w_vlr_despreciable = isnull(1.0 / power(10, @i_num_dec),0)
   ...
   begin
      ...
      begin
         ...
         if (@w_monto_rubro <> 0 and @i_abono_extraordinario = 'N') or
            (@w_monto_rubro <> 0 and @i_abono_extraordinario = 'S' and @w_di_dividendo <> @w_div_vigente) or
             ...
             insert into ca_det_trn
               ...
               values(@i_secuencial_pag,  @i_operacionca, @w_control,
                      ...
                      @w_codvalor,       @w_valor_pago,  
                       round(@w_valor_pago/@i_cotizacion, @i_num_dec),

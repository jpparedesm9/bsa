...
/* 30/Jun/2020        SRO                141685 - Cálculo Mora          */
/************************************************************************/  
...
-- INI - REQ 175: PEQUEÑA EMPRESA - CONSULTA DEL VALOR CAPITALIZADO POR GRACIA
...
-- FIN - REQ 175: PEQUEÑA EMPRESA - CONSULTA DEL VALOR CAPITALIZADO POR GRACIA
...
@w_banco,
@w_tramite,
'',--@w_lin_credito, No se está usando el campo en SANTANDER AL MOMENTO
@w_estado, 
@w_cliente,
@w_toperacion,
@w_desc_toperacion,
...
@w_capitalizado,       -- 135      REQ 175: PEQUEÑA EMPRESA
@w_telefonos,          -- 136
@w_direccion1,         -- 137

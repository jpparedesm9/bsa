/*************************************************************************/
/*   Archivo:            sp_crea_ren_hija_wf.sp                          */
/*   Stored procedure:   sp_crea_ren_hija_wf                             */
/*   Base de datos:      cob_workflow                                    */
/*   Producto:           Originacion                                     */
/*   Disenado por:       AGO                                             */
/*   Fecha de escritura: 14/01/2020                                      */
/*************************************************************************/
/*                                  IMPORTANTE                           */
...
IF OBJECT_ID ('dbo.sp_crea_ren_hija_wf') IS NOT NULL
	DROP PROCEDURE dbo.sp_crea_ren_hija_wf
GO

create procedure sp_crea_ren_hija_wf
(
   @s_ssn            int           = null,
   @s_ofi            smallint,
   @s_user           login,
...
select @w_sp_name = 'sp_crea_ren_hija_wf'
...
print 'ren_sp_eje_calendario_dia_pago-->>@w_respuesta: ' + @w_respuesta
if @w_respuesta = 'NO'
begin
   return 0
end
...
exec @w_return = sp_pasa_cartera_ren_wf
   @s_ssn            = @s_ssn          ,
   @s_ofi            = @s_ofi          ,
   @s_user           = @w_oficial      ,
   @s_date           = @s_date         ,

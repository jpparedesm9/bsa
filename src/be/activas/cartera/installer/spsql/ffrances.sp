...
/**PARAMETRO GENERAL DEL IVA*/
select @w_iva = pa_float                                                                                                                                                                                                                                      
from  cobis..cl_parametro                                                                                                                                                                                                                                     
where pa_nemonico = 'PIVA'                                                                                                                                                                                                                                    
and pa_producto = 'CTE'

if  @w_iva  is null begin
return 2600023
end                                                                                                                                                                                                                        

select @w_iva = (@w_iva/100)+1


select @w_tasa_cuota = (@i_dias_cap * @i_tasa_int) / (100.00 * @i_dias_anio) * @w_iva
...
select @o_cuota = ceiling(@o_cuota)

...
while @w_cont < 16 begin
   ...
   if @w_cont = 1 select @w_eje = case when @i_eje1 is null then (select ej_valor_default from cob_cartera..ca_eje where ej_matriz = @i_matriz and ej_fecha_vig = @w_fecha_vig and ej_eje = 1)  
                                       else @i_eje1 end
   if @w_cont = 2 select @w_eje = case when @i_eje2 is null then (select ej_valor_default from cob_cartera..ca_eje where ej_matriz = @i_matriz and ej_fecha_vig = @w_fecha_vig and ej_eje = 2)
                                       else @i_eje2 end
   if @w_cont = 3 select @w_eje = case when @i_eje3 is null then (select ej_valor_default from cob_cartera..ca_eje where ej_matriz = @i_matriz and ej_fecha_vig = @w_fecha_vig and ej_eje = 3)
                                       else @i_eje3 end
   if @w_cont = 4 select @w_eje = case when @i_eje4 is null then (select ej_valor_default from cob_cartera..ca_eje where ej_matriz = @i_matriz and ej_fecha_vig = @w_fecha_vig and ej_eje = 4)
                                       else @i_eje4 end
   if @w_cont = 5 select @w_eje = case when @i_eje5 is null then (select ej_valor_default from cob_cartera..ca_eje where ej_matriz = @i_matriz and ej_fecha_vig = @w_fecha_vig and ej_eje = 5)
                                       else @i_eje5 end
   if @w_cont = 6 select @w_eje = case when @i_eje6 is null then (select ej_valor_default from cob_cartera..ca_eje where ej_matriz = @i_matriz and ej_fecha_vig = @w_fecha_vig and ej_eje = 6)
                                       else @i_eje6 end
   if @w_cont = 7 select @w_eje = case when @i_eje7 is null then (select ej_valor_default from cob_cartera..ca_eje where ej_matriz = @i_matriz and ej_fecha_vig = @w_fecha_vig and ej_eje = 7)
                                       else @i_eje7 end
   if @w_cont = 8 select @w_eje = case when @i_eje8 is null then (select ej_valor_default from cob_cartera..ca_eje where ej_matriz = @i_matriz and ej_fecha_vig = @w_fecha_vig and ej_eje = 8)
                                       else @i_eje8 end
   if @w_cont = 9 select @w_eje = case when @i_eje9 is null then (select ej_valor_default from cob_cartera..ca_eje where ej_matriz = @i_matriz and ej_fecha_vig = @w_fecha_vig and ej_eje = 9)
                                       else @i_eje9 end
   if @w_cont = 10 select @w_eje = case when @i_eje10 is null then (select ej_valor_default from cob_cartera..ca_eje where ej_matriz = @i_matriz and ej_fecha_vig = @w_fecha_vig and ej_eje = 10)
                                        else @i_eje10 end
   if @w_cont = 11 select @w_eje = case when @i_eje11 is null then (select ej_valor_default from cob_cartera..ca_eje where ej_matriz = @i_matriz and ej_fecha_vig = @w_fecha_vig and ej_eje = 11)
                                        else @i_eje11 end
   if @w_cont = 12 select @w_eje = case when @i_eje12 is null then (select ej_valor_default from cob_cartera..ca_eje where ej_matriz = @i_matriz and ej_fecha_vig = @w_fecha_vig and ej_eje = 12)
                                        else @i_eje12 end
   if @w_cont = 13 select @w_eje = case when @i_eje13 is null then (select ej_valor_default from cob_cartera..ca_eje where ej_matriz = @i_matriz and ej_fecha_vig = @w_fecha_vig and ej_eje = 13)
                                        else @i_eje13 end
   if @w_cont = 14 select @w_eje = case when @i_eje14 is null then (select ej_valor_default from cob_cartera..ca_eje where ej_matriz = @i_matriz and ej_fecha_vig = @w_fecha_vig and ej_eje = 14)
                                        else @i_eje14 end
   if @w_cont = 15 select @w_eje = case when @i_eje15 is null then (select ej_valor_default from cob_cartera..ca_eje where ej_matriz = @i_matriz and ej_fecha_vig = @w_fecha_vig and ej_eje = 15)
                                        else @i_eje15 end

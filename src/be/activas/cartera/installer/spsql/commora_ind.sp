...
select distinct op_operacion, op_banco, di_dividendo, op_oficina, di_fecha_ven
into #individuales_tmp  
...
------------------------------------------------------------------------------------------
if exists(select 1 from #individuales_tmp where di_fecha_ven = @w_fecha_feriado_inc)
begin
   update #individuales_tmp set 
...
into #individuales
from #individuales_tmp  
where  di_fecha_ven         between @w_fecha_ini and  dateadd(dd,-1,@w_fecha_proceso)
------------------------------------------------------------------------------------------

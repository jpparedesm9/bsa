...
/*  29/07/2019   M. Taco           Caso 113432 Optimizacion sp          */
/************************************************************************/
...
select distinct
gv_asesor_id       = gr_oficial, --convert(int,0),
gv_asesor_name     = cob_conta_super.dbo.fn_formatea_ascii_ext(fu_nombre, 'AN'), --convert(varchar(60),''),
gv_coord_id        = oc_ofi_nsuperior,--convert(int,0),
...
gv_grupo_name      = cob_conta_super.dbo.fn_formatea_ascii_ext(gr_nombre, 'AN'), --convert(varchar(60),''),
...
from   ca_operacion inner join ca_dividendo on(op_operacion  = di_operacion)
...
group by  gr_oficial, fu_nombre, oc_ofi_nsuperior,  tg_grupo, gr_nombre, tg_referencia_grupal

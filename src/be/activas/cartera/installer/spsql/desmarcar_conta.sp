...
from ca_transaccion, cob_interfase..cco_error_conaut
...
from ca_transaccion_prv, cob_interfase..cco_error_conaut
...
if @@error <> 0 begin 
   select 
   @w_error = 710001, 
   @w_msg   = 'ERROR AL INSERT cob_interfase..cco_error_conaut'
   goto ERROR 
end 
...
delete cob_interfase..cco_error_conaut 
where ec_producto = 7
if @@error <> 0 begin 
   select 
   @w_error = 710003, 
   @w_msg   = 'ERROR AL MOVER LOS MENSAJES DE ERROR DESDE LA cob_interfase..cco_error_conaut'
   goto ERROR 
end 

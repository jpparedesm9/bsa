...
if @i_operacion = 'A'
begin
    print 'descheger.sp Ejecuta cob_interfase..sp_imprimir_lotes'
    exec @w_return           = cob_interfase..sp_imprimir_lotes
         @t_trn              = 29334,
         @s_ssn              = @s_ssn,
         @s_date             = @s_date,
         @s_user             = @s_user,
...
begin
    ...
    exec @w_return = cob_interfase..sp_modificar_suspencion
         @t_trn              = 29315,
         @s_date             = @s_date,
         @s_user             = @s_user,
         @s_sesn             = @s_sesn,

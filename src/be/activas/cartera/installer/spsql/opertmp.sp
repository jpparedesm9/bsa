...
/*      SEP-09-2020      Sonia Rojas      Req 140073                    */
/************************************************************************/
...
begin
   ...
   opt_emprendimiento,       opt_margen_redescuento,        opt_desplazamiento
   )
   values (
   ...
   @i_emprendimiento,                 @i_porcen_colateral,          @i_desplazamiento
   )
...
begin
   ...
   begin
	  ...
	  opt_margen_redescuento         = isnull(@i_porcen_colateral, opt_margen_redescuento),
	  opt_desplazamiento             = isnull(@i_desplazamiento, opt_desplazamiento)
      where opt_operacion            = @i_operacionca
      ...
      rot_valor = opt_monto
      from ca_operacion_tmp
      where rot_operacion   = opt_operacion 

/************************************************************************/
/*   Archivo:              impliqmsv.sp                                 */
/*   Stored procedure:     sp_imprimir_liquidacion_msv                  */
...
--and   op_banco = '140500243682'

--insert into tmp_plano_liq_msv (cadena) values 
--('dir_comercial | tel_comercial | ciudad_comercial | fec_nacimiento | sexo | tipo_linea | seguro_vida | otros_seguros | recursos | margen_redescuento | fec_ult_pago | vlr_ult_pago | tipo_productor | actividad | saldo_actual | pactado | clase | tipo_amortizacion | calificacion | cuota | provisiona | fec_calificacion | aprobado_por | nomina | monto_aprobado | fecha_aprobacion | matricula | escritura | notaria | tipo_garantia | des_garantia | vlr_avaluo | fecha_avaluo | ubicacion | mun_garantia | perito_aval | dias_venc | nom_estado | cuotas_vencidas | cuotas_pagadas | cuotas_pendientes | estado_juridico | fec_est_juridico | clausula_aplicada | fec_clausula | reestructuracion | anterior | numero_reest | oficina | deudor_otras | tasa | tasa_referencial | nombre_oficina | banco | nombre | mod_obligacion | periodo_pago | gracia_int | nom_estado | monto | otorgamiento | fecha_fin | destino | cedula | ultimo_pago | deudor | codeudor | moneda_desc | moneda | cliente | fecha_proceso | neto_cap | neto_deduc')

/************************************************************************/
/*   Archivo:              saldosmin.sp                                 */
/*   Stored procedure:     sp_saldos_minimos                            */
...
if @i_pago_cuota = 'N' begin
   ...
   @w_codvalor,             @w_diff_mop_mpag,       @w_diff_mop_mpag,
   @w_moneda_op,            1,                      'N',
...
if @i_pago_cuota = 'S' begin
  ...
  begin
   ...
   am_cuota - am_pagado,          am_cuota - am_pagado,      co_codigo*1000 + @w_op_estado * 10,             
   @w_moneda_op,                  1,                         'N',
   ...
   @w_codvalor,             -1*@w_monto,            -1*@w_monto,
   @w_moneda_op,            1,                      'N',

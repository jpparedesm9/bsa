...
/*01/07/2019       P. Ortiz      Agregar correo numero 5 en pagos       */
/************************************************************************/
...
begin
	...
	select
      ...
      'isnull(grv_dest_nombre5, ' + char(39) + char(32) + char(39) + ') as dest_nombre5, ' +
      'isnull(grv_dest_cargo5, ' + char(39) + char(32) + char(39) + ') as dest_cargo5, ' +
      'isnull(grv_dest_email5, ' + char(39) + char(32) + char(39) + ') as dest_email5, ' +
      '(select isnull(grvd_referencia, ' + char(39) + char(32) + char(39) + ') as referencia, '+
                 'isnull(grvd_institucion,' + char(39) + char(32) + char(39) + ') as institucion, '+
                 'isnull(grvd_convenio,' + char(39) + char(32) + char(39) + ') as nro_convenio '+
        'from cob_cartera..ca_gen_ref_cuota_vigente_det '+

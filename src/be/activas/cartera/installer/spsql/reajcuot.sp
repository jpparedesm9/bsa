...
/*      Producto:               Cartera                                  */
/*      Archivo:                reajcuot.sp                              */
/*      Procedimiento:          sp_reajuste_cuota                        */
...
opt_fecha_pri_cuot = @w_di_fecha_ven
where  opt_operacion = @i_operacionca
...
---PONER EL ESTADO DEL RUBRO CAP EN VIGENTE
...
while  @@fetch_status = 0 begin
   ...
   from   ca_amortizacion_tmp a, @wt_secs_conc

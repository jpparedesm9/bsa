...
insert into #grupos values ( 2857, 433 )-- se queda con 147, el problema es el trámite que esta en otra oficina-3354 y debería estar en 1032 por que el grupo pertenece a 1032
insert into #grupos values ( 3011, 490 )
select 
@w_grupo       = 0
...
while(1=1) begin 
   ...
   select @w_ciudad_dest = of_ciudad from cobis..cl_oficina
   where of_oficina     = @w_oficina_dest

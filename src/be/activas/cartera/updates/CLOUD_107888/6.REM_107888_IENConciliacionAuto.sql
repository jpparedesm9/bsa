...
BEGIN
    ...
    SELECT @w_cftd_order = @w_cftd_order + 1
    INSERT INTO ree_ien_column_file_def (cftd_id, cftd_id_parent, ftd_id, cftd_name, cftd_description, cftd_data_type, cftd_maxlength, cftd_filling_character, cftd_justification, cftd_expression, cftd_order, cftd_section, cftd_mandatory, cftd_reg_exp_validation, cftd_property_name, cftd_order_file, cftd_is_hidden)
    VALUES (@w_cftd_id, NULL, @w_ftd_id, 'FOLIO BANCO', 'FOLIO BANCO', 'STRING', 8, '', 'NONE', NULL, @w_cftd_order, 'DETAIL', 0, NULL, '[ns1:cobiscorp.ecobis.integrationengine.conciliation.service.dto][TransactionDetail%ns1.TransactionDetailDTO%trnCorrespondent]', @w_cftd_order, 0)
...
BEGIN
    ...
    VALUES (@w_jo_id, @w_co_id, 'Descarga de conciliacion santander', 'DOWNLOAD', '0 27 7 1/1 * ? *', NULL, 'JOB', 1, 'A', 'IN', 'APCDT')

    SELECT @w_jo_id = @w_jo_id + 1
    INSERT INTO ree_ien_jobs (jo_id, co_id, jo_description, jo_type, jo_cron_expression, jo_service_id, jo_type_cron, jo_has_template, jo_status, jo_in_out, jo_transaction_type)
    VALUES (@w_jo_id, @w_co_id, 'Procesamiento de conciliacion santander', 'PROCESS', NULL, NULL, 'ENTITY', 1, 'A', 'IN', 'APCDT')
...
BEGIN
    ...
    (
        ...
        @w_ente, NULL, 'D:\ien_home\conciliaciones', 'receive_APCDT', 0,
        0, '0 32 7 1/1 * ? *', 'H2H_43009668_\d{8}_\d{6}_\.edocta.copy', 'IN', 'A',
        'CFP=3', 0, 0, 'APCDT', 0,
        0, 0, NULL, NULL, NULL,
        'FTP', 'CDT', 0, NULL, 0,
        0, 0, 'CUSTOM', 0, 0,

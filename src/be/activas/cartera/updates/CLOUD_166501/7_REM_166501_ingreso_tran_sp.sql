...
VALUES(@w_tn_trn_code, 'APLICACION DESEMBOLSOS LCR', @w_tn_trn_code, 'APLICACION DESEMBOLSOS LCR')
...
VALUES(@w_pd_procedure, 'sp_ejecuta_desembolso_lcr', 'cob_cartera', 'V', getdate(), 'desembolsolcr')

/**********************************************************************************************************************/
--No Bug                     : NA
--Título de la Historia      : CGS-S114109 Pago Solidario-Cobranzas
--Fecha                      : 09/06/2017
--Descripción del Problema   : Al cargar el plazo aparece el código en vez de la descripcion.
--Descripción de la Solución : Aagregado de un select que permita mostrar correctamente el plazo
--Autor                      : Paúl Ortiz Vera
--Instalador                 : sp_consulta_pago_solidario.sp
--Ruta Instalador            : $/COB/Desarrollos/DEV_SaaSMX/Activas/Cartera/Backend/spsql
/**********************************************************************************************************************/
...
begin
  ...
  --actualizo las suma de la operacion grupal
    ...
    (operacion,    grupo,      opegrupal, monto_grupal,  fecha_solicitud,  oficial,     oficina,    tipo_credito,  tasa,
     plazo1,       plazo2 )
    select 
    op_operacion,  op_cliente, op_banco, op_monto,       op_fecha_ini,     op_oficial,  op_oficina, op_toperacion, op_tasa_cap, 

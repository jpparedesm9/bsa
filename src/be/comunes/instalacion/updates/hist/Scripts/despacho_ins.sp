...
/****** Object:  StoredProcedure [dbo].[sp_despacho_ins]    Script Date: 23/02/2018 01:54:20 p. m. ******/
DROP PROCEDURE [dbo].[sp_despacho_ins]
GO
...
values 
        (@w_siguiente ,       @i_template,        		@i_servicio,              
		 ...
		 @i_var7,             @i_from,                  @i_to,                    
		 @i_cc,				  'GRP-Santander@cobiscorp.com',                   @i_subject,               

...
rem ***********************************************************************
rem *                     PROPOSITO
rem *   Instalacion de personalizacion de catalogos y tablas de cob_fpm
rem ***********************************************************************
rem *                     MODIFICACIONES
...
echo fp_catlgo.sql
sqlcmd -U%1 -P%2 -S%3 -i %4\fp_catlgo.sql  -o %5\fp_catlgo.out

echo fp_tablesbymodule.sql
sqlcmd -U%1 -P%2 -S%3 -i %4\fp_tablesbymodule.sql  -o %5\fp_tablesbymodule.out

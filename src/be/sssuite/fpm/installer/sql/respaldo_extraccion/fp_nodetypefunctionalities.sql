...
insert into fp_nodetypefunctionalities values(5,'ACC_PROF',5)
insert into fp_nodetypefunctionalities values(6,'HIST_PROD',5)
insert into fp_nodetypefunctionalities values(7,'SEC_PROD',5)
insert into fp_nodetypefunctionalities values(6,'TIP_GAR',5)
insert into fp_nodetypefunctionalities values(3,'TIP_GAR',4)
go

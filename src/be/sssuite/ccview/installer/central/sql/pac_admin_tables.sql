...
/*if exists (SELECT 1
           FROM  INFORMATION_SCHEMA.TABLE_CONSTRAINTS
           WHERE CONSTRAINT_NAME = 'fk_section_management')
   alter table vcc_product_admin
...
if exists (SELECT 1
           FROM  INFORMATION_SCHEMA.TABLE_CONSTRAINTS
           WHERE CONSTRAINT_NAME = 'fk_vcc_dtos_ref_servi_vcc_serv')
...
if exists (SELECT 1
           FROM  INFORMATION_SCHEMA.TABLE_CONSTRAINTS
           WHERE CONSTRAINT_NAME = 'fk_vcc_prop_ref_dtos__vcc_dtos')
...
if exists (SELECT 1
           FROM  INFORMATION_SCHEMA.TABLE_CONSTRAINTS
           WHERE CONSTRAINT_NAME = 'fk_vcc_pro__ref_dtos__vcc_dtos')

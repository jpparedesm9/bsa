...
VALUES ('Businessprocess.Creditmanagement.RuleByRoleQuery.QueryExceptionByClient', 'cobiscorp.ecobis.businessprocess.creditmanagement.service.IRuleByRoleQuery', 'queryExceptionByClient', ' ', 21796, NULL, NULL, NULL)
go

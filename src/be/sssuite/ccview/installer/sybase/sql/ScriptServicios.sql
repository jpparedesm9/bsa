...
ELSE
	INSERT INTO ad_servicio_autorizado VALUES ('ClientViewer.Administration.DeleteConfigurationVCC',@rol,@producto, 'R', @moneda, getDate(), 'V', getDate())
...
ELSE
	INSERT INTO ad_servicio_autorizado VALUES ('ClientViewer.Administration.GetAllRoleConfigurationVCC',@rol,@producto, 'R', @moneda, getDate(), 'V', getDate())
...
ELSE
	INSERT INTO ad_servicio_autorizado VALUES ('ClientViewer.Administration.InsertConfigurationVCC',@rol,@producto, 'R', @moneda, getDate(), 'V', getDate())
...
ELSE
	INSERT INTO ad_servicio_autorizado VALUES ('ClientViewer.Administration.QueryConfigurationVCC',@rol,@producto, 'R', @moneda, getDate(), 'V', getDate())
...
ELSE
	INSERT INTO ad_servicio_autorizado VALUES ('ClientViewer.Administration.UpdateConfigurationVCC',@rol,@producto, 'R', @moneda, getDate(), 'V', getDate())
...
ELSE
	INSERT INTO ad_servicio_autorizado VALUES ('ClientViewer.Client.QueryClient',@rol,@producto, 'R', @moneda, getDate(), 'V', getDate())
...
ELSE
	INSERT INTO ad_servicio_autorizado VALUES ('ClientViewer.Client.QueryClientByParameters',@rol,@producto, 'R', @moneda, getDate(), 'V', getDate())
...
ELSE
	INSERT INTO ad_servicio_autorizado VALUES ('ClientViewer.Client.QueryClientDirections',@rol,@producto, 'R', @moneda, getDate(), 'V', getDate())
...
ELSE
	INSERT INTO ad_servicio_autorizado VALUES ('ClientViewer.Client.QueryClientRate',@rol,@producto, 'R', @moneda, getDate(), 'V', getDate())
...
ELSE
	INSERT INTO ad_servicio_autorizado VALUES ('ClientViewer.Client.QueryClientType',@rol,@producto, 'R', @moneda, getDate(), 'V', getDate())
...
ELSE
	INSERT INTO ad_servicio_autorizado VALUES ('ClientViewer.Client.QueryConsolidatedPosition',@rol,@producto, 'R', @moneda, getDate(), 'V', getDate())
...
ELSE
	INSERT INTO ad_servicio_autorizado VALUES ('ClientViewer.Client.QueryGroup',@rol,@producto, 'R', @moneda, getDate(), 'V', getDate())
...
ELSE
	INSERT INTO ad_servicio_autorizado VALUES ('ClientViewer.Client.QueryGroupDetail',@rol,@producto, 'R', @moneda, getDate(), 'V', getDate())
...
ELSE
	INSERT INTO ad_servicio_autorizado VALUES ('ClientViewer.Client.QueryGroupMembers',@rol,@producto, 'R', @moneda, getDate(), 'V', getDate())
...
ELSE
	INSERT INTO ad_servicio_autorizado VALUES ('ClientViewer.Client.QueryLegalClient',@rol,@producto, 'R', @moneda, getDate(), 'V', getDate())
...
ELSE
	INSERT INTO ad_servicio_autorizado VALUES ('ClientViewer.MaxDebt.QueryMaxDebt',@rol,@producto, 'R', @moneda, getDate(), 'V', getDate())
...
ELSE
	INSERT INTO ad_servicio_autorizado VALUES ('ClientViewer.Products.PrepareProductsData',@rol,@producto, 'R', @moneda, getDate(), 'V', getDate())
...
ELSE
	INSERT INTO ad_servicio_autorizado VALUES ('ClientViewer.Products.QueryProductsByClientId',@rol,@producto, 'R', @moneda, getDate(), 'V', getDate())
...
ELSE
	INSERT INTO ad_servicio_autorizado VALUES ('AddressTxService.getAddressesbyCustomer',@rol,@producto, 'R', @moneda, getDate(), 'V', getDate())
...
ELSE
	INSERT INTO ad_servicio_autorizado VALUES ('ClientViewer.Products.PrepareProductsDataHistory',@rol,@producto, 'R', @moneda, getDate(), 'V', getDate())
...
ELSE
	INSERT INTO ad_servicio_autorizado VALUES ('ClientViewer.Products.QueryHistoryProductsByClientId',@rol,@producto, 'R', @moneda, getDate(), 'V', getDate())
...
ELSE
	INSERT INTO ad_servicio_autorizado VALUES ('PhoneTxService.getPhonebyCustomerAndAddress',@rol,@producto, 'R', @moneda, getDate(), 'V', getDate())

...
begin
       ...
       select   @o_nombre   =  en_nombre,
            ...
            @w_otros_ingresos       = en_otros_ingresos,    -- CL00031 RVI  02-Feb-2010   --PSO Sincronizaci¾n BOLIVARIANO
            ...
            @w_es_cliente           = (select case when (en_ente in (select cl_cliente 
                                       from cl_cliente(index cl_cliente_Key))) then 'S' else 'N' end from cl_ente where en_ente = @i_compania and en_subtipo = 'C')
        from  cl_ente
